...
class ControlProgController extends Controller
{
    ...
    public function buscarPorUsuario(Request $request)
    {
        ...
        $apodosTablas = [
            'clientes' => 'Clientes',
            'contactosubclientes' => 'Contactos Subclientes',
            'tramitessubclientes' => 'Trámites Subclientes',
            'requisitosubclientes' => 'Requisitos Subclientes',
            'bateriasubclientes' => 'Batería Subclientes',
            'estadocotizacionsubclientes' => 'Estado Cotización Subclientes',
            'programacionsubclientes' => 'Programación Subclientes',
            'estadoprogramacionsubclientes' => 'Estado Programación Subclientes',
            'documentacionsubclientes' => 'Documentación Subclientes',
