...
class AsociadoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.asociados.index', compact('asociados', 'grupoclientes'));
    }
    ...
    public function guardarclienteita(StoreClienteRequest $request)
    {
        ...
        // Guardar en la sesión que se debe descargar el PDF
        session()->flash('descargar_pdf', $cliente->id);

        // Redirigir al perfil del cliente recién creado usando el ID del cliente
    ...
    /* public function generarpdfcotizacionclienteita(Cliente $cliente, Request $request) 
    {
        ...
        $pdf = Pdf::loadView('admin.asociados.pdfcotizacionclienteita', [
            'cliente' => $cliente,
            'bateriasubclientes' => $bateriasubclientes,
            'total' => $total
        ]);

        $pdfName = 'Cotización_' . $cliente->nombres;
    ...
    public function crearprogramacionclienteita(Cliente $cliente, Request $request)
    {
        ...
        foreach ($fechasBateriaPorAccion as $item) {
            ...
            if (!isset($accionesRegistradas[$fecha]) || !in_array($accion, $accionesRegistradas[$fecha])) {
                $accionesPorFecha[$fecha][] = $accion;
            }
        } */
        $accionesPorFecha = [];
        foreach ($fechasBateriaPorAccion as $item) {
            ...
            // Verifica si la acción ya está registrada para la fecha y cliente específico
            ...
            // Solo agrega la acción si no está registrada
        ...
        foreach ($proveedoresAsignados as $accion => $nombreProveedor) {
            $proveedor = BateriaSubCliente::where('accionnombre', $accion)
                ->latest()
                ->first();
    ...
    public function estadoprogramacionclienteita(Cliente $cliente, Request $request)
    {
        ...
        return view('admin.asociados.estadoprogramacionclienteita', compact('estadoMapeado', 'fechaSeleccionada', 'id', 'fechas', 'nombreclienteita', 'accionesDisponibles', 'cliente', 'id', 'accionesCliente', 'estadoRegistrados', 'fechasBateriaPorAccion', 'accionesPorFecha', 'accionesRegistradas'));
    }
    ...
    public function generarpdfclienteita(Cliente $cliente, Request $request)
    {
        ...
        $request->validate([
            ...
            'preguntas.4.respuesta' => 'nullable|string',
            'detpe4' => 'nullable|string',
            'preguntas.5.respuesta' => 'nullable|string',
            'detpe5' => 'nullable|string',
            'preguntas.6.respuesta' => 'nullable|string',
            'detpe6' => 'nullable|string',
            'preguntas.7.respuesta' => 'nullable|string',
            'detpe7' => 'nullable|string',
            'preguntas.8.respuesta' => 'nullable|string',
            'detpe8' => 'nullable|string',
            'preguntas.9.respuesta' => 'nullable|string',
            'detpe9' => 'nullable|string',
            'preguntas.10.respuesta' => 'nullable|string',
            'detpe10' => 'nullable|string',
            'preguntas.11.respuesta' => 'nullable|string',
            'detpe11' => 'nullable|string',
            'otros' => '',
            //
            //OFTALMOLOGIA
            'preguntas.001.respuesta' => 'nullable|string',
            'hacecuanto001' => 'nullable|string',
            'periodotipo001' => 'nullable|string',
            'preguntas.002.respuesta' => 'nullable|string',
            'hacecuanto002' => 'nullable|string',
            'periodotipo002' => 'nullable|string',
            'preguntas.003.respuesta' => 'nullable|string',
            'hacecuanto003' => 'nullable|string',
            'periodotipo003' => 'nullable|string',
            'preguntas.004.respuesta' => 'nullable|string',
            'hacecuanto004' => 'nullable|string',
            'periodotipo004' => 'nullable|string',
            'preguntas.005.respuesta' => 'nullable|string',
            'hacecuanto005' => 'nullable|string',
            'periodotipo005' => 'nullable|string',
            'preguntas.006.respuesta' => 'nullable|string',
            'hacecuanto006' => 'nullable|string',
            'periodotipo006' => 'nullable|string',
            //
            //OTORRINOLARINGOLOGIA
            'preguntas.007.respuesta' => 'nullable|string',
            'hacecuanto007' => 'nullable|string',
            'periodotipo007' => 'nullable|string',
            'preguntas.008.respuesta' => 'nullable|string',
            'hacecuanto008' => 'nullable|string',
            'periodotipo008' => 'nullable|string',
            'preguntas.009.respuesta' => 'nullable|string',
            'hacecuanto009' => 'nullable|string',
            'periodotipo009' => 'nullable|string',
            'preguntas.010.respuesta' => 'nullable|string',
            'hacecuanto010' => 'nullable|string',
            'periodotipo010' => 'nullable|string',
            //
            //NEUROLOGIA
            'preguntas.011.respuesta' => 'nullable|string',
            'hacecuanto011' => 'nullable|string',
            'periodotipo011' => 'nullable|string',
            'preguntas.012.respuesta' => 'nullable|string',
            'hacecuanto012' => 'nullable|string',
            'periodotipo012' => 'nullable|string',
            'preguntas.013.respuesta' => 'nullable|string',
            'hacecuanto013' => 'nullable|string',
            'periodotipo013' => 'nullable|string',
            'preguntas.014.respuesta' => 'nullable|string',
            'hacecuanto014' => 'nullable|string',
            'periodotipo014' => 'nullable|string',
            'preguntas.015.respuesta' => 'nullable|string',
            'hacecuanto015' => 'nullable|string',
            'periodotipo015' => 'nullable|string',
            'preguntas.016.respuesta' => 'nullable|string',
            'hacecuanto016' => 'nullable|string',
            'periodotipo016' => 'nullable|string',
            'preguntas.017.respuesta' => 'nullable|string',
            'hacecuanto017' => 'nullable|string',
            'periodotipo017' => 'nullable|string',
            'preguntas.018.respuesta' => 'nullable|string',
            'hacecuanto018' => 'nullable|string',
            'periodotipo018' => 'nullable|string',
            //
            //CARDIOLOGIA
            'preguntas.019.respuesta' => 'nullable|string',
            'hacecuanto019' => 'nullable|string',
            'periodotipo019' => 'nullable|string',
            'preguntas.020.respuesta' => 'nullable|string',
            'hacecuanto020' => 'nullable|string',
            'periodotipo020' => 'nullable|string',
            'preguntas.021.respuesta' => 'nullable|string',
            'hacecuanto021' => 'nullable|string',
            'periodotipo021' => 'nullable|string',
            'preguntas.022.respuesta' => 'nullable|string',
            'hacecuanto022' => 'nullable|string',
            'periodotipo022' => 'nullable|string',
            'preguntas.023.respuesta' => 'nullable|string',
            'hacecuanto023' => 'nullable|string',
            'periodotipo023' => 'nullable|string',
            'preguntas.024.respuesta' => 'nullable|string',
            'hacecuanto024' => 'nullable|string',
            'periodotipo024' => 'nullable|string',
            'preguntas.025.respuesta' => 'nullable|string',
            'hacecuanto025' => 'nullable|string',
            'periodotipo025' => 'nullable|string',
            'preguntas.026.respuesta' => 'nullable|string',
            'hacecuanto026' => 'nullable|string',
            'periodotipo026' => 'nullable|string',
            //
            //ENDICRONOLOGIA
            'preguntas.027.respuesta' => 'nullable|string',
            'hacecuanto027' => 'nullable|string',
            'periodotipo027' => 'nullable|string',
            'preguntas.028.respuesta' => 'nullable|string',
            'hacecuanto028' => 'nullable|string',
            'periodotipo028' => 'nullable|string',
            'preguntas.029.respuesta' => 'nullable|string',
            'hacecuanto029' => 'nullable|string',
            'periodotipo029' => 'nullable|string',
            'preguntas.030.respuesta' => 'nullable|string',
            'hacecuanto030' => 'nullable|string',
            'periodotipo030' => 'nullable|string',
            'preguntas.031.respuesta' => 'nullable|string',
            'hacecuanto031' => 'nullable|string',
            'periodotipo031' => 'nullable|string',
            //
            //TRAUMATOLOGIA
            'preguntas.032.respuesta' => 'nullable|string',
            'hacecuanto032' => 'nullable|string',
            'periodotipo032' => 'nullable|string',
            'preguntas.033.respuesta' => 'nullable|string',
            'hacecuanto033' => 'nullable|string',
            'periodotipo033' => 'nullable|string',
            'preguntas.034.respuesta' => 'nullable|string',
            'hacecuanto034' => 'nullable|string',
            'periodotipo034' => 'nullable|string',
            'preguntas.035.respuesta' => 'nullable|string',
            'hacecuanto035' => 'nullable|string',
            'periodotipo035' => 'nullable|string',
            'preguntas.036.respuesta' => 'nullable|string',
            'hacecuanto036' => 'nullable|string',
            'periodotipo036' => 'nullable|string',
            'preguntas.037.respuesta' => 'nullable|string',
            'hacecuanto037' => 'nullable|string',
            'periodotipo037' => 'nullable|string',
            //
            //NEUMOLOGIA
            'preguntas.038.respuesta' => 'nullable|string',
            'hacecuanto038' => 'nullable|string',
            'periodotipo038' => 'nullable|string',
            'preguntas.039.respuesta' => 'nullable|string',
            'hacecuanto039' => 'nullable|string',
            'periodotipo039' => 'nullable|string',
            'preguntas.040.respuesta' => 'nullable|string',
            'hacecuanto040' => 'nullable|string',
            'periodotipo040' => 'nullable|string',
            'preguntas.041.respuesta' => 'nullable|string',
            'hacecuanto041' => 'nullable|string',
            'periodotipo041' => 'nullable|string',
            'preguntas.042.respuesta' => 'nullable|string',
            'hacecuanto042' => 'nullable|string',
            'periodotipo042' => 'nullable|string',
            //
            //GASTROENTEROLOGIA
            'preguntas.043.respuesta' => 'nullable|string',
            'hacecuanto043' => 'nullable|string',
            'periodotipo043' => 'nullable|string',
            'preguntas.044.respuesta' => 'nullable|string',
            'hacecuanto044' => 'nullable|string',
            'periodotipo044' => 'nullable|string',
            'preguntas.045.respuesta' => 'nullable|string',
            'hacecuanto045' => 'nullable|string',
            'periodotipo045' => 'nullable|string',
            'preguntas.046.respuesta' => 'nullable|string',
            'hacecuanto046' => 'nullable|string',
            'periodotipo046' => 'nullable|string',
            'preguntas.047.respuesta' => 'nullable|string',
            'hacecuanto047' => 'nullable|string',
            'periodotipo047' => 'nullable|string',
            'preguntas.048.respuesta' => 'nullable|string',
            'hacecuanto048' => 'nullable|string',
            'periodotipo048' => 'nullable|string',
            'preguntas.049.respuesta' => 'nullable|string',
            'hacecuanto049' => 'nullable|string',
            'periodotipo049' => 'nullable|string',
            'preguntas.050.respuesta' => 'nullable|string',
            'hacecuanto050' => 'nullable|string',
            'periodotipo050' => 'nullable|string',
            //
            //UROLOGIA / NEFROLOGIA
            'preguntas.051.respuesta' => 'nullable|string',
            'hacecuanto051' => 'nullable|string',
            'periodotipo051' => 'nullable|string',
            'preguntas.052.respuesta' => 'nullable|string',
            'hacecuanto052' => 'nullable|string',
            'periodotipo052' => 'nullable|string',
            'preguntas.053.respuesta' => 'nullable|string',
            'hacecuanto053' => 'nullable|string',
            'periodotipo053' => 'nullable|string',
            'preguntas.054.respuesta' => 'nullable|string',
            'hacecuanto054' => 'nullable|string',
            'periodotipo054' => 'nullable|string',
            //
            //DERMATOLOGIA
            'preguntas.055.respuesta' => 'nullable|string',
            'hacecuanto055' => 'nullable|string',
            'periodotipo055' => 'nullable|string',
            'preguntas.056.respuesta' => 'nullable|string',
            'hacecuanto056' => 'nullable|string',
            'periodotipo056' => 'nullable|string',
            'preguntas.057.respuesta' => 'nullable|string',
            'hacecuanto057' => 'nullable|string',
            'periodotipo057' => 'nullable|string',
            'preguntas.058.respuesta' => 'nullable|string',
            'hacecuanto058' => 'nullable|string',
            'periodotipo058' => 'nullable|string',
            'preguntas.059.respuesta' => 'nullable|string',
            'hacecuanto059' => 'nullable|string',
            'periodotipo059' => 'nullable|string',
            'preguntas.060.respuesta' => 'nullable|string',
            'hacecuanto060' => 'nullable|string',
            'periodotipo060' => 'nullable|string',
            //
            //CIRUGIA VASCULAR
            'preguntas.061.respuesta' => 'nullable|string',
            'hacecuanto061' => 'nullable|string',
            'periodotipo061' => 'nullable|string',
            'preguntas.062.respuesta' => 'nullable|string',
            'hacecuanto062' => 'nullable|string',
            'periodotipo062' => 'nullable|string',
            'preguntas.063.respuesta' => 'nullable|string',
            'hacecuanto063' => 'nullable|string',
            'periodotipo063' => 'nullable|string',
            //
            //REUMATOLOGIA
            'preguntas.064.respuesta' => 'nullable|string',
            'hacecuanto064' => 'nullable|string',
            'periodotipo064' => 'nullable|string',
            'preguntas.065.respuesta' => 'nullable|string',
            'hacecuanto065' => 'nullable|string',
            'periodotipo065' => 'nullable|string',
            'preguntas.066.respuesta' => 'nullable|string',
            'hacecuanto066' => 'nullable|string',
            'periodotipo066' => 'nullable|string',
            'preguntas.067.respuesta' => 'nullable|string',
            'hacecuanto067' => 'nullable|string',
            'periodotipo067' => 'nullable|string',
            'preguntas.068.respuesta' => 'nullable|string',
            'hacecuanto068' => 'nullable|string',
            'periodotipo068' => 'nullable|string',
            'preguntas.069.respuesta' => 'nullable|string',
            'hacecuanto069' => 'nullable|string',
            'periodotipo069' => 'nullable|string',
            'preguntas.070.respuesta' => 'nullable|string',
            'hacecuanto070' => 'nullable|string',
            'periodotipo070' => 'nullable|string',
            'preguntas.071.respuesta' => 'nullable|string',
            'hacecuanto071' => 'nullable|string',
            'periodotipo071' => 'nullable|string',
            //
            //ONCOLOGIA
            'preguntas.072.respuesta' => 'nullable|string',
            'hacecuanto072' => 'nullable|string',
            'periodotipo072' => 'nullable|string',
            //
            //CIRUGIA GENERAL
            'preguntas.073.respuesta' => 'nullable|string',
            'hacecuanto073' => 'nullable|string',
            'periodotipo073' => 'nullable|string',
            'preguntas.074.respuesta' => 'nullable|string',
            'hacecuanto074' => 'nullable|string',
            'periodotipo074' => 'nullable|string',
            //
            //GINECOLOGIA
            'preguntas.075.respuesta' => 'nullable|string',
            'hacecuanto075' => 'nullable|string',
            'periodotipo075' => 'nullable|string',
            'preguntas.076.respuesta' => 'nullable|string',
            'hacecuanto076' => 'nullable|string',
            'periodotipo076' => 'nullable|string',
            'preguntas.077.respuesta' => 'nullable|string',
            'hacecuanto077' => 'nullable|string',
            'periodotipo077' => 'nullable|string',
            'preguntas.078.respuesta' => 'nullable|string',
            'hacecuanto078' => 'nullable|string',
            'periodotipo078' => 'nullable|string',
            'preguntas.079.respuesta' => 'nullable|string',
            'hacecuanto079' => 'nullable|string',
            'periodotipo079' => 'nullable|string',
            //
            ...
            'alteracionoido' => '',
            'enfermedaddigestivo' => '',
            'enfermedadurogenital' => '',
            //ANTECEDENTES PERSONALES NO PATOLOGICOS
            //CIGARILLOS
            'estadocigarrillos' => '',
            'suspcigarillos' => '',
            'tiemposuspcigarillos' => '',
            'freccigarillos' => '',
            'tiempofreccigarillos' => '',
            'consumocigarillos' => '',
            'tiempoconscigarillos' => '',
            'numerocigarrillos' => '',
            //ALCOHOL
            'estadoalcoholismo' => '',
            'suspensionalcohol' => '',
            ...
            'preguntas.100.antecedente' => 'nullable|string',
            'preguntas.100.periodotiempo' => 'nullable|string',
            'preguntas.200.antecedente' => 'nullable|string',
            'preguntas.200.periodotiempo' => 'nullable|string',
            'preguntas.300.antecedente' => 'nullable|string',
            'preguntas.300.periodotiempo' => 'nullable|string',
            //ANTECEDENTES TRAUMATICOS
            'preguntas.1000.antecedente' => 'nullable|string',
            'preguntas.1000.periodotiempo' => 'nullable|string',
            'preguntas.2000.antecedente' => 'nullable|string',
            'preguntas.2000.periodotiempo' => 'nullable|string',
            'preguntas.3000.antecedente' => 'nullable|string',
            'preguntas.3000.periodotiempo' => 'nullable|string',
            ...
            'preguntas.30.respuesta' => 'nullable|string',
            'hacecuanto30' => 'nullable|string',
            'periodotipo30' => 'nullable|string',
            'preguntas.31.respuesta' => 'nullable|string',
            'hacecuanto31' => 'nullable|string',
            'periodotipo31' => 'nullable|string',
            'preguntas.32.respuesta' => 'nullable|string',
            'hacecuanto32' => 'nullable|string',
            'periodotipo32' => 'nullable|string',
            'preguntas.33.respuesta' => 'nullable|string',
            'hacecuanto33' => 'nullable|string',
            'periodotipo33' => 'nullable|string',
            'preguntas.34.respuesta' => 'nullable|string',
            'hacecuanto34' => 'nullable|string',
            'periodotipo34' => 'nullable|string',
            'preguntas.35.respuesta' => 'nullable|string',
            'hacecuanto35' => 'nullable|string',
            'periodotipo35' => 'nullable|string',
            'preguntas.36.respuesta' => 'nullable|string',
            'hacecuanto36' => 'nullable|string',
            'periodotipo36' => 'nullable|string',
            'preguntas.37.respuesta' => 'nullable|string',
            'hacecuanto37' => 'nullable|string',
            'periodotipo37' => 'nullable|string',
            'preguntas.38.respuesta' => 'nullable|string',
            'hacecuanto38' => 'nullable|string',
            'periodotipo38' => 'nullable|string',
            'preguntas.39.respuesta' => 'nullable|string',
            'hacecuanto39' => 'nullable|string',
            'periodotipo39' => 'nullable|string',
            'preguntas.40.respuesta' => 'nullable|string',
            'hacecuanto40' => 'nullable|string',
            'periodotipo40' => 'nullable|string',
            'preguntas.41.respuesta' => 'nullable|string',
            'hacecuanto41' => 'nullable|string',
            'periodotipo41' => 'nullable|string',
            //ANTECEDENTES LABORALES
            'fechainicioatclab' => '',
            'fechafinalatclab' => '',
            'preguntas.1.carac' => 'nullable|string',
            'preguntas.1.denun' => 'nullable|string',
            'preguntas.1.aten' => 'nullable|string',
            'preguntas.2.carac' => 'nullable|string',
            'preguntas.2.denun' => 'nullable|string',
            'preguntas.2.aten' => 'nullable|string',
            'preguntas.3.carac' => 'nullable|string',
            'preguntas.3.denun' => 'nullable|string',
            'preguntas.3.aten' => 'nullable|string',
            ...
            'exfipulmones' => '',
            'exfiabdomen' => '',
            'exfiextremidadesmmss' => '',
            'exfiextremidadesmmii' => '',
            'exfineurologico' => '',
            'exfivestibulocereboloso' => '',
            'exfimarcha' => '',
            'exficraneoycolumna' => '',
            'exfiexploracionneuro' => '',
            //
        ]);
    ...
    public function subirdocrequisitos(Cliente $cliente)
    {
        ...
        return view('admin.asociados.subirdocrequisitos', compact(
            'cliente',
            'poderPendiente',
            'avcciPendiente',
            'cnacaseguradoPendiente',
            'ciaseguradoPendiente',
            'cmatrimonioPendiente',
            'cnacconyugePendiente',
            'ciconyugePendiente',
            'cnacjihosPendiente',
            'cihijosPendiente',
            'denfaccidentePendiente',
            'recordserviciosPendiente',
            'crodomicilioPendiente',
            'contratoPendiente',
            'requisito',
            'poderSubido',
            'avcciSubido',
            ...
            'egestoraPendiente',
            'actdatosPendiente',
            'resolinvhijosPendiente',
            'ctrabajoSubido',
            'boletapagoSubido',
            'egestoraSubido',
            'actdatosSubido',
            'resolinvhijosSubido',
            'cunionlibrePendiente',
            'cnacimientounionlibrePendiente',
            'ciunionlibrePendiente',
            'cdivorcioPendiente',
            'cdefuncionPendiente',
            'cunionlibreSubido',
            'recordserviciosSubido',
            'cnacimientounionlibreSubido',
            'ciunionlibreSubido',
            'cdivorcioSubido',
            'cdefuncionSubido',
            'userRole'
    ...
    public function subirdocrequisitosaudi(Cliente $cliente)
    {
        ...
        return view('admin.asociados.subirdocrequisitosaudi', compact(
            'cliente',
            'cnacaseguradoPendiente',
            'ciaseguradoPendiente',
            'polizasgenPendiente',
            'declasaludPendiente',
            'polizaseguroPendiente',
            'requisito',
            'userRole',
            'cnacaseguradoSubido',
            'ciaseguradoSubido',
    ...
    public function subirdocrequisitosapelacion(Cliente $cliente)
    {
        ...
        return view('admin.asociados.subirdocrequisitosapelacion', compact(
            'cliente',
            'poderPendiente',
            'avcciPendiente',
            'cnacaseguradoPendiente',
            ...
            'cdefuncionSubido',
            'userRole',
            'dictamencalentencPendiente',
            'infomedicasaludPendiente',
            'anteriordictamenPendiente',
            'dictamencalentencSubido',
            'infomedicasaludSubido',
            'anteriordictamenSubido',
        ));
    }
    ...
    public function subirdocrequisitossegsolicitud(Cliente $cliente)
    {
        ...
        return view('admin.asociados.subirdocrequisitossegsolicitud', compact(
            'cliente',
            'poderPendiente',
            'avcciPendiente',
            'cnacaseguradoPendiente',
            ...
            'infomedicasaludSubido',
            'anteriordictamenSubido',
            'poderciapoderadoPendiente',
            'poderciapoderadoSubido'
        ));
    }
    ...
    public function generarPDFconsentimiento(Request $request)
    {
        ...
        $programacion = Bateriasubcliente::create([
            ...
            'accionid' => '6',
            'servicio' => 'INTERNO',
            'fechabateria' => now(), // Aquí asignamos la fecha actual
            'usuarioid' => $usuarioId,
            'usuarioregistro' => $usuarioNombre,
        ]);
    ...
    public function editarclienteauditoria(ClienteAuditoria $clienteauditoria)
    {
        ...
        return view('admin.asociados.editarclienteauditoria', compact('clienteauditoria', 'suc', 'genero', 'departamentos', 'estciv', 'gradoins', 'actlab', 'bancoActual', 'bancos'));
    }
    ...
    public function crearbateriaclienteauditoria(ClienteAuditoria $clienteauditoria)
    {
        ...
        $areas = Area::orderBy('nombrearea', 'asc')->where('idtipoarea', 2)->pluck('nombrearea', 'id');
        $accionesPorArea = [];
        foreach ($areas as $id => $nombreArea) {
            $accionesPorArea[$id] = AreaAccion::where('areasid', $id)
                ->where('sucursal', $sucursalCliente)
        ...
        $fechasbateriasSubCliente = BateriaSubCliente::where('clienteauditorianombre', $nombreCliente)
            ->distinct()
            ->pluck('fechabateria');
        $fechasBateriaPorAccion = BateriaSubCliente::whereIn('accionnombre', $accionesCliente)
        ...
        return view('admin.asociados.crearbateriaclienteauditoria', compact('accionesPorFecha', 'fechasBateriaPorAccion', 'departamentos', 'estadoproveedor', 'areas', 'accionesPorArea', 'clienteauditoria', 'id', 'accionesCliente', 'areas2'));
    }
    ...
    public function aprobacioncotizacionclienteauditoria(ClienteAuditoria $clienteauditoria, Request $request)
    {
        ...
        $fechas = BateriaSubCliente::where('clienteauditoriaid', $clienteauditoria->id)
            ->pluck('fechabateria')
            ->unique();
        $areas = BateriaSubCliente::where('clienteauditoriaid', $clienteauditoria->id)
            ->pluck('areanombre')
            ->unique();
        ...
        return view('admin.asociados.aprobacioncotizacionclienteauditoria', compact('bateriasubclientes', 'id', 'clienteauditoria', 'fechas', 'total', 'fechaSeleccionada', 'areas', 'areaSeleccionada'));
    }
    ...
    public function generarpdfcotizacionclienteauditoria(ClienteAuditoria $clienteauditoria, Request $request)
    {
        ...
        $areaSeleccionada = $request->get('buscarporarea');
        $total = $request->get('total');
        $bateriasubclientes = BateriaSubCliente::where('clienteauditoriaid', $clienteauditoria->id)
            ->when($fechaSeleccionada, function ($query) use ($fechaSeleccionada) {
                return $query->where('fechabateria', $fechaSeleccionada);
            })
            ->when($areaSeleccionada, function ($query) use ($areaSeleccionada) {
                return $query->where('areanombre', $areaSeleccionada); // Ajusta 'nombre_area' según el nombre real del campo en tu tabla
            })
            ->get();

        $pdf = PDF::loadView('admin.asociados.pdfcotizacionclienteauditoria', compact('clienteauditoria', 'bateriasubclientes', 'total'));
        $pdfName = 'Cotización_' . $clienteauditoria->nombrecompleto;
        $pdfName .= '.pdf';
    ...
    public function aprobarcotizacionprogramacionclienteauditoria(ClienteAuditoria $clienteauditoria)
    {
        ...
        return view('admin.asociados.aprobarcotizacionprogramacionclienteauditoria', compact('clienteauditoria', 'id', 'fechas', 'fechasRegistradas', 'fechasDisponibles'));
    }
    ...
    public function crearprogramacionclienteauditoria(ClienteAuditoria $clienteauditoria)
    {
        $nombreCliente = $clienteauditoria->nombrecompleto;
        $sucursalCliente = $clienteauditoria->sucursal;
        ...
        return view('admin.asociados.crearprogramacionclienteauditoria', compact('id', 'clienteauditoria', 'accionesPorFecha', 'proveedoresAsociados', 'accionesRegistradas', 'fechasBateriaPorAccion', 'accionesCliente'));
    }
    public function guardarprogramacionclienteauditoria(StoreProgramacionsubclienteRequest $request, WhatsAppService $whatsAppService)
    {
        $proveedoresSeleccionados = $request->input('proveedornombre');
        $horaasignada = $request->input('horaasignada');
        $fechaasignada = $request->input('fechaasignada');
        ...
        foreach ($proveedoresSeleccionados as $proveedor) {
            ...
            $clienteauditoria = ClienteAuditoria::findOrFail($idCliente);
            $clienteID = $clienteauditoria->id;

            $clienteitaData['clienteauditoriaid'] = $clienteID;
            $clienteitaData['accionnombre'] = $accionnombre;
            $clienteitaData['horaasignada'] = $horaasignada;
            $clienteitaData['clienteauditorianombre'] = $request->input('nombrecompleto');
            $clienteitaData['fechaasignada'] = $fechaasignada;
            $clienteitaData['precio'] = $precio;
            $clienteitaData['fechabateria'] = $request->input('fechabateria');

            $clienteauditoria = Programacionsubcliente::create($clienteitaData);
        }

        return redirect()->route('admin.asociados.crearprogramacionclienteauditoria', $request->clienteauditoria)->with('info', 'La programacion del cliente se creo con éxito');
    }
    public function reprogramacionclienteauditoria(ClienteAuditoria $clienteauditoria, Request $request)
    {
        ...
        $reprogramaciones = ProgramacionSubCliente::where('clienteauditoriaid', $clienteauditoria->id)
            ->onlyTrashed() // Obtener solo los registros eliminados
            ->get();
        $total = 0;
        if ($fechaSeleccionada) {
        ...
        return view('admin.asociados.reprogramacionclienteita', compact('reprogramaciones', 'programacionsubclientes', 'id', 'clienteauditoria', 'fechas', 'total', 'fechaSeleccionada'));
    }
    ...
    public function estadoprogramacionclienteauditoria(ClienteAuditoria $clienteauditoria, Request $request)
    {
        ...
        $id = ClienteAuditoria::where('nombrecompleto', $clienteauditoria->nombrecompleto)->value('id');
        return view('admin.asociados.estadoprogramacionclienteauditoria', compact('fechaSeleccionada', 'id', 'fechas', 'nombreclienteita', 'accionesDisponibles', 'clienteauditoria', 'id', 'accionesCliente', 'estadoRegistrados', 'fechasBateriaPorAccion', 'accionesPorFecha', 'accionesRegistradas'));
    }
    ...
    public function guardarestadoprogramacionclienteauditoria(StoreEstadoprogramacionsubclienteRequest $request)
    {
        ...
        return redirect()->route('admin.asociados.estadoprogramacionclienteauditoria', $request->clienteauditoria)->with('info', 'El estado se actualizó con éxito');
    }
    //
    ...
    public function creardocumentacionclienteauditoria(ClienteAuditoria $clienteauditoria, Asociado $asociado)
    {
        ...
        return view('admin.asociados.creardocumentacionclienteauditoria', compact('asociado', 'accionesEnEstado', 'id', 'clienteauditoria', 'accionesPorFecha', 'accionesRegistradas', 'fechasBateriaPorAccion', 'accionesCliente', 'documentosRegistrados'));
    }
    public function guardardocumentacionclienteauditoria(StoreDocumentacionsubclienteRequest $request)
    {
        $archivo_name = null;
        if ($request->hasFile('archivo')) {
            $file = $request->file('archivo');
        ...
        if ($request->hasFile('picture2')) {
            $file = $request->file('picture2');
            $image_name2 = time() . '_' . $file->getClientOriginalName();
            $file->move(public_path("/image"), $image_name2);
        }
    ...
    public function descargarchecklistclienteauditoria(Request $request, ClienteAuditoria $clienteauditoria)
    {
        ...
        $requisito = new RequisitoSubCliente();
        $requisito->clienteauditoriaid = $clienteauditoria->id;
        $requisito->clienteauditorianombre = $clienteauditoria->nombrecompleto;
        $requisito->usuarioid = $usuarioAutenticado->id;
        $requisito->usuarioregistro = $usuarioAutenticado->name;

        $nombreDocumentos = [
            'poder' => 'PODER',
            'avcci' => 'AVC / CARNET DEL ASEGURADO',
            'cnacasegurado' => 'CERTIFICADO DE NACIMIENTO DEL ASEGURADO',
            'ciasegurado' => 'CARNET DE IDENTIDAD DEL ASEGURADO',
            'cmatrimonio' => 'CERTIFICADO DE MATRIMONIO',
            'cnacconyuge' => 'CERTIFICADO DE NACIMIENTO DEL CONYUGE',
            'ciconyuge' => 'CARNET DE IDENTIDAD DEL CONYUGE',
            'cnacjihos' => 'CERTIFICADO DE NACIMIENTO DE HIJOS MENORES DE 25 AÑOS',
            'cihijos' => 'CARNET DE IDENTIDAD DE HIJOS MENORES DE 25 AÑOS',
            'denfaccidente' => 'DENUNCIA DE ENFERMEDAD DE ACCIDENTE',
        ...
        $pdf = PDF::loadView('admin.asociados.descargarchecklistclienteauditoria', compact('clienteauditoria', 'documentosSeleccionados', 'nombreDocumentos'));
        $pdfName = 'Requisitos_' . $clienteauditoria->nombrecompleto . '.pdf';
        return $pdf->download($pdfName);
    }
    //
    ...
    public function crearbateriabanco(Areaaccion $areaaccion, Asociado $asociado)
    {
        ...
        return view('admin.asociados.crearbateriabanco', compact('asociado', 'categoria', 'tiponombre', 'areaaccion', 'areas', 'estado', 'tipocliente', 'sucursal'));
    }
    public function guardarbateriabanco(StoreAreaaccionRequest $request)
    {
        $areaData = $request->all();

        $areaccion = Areaaccion::create($areaData);

        return redirect()->route('admin.asociados.index', $areaccion)->with('info', 'La acción se creó con éxito');
    }
