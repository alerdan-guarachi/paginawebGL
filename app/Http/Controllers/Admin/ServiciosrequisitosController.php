...
class ServiciosrequisitosController extends Controller
{
    /**
...
{
    $serviciosrequisitos = Serviciosrequisito::orderBy('created_at', 'desc')->get();

    // Agrupar por servicionombre
    $groupedServicios = $serviciosrequisitos->groupBy('servicionombre');

    return view('admin.serviciosrequisitos.index', compact('groupedServicios'));
}
