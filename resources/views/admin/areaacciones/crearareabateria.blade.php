...
<div class="card">
    <div class="card-body">
        {!! Form::model($area, ['route' => ['admin.areaacciones.guardarareabateria', $area], 'method' => 'POST']) !!}
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('tipoarea', $tipoareas, null, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45']) !!}
                            @error('tipoarea')
                    ...
                    {!! Form::text('idtipoarea', null, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45']) !!}
