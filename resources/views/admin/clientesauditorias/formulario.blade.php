            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('direccion', $clienteauditoria->direccion, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('motivoconsulta', $clienteauditoria->motivoconsulta, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        {!! Form::label('Ente gestor de salud:') !!}
                        {!! Form::text('entgestorsalud', $clienteauditoria->entgestorsalud, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('ocupacionprofesion', $clienteauditoria->ocupacionprofesion, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        {!! Form::label('Actividad laboral:') !!}
                        {!! Form::text('actividadlaboral', $clienteauditoria->actividadlaboral, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
            </div>
