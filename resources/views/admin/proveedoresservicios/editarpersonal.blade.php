...
<a class="btn btn-sm float-right btn-regresar" href="{{ route('admin.proveedoresservicios.verpersonal', $proveedoresservicios) }}">REGRESAR</a>
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12">
                {!! Form::model($proveedoresservicios, ['route' => ['admin.proveedoresservicios.actualizarpersonal', $proveedoresservicios], 'method' => 'post']) !!}
                ...
                <div class="row">
                    <div class="form-group col-lg-2">
                        ...
                        {!! Form::text('sexo', null, ['class' => 'form-control', 'maxlength' => '255']) !!}
                        @error('sexo')
                            <small class="text-danger fas fa-exclamation-circle">
                                {{$message}}
                            </small>
                    ...
                    <div class="form-group col-lg-2">
                        ...
                        {!! Form::date('fechanacimiento', null, ['class' => 'form-control', 'maxlength' => '255']) !!}
                    ...
                    <div class="form-group col-lg-2">
                        ...
                        {!! Form::text('nacionalidad', null, ['class' => 'form-control', 'maxlength' => '255']) !!}
                        @error('nacionalidad')
                            <small class="text-danger fas fa-exclamation-circle">
                                {{$message}}
                            </small>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-2">
                        ...
                        {!! Form::date('fechaingreso', null, ['class' => 'form-control', 'maxlength' => '255']) !!}
                        @error('fechaingreso')
                            <small class="text-danger fas fa-exclamation-circle">
                                {{$message}}
                            </small>
                    ...
                    <div class="form-group col-lg-2">
                        ...
                        {!! Form::date('fechasalida', null, ['class' => 'form-control', 'maxlength' => '255']) !!}
                        @error('fechasalida')
                            <small class="text-danger fas fa-exclamation-circle">
                                {{$message}}
                            </small>
