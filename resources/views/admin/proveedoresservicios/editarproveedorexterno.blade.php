...
<a class="btn btn-sm float-right btn-regresar" href="{{ route('admin.proveedoresservicios.verproveedorexterno', $proveedoresservicios) }}">REGRESAR</a>
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12">
                {!! Form::model($proveedoresservicios, ['route' => ['admin.proveedoresservicios.actualizarproveedorexterno', $proveedoresservicios], 'method' => 'post']) !!}
