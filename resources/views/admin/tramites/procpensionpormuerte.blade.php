...
<h5>PROCEDIMIENTO DE TRÁMITE DE PENSIÓN POR MUERTE DE:</h5>
...
<div class="card">
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" id="myTabs">
            ...
            @php
                $documento5 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->where('estadocomunicado', 'COMUNICADO')->first();
            @endphp
            @if (!$documento5)
            <li class="nav-item">
            ...
            <div class="tab-pane fade show active" id="tab-content-1" role="tabpanel" aria-labelledby="tab-1">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <br>
                        @php
                            $documento01 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'AVISO DE FALLECIMIENTO')->first();
                            $documento1 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                            $documento2 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->first();
                        @endphp
                        <div class="text-center">
                            @if (!$documento01 || !$documento1 || !$documento2)
                    ...
                    @php
                        $documento01 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'AVISO DE FALLECIMIENTO')->where('estadocomunicado', 'COMUNICADO')->first();
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <br>
                        @php
                            $documento3 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'VALIDACIÓN DE PODER')->first();
                        @endphp
                        <div class="text-center">
                            @if (!$documento3)
                                <span class="mb-0 checkamarillo">
                    ...
                    {{-- FIRMA EAP --}}
                    @php
                        $documento3 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'VALIDACIÓN DE PODER')->where('estadocomunicado', 'COMUNICADO')->first();
                    @endphp
                    <div class="col-12 col-md-4 mb-3">
                        <button type="button" class="btn btn-custom btn-block text-center" data-toggle="modal" data-target="#modalFirmaEAP" @if (!$documento3) disabled @endif>
                            <div class="d-flex flex-column align-items-center justify-content-center">
                                ...
                                @php
                                    $documento5 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                @endphp
                                @if (!$documento5)
                                    @if ($documento3)
                                        @php
            ...
            <div class="tab-pane fade" id="tab-content-2" role="tabpanel" aria-labelledby="tab-2">
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 mb-3">
                        ...
                        <br>
                        @php
                            $documento6 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'NOTIFICACIÓN DE GESTORA')->first();
                            $documento7 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'SOLICITUD DE CERTIFICADO DE OBITO LEGALIZADO')->first();
                            $documento8 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'RESPUESTA A NOTA DE GESTORA')->first();
                            $documento9 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'ADJUNTO DE DECLARACIÓN DE HEREDEROS')->first();
                        @endphp
                        <div class="text-center">
                                        ...
                                        <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="row mb-3 align-items-center {{ !$documento6 ? 'no-documento' : '' }}">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        @php
                                                            $documento6 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('nivelprocedimiento', 'NOTIFICACIONES, SOLICITUDES, ADJUNTOS Y RESPUESTAS')->where('subprocedimiento', 'NOTIFICACIÓN DE GESTORA')->first();
                                                        @endphp
                                                        @if ($documento6)
                                                ...
                                                <div class="row mb-3 align-items-center {{ !$documento7 ? 'no-documento' : '' }}">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        @php
                                                            $documento7 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('nivelprocedimiento', 'NOTIFICACIONES, SOLICITUDES, ADJUNTOS Y RESPUESTAS')->where('subprocedimiento', 'SOLICITUD DE CERTIFICADO DE OBITO LEGALIZADO')->first();
                                                        @endphp
                                                        @if ($documento7)
                                                ...
                                                <div class="row mb-3 align-items-center {{ !$documento8 ? 'no-documento' : '' }}">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        @php
                                                            $documento8 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('nivelprocedimiento', 'NOTIFICACIONES, SOLICITUDES, ADJUNTOS Y RESPUESTAS')->where('subprocedimiento', 'RESPUESTA A NOTA DE GESTORA')->first();
                                                        @endphp
                                                        @if ($documento8)
                                                ...
                                                <div class="row mb-3 align-items-center {{ !$documento9 ? 'no-documento' : '' }}">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        @php
                                                            $documento9 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('nivelprocedimiento', 'NOTIFICACIONES, SOLICITUDES, ADJUNTOS Y RESPUESTAS')->where('subprocedimiento', 'ADJUNTO DE DECLARACIÓN DE HEREDEROS')->first();
                                                        @endphp
                                                        @if ($documento9)
                                            ...
                                            @php
                                                $documento6 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'RECOJO DE NOTIFICACIÓN DE GESTORA')->first();
                                                $documento7 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'SOLICITUD DE CERTIFICADO DE OBITO LEGALIZADO')->first();
                                                $documento8 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'RESPUESTA A NOTA DE GESTORA')->first();
                                                $documento9 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'ADJUNTO DE DECLARACIÓN DE HEREDEROS')->first();
                                            @endphp
            ...
            <div class="tab-pane fade" id="tab-content-3" role="tabpanel" aria-labelledby="tab-3">
                <div class="row">
                    <div class="col-12 col-md-12 mb-3">
                        ...
                        <br>
                        @php
                            $documento11 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'FIRMA DE CONTRATO')->first();
                            $documento13 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'NOTA DE RECHAZO DE TRÁMITE')->first();
                        @endphp
                        <div class="text-center">
                ...
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        @php
                            $documento01 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'AVISO DE FALLECIMIENTO')->first();
                        @endphp
                        <div class="row mb-3 align-items-center {{ !$documento01 ? 'no-documento' : '' }}">
                            <div class="col-md-4 text-center">
                                <p class="mb-0">AVISO DE FALLECIMIENTO</p>
                                @if (!$documento01)
                                <input type="text" class="form-control" id="tramite1" name="tramite[]" value="PENSIÓN POR MUERTE" hidden>
                                <input type="text" class="form-control" id="nivelprocedimiento1" name="nivelprocedimiento[]" value="INGRESO DE TRÁMITE" hidden>
                                <input type="text" class="form-control" id="subprocedimiento1" name="subprocedimiento[]" value="AVISO DE FALLECIMIENTO" hidden>
                                @endif
                            </div>
                            <div class="col-md-4 text-center">
                                @php
                                ...
                                @endphp
                                @if ($documento01)
                                    <p class="mb-0">{{ $documento01->fechasubida }}</p>
                                @else
                                <input type="date" class="form-control" id="fechasubida1" name="fechasubida[]" value="{{ \Carbon\Carbon::now()->toDateString() }}" readonly>
                                @endif
                            </div>
                            <div class="col-md-4 text-center">
                                @if ($documento01)
                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/{$documento01->document}") }}" class="btn btn-verdocumento" target="_blank" style="width: 150px;">Ver Doc.</a>
                                @else
                                <input type="file" name="archivo[]" id="archivo1" class="dropify mx-auto d-block" accept=".pdf">
                                @endif
                            </div>
                        ...
                        <div class="row mb-3 align-items-center {{ !$documento1 ? 'no-documento' : '' }}">
                            <div class="col-md-4 text-center">
                                ...
                                @if (!$documento1)
                                <input type="text" class="form-control" id="tramite2" name="tramite[]" value="PENSIÓN POR MUERTE" hidden>
                                <input type="text" class="form-control" id="nivelprocedimiento2" name="nivelprocedimiento[]" value="INGRESO DE TRÁMITE" hidden>
                                <input type="text" class="form-control" id="subprocedimiento2" name="subprocedimiento[]" value="RECEPCIÓN DE TRÁMITE" hidden>
                                @endif
                            </div>
                            <div class="col-md-4 text-center">
                                @php
                        ...
                        <div class="row mb-3 align-items-center {{ !$documento2 ? 'no-documento' : '' }}">
                            <div class="col-md-4 text-center">
                                ...
                                <input type="text" class="form-control" id="tramite3" name="tramite[]" value="PENSIÓN POR MUERTE" hidden>
                                <input type="text" class="form-control" id="nivelprocedimiento3" name="nivelprocedimiento[]" value="INGRESO DE TRÁMITE" hidden>
                                <input type="text" class="form-control" id="subprocedimiento3" name="subprocedimiento[]" value="INCLUSIÓN DE PODER" hidden>
                            </div>
                            <div class="col-md-4 text-center">
                                @php
                                    $documento2 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->first();
            ...
            <div class="modal-body">
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        @php
                        $documento4 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'RECHAZO DE PODER')->first();
                        @endphp
                    ...
                    @php
                        $documento3 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'VALIDACION DE PODER')->first();
                        $documento4 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'RECHAZO DE PODER')->first();
                    @endphp
                    @if (!$documento3)
                        <button type="submit" class="btn btn-subirarchivos d-block mx-auto mb-3" target="_blank" style="width: fit-content;">SUBIR ARCHIVOS</button>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('admin.tramites.generarcartareclamo', $cliente) }}" method="GET" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <input type="text" class="form-control" id="tipocartareclamo" name="tipocartareclamo" value="PENSIÓN POR MUERTE" hidden>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        @php
                            $documento11 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'FIRMA DE CONTRATO')->first();
                        @endphp
            ...
            <div class="modal-body">
                <form id="seguimientoForm" action="{{ route('admin.tramites.guardartramitesclienteitaseguimiento', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        @php
                            $seguimientos = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('nivelprocedimiento', 'SEGUIMIENTO')->get();
                        @endphp
