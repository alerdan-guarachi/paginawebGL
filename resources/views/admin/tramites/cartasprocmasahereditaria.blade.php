...
<a class="btn btn-sm float-right btn-regresar" href="{{ route('admin.tramites.procmasahereditaria', $cliente->id) }}">REGRESAR</a>
<h5>MISIVAS DE MASA HEREDITARIA DE:</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-lg-4" id="fechainiciotramiteContainer" style="display: none;">
                                                        {!! Form::label('fechainiciotramite', 'Fecha Inicio Trámite:') !!}
                                                        {!! Form::date('fechainiciotramite', null, ['class' => 'form-control', 'placeholder' => '', 'value' => '{{ \Carbon\Carbon::now()->toDateString() }}']) !!}
                                                    </div>
                                                    <div class="form-group col-lg-4" id="fechafirmaeapContainer" style="display: none;">
                                                        {!! Form::label('fechafirmaeap', 'Fecha Firma EAP:') !!}
                                                        {!! Form::date('fechafirmaeap', null, ['class' => 'form-control', 'placeholder' => '', 'value' => '{{ \Carbon\Carbon::now()->toDateString() }}']) !!}
                                                    </div>
                                                    <div class="form-group col-lg-4" id="fechaformularioContainer" style="display: none;">
                                                        {!! Form::label('fechaformulario', 'Fecha Formulario:') !!}
                                                        {!! Form::date('fechaformulario', null, ['class' => 'form-control', 'placeholder' => '', 'value' => '{{ \Carbon\Carbon::now()->toDateString() }}']) !!}
                                                    </div>
                                                    <div class="form-group col-lg-4" id="nroresolucionContainer" style="display: none;">
                                                        {!! Form::label('nroresolucion', 'Nro. Resol. Adm.:') !!}
                                                        {!! Form::text('nroresolucion', null, ['class' => 'form-control', 'placeholder' => '']) !!}
                                                    </div>
                                                    <div class="form-group col-lg-4" id="fecharesolucionContainer" style="display: none;">
                                                        {!! Form::label('fecharesolucion', 'Fecha Resol. Adm.:') !!}
                                                        {!! Form::date('fecharesolucion', null, ['class' => 'form-control', 'placeholder' => '', 'value' => '{{ \Carbon\Carbon::now()->toDateString() }}']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            {{-- Acta de cobros --}}
                                            <div class="col-lg-12" id="tablaactacobrosContainer" style="display: none;">
                                                <div class="table-responsive">
                                                    <table class="table" id="actacobrosTable">
                                                        <thead class="table-secondary">
                                                            <tr style="text-align: center">
                                                                <th class="col-lg-6">PRESTACIÓN O MODALIDAD</th>
                                                                <th class="col-lg-6">PERIODOS NO COBRADOS</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                                <td class="col-lg-6">
                                                                    <select name="prestacion1" class="form-control">
                                                                ...
                                                                <td class="col-lg-6"><input type="month" name="periodo1" class="form-control" /></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <button type="button" class="btn btn-sm btn-verdocumento" id="agregarFilaadjunto22">AGREGAR MÁS</button>
                                                </div>
                                                {{-- <input type="text" class="form-control" id="tipocartareclamo" name="tipocartareclamo" value="PENSIÓN DE MASA HEREDITARIA" hidden> --}}
                                            </div>
                                            <script>
                                                $(document).ready(function() {
                                                    let filaCount22 = 1;
                                                    $('#agregarFilaadjunto22').on('click', function() {
                                                        filaCount22++;
                                                        if(filaCount22 > 15) return;

                                                        const nuevaFila = `
                                                            <tr>
                                                                <td class="col-lg-6">
                                                                    <select name="prestacion${filaCount22}" class="form-control">
                                                                        <option value="">Seleccione...</option>
                                                                        <option value="INVALIDEZ">INVALIDEZ</option>
                                                                        <option value="JUBILACIÓN">JUBILACIÓN</option>
                                                                        <option value="PENSIÓN POR MUERTE">PENSIÓN POR MUERTE</option>
                                                                ...
                                                                <td class="col-lg-6"><input type="month" name="periodo${filaCount22}" class="form-control" /></td>
                                                            </tr>
                                                        `;
                                                        $('#actacobrosTable tbody').append(nuevaFila);
                                                    });
                                                });
                                            </script>
                                        </div>
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                $('#tipoPdfSelect2').on('change', function() {
                                                    ...
                                                    $('#fechainiciotramiteContainer').hide();
                                                    $('#fechafirmaeapContainer').hide();
                                                    $('#fechaformularioContainer').hide();
                                                    $('#nroresolucionContainer').hide();
                                                    $('#fecharesolucionContainer').hide();
                                                    $('#tablaactacobrosContainer').hide();
                                                    ...
                                                    if (selectedValue === 'ACTUALIZACIÓN DE DATOS') {
                                                        ...
                                                        $('#nombremedicoContainer').show();
                                                    } else if (selectedValue === 'ACTA DE COBROS') { 
                                                        $('#nombremedicoContainer').show();
                                                        $('#fechainiciotramiteContainer').show();
                                                        $('#fechafirmaeapContainer').show();
                                                        $('#fechaformularioContainer').show();
                                                        $('#nroresolucionContainer').show();
                                                        $('#fecharesolucionContainer').show();
                                                        $('#tablaactacobrosContainer').show();
                                                    }
                                                });
                                            });
                                        </script>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.tramites.generaradjuntoyrespuesta', $cliente) }}" method="GET" enctype="multipart/form-data" id="formAdjunto">
                                        ...
                                        <input type="text" class="form-control" id="tramite2" name="tramite2" value="MASA HEREDITARIA" hidden>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.tramites.generarcartareclamo', $cliente) }}" method="GET" enctype="multipart/form-data" id="formCarta">
                                        ...
                                        <input type="text" class="form-control" id="tramite" name="tramite3" value="MASA HEREDITARIA" hidden>
                                            ...
                                            $(document).ready(function(){
                                                ...
                                                function toggleAdjuntoFields() {
                                                    ...
                                                    const subnivelesAdjuntos = [
                                                        ...
                                                        'ADJUNTO Y RESPUESTA A NOTIFICACIÓN TMC',
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.tramites.generarlibre', $cliente) }}" method="GET" enctype="multipart/form-data" id="formLibre">
                                        ...
                                        <input type="text" class="form-control" id="tramite4" name="tramite4" value="MASA HEREDITARIA" hidden>
