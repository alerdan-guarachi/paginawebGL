...
<h5>PROCEDIMIENTO DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES DE:</h5>
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="tab-content-1" role="tabpanel" aria-labelledby="tab-1">
                    <form id="formTramite" action="{{ route('admin.tramites.guardariniciotramiteclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                        ...
                        {!! Form::hidden('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES') !!}
    ...
    @if($inicioocontinuidad)
        ...
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs" id="myTabs">
                ...
                @php
                    $documento5 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')
            ...
            <div class="tab-content" id="myTabContent">
                    ...
                    @if($tramiteinicio)
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <br>
                                @php
                                    $documento1 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                                    $documento2 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->first();
                                @endphp
                                <div class="text-center"> 
                            ...
                            @php
                                $documento1 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where('subprocedimiento', 'RECEPCION DE TRÁMITE')->where('estadocomunicado', 'COMUNICADO')->first();
                                $documento2 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where('subprocedimiento', 'INCLUSION DE PODER')->where('estadocomunicado', 'COMUNICADO')->first();
                            @endphp
                            <div class="col-12 col-md-3 mb-3">
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                <button type="button" class="btn btn-custom btn-block text-center" data-toggle="modal" data-target="#modalFirmaEAP" @if (!$documento3) disabled @endif>
                                    <div class="d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        @php
                                            $documento1 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                        @endphp
                                        @if (!$documento1)
                                            @if ($documento3)
                                                @php
                                ...
                                <br>
                                @php
                                    $documento5 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                @endphp
                                <div class="text-center">
                                    @if (!$documento1)
                                        <span class="mb-0 checkamarillo">
                    ...
                    @if($tramitecontinuidad)
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <br>
                                @php
                                    $documento3 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'VALIDACIÓN DE PODER')->first();
                                @endphp
                                <div class="text-center">
                                    @if (!$documento3)
                                        <span class="mb-0 checkamarillo">
                            ...
                            @php
                                ...
                                $estadotramite = $cliente->tramites()->where('nivelprocedimiento', 'INGRESO DE TRÁMITE')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->whereIn('estadotramite', ['INGRESO DE TRÁMITE', 'FIRMA EAP'])->first();
                            @endphp
                            <div class="col-12 col-md-3 mb-3">
                ...
                <div class="modal fade" id="modalDatosAfiliado" tabindex="-1" role="dialog" aria-labelledby="modalDatosAfiliadoLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title titulomodal" id="modalDatosAfiliadoLabel">DATOS DEL AFILIADO</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label class="text-center d-block w-100">Observación de Trámite</label>
                                                            <p class="form-control-plaintext text-center">{{ $tiporetiroaportestotal }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    @endif
                                    <a class="btn btn-sm btn-subirrequisitos ml-2" href="{{ route('admin.asociados.subirdocrequisitosretiroaportestotal', $cliente->id) }}">VER REQUISITOS</a>
                                </div>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento1 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                                            $fecha = \Carbon\Carbon::now();
                                            $valor = $fecha->day <= 15 ? $fecha : $fecha->copy()->addMonth();
                                            $valorFormateado = $valor->format('m/y');
                                            $documento2 = $cliente->tramites()->where('subprocedimiento', 'INCLUSIÓN DE PODER')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                        @endphp
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        ...
                                                                        @if (!$documento1)
                                                                            <input type="hidden" name="tramite[]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        @if ($documento1)
                                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/INGRESO DE TRÁMITE/{$documento1->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                        ...
                                                        <table class="table table-bordered table-sm align-middle text-center">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        @if ($documento2)
                                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/INGRESO DE TRÁMITE/{$documento2->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                            @if ($puedeEditarArchivo)
                                                                                <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                                    <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                                    <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                                                        ...
                                                        <table class="table table-bordered table-sm align-middle text-center">
                                                            <thead class="thead-light">
                                                                <tr>
                                                                    ...
                                                                    <th style="width: 20%;">FECHA_INGRESO</th>
                                                                    <th style="width: 20%;">MES_CIERRE</th>
                                                                    <th style="width: 20%;">ESTADO_TRAMITE</th>
                                                                    <th style="width: 20%;">FECHA_ESTADO_TRAMITE</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        @if ($documento2)
                                                                            {{ $documento2->opcioncorsolicitud }}
                                                                        @else
                                                                            <input type="text" class="form-control text-center" name="opcioncorsolicitud[]">
                                                                        @endif
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        @if ($documento2)
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        ...
                                                                        @else
                                                                            <select class="form-control" name="estadotramite[]">
                                                                                ...
                                                                                <option value="INICIO DE TRÁMITE">INICIO DE TRÁMITE</option>
                                                                                <option value="FIRMA EAP">FIRMA EAP</option>
                                                                                <option value="SOLICITUD DE INFORMACIÓN COMPLEMENTARIA EGS">SOLICITUD DE INFORMACIÓN COMPLEMENTARIA EGS</option>
                                                                                <option value="SOLICITUD DE INFORME DEL EMPLEADOR">SOLICITUD DE INFORME DEL EMPLEADOR</option>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento4 = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE PODER')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                            $documento3 = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE PODER')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                            $documentoformval = $cliente->tramites()->where('subprocedimiento', 'FORMULARIO DE VALIDACIÓN DE PODER')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                            $correccionpoder = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE PODER')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                            $rechazodocext = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                            $validaciondocext = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                            $correcciondocext = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();

                                            $docformretiro = $cliente->tramites()->where('subprocedimiento', 'FORMULARIO DE VALIDACIÓN DE RETIRO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                            $docvalret = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE RETIRO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                        @endphp
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm align-middle text-center">
                                                <thead class="thead-light">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="align-middle text-center">
                                                            ...
                                                            @if (!$documentoformval)
                                                                <input type="hidden" name="tramite[formulariovalidacion]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                        ...
                                                        <td class="align-middle text-center">
                                                            @if ($documentoformval)
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/NOTIFICACIÓN DE PODER/{$documentoformval->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                @if ($puedeEditarArchivo)
                                                                    <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                        <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                        <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                                                    ...
                                                    <tr>
                                                        <td class="align-middle text-center">
                                                            ...
                                                            @if (!$documento3)
                                                                <input type="hidden" name="tramite[validacionpoder]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                        ...
                                                        <td class="align-middle text-center">
                                                            @if ($documento3)
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/NOTIFICACIÓN DE PODER/{$documento3->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                @if ($puedeEditarArchivo)
                                                                    <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                        <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                        <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                                                    ...
                                                    <tr>
                                                        <td class="align-middle text-center">
                                                            ...
                                                            @if (!$docformretiro)
                                                                <input type="hidden" name="tramite[formulariovalidacionretiro]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                        ...
                                                        <td class="align-middle text-center">
                                                            @if ($docformretiro)
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/NOTIFICACIÓN DE PODER/{$docformretiro->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                            @else
                                                    ...
                                                    <tr>
                                                        <td class="align-middle text-center">
                                                            ...
                                                            @if (!$docvalret)
                                                                <input type="hidden" name="tramite[validacionret]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                        ...
                                                        <td class="align-middle text-center">
                                                            @if ($docvalret)
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/NOTIFICACIÓN DE PODER/{$docvalret->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                            @else
                                            ...
                                            @if ($cliente->paisnacimiento !== 'BOLIVIA')
                                                <table class="table table-bordered table-sm align-middle text-center">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @php
                                                            $formulariosrecepcion = $cliente->tramites()->where('subprocedimiento', 'FORMULARIO DE RECEPCIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->get();
                                                        @endphp
                                                                    ...
                                                                    <tr class="fila-formulariorecepcion">
                                                                        ...
                                                                        <td class="align-middle text-center">
                                                                            @if ($formulariorecepcion->document)
                                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/NOTIFICACIÓN DE PODER/{$formulariorecepcion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                            @else
                                                        ...
                                                        @if (!$validaciondocext || $rechazodocext && (!$rechazodocext || $rechazodocext))
                                                            @php
                                                                $rechazosDocExt = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->get();
                                                                $validacionesDocExt = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->get();
                                                            @endphp
                                                                ...
                                                                @if ($rechazosDocExt->count() > 0)
                                                                    @foreach ($rechazosDocExt as $rechazo)
                                                                        <tr class="fila-rechazo">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($rechazo->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/NOTIFICACIÓN DE PODER/{$rechazo->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                                                        ...
                                                        @if ($rechazodocext)
                                                            @php
                                                                $correccionesDocExt = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->get();
                                                            @endphp
                                                                        ...
                                                                        <tr class="fila-correccion">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($correccion->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/NOTIFICACIÓN DE PODER/{$correccion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                                                                        ...
                                                                        <tr class="fila-validacion">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($validacion->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/NOTIFICACIÓN DE PODER/{$validacion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    {!! Form::hidden('apoderado', $apoderadoAsignado) !!}
                                    {!! Form::hidden('idtramite', $idTramite) !!}
                                    {!! Form::hidden('tramitenombreprog', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES') !!}
                                    @csrf
                                    <div class="container">
                                        @php
                                            $documento5 = $cliente->tramites()->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                        @endphp
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm align-middle text-center">
                                                <thead class="thead-light">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            @if ($documento5)
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/FIRMA EAP/{$documento5->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                @if ($puedeEditarArchivo)
                                                                    <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                        <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                        <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            <div class="dropdown">
                                ...
                                @php
                                    $documentos = [
                                        $documento210 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ÓBITO _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first(),
                                        $documento250 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'FORENSE _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first(),
                                        $documento290 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'EMPLEADOR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first(),
                                        $documento270 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'CERTIFICADO DE ESTUDIOS _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first(),
                                    ];
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item @if($documento210) text-success @endif" href="#" data-toggle="modal" data-target="#modalEnteGestorSalud2">ÓBITO</a>
                                    <a class="dropdown-item @if($documento250) text-success @endif" href="#" data-toggle="modal" data-target="#modalNotificacionTMC2">FORENSE</a>
                                    <a class="dropdown-item @if($documento290) text-success @endif" href="#" data-toggle="modal" data-target="#modalEmpleador2">EMPLEADOR</a>
                                    <a class="dropdown-item @if($documento270) text-success @endif" href="#" data-toggle="modal" data-target="#modalCertEst2">CERTIFICADO DE ESTUDIOS</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="modalEnteGestorSalud2" tabindex="-1" role="dialog" aria-labelledby="modalEnteGestorSalud2Label" aria-hidden="true">
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title titulomodal" id="modalEnteGestorSalud2Label">SIC - ÓBITO</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="container">
                                                @php
                                                    $documento21com = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ÓBITO _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                                    $sitmentegestorcom = $cliente->tramites()
                                                        ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')
                                                        ->where('subprocedimiento', 'ÓBITO _ NOTIFICACIÓN DE REQUERIMIENTO')
                                                        ->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')
                                                    ->get();
                                                    $sicobitorespuesta2 = $cliente->tramites()
                                                        ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')
                                                        ->where('subprocedimiento', 'ÓBITO _ RESPUESTA A REQUERIMIENTO')
                                                        ->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')
                                                    ->get();
                                                @endphp
                                                <div class="table-responsive">
                                                                ...
                                                                <tbody>
                                                                    @foreach ($sitmentegestorcom as $documento)
                                                                        <tr>
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/SOLICITUD DE INFORMACIÓN COMPLEMENTARIA/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                                                                    ...
                                                                    @endif
                                                                        ...
                                                                        <td class="align-middle text-center">
                                                                            ...
                                                                            <input type="hidden" name="subprocedimiento[]" value="ÓBITO _ NOTIFICACIÓN DE REQUERIMIENTO">
                                                                        </td>
                                                                        <td class="align-middle text-center">
                                                    ...
                                                    <table class="table table-bordered table-sm align-middle text-center">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sicobitorespuesta2 as $documento)
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ $documento->id }}</p>
                                                                    </td>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/SOLICITUD DE INFORMACIÓN COMPLEMENTARIA/{$documento->document2}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach

                                                            @if ($sicobitorespuesta2->isEmpty())
                                                                <tr class="fila-sicobitorespuesta2">
                                                            @else
                                                                <tr class="fila-sicobitorespuesta2 d-none">
                                                            @endif
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control" disabled>
                                                                </td>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    ...
                                                                    <input type="hidden" name="tramite[]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                                    <input type="hidden" name="nivelprocedimiento[]" value="SOLICITUD DE INFORMACIÓN COMPLEMENTARIA">
                                                                    <input type="hidden" name="subprocedimiento[]" value="ÓBITO _ RESPUESTA A REQUERIMIENTO">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    @php
                                                                        $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                                                        ...
                                                                        $fechaLimiteStr = $fechaLimite->toDateString();
                                                                    @endphp
                                                                    <input type="date" class="form-control text-center" id="fechasubida18" name="fechasubida[]" value="{{ $fechaSubidaDefault }}" data-max="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }} onchange="actualizarFechaRetorno18(this)">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="date" class="form-control text-center" id="fecharetorno18" name="fecharetorno[]" value="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="file" name="archivo[]" class="dropify mx-auto d-block" accept="application/pdf">
                                                                </td>
                                                    ...
                                                    @if (!$sicobitorespuesta2->isEmpty())
                                                    <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                        <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarSITMsicobitorespuesta2()">AGREGAR MÁS</button>
                                                    </div>
                                                    @endif
                                                    <script>
                                                        function agregarSITMsicobitorespuesta2() {
                                                            const filaOculta = document.querySelector('.fila-sicobitorespuesta2.d-none');
                                                            if (filaOculta) {
                                                                filaOculta.classList.remove('d-none');
                                                            }
                                                        }
                        ...
                        <div class="modal fade" id="modalNotificacionTMC2" tabindex="-1" role="dialog" aria-labelledby="modalNotificacionTMC2CLabel" aria-hidden="true">
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title titulomodal" id="modalEnteGestorSalud2Label">SIC - FORENSE</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="container">
                                                @php
                                                    $documento21com2 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'FORENSE _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                                    $sitmentegestorcom2 = $cliente->tramites()
                                                        ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')
                                                        ->where('subprocedimiento', 'FORENSE _ NOTIFICACIÓN DE REQUERIMIENTO')
                                                        ->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')
                                                    ->get();
                                                    $sitforenserespuesta2 = $cliente->tramites()
                                                        ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')
                                                        ->where('subprocedimiento', 'FORENSE _ RESPUESTA A REQUERIMIENTO')
                                                        ->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')
                                                    ->get();
                                                @endphp
                                                <div class="table-responsive">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @endif
                                                                        ...
                                                                        <td class="align-middle text-center">
                                                                            ...
                                                                            <input type="hidden" name="tramite[]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                                            <input type="hidden" name="nivelprocedimiento[]" value="SOLICITUD DE INFORMACIÓN COMPLEMENTARIA">
                                                                            <input type="hidden" name="subprocedimiento[]" value="FORENSE _ NOTIFICACIÓN DE REQUERIMIENTO">
                                                                        </td>
                                                                        <td class="align-middle text-center">
                                                                            <input type="text" class="form-control text-center" name="citenotificacion[]">
                                                                        </td>
                                                    ...
                                                    <table class="table table-bordered table-sm align-middle text-center">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sitforenserespuesta2 as $documento)
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ $documento->id }}</p>
                                                                    </td>
                                                            ...
                                                            @if ($sitforenserespuesta2->isEmpty())
                                                                <tr class="fila-sitforenserespuesta2">
                                                            @else
                                                                <tr class="fila-sitforenserespuesta2 d-none">
                                                            @endif
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control" disabled>
                                                                </td>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    ...
                                                                    <input type="hidden" name="tramite[]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                                    <input type="hidden" name="nivelprocedimiento[]" value="SOLICITUD DE INFORMACIÓN COMPLEMENTARIA">
                                                                    <input type="hidden" name="subprocedimiento[]" value="FORENSE _ RESPUESTA A REQUERIMIENTO">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    @php
                                                                        $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                                                        ...
                                                                        $fechaLimiteStr = $fechaLimite->toDateString();
                                                                    @endphp
                                                                    <input type="date" class="form-control text-center" id="fechasubida17" name="fechasubida[]" value="{{ $fechaSubidaDefault }}" data-max="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }} onchange="actualizarFechaRetorno17(this)">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="date" class="form-control text-center" id="fecharetorno17" name="fecharetorno[]" value="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="file" name="archivo[]" class="dropify mx-auto d-block" accept="application/pdf">
                                                                </td>
                                                    ...
                                                    @if (!$sitforenserespuesta2->isEmpty())
                                                    <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                        <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarSITMsitforenserespuesta2()">AGREGAR MÁS</button>
                                                    </div>
                                                    @endif
                                                    <script>
                                                        function agregarSITMsitforenserespuesta2() {
                                                            const filaOculta = document.querySelector('.fila-sitforenserespuesta2.d-none');
                                                            if (filaOculta) {
                                                                filaOculta.classList.remove('d-none');
                                                            }
                                                        }
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-subirarchivos d-block mx-auto" style="margin-top:10px;">GUARDAR</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!-- MODAL CERTIFICADO DE ESTUDIOS -->
                        <div class="modal fade" id="modalCertEst2" tabindex="-1" role="dialog" aria-labelledby="modalCertEst2Label" aria-hidden="true">
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title titulomodal" id="modalCertEst2Label">SIC - CERTIFICADO DE ESTUDIOS</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                        ...
                                        <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="container">
                                                @php
                                                    ...
                                                    $valor = $fecha->day <= 15 ? $fecha : $fecha->copy()->addMonth();
                                                    $valorFormateado = $valor->format('m/y');
                                                    $sitcertestnotificacion2 = $cliente->tramites()
                                                        ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')
                                                        ->where('subprocedimiento', 'CERTIFICADO DE ESTUDIOS _ NOTIFICACIÓN DE REQUERIMIENTO')
                                                        ->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')
                                                    ->get();
                                                    $sitcertestrespuesta2 = $cliente->tramites()
                                                        ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')
                                                        ->where('subprocedimiento', 'CERTIFICADO DE ESTUDIOS _ RESPUESTA A REQUERIMIENTO')
                                                        ->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')
                                                    ->get();
                                                @endphp
                                                <div class="table-responsive">
                                                    <div class="scroll-shadow-wrapper">
                                                        <div class="scroll-shadow-container">
                                                            <table class="table table-bordered table-sm align-middle text-center">
                                                                ...
                                                                <tbody>
                                                                    @foreach ($sitcertestnotificacion2 as $documento)
                                                                        <tr>
                                                                            <td class="align-middle text-center">
                                                                                <p class="mb-0">{{ $documento->id }}</p>
                                                                            </td>
                                                                    ...
                                                                    @if ($sitcertestnotificacion2->isEmpty())
                                                                        <tr class="fila-sitcertestnotificacion2">
                                                                    @else
                                                                        <tr class="fila-sitcertestnotificacion2 d-none">
                                                                    @endif
                                                                        <td class="align-middle text-center">
                                                                            <input type="text" class="form-control" disabled>
                                                                        </td>
                                                                        ...
                                                                        <td class="align-middle text-center">
                                                                            ...
                                                                            <input type="hidden" name="tramite[]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                                            <input type="hidden" name="nivelprocedimiento[]" value="SOLICITUD DE INFORMACIÓN COMPLEMENTARIA">
                                                                            <input type="hidden" name="subprocedimiento[]" value="CERTIFICADO DE ESTUDIOS _ NOTIFICACIÓN DE REQUERIMIENTO">
                                                                        </td>
                                                                        <td class="align-middle text-center">
                                                                            <input type="text" class="form-control text-center" name="citenotificacion[]">
                                                                        </td>
                                                                        ...
                                                                        <td class="align-middle text-center">
                                                                            @php
                                                                                ...
                                                                                $fechaLimiteStr = $fechaLimite->toDateString();
                                                                            @endphp
                                                                            <input type="date" class="form-control text-center" id="fechasubida15" name="fechasubida[]" value="{{ $fechaSubidaDefault }}" data-max="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }} onchange="actualizarFechaRetorno15(this)">
                                                                        </td>
                                                                        <td class="align-middle text-center">
                                                                            <input type="date" class="form-control text-center" id="fecharetorno15" name="fecharetorno[]" value="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                        </td>
                                                                        <td class="align-middle text-center">
                                                                            <input type="file" name="archivo[]" class="dropify mx-auto d-block" accept="application/pdf">
                                                                        </td>
                                                            ...
                                                            @if (!$sitcertestnotificacion2->isEmpty())
                                                            <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                                <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarSITMsitcertestnotificacion2()">AGREGAR MÁS</button>
                                                            </div>
                                                            @endif
                                                            <script>
                                                                function agregarSITMsitcertestnotificacion2() {
                                                                    const filaOculta = document.querySelector('.fila-sitcertestnotificacion2.d-none');
                                                                    if (filaOculta) {
                                                                        filaOculta.classList.remove('d-none');
                                                                    }
                                                                }
                                                    ...
                                                    <table class="table table-bordered table-sm align-middle text-center">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sitcertestrespuesta2 as $documento)
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ $documento->id }}</p>
                                                                    </td>
                                                            ...
                                                            @if ($sitcertestrespuesta2->isEmpty())
                                                                <tr class="fila-sitcertestrespuesta2">
                                                            @else
                                                                <tr class="fila-sitcertestrespuesta2 d-none">
                                                            @endif
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control" disabled>
                                                                </td>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    ...
                                                                    <input type="hidden" name="tramite[]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                                    <input type="hidden" name="nivelprocedimiento[]" value="SOLICITUD DE INFORMACIÓN COMPLEMENTARIA">
                                                                    <input type="hidden" name="subprocedimiento[]" value="CERTIFICADO DE ESTUDIOS _ RESPUESTA A REQUERIMIENTO">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    @php
                                                                        $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                                                        ...
                                                                        $fechaLimiteStr = $fechaLimite->toDateString();
                                                                    @endphp
                                                                    <input type="date" class="form-control text-center" id="fechasubida16" name="fechasubida[]" value="{{ $fechaSubidaDefault }}" data-max="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }} onchange="actualizarFechaRetorno16(this)">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="date" class="form-control text-center" id="fecharetorno16" name="fecharetorno[]" value="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="file" name="archivo[]" class="dropify mx-auto d-block" accept="application/pdf">
                                                                </td>
                                                    ...
                                                    @if (!$sitcertestrespuesta2->isEmpty())
                                                    <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                        <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarSITMsitcertestrespuesta2()">AGREGAR MÁS</button>
                                                    </div>
                                                    @endif
                                                    <script>
                                                        function agregarSITMsitcertestrespuesta2() {
                                                            const filaOculta = document.querySelector('.fila-sitcertestrespuesta2.d-none');
                                                            if (filaOculta) {
                                                                filaOculta.classList.remove('d-none');
                                                            }
                                                        }
                ...
                <div class="tab-pane fade" id="tab-content-3" role="tabpanel" aria-labelledby="tab-3">
                    <div class="row">
                        {{-- DICTAMEN --}}
                        <div class="col-12 col-md-3 mb-3">
                            <button type="button" class="btn btn-custom btn-block text-center" data-toggle="modal" data-target="#modalDictamenInicio">
                                <div class="d-flex flex-column align-items-center justify-content-center">
                            ...
                            <br>
                            @php
                                $documento41 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'NOTIFICACIÓN DE DICTAMEN')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                            @endphp
                            <div class="text-center">
                                @if ($documento41)
                        ...
                        <div class="col-12 col-md-3 mb-3">
                            @if ($documentoRechazado)
                                <button type="button" class="btn btn-custom btn-block text-center" data-toggle="modal" data-target="#modalDictamenRechazado11" disabled>
                                    <div class="d-flex flex-column align-items-center justify-content-center">
                            ...
                            @elseif ($documento43)
                                <button type="button" class="btn btn-custom btn-block text-center" data-toggle="modal" data-target="#modalDictamenAceptado11">
                                    <div class="d-flex flex-column align-items-center justify-content-center">
                                        <i class="fas fa-balance-scale-left fa-5x mr-2"></i>
                                        <span class="h6 mb-0 btn-block text-center">DICTAMEN ACEPTADO</span>
                                    </div>
                                ...
                                @else
                                <button type="button" class="btn btn-custom btn-block text-center" data-toggle="modal" data-target="#modalDictamenAceptado11" disabled>
                                    <div class="d-flex flex-column align-items-center justify-content-center">
                                        <i class="fas fa-balance-scale-left fa-5x mr-2"></i>
                        ...
                        <div class="col-12 col-md-3 mb-3">
                            <button class="btn btn-custom btn-block text-center" type="button" data-toggle="modal" data-target="#modalCompradeservicios">
                                <div class="d-flex flex-column align-items-center justify-content-center">
                                    ...
                                    <span class="h6 mb-0 btn-block text-center">RESPUESTA A TRÁMITE</span>
                                </div>
                            </button>

                            <br>
                            @php
                                $documento10 = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'NOTIFICACIÓN DE GESTORA')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                $documento103 = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'AGENDAMIENTO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                $documento104 = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'ORDENES DE COMPRA DE SERVICIOS')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                            @endphp
                            <div class="text-center">
                        ...
                        <div class="modal fade" id="modalCompradeservicios" tabindex="-1" role="dialog" aria-labelledby="modalCompradeserviciosLabel" aria-hidden="true">
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title titulomodal" id="modalCompradeserviciosLabel">RESPUESTA A TRÁMITE</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                            ...
                                            <div class="container">
                                                @php
                                                    $cssolicitud = $cliente->tramites()
                                                        ->where('nivelprocedimiento', 'RESPUESTA A TRÁMITE')
                                                        ->where('subprocedimiento', 'SELECCIÓN DE BENEFICIO')
                                                        ->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')
                                                    ->get();
                                                    $csnotarechazo = $cliente->tramites()
                                                        ->where('nivelprocedimiento', 'RESPUESTA A TRÁMITE')
                                                        ->where('subprocedimiento', 'NOTA DE RECHAZO')
                                                        ->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')
                                                    ->get();
                                                    $csformretiroaportes = $cliente->tramites()
                                                        ->where('nivelprocedimiento', 'RESPUESTA A TRÁMITE')
                                                        ->where('subprocedimiento', 'FORMULARIO DE RETIRO DE APORTES')
                                                        ->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')
                                                    ->get();
                                                @endphp
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table table-bordered table-sm align-middle text-center">
                                                        <thead class="thead-light">
                                                            <tr>
                                                                ...
                                                                <th style="width: 10%;">NRO.</th>
                                                                <th style="width: 20%;">SUB_PROCEDIMIENTO</th>
                                                                <th style="width: 20%;">CITE_NOTIFICACIÓN</th>
                                                                <th style="width: 20%;">FECHA_CITE_NOTIF.</th>
                                                                <th style="width: 10%;">FECHA_REGISTRO</th>
                                                        ...
                                                        <tbody>
                                                            @foreach ($cssolicitud as $documento)
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">SELECCIÓN DE BENEFICIO</p>
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                                    </td>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/RESPUESTA A TRÁMITE/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                            ...
                                                            @endif
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    <p class="mb-0">SELECCIÓN DE BENEFICIO</p>
                                                                    <input type="hidden" name="tramite[respuestatramite]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                                    <input type="hidden" name="nivelprocedimiento[respuestatramite]" value="RESPUESTA A TRÁMITE">
                                                                    <input type="hidden" name="subprocedimiento[respuestatramite]" value="SELECCIÓN DE BENEFICIO">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control text-center" name="citenotificacion[respuestatramite]">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="date" class="form-control text-center" name="fechacitenotificacion[respuestatramite]" value="{{ \Carbon\Carbon::now()->toDateString() }}">
                                                                </td>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    @php
                                                                        $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                                                    @endphp
                                                                    <input type="date" class="form-control text-center" name="fechasubida[respuestatramite]" value="{{ $fechaSubidaDefault }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="file" name="archivo[respuestatramite]" class="dropify mx-auto d-block" accept="application/pdf">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                        ...
                                                        <tbody>
                                                            @foreach ($csnotarechazo as $documento)
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">NOTA DE RECHAZO</p>
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                                    </td>
                                                            ...
                                                            @if ($csnotarechazo->isEmpty())
                                                                <tr class="fila-csnotarechazo">
                                                            @else
                                                                <tr class="fila-csnotarechazo d-none">
                                                            @endif
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control" disabled>
                                                                </td>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    <p class="mb-0">NOTA DE RECHAZO</p>
                                                                    <input type="hidden" name="tramite[notarechazo]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                                    <input type="hidden" name="nivelprocedimiento[notarechazo]" value="RESPUESTA A TRÁMITE">
                                                                    <input type="hidden" name="subprocedimiento[notarechazo]" value="NOTA DE RECHAZO">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control text-center" name="citenotificacion[notarechazo]">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="date" class="form-control text-center" name="fechacitenotificacion[notarechazo]" value="{{ \Carbon\Carbon::now()->toDateString() }}">
                                                                </td>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    @php
                                                                        $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                                                    @endphp
                                                                    <input type="date" class="form-control text-center" name="fechasubida[notarechazo]" value="{{ $fechaSubidaDefault }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="file" name="archivo[notarechazo]" class="dropify mx-auto d-block" accept="application/pdf">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    @if (!$csnotarechazo->isEmpty())
                                                        <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                            <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarCScsnotarechazo()">AGREGAR MÁS</button>
                                                        </div>
                                                    @endif
                                                    <script>
                                                        function agregarCScsnotarechazo() {
                                                            const filaOculta = document.querySelector('.fila-csnotarechazo.d-none');
                                                            if (filaOculta) {
                                                                filaOculta.classList.remove('d-none');
                                                            }
                                                        }
                                                    ...
                                                    {{-- FORMULARIO DE RETIRO DE APORTES --}}
                                                    <table class="table table-bordered table-sm align-middle text-center">
                                                        <thead class="thead-light">
                                                            <tr>
                                                                <th style="width: 10%;">ID</th>
                                                        ...
                                                        <tbody>
                                                            @foreach ($csformretiroaportes as $documento)
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ $documento->id }}</p>
                                                                    </td>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">FORMULARIO DE RETIRO DE APORTES</p>
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                                    </td>
                                                            ...
                                                            @if ($csformretiroaportes->isEmpty())
                                                                <tr class="fila-csformretiroaportes">
                                                            @else
                                                                <tr class="fila-csformretiroaportes d-none">
                                                            @endif
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control" disabled>
                                                                </td>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    <p class="mb-0">FORMULARIO DE RETIRO DE APORTES</p>
                                                                    <input type="hidden" name="tramite[csformretiroaportes]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                                    <input type="hidden" name="nivelprocedimiento[csformretiroaportes]" value="RESPUESTA A TRÁMITE">
                                                                    <input type="hidden" name="subprocedimiento[csformretiroaportes]" value="FORMULARIO DE RETIRO DE APORTES">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control text-center" name="citenotificacion[csformretiroaportes]">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="date" class="form-control text-center" name="fechacitenotificacion[csformretiroaportes]" value="{{ \Carbon\Carbon::now()->toDateString() }}">
                                                                </td>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    @php
                                                                        $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                                                    @endphp
                                                                    <input type="date" class="form-control text-center" name="fechasubida[csformretiroaportes]" value="{{ $fechaSubidaDefault }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="file" name="archivo[csformretiroaportes]" class="dropify mx-auto d-block" accept="application/pdf">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    @if (!$csformretiroaportes->isEmpty())
                                                        <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                            <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarCScsformretiroaportes()">AGREGAR MÁS</button>
                                                        </div>
                                                    @endif
                                                    <script>
                                                        function agregarCScsformretiroaportes() {
                                                            const filaOculta = document.querySelector('.fila-csformretiroaportes.d-none');
                                                            if (filaOculta) {
                                                                filaOculta.classList.remove('d-none');
                                                            }
                                                        }
                        ...
                        <div class="col-12 col-md-3 mb-3">
                            ...
                            <br>
                            @php
                                $documento41 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'NOTIFICACIÓN DE CONTRATO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                            @endphp
                            <div class="text-center">
                                @if ($documento41)
                                    @if ($documento41->estadodictamen == 'ACEPTADO')
                        ...
                        {{-- @php
                            $documento43 = $cliente->tramites()->where('subprocedimiento', 'NOTIFICACIÓN DE CONTRATO')->where('estadodictamen', 'ACEPTADO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                            $documentoRechazado = $cliente->tramites()->where('subprocedimiento', 'NOTIFICACIÓN DE CONTRATO')->where('estadodictamen', 'RECHAZADO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                        @endphp
                        <div class="col-12 col-md-6 mb-3">
                            @if ($documentoRechazado)
                            ...
                            @elseif ($documento43)
                                ...
                                <br>
                                @php
                                    $documento43 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'ACEPTACIÓN DE CONTRATO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                    $documento44 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'FIRMA DE FORMULARIO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                    $documento45 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'FIRMA DE CONTRATO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                    $documento46 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'COBRO DE PENSIÓN')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                    $documento47 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'NOTA DE RECHAZO DE TRÁMITE')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();

                                    $accedepensiondictamen = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE CONTRATO')->where('accesopension', 'SI')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                    $noaccedepensiondictamene6 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE CONTRATO (EXCESO DE 6 MESES)')->where('accesopension', 'NO')->where('motivonopension', 'EXCESO DE 6 MESES')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                    $noaccedepensiondictamenfc = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE CONTRATO (FALTA DE COBERTURA)')->where('accesopension', 'NO')->where('motivonopension', 'FALTA DE COBERTURA')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('admin.tramites.generarcartareclamo', $cliente) }}" method="GET" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" id="tramite" name="tramite" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES" hidden>
                    <input type="date" class="form-control" id="fechasubida" name="fechasubida" value="{{ \Carbon\Carbon::now()->toDateString() }}" hidden>
                    @csrf
                    <div class="row">
                        @php
                            $documento1 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where('nivelprocedimiento', 'INGRESO DE TRÁMITE')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                            $documento5 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where('nivelprocedimiento', 'FIRMA EAP')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                            $fechaingresoyeap = $documento1 && $documento5;

                            $primeracartasit = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'PRIMERA CARTA SIT')->first();
                            $segundacartasit = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'SEGUNDA CARTA SIT')->first();
                            $terceracartasit = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'TERCERA CARTA SIT')->first();
                            $primeracartareclamo = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'PRIMERA CARTA DE RECLAMO')->first();
                            $segundacartareclamo = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'SEGUNDA CARTA DE RECLAMO')->first();
                            $terceracartareclamo = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'TERCERA CARTA DE RECLAMO')->first();
                            $cartareclamoaps = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'CARTA DE RECLAMO APS')->first();
                        @endphp
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" id="tipocartareclamo" name="tipocartareclamo" value="PENSIÓN DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES" hidden>
                                    ...
                                    <tbody>
                                        @forelse ($listasolicitudes as $solicitud)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/SOLICITUDES/{$solicitud->document}") }}"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuesta', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="nombretramite" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                    ...
                                                    <td>
                                                        @if ($solicitud->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/SOLICITUDES/{$solicitud->document2}") }}"
                                    ...
                                    <tbody>
                                        @forelse ($listaadjuntos as $adjunto)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/ADJUNTOS Y RESPUESTAS/{$adjunto->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuestaadjunto', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($adjunto->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/ADJUNTOS Y RESPUESTAS/{$adjunto->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
                                    ...
                                    <tbody>
                                        @forelse ($listacartas as $carta)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/CARTAS Y RECLAMOS/{$carta->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                    title="VER ADJUNTO/RESPUESTA" target="_blank"></a>
                                                </td>
                                                <form action="{{ route('admin.tramites.guardarrespuestacarta', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($carta->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/CARTAS Y RECLAMOS/{$carta->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                    ...
                                                    <td>
                                                        @if ($carta->document3)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/CARTAS Y RECLAMOS/{$carta->document3}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
                                                ...
                                                <tr class="bg-light">
                                                    <td colspan="13">
                                                        <div class="row g-2">
                                                            ...
                                                            <div class="col-md-2">
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/CARTAS Y RECLAMOS/{$carta->document4}") }}"
                                                                class="btn btn-sm btn-verdocumento"
                                                                target="_blank">
                                    ...
                                    <tbody>
                                        @forelse ($listamisivas as $misiva)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/MISIVAS LIBRES/{$misiva->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuestamisivalibre', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($misiva->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/MISIVAS LIBRES/{$misiva->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                    ...
                                                    <td>
                                                        @if ($misiva->document3)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/MISIVAS LIBRES/{$misiva->document3}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
...
<!-- DICTAMEN -->
<div class="modal fade" id="modalDictamenInicio" tabindex="-1" role="dialog" aria-labelledby="modalDictamenInicioLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <form id="formTramite" action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    {!! Form::hidden('usuarioid', auth()->user()->id) !!}
                    {!! Form::hidden('usuarioregistro', auth()->user()->name) !!}
                    {!! Form::hidden('clienteid', $cliente->id) !!}
                    {!! Form::hidden('clientenombre', $cliente->nombrecompleto) !!}
                                        ...
                                        <tbody>
                                            @foreach ($dictamennotificacion as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/DICTAMEN/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            ...
                                            @endif
                                                    ...
                                                    document.addEventListener('input', function(e) {
                                                        if (e.target.classList.contains('porcentaje') || e.target.classList.contains('riesgo')) {
                                                            ...
                                                            if (riesgo === 'RIESGO PROFESIONAL') {
                                                                ...
                                                                else tipo = 'GRAN PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES';
                                                ...
                                                <td class="align-middle text-center">
                                                    ...
                                                    <select class="form-control motivonopension" name="motivonopension[]" style="display:none;">
                                                        <option value="" disabled selected>Seleccione una opción...</option>
                                                        <option value="MENOR A 120 APORTES">MENOR A 120 APORTES</option>
...
<!-- DICTAMEN ACEPTADO -->
<div class="modal fade" id="modalDictamenAceptado11" tabindex="-1" role="dialog" aria-labelledby="modalDictamenAceptado11Label" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        @php
                            $documento29 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                            $documento30 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ CARTA SOLICITUD A EMPLEADOR')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                            $documento31 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ SOLICITUD DE MODIFICACIÓN DE CITE')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();

                            $documento31 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ SOLICITUD DE MODIFICACIÓN DE CITE')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                            
                            $dictamenexiste = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'NOTIFICACIÓN DE DICTAMEN')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                            ...
                            $rechazosolinvdictamenexceso6mes = $cliente->tramites()
                                ->where('nivelprocedimiento', 'DICTAMEN')
                                ->where('subprocedimiento', 'RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES (EXCESO DE SEIS MESES)')
                                ->where('accesopension', 'NO')
                                ->where('motivonopension', 'EXCESO DE 6 MESES')
                                ->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')
                            ->get();
                            ...
                            $rechazosolinvdictamenfaltacober = $cliente->tramites()
                                ->where('nivelprocedimiento', 'DICTAMEN')
                                ->where('subprocedimiento', 'RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES (FALTA DE COBERTURA)')
                                ->where('accesopension', 'NO')
                                ->where('motivonopension', 'FALTA DE COBERTURA')
                                ->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')
                            ->get();
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RENUNCIA A REVISIÓN DE DICTAMEN</p>
                                                <input type="hidden" name="tramite[renunciarevdictamen]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                        ...
                                        <table class="table table-bordered table-sm align-middle text-center">
                                            ...
                                            <tbody>
                                                ...
                                                @endif
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">FIRMA DE CONTRATO</p>
                                                        <input type="hidden" name="tramite[firmacontratodictamen]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                        ...
                        {{-- DICTAMEN NO ACCEDE A PENSION CON EXCESO DE SEIS MESES --}}
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RENUNCIA A REVISIÓN DE DICTAMEN (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[renunciarevdictamenexceso6mes]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                            ...
                            {{-- RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES --}}
                            <div class="scroll-shadow-wrapper">
                                <div class="scroll-shadow-container">
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        <thead class="thead-light">
                                        ...
                                        <tbody>
                                            @foreach ($rechazosolinvdictamenexceso6mes as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES (EXCESO DE SEIS MESES)</p>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                    </td>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[rechazosolinvdictamenexceso6mes]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                    <input type="hidden" name="nivelprocedimiento[rechazosolinvdictamenexceso6mes]" value="DICTAMEN">
                                                    <input type="hidden" name="subprocedimiento[rechazosolinvdictamenexceso6mes]" value="RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES (EXCESO DE SEIS MESES)">
                                ...
                                <tbody>
                                    ...
                                    @endif
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <input type="hidden" name="tramite[formulariodictamenexceso6mes]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">FIRMA DE CONTRATO (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[firmacontratodictamenexceso6mes]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RENUNCIA A REVISIÓN DE DICTAMEN (FALTA DE COBERTURA)</p>
                                                    <input type="hidden" name="tramite[renunciarevdictamenfaltacober]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                        ...
                                        <tbody>
                                            @foreach ($rechazosolinvdictamenfaltacober as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES (FALTA DE COBERTURA)</p>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                    </td>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES (FALTA DE COBERTURA)</p>
                                                    <input type="hidden" name="tramite[rechazosolinvdictamenfaltacober]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                                    <input type="hidden" name="nivelprocedimiento[rechazosolinvdictamenfaltacober]" value="DICTAMEN">
                                                    <input type="hidden" name="subprocedimiento[rechazosolinvdictamenfaltacober]" value="RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES (FALTA DE COBERTURA)">
...
<!-- DICTAMEN RECHAZADO -->
<div class="modal fade" id="modalDictamenRechazado11" tabindex="-1" role="dialog" aria-labelledby="modalDictamenRechazado11Label" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        @php
                            $documento48 = $cliente->tramites()->where('subprocedimiento', 'INICIO PROCESO DE APELACIÓN')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                        @endphp
                        <div class="row mb-3 align-items-center {{ !$documento48 ? 'no-documento' : '' }}">
                            <div class="col-md-4 text-center">
                                <p class="mb-0">ABRIR PROCESO DE APELACIÓN</p>
                                <input type="text" class="form-control" id="tramite1" name="tramite[]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES" hidden>
                                        ...
                                        <tbody>
                                            @foreach ($dictamennotificacion as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/CONTRATO/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                ...
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        @php
                            ...
                            $dictamenexiste = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'NOTIFICACIÓN DE CONTRATO')->where('tramite', 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES')->first();
                                                            ...
                                                            select.addEventListener('change', function () {
                                                                ...
                                                                if (this.value === 'SI') {
                                                                    opcionaccedepension.querySelectorAll('option').forEach(opt => {
                                                                        if (
                                                                            opt.value !== '' &&
                                                                            opt.value !== 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES' &&
                                                                            opt.value !== 'RETIRO DE APORTES PARCIAL' &&
                                                                            opt.value !== 'PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES'
                                                                        ) {
                                                                            opt.remove();
                    ...
                    <div class="container">
                        ...
                        <div class="row mb-3 align-items-center no-documento">
                            <div class="col-md-3 text-center" hidden>
                                <input type="text" class="form-control" name="tramite[]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES" hidden>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($procedimientotramite->capturacomunicacion)
                                                            ...
                                                            <td class="align-middle text-center">
                                                                ...
                                                                @else
                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/COMUNICACIONES/{$procedimientotramite->capturacomunicacion}") }}"
                                                                    class="btn btn-sm btn-verdocumento"
                                                                    target="_blank">
                                                                    VER CAPTURA
                                                                    </a>
                                                        ...
                                                        @else
                                                            <td class="align-middle text-center" colspan="8">
                                                                <form action="{{ route('tramites.subirArchivo', ['id' => $procedimientotramite->id, 'clienteId' => $cliente->id]) }}" method="POST" enctype="multipart/form-data" class="d-flex gap-2">
                                                                    @csrf
                                                                    <input type="hidden" name="tramitenombre" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                        ...
                                        <form action="{{ route('admin.tramites.guardarseguimientoclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <table class="table table-striped table-bordered align-middle text-center table-sm tabla-comunicaciones" style="table-layout: fixed; width: 100%;">
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="align-middle text-center">
                                                                @if(!$seguimiento->capturacomunicacion)
                                                                    <span class="badge bg-warning text-dark">VACÍO</span>
                                                                @else
                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/COMUNICACIONES/{$seguimiento->capturacomunicacion}") }}"
                                                                        class="btn btn-sm btn-verdocumento"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="hidden" name="comtramitenombre" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                        ...
                                        <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                            ...
                                            <tbody>
                                                ...
                                                @endif
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">CANCELACIÓN DE TRAMITE</p>
                                                        <input type="hidden" name="tramite[cancelaciontramitegestora]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                    ...
                                    <tbody>
                                        @foreach ($rechazocancelaciontramite as $documento)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/CANCELACIÓN/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER CARTA</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RECHAZO DE CANCELACIÓN DE TRÁMITE GP</p>
                                                <input type="hidden" name="tramite[rechazocancelaciontramite]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RECHAZO DE CANCELACIÓN DE TRÁMITE APS</p>
                                                <input type="hidden" name="tramite[rechazocancelaciontramiteaps]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">ACEPTACIÓN DE CANCELACIÓN DE TRÁMITE</p>
                                                <input type="hidden" name="tramite[aceptacioncancelaciontramite]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">DESISTIMIENTO A CANCELACIÓN DE TRÁMITE</p>
                                                <input type="hidden" name="tramite[desistimientocancelaciontramite]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                ...
                                <tbody>
                                    @foreach ($notiferronea as $documento)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/NOTIFICACIÓN ERRÓNEA/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    @endif
                                        ...
                                        <td class="align-middle text-center">
                                            <input type="hidden" name="tramite[notiferronea]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
                                        ...
                                        <tbody>
                                            @foreach ($notifobservadas as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/NOTIFICACIÓN OBSERVADA/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        @if($documento->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES/NOTIFICACIÓN OBSERVADA/{$documento->document2}") }}"
                                                            target="_blank"
                                                            class="btn btn-sm btn-verdocumento">
                                                            VER RESPUESTA
                                                            </a>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <input type="hidden" name="tramite[notifobservadas]" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
