...
{{-- @if($inicioocontinuidad)
    ...
    <a class="btn btn-sm float-right btn-cartareclamo" href="{{ route('admin.tramites.cartasprocpensionmuerte', $cliente->id) }}">NUEVA MISIVA</a>
...
@if($inicioocontinuidad)
    <div class="dropdown float-right ml-2">
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
            ...
            <a class="dropdown-item" href="{{ route('admin.tramites.cartasprocpensionmuerte', $cliente->id) }}">
...
<h5>PROCEDIMIENTO DE PENSIÓN POR MUERTE DE:</h5>
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="tab-content-1" role="tabpanel" aria-labelledby="tab-1">
                    <form id="formTramite" action="{{ route('admin.tramites.guardariniciotramiteclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                        ...
                        {!! Form::hidden('tramite', 'PENSIÓN POR MUERTE') !!}
    ...
    @if($inicioocontinuidad)
        ...
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs" id="myTabs">
                ...
                @php
                    $documento5 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')
            ...
            <div class="tab-content" id="myTabContent">
                    ...
                    @if($tramiteinicio)
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <br>
                                @php
                                    $datosAfiliado = $subtramites->where('tipo', 'DATOS DE AFILIADO')->where('tramite', 'PENSIÓN POR MUERTE')->where('clienteid', $cliente->id)->first();
                                @endphp
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <br>
                                @php
                                    $documento1 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                                    $documento2 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->first();
                                @endphp
                                <div class="text-center"> 
                            ...
                            @php
                                $documento1 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'RECEPCION DE TRÁMITE')->where('estadocomunicado', 'COMUNICADO')->first();
                                $documento2 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'INCLUSION DE PODER')->where('estadocomunicado', 'COMUNICADO')->first();
                            @endphp
                            <div class="col-12 col-md-3 mb-3">
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                <button type="button" class="btn btn-custom btn-block text-center" data-toggle="modal" data-target="#modalFirmaEAP" @if (!$documento3) disabled @endif>
                                    <div class="d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        @php
                                            $documento1 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                        @endphp
                                        @if (!$documento1)
                                            @if ($documento3)
                                                @php
                                ...
                                <br>
                                @php
                                    $documento5 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                @endphp
                                <div class="text-center">
                                    @if (!$documento1)
                                        <span class="mb-0 checkamarillo">
                    ...
                    @if($tramitecontinuidad)
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 mb-3">
                                ...
                                <br>
                                @php
                                    $documento3 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'VALIDACIÓN DE PODER')->first();
                                @endphp
                                <div class="text-center">
                                    @if (!$documento3)
                                        <span class="mb-0 checkamarillo">
                            ...
                            @php
                                ...
                                $estadotramite = $cliente->tramites()->where('nivelprocedimiento', 'INGRESO DE TRÁMITE')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->where('tramite', 'PENSIÓN POR MUERTE')->whereIn('estadotramite', ['INGRESO DE TRÁMITE', 'FIRMA EAP'])->first();
                            @endphp
                            <div class="col-12 col-md-4 mb-3">
                ...
                <div class="modal fade" id="modalDatosAfiliado" tabindex="-1" role="dialog" aria-labelledby="modalDatosAfiliadoLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardardatosafiliadopensionmuerte', $cliente) }}" method="POST">
                                    @csrf
                                    {!! Form::hidden('usuarioid', auth()->user()->id) !!}
                                    {!! Form::hidden('usuarioregistro', auth()->user()->name) !!}
                                    {!! Form::hidden('clienteid', $cliente->id) !!}
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="container p-3">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-12">
                                                            <label class="form-label fw-bold">Nombre Afiliado</label>
                                                            @if($datosAfiliado)
                                                                <p class="form-control-plaintext">{{ $datosAfiliado->nombreafiliado }}</p>
                                                                {!! Form::hidden('nombreafiliado', $datosAfiliado->nombreafiliado) !!}
                                                            @else
                                                                {!! Form::text('nombreafiliado', null, ['class'=>'form-control']) !!}
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-12">
                                                            <label class="form-label fw-bold">Edad Fallecimiento</label>
                                                            @if($datosAfiliado)
                                                                <p class="form-control-plaintext">{{ $datosAfiliado->edadfallecimiento }}</p>
                                                                {!! Form::hidden('edadfallecimiento', $datosAfiliado->edadfallecimiento) !!}
                                                            @else
                                                                {!! Form::number('edadfallecimiento', null, ['class'=>'form-control']) !!}
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-12">
                                                            <label class="form-label fw-bold">Servicios Percibidos</label>
                                                            @if($datosAfiliado)
                                                                <p class="form-control-plaintext">
                                                                    {{ $datosAfiliado->percibiaservicio1 }}
                                                                    {{ $datosAfiliado->percibiaservicio2 ? ' - '.$datosAfiliado->percibiaservicio2 : '' }}
                                                                    {{ $datosAfiliado->percibiaservicio3 ? ' - '.$datosAfiliado->percibiaservicio3 : '' }}
                                                                </p>
                                                                {!! Form::hidden('percibiaservicio1', $datosAfiliado->percibiaservicio1) !!}
                                                                {!! Form::hidden('percibiaservicio2', $datosAfiliado->percibiaservicio2) !!}
                                                                {!! Form::hidden('percibiaservicio3', $datosAfiliado->percibiaservicio3) !!}
                                                            @else
                                                                @php
                                                                    $opciones = [
                                                                        'INVALIDEZ'=>'INVALIDEZ',
                                                                        'PENSIÓN DE VEJEZ'=>'PENSIÓN DE VEJEZ',
                                                                        'PENSIÓN SOLIDARIA DE VEJEZ'=>'PENSIÓN SOLIDARIA DE VEJEZ'
                                                                    ];
                                                                @endphp
                                                                @foreach($opciones as $valor => $texto)
                                                                    <div class="form-check mb-1">
                                                                        <input type="checkbox" name="servicios[]" value="{{ $valor }}" class="form-check-input servicio-check" id="servicio-{{ $valor }}">
                                                                        <label class="form-check-label" for="servicio-{{ $valor }}">{{ $texto }}</label>
                                                                    </div>
                                                                @endforeach
                                                                {!! Form::hidden('percibiaservicio1', null, ['id'=>'servicio1']) !!}
                                                                {!! Form::hidden('percibiaservicio2', null, ['id'=>'servicio2']) !!}
                                                                {!! Form::hidden('percibiaservicio3', null, ['id'=>'servicio3']) !!}
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    {{-- Estado laboral al fallecer --}}
                                                    <div class="row mb-3">
                                                        <div class="col-12">
                                                            <label class="form-label fw-bold">Estado laboral al fallecer</label>
                                                            @if($datosAfiliado)
                                                                <p class="form-control-plaintext">{{ $datosAfiliado->estadolaboralfallec }}</p>
                                                                {!! Form::hidden('estadolaboralfallec', $datosAfiliado->estadolaboralfallec) !!}
                                                            @else
                                                                {!! Form::select('estadolaboralfallec',['ACTIVO'=>'ACTIVO','INACTIVO'=>'INACTIVO'], null, ['class'=>'form-select form-control']) !!}
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    {{-- Última Fecha Laboral --}}
                                                    <div class="row mb-3" id="fechaLaboralContainer" style="display:none;">
                                                        <div class="col-12">
                                                            <label class="form-label fw-bold">Última Fecha Laboral</label>
                                                            @if($datosAfiliado)
                                                                <p class="form-control-plaintext">{{ $datosAfiliado->ultimafechalaboral }}</p>
                                                                {!! Form::hidden('ultimafechalaboral', $datosAfiliado->ultimafechalaboral) !!}
                                                            @else
                                                                {!! Form::date('ultimafechalaboral', null, ['class'=>'form-control']) !!}
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <script>
                                                    document.addEventListener('DOMContentLoaded', function() {
                                                        ...
                                                        const hidden1 = document.getElementById('servicio1');
                                                        const hidden2 = document.getElementById('servicio2');
                                                        const hidden3 = document.getElementById('servicio3');
                                                        checks.forEach(chk => {
                                                            chk.addEventListener('change', function() {
                                                                ...
                                                                hidden1.value = seleccionados[0] || '';
                                                                hidden2.value = seleccionados[1] || '';
                                                                hidden3.value = seleccionados[2] || '';
                                                            });
                                                        });
                                                        const selectEstado = document.querySelector('[name="estadolaboralfallec"]');
                                                        const fechaLaboralContainer = document.getElementById('fechaLaboralContainer');
                                                        function toggleFechaLaboral() {
                                                            if (selectEstado && selectEstado.value === 'INACTIVO') {
                                                                fechaLaboralContainer.style.display = 'block';
                                                            } else {
                                                                fechaLaboralContainer.style.display = 'none';
                                                            }
                                                        }
                                                        if (selectEstado) {
                                                            selectEstado.addEventListener('change', toggleFechaLaboral);
                                                            toggleFechaLaboral();
                                                        }
                                                    });
                                                </script>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento1 = $cliente->tramites()->where('tramite', 'PENSIÓN POR MUERTE')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                                            $fecha = \Carbon\Carbon::now();
                                            $valor = $fecha->day <= 15 ? $fecha : $fecha->copy()->addMonth();
                                            $valorFormateado = $valor->format('m/y');
                                            $documento2 = $cliente->tramites()->where('subprocedimiento', 'INCLUSIÓN DE PODER')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                        @endphp
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        ...
                                                                        @if (!$documento1)
                                                                            <input type="hidden" name="tramite[]" value="PENSIÓN POR MUERTE">
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        @if ($documento1)
                                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/INGRESO DE TRÁMITE/{$documento1->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                        ...
                                                        <table class="table table-bordered table-sm align-middle text-center">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        @if ($documento2)
                                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/INGRESO DE TRÁMITE/{$documento2->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                            @if ($puedeEditarArchivo)
                                                                                <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                                    <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                                    <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento4 = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE PODER')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                            $documento3 = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE PODER')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                            $documentoformval = $cliente->tramites()->where('subprocedimiento', 'FORMULARIO DE VALIDACIÓN DE PODER')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                            $correccionpoder = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE PODER')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                            $rechazodocext = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                            $validaciondocext = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                            $correcciondocext = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                        @endphp
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm align-middle text-center">
                                                <thead class="thead-light">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="align-middle text-center">
                                                            ...
                                                            @if (!$documentoformval)
                                                                <input type="hidden" name="tramite[formulariovalidacion]" value="PENSIÓN POR MUERTE">
                                                    ...
                                                    <tr>
                                                        <td class="align-middle text-center">
                                                            ...
                                                            @if (!$documento3)
                                                                <input type="hidden" name="tramite[validacionpoder]" value="PENSIÓN POR MUERTE">
                                                        ...
                                                        <td class="align-middle text-center">
                                                            @if ($documento3)
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/NOTIFICACIÓN DE PODER/{$documento3->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                @if ($puedeEditarArchivo)
                                                                    <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                        <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                        <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                                                ...
                                                <table class="table table-bordered table-sm align-middle text-center">
                                                    ...
                                                    <tbody>
                                                                    ...
                                                                    <tr class="fila-formulariorecepcion">
                                                                        ...
                                                                        <td class="align-middle text-center">
                                                                            @if ($formulariorecepcion->document)
                                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/NOTIFICACIÓN DE PODER/{$formulariorecepcion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                            @else
                                                        ...
                                                        @if (!$validaciondocext || $rechazodocext && (!$rechazodocext || $rechazodocext))
                                                            @php
                                                                $rechazosDocExt = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'PENSIÓN POR MUERTE')->get();
                                                                $validacionesDocExt = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'PENSIÓN POR MUERTE')->get();
                                                            @endphp
                                                                ...
                                                                @if ($rechazosDocExt->count() > 0)
                                                                    @foreach ($rechazosDocExt as $rechazo)
                                                                        <tr class="fila-rechazo">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($rechazo->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/NOTIFICACIÓN DE PODER/{$rechazo->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                                                        ...
                                                        @if ($rechazodocext)
                                                            @php
                                                                $correccionesDocExt = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'PENSIÓN POR MUERTE')->get();
                                                            @endphp
                                                                        ...
                                                                        <tr class="fila-correccion">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($correccion->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/NOTIFICACIÓN DE PODER/{$correccion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                                                                        ...
                                                                        <tr class="fila-validacion">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($validacion->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/NOTIFICACIÓN DE PODER/{$validacion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    {!! Form::hidden('apoderado', $apoderadoAsignado) !!}
                                    {!! Form::hidden('idtramite', $idTramite) !!}
                                    {!! Form::hidden('tramitenombreprog', 'PENSIÓN POR MUERTE') !!}
                                    @csrf
                                    <div class="container">
                                        @php
                                            $documento5 = $cliente->tramites()->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                        @endphp
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm align-middle text-center">
                                                <thead class="thead-light">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            @if ($documento5)
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/FIRMA EAP/{$documento5->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                @if ($puedeEditarArchivo)
                                                                    <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                        <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                        <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            <div class="dropdown">
                                ...
                                @php
                                    $documentos = [
                                        $documento210 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ÓBITO _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE')->first(),
                                        $documento250 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'FORENSE _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE')->first(),
                                        $documento290 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'EMPLEADOR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE')->first(),
                                        $documento270 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'CERTIFICADO DE ESTUDIOS _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE')->first(),
                                    ];
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento21com = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ÓBITO _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                                        ...
                                                        <tbody>
                                                            @foreach ($sitmentegestorcom as $documento)
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/SOLICITUD DE INFORMACIÓN COMPLEMENTARIA/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                ...
                                                <tbody>
                                                    @foreach ($sicobitorespuesta2 as $documento)
                                                        <tr>
                                                            ...
                                                            <td class="align-middle text-center">
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/SOLICITUD DE INFORMACIÓN COMPLEMENTARIA/{$documento->document2}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento21com2 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'FORENSE _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                ...
                <div class="tab-pane fade" id="tab-content-3" role="tabpanel" aria-labelledby="tab-3">
                    <div class="row">
                        ...
                        @php
                            $documento43 = $cliente->tramites()->where('subprocedimiento', 'NOTIFICACIÓN DE DICTAMEN')->where('estadodictamen', 'ACEPTADO')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                            $documentoRechazado = $cliente->tramites()->where('subprocedimiento', 'NOTIFICACIÓN DE DICTAMEN')->where('estadodictamen', 'RECHAZADO')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                        @endphp
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            @elseif ($documento43)
                                ...
                                <br>
                                @php
                                    $documento43 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'ACEPTACIÓN DE DICTAMEN')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                    $documento44 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'FIRMA DE FORMULARIO')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                    $documento45 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'FIRMA DE CONTRATO')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                    $documento46 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'COBRO DE PENSIÓN')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                    $documento47 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'NOTA DE RECHAZO DE TRÁMITE')->where('tramite', 'PENSIÓN POR MUERTE')->first();

                                    $accedepensiondictamen = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE DICTAMEN')->where('accesopension', 'SI')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                    $noaccedepensiondictamene6 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE DICTAMEN (EXCESO DE 6 MESES)')->where('accesopension', 'NO')->where('motivonopension', 'EXCESO DE 6 MESES')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                    $noaccedepensiondictamenfc = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE DICTAMEN (FALTA DE COBERTURA)')->where('accesopension', 'NO')->where('motivonopension', 'FALTA DE COBERTURA')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            @elseif ($documentoRechazado)
                                ...
                                <br>
                                @php
                                    $documento48 = $cliente->tramites()->where('subprocedimiento', 'INICIO PROCESO DE APELACIÓN')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                                @endphp
                                <div class="text-center">
                                    @if (!$documento48)
                                        <span class="mb-0 checkamarillo">
                                    ...
                                    <tbody>
                                        @forelse ($listasolicitudes as $solicitud)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/SOLICITUDES/{$solicitud->document}") }}"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuesta', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="nombretramite" value="PENSIÓN POR MUERTE">
                                                    ...
                                                    <td>
                                                        @if ($solicitud->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/SOLICITUDES/{$solicitud->document2}") }}"
                                    ...
                                    <tbody>
                                        @forelse ($listaadjuntos as $adjunto)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/ADJUNTOS Y RESPUESTAS/{$adjunto->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuestaadjunto', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($adjunto->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/ADJUNTOS Y RESPUESTAS/{$adjunto->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
                                    ...
                                    <tbody>
                                        @forelse ($listacartas as $carta)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/CARTAS Y RECLAMOS/{$carta->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                    title="VER ADJUNTO/RESPUESTA" target="_blank"></a>
                                                </td>
                                                <form action="{{ route('admin.tramites.guardarrespuestacarta', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($carta->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/CARTAS Y RECLAMOS/{$carta->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                    ...
                                                    <td>
                                                        @if ($carta->document3)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/CARTAS Y RECLAMOS/{$carta->document3}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
                                                ...
                                                <tr class="bg-light">
                                                    <td colspan="13">
                                                        <div class="row g-2">
                                                            ...
                                                            <div class="col-md-2">
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/CARTAS Y RECLAMOS/{$carta->document4}") }}"
                                                                class="btn btn-sm btn-verdocumento"
                                                                target="_blank">
                                    ...
                                    <tbody>
                                        @forelse ($listamisivas as $misiva)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/MISIVAS LIBRES/{$misiva->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuestamisivalibre', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($misiva->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/MISIVAS LIBRES/{$misiva->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                    ...
                                                    <td>
                                                        @if ($misiva->document3)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/MISIVAS LIBRES/{$misiva->document3}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
                                        ...
                                        <tbody>
                                            @foreach ($dictamennotificacion as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/DICTAMEN/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <select class="form-control tipo" name="tiporiesgodictamen_disabled[]" disabled>
                                                        ...
                                                        <option value="GRAN PENSIÓN POR MUERTE">GRAN PENSIÓN POR MUERTE</option>
                                                    </select>
                                                    ...
                                                    document.addEventListener('input', function(e) {
                                                        if (e.target.classList.contains('porcentaje') || e.target.classList.contains('riesgo')) {
                                                            ...
                                                            if (riesgo === 'RIESGO PROFESIONAL') {
                                                                ...
                                                                else tipo = 'GRAN PENSIÓN POR MUERTE';
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        @php
                            $documento29 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                            $documento30 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ CARTA SOLICITUD A EMPLEADOR')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                            $documento31 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ SOLICITUD DE MODIFICACIÓN DE CITE')->where('tramite', 'PENSIÓN POR MUERTE')->first();

                            $documento31 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ SOLICITUD DE MODIFICACIÓN DE CITE')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                            
                            $dictamenexiste = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'NOTIFICACIÓN DE DICTAMEN')->where('tramite', 'PENSIÓN POR MUERTE')->first();
                            ...
                            $rechazosolinvdictamenexceso6mes = $cliente->tramites()
                                ->where('nivelprocedimiento', 'DICTAMEN')
                                ->where('subprocedimiento', 'RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE (EXCESO DE SEIS MESES)')
                                ->where('accesopension', 'NO')
                                ->where('motivonopension', 'EXCESO DE 6 MESES')
                                ->where('tramite', 'PENSIÓN POR MUERTE')
                            ->get();
                            ...
                            $rechazosolinvdictamenfaltacober = $cliente->tramites()
                                ->where('nivelprocedimiento', 'DICTAMEN')
                                ->where('subprocedimiento', 'RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE (FALTA DE COBERTURA)')
                                ->where('accesopension', 'NO')
                                ->where('motivonopension', 'FALTA DE COBERTURA')
                                ->where('tramite', 'PENSIÓN POR MUERTE')
                            ->get();
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RENUNCIA A REVISIÓN DE DICTAMEN</p>
                                                <input type="hidden" name="tramite[renunciarevdictamen]" value="PENSIÓN POR MUERTE">
                                        ...
                                        <table class="table table-bordered table-sm align-middle text-center">
                                            ...
                                            <tbody>
                                                ...
                                                @endif
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">FIRMA DE CONTRATO</p>
                                                        <input type="hidden" name="tramite[firmacontratodictamen]" value="PENSIÓN POR MUERTE">
                        ...
                        {{-- DICTAMEN NO ACCEDE A PENSION CON EXCESO DE SEIS MESES --}}
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RENUNCIA A REVISIÓN DE DICTAMEN (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[renunciarevdictamenexceso6mes]" value="PENSIÓN POR MUERTE">
                            ...
                            {{-- RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE --}}
                            <div class="scroll-shadow-wrapper">
                                <div class="scroll-shadow-container">
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        <thead class="thead-light">
                                        ...
                                        <tbody>
                                            @foreach ($rechazosolinvdictamenexceso6mes as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE (EXCESO DE SEIS MESES)</p>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                    </td>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[rechazosolinvdictamenexceso6mes]" value="PENSIÓN POR MUERTE">
                                                    <input type="hidden" name="nivelprocedimiento[rechazosolinvdictamenexceso6mes]" value="DICTAMEN">
                                                    <input type="hidden" name="subprocedimiento[rechazosolinvdictamenexceso6mes]" value="RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE (EXCESO DE SEIS MESES)">
                                ...
                                <tbody>
                                    ...
                                    @endif
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <input type="hidden" name="tramite[formulariodictamenexceso6mes]" value="PENSIÓN POR MUERTE">
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">FIRMA DE CONTRATO (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[firmacontratodictamenexceso6mes]" value="PENSIÓN POR MUERTE">
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RENUNCIA A REVISIÓN DE DICTAMEN (FALTA DE COBERTURA)</p>
                                                    <input type="hidden" name="tramite[renunciarevdictamenfaltacober]" value="PENSIÓN POR MUERTE">
                                        ...
                                        <tbody>
                                            @foreach ($rechazosolinvdictamenfaltacober as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE (FALTA DE COBERTURA)</p>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                    </td>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE (FALTA DE COBERTURA)</p>
                                                    <input type="hidden" name="tramite[rechazosolinvdictamenfaltacober]" value="PENSIÓN POR MUERTE">
                                                    <input type="hidden" name="nivelprocedimiento[rechazosolinvdictamenfaltacober]" value="DICTAMEN">
                                                    <input type="hidden" name="subprocedimiento[rechazosolinvdictamenfaltacober]" value="RECHAZO DE SOLICITUD DE PENSIÓN POR MUERTE (FALTA DE COBERTURA)">
                    ...
                    <div class="container">
                        ...
                        <div class="row mb-3 align-items-center {{ !$documento48 ? 'no-documento' : '' }}">
                            <div class="col-md-4 text-center">
                                ...
                                <input type="text" class="form-control" id="tramite1" name="tramite[]" value="PENSIÓN POR MUERTE" hidden>
                    ...
                    <div class="container">
                        ...
                        <div class="row mb-3 align-items-center no-documento">
                            <div class="col-md-3 text-center" hidden>
                                <input type="text" class="form-control" name="tramite[]" value="PENSIÓN POR MUERTE" hidden>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($procedimientotramite->capturacomunicacion)
                                                            ...
                                                            <td class="align-middle text-center">
                                                                ...
                                                                @else
                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/COMUNICACIONES/{$procedimientotramite->capturacomunicacion}") }}"
                                                                    class="btn btn-sm btn-verdocumento"
                                                                    target="_blank">
                                                                    VER CAPTURA
                                                                    </a>
                                                        ...
                                                        @else
                                                            <td class="align-middle text-center" colspan="8">
                                                                <form action="{{ route('tramites.subirArchivo', ['id' => $procedimientotramite->id, 'clienteId' => $cliente->id]) }}" method="POST" enctype="multipart/form-data" class="d-flex gap-2">
                                                                    @csrf
                                                                    <input type="hidden" name="tramitenombre" value="PENSIÓN POR MUERTE">
                                        ...
                                        <form action="{{ route('admin.tramites.guardarseguimientoclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <table class="table table-striped table-bordered align-middle text-center table-sm tabla-comunicaciones" style="table-layout: fixed; width: 100%;">
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="align-middle text-center">
                                                                @if(!$seguimiento->capturacomunicacion)
                                                                    <span class="badge bg-warning text-dark">VACÍO</span>
                                                                @else
                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/COMUNICACIONES/{$seguimiento->capturacomunicacion}") }}"
                                                                        class="btn btn-sm btn-verdocumento"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="hidden" name="comtramitenombre" value="PENSIÓN POR MUERTE">
                                        ...
                                        <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                            ...
                                            <tbody>
                                                ...
                                                @endif
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">CANCELACIÓN DE TRAMITE</p>
                                                        <input type="hidden" name="tramite[cancelaciontramitegestora]" value="PENSIÓN POR MUERTE">
                                    ...
                                    <tbody>
                                        @foreach ($rechazocancelaciontramite as $documento)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/CANCELACIÓN/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER CARTA</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RECHAZO DE CANCELACIÓN DE TRÁMITE GP</p>
                                                <input type="hidden" name="tramite[rechazocancelaciontramite]" value="PENSIÓN POR MUERTE">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RECHAZO DE CANCELACIÓN DE TRÁMITE APS</p>
                                                <input type="hidden" name="tramite[rechazocancelaciontramiteaps]" value="PENSIÓN POR MUERTE">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">ACEPTACIÓN DE CANCELACIÓN DE TRÁMITE</p>
                                                <input type="hidden" name="tramite[aceptacioncancelaciontramite]" value="PENSIÓN POR MUERTE">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">DESISTIMIENTO A CANCELACIÓN DE TRÁMITE</p>
                                                <input type="hidden" name="tramite[desistimientocancelaciontramite]" value="PENSIÓN POR MUERTE">
                                ...
                                <tbody>
                                    @foreach ($notiferronea as $documento)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/NOTIFICACIÓN ERRÓNEA/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    @endif
                                        ...
                                        <td class="align-middle text-center">
                                            <input type="hidden" name="tramite[notiferronea]" value="PENSIÓN POR MUERTE">
                                        ...
                                        <tbody>
                                            @foreach ($notifobservadas as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/NOTIFICACIÓN OBSERVADA/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        @if($documento->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/PENSIÓN POR MUERTE/NOTIFICACIÓN OBSERVADA/{$documento->document2}") }}"
                                                            target="_blank"
                                                            class="btn btn-sm btn-verdocumento">
                                                            VER RESPUESTA
                                                            </a>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <input type="hidden" name="tramite[notifobservadas]" value="PENSIÓN POR MUERTE">
...
<script>
    function ajustarFechaFinDeSemana14(fecha) {
        const dia = fecha.getDay();
        if (dia === 6) {
            fecha.setDate(fecha.getDate() - 1);
        } else if (dia === 0) {
...
{{-- FECHA RETORNO EN SIC CERTIFICADO DE ESTUDIOS - NOTIFICACION DE REQUERIMIENTO --}}
<script>
    function ajustarFechaFinDeSemana15(fecha) {
        const dia = fecha.getDay();
        if (dia === 6) {
            fecha.setDate(fecha.getDate() - 1);
        } else if (dia === 0) {
    ...
    function actualizarFechaRetorno15(inputFechaSubida) {
        const id = inputFechaSubida.id.replace('fechasubida15', '');
        const fechaRetornoInput = document.getElementById('fecharetorno15' + id);
        const fechaSubida = new Date(inputFechaSubida.value);
        if (!isNaN(fechaSubida.getTime())) {
            let fechaMax = new Date(fechaSubida);
            fechaMax.setDate(fechaMax.getDate() + 30);
            fechaMax = ajustarFechaFinDeSemana15(fechaMax);
            const formatoFecha = f => f.toISOString().split('T')[0];
            fechaRetornoInput.min = inputFechaSubida.value;
        }
    }
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('input[id^="fechasubida15"]').forEach(input => {
            actualizarFechaRetorno15(input);
        });
    });
</script>

{{-- FECHA RETORNO EN SIC CERTIFICADO DE ESTUDIOS - RESPUESTA A REQUERIMIENTO --}}
<script>
    function ajustarFechaFinDeSemana16(fecha) {
        const dia = fecha.getDay();
        if (dia === 6) {
            fecha.setDate(fecha.getDate() - 1);
        } else if (dia === 0) {
    ...
    function actualizarFechaRetorno16(inputFechaSubida) {
        const id = inputFechaSubida.id.replace('fechasubida16', '');
        const fechaRetornoInput = document.getElementById('fecharetorno16' + id);
        const fechaSubida = new Date(inputFechaSubida.value);
        if (!isNaN(fechaSubida.getTime())) {
            let fechaMax = new Date(fechaSubida);
            fechaMax.setDate(fechaMax.getDate() + 30);
            fechaMax = ajustarFechaFinDeSemana16(fechaMax);
            const formatoFecha = f => f.toISOString().split('T')[0];
            fechaRetornoInput.min = inputFechaSubida.value;
        }
    }
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('input[id^="fechasubida16"]').forEach(input => {
            actualizarFechaRetorno16(input);
        });
    });
</script>

{{-- FECHA RETORNO EN SIC FORENSE - RESPUESTA A REQUERIMIENTO --}}
<script>
    function ajustarFechaFinDeSemana17(fecha) {
        const dia = fecha.getDay();
        if (dia === 6) {
            fecha.setDate(fecha.getDate() - 1);
        } else if (dia === 0) {
    ...
    function actualizarFechaRetorno17(inputFechaSubida) {
        const id = inputFechaSubida.id.replace('fechasubida17', '');
        const fechaRetornoInput = document.getElementById('fecharetorno17' + id);
        const fechaSubida = new Date(inputFechaSubida.value);
        if (!isNaN(fechaSubida.getTime())) {
            let fechaMax = new Date(fechaSubida);
            fechaMax.setDate(fechaMax.getDate() + 30);
            fechaMax = ajustarFechaFinDeSemana17(fechaMax);
            const formatoFecha = f => f.toISOString().split('T')[0];
            fechaRetornoInput.min = inputFechaSubida.value;
        }
    }
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('input[id^="fechasubida17"]').forEach(input => {
            actualizarFechaRetorno17(input);
        });
    });
</script>

{{-- FECHA RETORNO EN SIC ÓBITO - RESPUESTA A REQUERIMIENTO --}}
<script>
    function ajustarFechaFinDeSemana18(fecha) {
        const dia = fecha.getDay();
        if (dia === 6) {
            fecha.setDate(fecha.getDate() - 1);
        } else if (dia === 0) {
    ...
    function actualizarFechaRetorno18(inputFechaSubida) {
        const id = inputFechaSubida.id.replace('fechasubida18', '');
        const fechaRetornoInput = document.getElementById('fecharetorno18' + id);
        const fechaSubida = new Date(inputFechaSubida.value);
        if (!isNaN(fechaSubida.getTime())) {
            let fechaMax = new Date(fechaSubida);
            fechaMax.setDate(fechaMax.getDate() + 30);
            fechaMax = ajustarFechaFinDeSemana18(fechaMax);
            const formatoFecha = f => f.toISOString().split('T')[0];
            fechaRetornoInput.min = inputFechaSubida.value;
        }
    }
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('input[id^="fechasubida18"]').forEach(input => {
            actualizarFechaRetorno18(input);
        });
    });
</script>
@endsection
