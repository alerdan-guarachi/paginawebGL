...
<body>
    <main>
        ...
        <div class="tipo5">REF.- ADJUNTO DOCUMENTACIÓN TECNICO MEDICO</div>
        ...
        <div class="tipo6">
        Me dirijo a su Institución con la finalidad de brindar respuesta a la solicitud de Información Técnico Medico con NOTA {{ $notatecnicomedico }} de fecha {{ $fechanotatecnicomedico }}. Dentro del Tramite de {{ $tipocartareclamo }}. 
        </div>
        <div class="tipo6">
