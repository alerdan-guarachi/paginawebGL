...
<body>
    <main>
        ...
        <div class="tipo5"><strong>REF.- ADJUNTO DOCUMENTACIÓN</strong></div>
        <div class="tipo5"><strong>(INFORME DEL EMPLEADOR)</strong></div>
        ...
        <div class="tipo6">
            Me dirijo a su Institución con la finalidad de brindar respuesta a la <strong>{{ $nivelprocedimiento }}</strong> emitido por el <strong>TMC</strong> con 
