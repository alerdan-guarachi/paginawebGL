...
<body>
    <main>
        ...
        <div class="tipo6">
        Me dirijo a su Institución con la finalidad de brindar respuesta a la solicitud de Información Complementaria con NOTA CITE {{ $notatecnicomedico }} de fecha {{ $fechanotatecnicomedico }}. Dentro del Tramite de {{ $tipocartareclamo }}. 
        </div>
        <div class="tipo6">
