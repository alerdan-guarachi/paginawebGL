...
<body>
    <main>
        ...
        <div class="tipo5"><strong>REF.- ADJUNTO DOCUMENTACIÓN TECNICO MEDICO</strong></div>
        <div class="tipo5">@php
        ...
        <div class="tipo6">
        Me dirijo a su Institución con la finalidad de brindar respuesta a la Solicitud de Información Técnico Medico con 
