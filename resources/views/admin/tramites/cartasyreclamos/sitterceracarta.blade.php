...
{{-- <body>
    <main>
        ...
        <div class="tipo5">REF.-TERCERA SOLICITUD DE INFORMACIÓN DE TRÁMITE DE</div>
        ...
        <div class="tipo6">
        Me dirijo a su Institución con la finalidad de solicitar Información sobre el estado del Trámite de {{ $tipocartareclamo }}. En fecha {{ $fechaingresotramite  }} se Ingresó el Trámite, y en fecha {{ $fechafirmaeap  }} se firmó la Verificación del Estado de 
        Ahorro Previsional (Extracto), con fecha de retorno para consultar el {{ $fechaeap30  }}. Posteriormente en fechas {{ $fechaprimeracartasit  }} y {{ $fechasegundacartasit  }} se solicito información del Tramite. Hasta la fecha de hoy {{ $fechaactual }} no se tiene respuesta 
        alguna sobre el Trámite, por lo que reitero y solicito de la Manera más Humana puedan dar seguimiento y una respuesta a la brevedad posible del presente caso.
        </div>
        <div class="tipo6">
...
<body>
    <main>
        ...
        <div class="tipo6">
            Me dirijo a su Institución con la finalidad de solicitar Información sobre el estado del Trámite de {!! $tipocartareclamo ?? '<strong><em style="color: green;">TIPO CARTA/RECLAMO</em></strong>' !!}. En fecha {!! $fechaingresotramite ?? '<strong><em style="color: green;">FECHA INGRESO DE TRAMITE</em></strong>' !!} se Ingresó el Trámite, y en fecha {!! $fechafirmaeap ?? '<strong><em style="color: green;">FECHA FIRMA EAP</em></strong>' !!} se firmó la Verificación del Estado de 
            Ahorro Previsional (Extracto), con fecha de retorno para consultar el {!! $fechaeap30 ?? '<strong><em style="color: green;">FECHA EAP 30</em></strong>' !!}. Posteriormente en fechas {!! $fechaprimeracartasit ?? '<strong><em style="color: green;">FECHA PRIMERA CARTA SIT</em></strong>' !!} y {!! $fechasegundacartasit ?? '<strong><em style="color: green;">FECHA SEGUNDA CARTA SIT</em></strong>' !!} se solicitó información del Tramite. Hasta la fecha de hoy {!! $fechaactual ?? '<strong><em style="color: green;">FECHA ACTUAL</em></strong>' !!} no se tiene respuesta 
            alguna sobre el Trámite, por lo que reitero y solicito de la manera más humana puedan dar seguimiento y una respuesta a la brevedad posible del presente caso.
        </div>
        <div class="tipo6">
            Sin más que decir y esperando su pronta respuesta me despido con las consideraciones más distinguidas.
