...
<body>
    <main>
        ...
        <div class="tipo6">
        Me dirijo a su Institución con la finalidad de solicitar Información sobre el estado del Trámite de {{ $tipocartareclamo }}. En fecha {{ $fechaingresotramite  }} se Ingresó el Trámite, y en fecha {{ $fechafirmaeap  }} se firmó la Verificación del Estado de Ahorro Previsional 
