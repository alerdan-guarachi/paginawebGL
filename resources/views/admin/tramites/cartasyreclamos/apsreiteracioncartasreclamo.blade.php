...
<body> 
    <main>
        ...
        @if ($nombretramite !== 'APELACIÓN')
            <div class="tipo6">
                Me permito dirigirme a su Autoridad con la finalidad de presentar mi Reclamo, ya que a la fecha no llega ninguna respuesta de la Gestora Pública de la Seguridad Social de Largo Plazo. Dentro del Trámite de
                <strong>
                    @if (
                        strtoupper($nombretramite) === 'INVALIDEZ' ||
                        strtoupper($nombretramite) === 'APELACIÓN' ||
        ...
        <div class="tipo6">
            Con relación al avance del trámite de @if (
                    ...
                    @else
                        {{ $nombretramite }}
                    @endif se informa que dentro su Entidad APS se realizó lo siguiente:
        </div>
        ...
        <div class="tipo6">
            Con relación al avance del trámite de @if (strtoupper($nombretramite) === 'INVALIDEZ')
                                        PENSIÓN POR INVALIDEZ
                                    @else
                                        {{ $nombretramite }},
                                    @endif se informa que dentro su Entidad APS se realizó lo siguiente:
