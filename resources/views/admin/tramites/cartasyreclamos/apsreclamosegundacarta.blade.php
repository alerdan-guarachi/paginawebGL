...
<body> 
    <main>
        ...
        <div class="tipo5"><strong>REF.- SEGUNDA CARTA DE RECLAMO DE TRÁMITE DE</strong></div>
        <div class="tipo5">
            <strong>
                @if (
        ...
        @if ($nombretramite === 'APELACIÓN')
            <div class="tipo6">
                    Me permito dirigirme a su Autoridad con la finalidad de presentar mi Reclamo, ya que a la fecha no llega ninguna respuesta de la Gestora Pública de la Seguridad Social de Largo Plazo. Dentro del Trámite de                <strong>
                    @if (
                        strtoupper($nombretramite) === 'INVALIDEZ' ||
                        strtoupper($nombretramite) === 'APELACIÓN' ||
                        strtoupper($nombretramite) === 'SEGUNDA SOLICITUD' ||
