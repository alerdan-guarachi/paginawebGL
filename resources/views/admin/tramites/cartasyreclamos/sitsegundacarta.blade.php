...
<body>
    <main>
        ...
        <div class="tipo6">
        Me dirijo a su Institución con la finalidad de solicitar Información sobre el estado del Trámite de {{ $tipocartareclamo }}. Iniciado en su Institución Publica en fecha {{ $fechaingresotramite  }}, y que en fecha {{ $fechafirmaeap  }} se firmó la Verificación del Estado de Ahorro 
        Previsional (Extracto) con fecha de retorno para consultar por Dictamen y/o información Complementaria el {{ $fechaeap30  }} (Sin Respuesta). Posteriormente en fecha {{ $fechaprimeracartasit  }} se Solicitó Información del Tramite. Hasta la fecha no se tiene respuesta alguna, por lo que solicito 
