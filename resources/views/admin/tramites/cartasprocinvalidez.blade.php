...
<a class="btn btn-sm float-right btn-regresar" href="{{ route('admin.tramites.procinvalidez', $cliente->id) }}">REGRESAR</a>
<h5>MISIVAS DE INVALIDEZ DE:</h5>
                                                                                                            ...
                                                                                                            <td class="text-center align-middle">
                                                                                                                @php
                                                                                                                    ...
                                                                                                                    $ruta = match(true) {
                                                                                                                        ...
                                                                                                                        in_array($tipoarea, ['PROGRAMACIONES', 'INFORMES ADICIONALES']) => "tramitesclientesita/{$cliente->id}/INVALIDEZ/INFORMES/{$doc->document}",
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.tramites.generaradjuntoyrespuesta', $cliente) }}" method="GET" enctype="multipart/form-data" id="formAdjunto">
                                        ...
                                        <input type="text" class="form-control" id="tramite2" name="tramite2" value="INVALIDEZ" hidden>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.tramites.generarcartareclamo', $cliente) }}" method="GET" enctype="multipart/form-data" id="formCarta">
                                        ...
                                        <input type="text" class="form-control" id="tramite" name="tramite3" value="INVALIDEZ" hidden>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-4">
                                                ...
                                                {!! Form::select('subnivelprocedimiento3', [
                                                    ...
                                                    'CANCELACIÓN DE TRÁMITE' => 'CANCELACIÓN DE TRÁMITE',
                                                    'RESPUESTA A CANCELACIÓN DE TRÁMITE' => 'RESPUESTA A CANCELACIÓN DE TRÁMITE',
                                                    'REIMPRESIÓN DE NOTIFICACIÓN CITE' => 'REIMPRESIÓN DE NOTIFICACIÓN CITE',
