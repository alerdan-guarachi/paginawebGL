...
<body>
    <main>
        ...
        <div class="tipo5"><strong>REF.- SOLICITUD DE COPIA LEGALIZADA DE DICTAMEN</strong></div>
        <div class="tipo5">
            @php
        ...
        <div class="tipo6">
            ...
            @endif
            <strong>N° {!! $nrodictamen ?? '<span class="textoedita">NRO. DICTAMEN</span>' !!}</strong> firmado en fecha <strong>{!! $fechacontrato ?? '<span class="textoedita">FECHA DOCUMENTO</span>' !!}</strong> 
            en {!! $firmadoen ?? '<span class="textoedita">ENTREGADO EN</span>' !!}.
        </div>

        <div class="tipo6">
        Sin otro particular me despido, esperando su pronta respuesta 
        </div>
        <div class="tipo6">
        Atte.
        </div>
