...
@if($inicioocontinuidad)
    ...
    <a class="btn btn-sm float-right btn-cartareclamo" href="{{ route('admin.tramites.cartasproccompensacionsenasir', $cliente->id) }}">NUEVA MISIVA</a>
...
<h5>PROCEDIMIENTO DE COMPENSACIÓN DE COTIZACIONES (SENASIR) DE:</h5>
    ...
    @if($inicioocontinuidad)
        ...
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs" id="myTabs">
                ...
                @php
                    $documento5 = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
            ...
            <div class="tab-content" id="myTabContent">
                    ...
                    @if($tramiteinicio)
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 mb-3">
                                ...
                                <br>
                                @php
                                    $documento1 = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                                    $documento2 = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->first();
                                @endphp
                            ...
                            @php
                                $documento1 = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where('subprocedimiento', 'RECEPCION DE TRÁMITE')->where('estadocomunicado', 'COMUNICADO')->first();
                                $documento2 = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where('subprocedimiento', 'INCLUSION DE PODER')->where('estadocomunicado', 'COMUNICADO')->first();
                            @endphp
                            <div class="col-12 col-md-4 mb-3">
                                ...
                                <br>
                                @php
                                    $documento3 = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->whereIn('subprocedimiento', ['VALIDACIÓN DE PODER', 'VALIDACIÓN DE DOCUMENTOS EXTRANJEROS'])->first();
                                @endphp
                                <div class="text-center">
                                    @if (!$documento3)
                                        <span class="mb-0 checkamarillo">
                            ...
                            <div class="col-12 col-md-4 mb-3">
                                <button type="button" class="btn btn-custom btn-block text-center" data-toggle="modal" data-target="#modalFirmaEAP" @if (!$documento3) disabled @endif>
                                    <div class="d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        @php
                                            $documento1 = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                        @endphp
                                        @if (!$documento1)
                                            @if ($documento3)
                                                @php
                                ...
                                <br>
                                @php
                                    $documento5 = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                @endphp
                                <div class="text-center">
                                    @if (!$documento1)
                                        <span class="mb-0 checkamarillo">
                    ...
                    @if($tramitecontinuidad)
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 mb-3">
                                ...
                                <br>
                                @php
                                    $documento3 = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'VALIDACIÓN DE PODER')->first();
                                @endphp
                                <div class="text-center">
                                    @if (!$documento3)
                                        <span class="mb-0 checkamarillo">
                            ...
                            {{-- FIRMA EAP --}}
                            @php
                                $documento3 = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'VALIDACIÓN DE PODER')->where('estadocomunicado', 'COMUNICADO')->first();
                                $estadotramite = $cliente->tramites()->where('nivelprocedimiento', 'INGRESO DE TRÁMITE')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->whereIn('estadotramite', ['INGRESO DE TRÁMITE', 'FIRMA EAP'])->first();
                            @endphp
                            <div class="col-12 col-md-4 mb-3">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    @endif
                                    <a class="btn btn-sm btn-subirrequisitos ml-2" href="{{ route('admin.asociados.subirdocrequisitoscompensacioncotsenasir', $cliente->id) }}">VER REQUISITOS</a>
                                </div>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento1 = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                                            $fecha = \Carbon\Carbon::now();
                                            $valor = $fecha->day <= 15 ? $fecha : $fecha->copy()->addMonth();
                                            $valorFormateado = $valor->format('m/y');
                                            $documento2 = $cliente->tramites()->where('subprocedimiento', 'INCLUSIÓN DE PODER')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                        @endphp
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        ...
                                                                        @if (!$documento1)
                                                                            <input type="hidden" name="tramite[]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        @if ($documento1)
                                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/INGRESO DE TRÁMITE/{$documento1->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                        ...
                                                        <table class="table table-bordered table-sm align-middle text-center">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        @if ($documento2)
                                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/INGRESO DE TRÁMITE/{$documento2->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                            @if ($puedeEditarArchivo)
                                                                                <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                                    <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                                    <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento4 = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE PODER')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento3 = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE PODER')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $correccionpoder = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE PODER')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $rechazodocext = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $validaciondocext = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $correcciondocext = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                        @endphp
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm align-middle text-center">
                                                <thead class="thead-light">
                                                ...
                                                <tbody>
                                                    ...
                                                    @if (!$documento4 || $correccionpoder)
                                                        <tr>
                                                            ...
                                                            <td class="align-middle text-center">
                                                                @if ($documento3)
                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/NOTIFICACIÓN DE PODER/{$documento3->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                    @if ($puedeEditarArchivo)
                                                                        <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                            <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                            <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                                                    ...
                                                    @if ($cliente->paisnacimiento !== 'BOLIVIA')
                                                        ...
                                                        @if (!$validaciondocext || $rechazodocext && (!$rechazodocext || $rechazodocext))
                                                            @php
                                                                $rechazosDocExt = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->get();
                                                                $validacionesDocExt = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->get();
                                                            @endphp
                                                                ...
                                                                @if ($rechazosDocExt->count() > 0)
                                                                    @foreach ($rechazosDocExt as $rechazo)
                                                                        <tr class="fila-rechazo">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($rechazo->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/NOTIFICACIÓN DE PODER/{$rechazo->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                        ...
                                                        @if ($rechazodocext)
                                                            @php
                                                                $correccionesDocExt = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->get();
                                                            @endphp
                                                                        ...
                                                                        <tr class="fila-correccion">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($correccion->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/NOTIFICACIÓN DE PODER/{$correccion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                                                                        ...
                                                                        <tr class="fila-validacion">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($validacion->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/NOTIFICACIÓN DE PODER/{$validacion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    {!! Form::hidden('apoderado', $apoderadoAsignado) !!}
                                    {!! Form::hidden('idtramite', $idTramite) !!}
                                    {!! Form::hidden('tramitenombreprog', 'INVALIDEZ') !!}
                                    @csrf
                                    <div class="container">
                                        @php
                                            $documento5 = $cliente->tramites()->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                        @endphp
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm align-middle text-center">
                                                <thead class="thead-light">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            @if ($documento5)
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/FIRMA EAP/{$documento5->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                @if ($puedeEditarArchivo)
                                                                    <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                        <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                        <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            <div class="dropdown">
                                ...
                                @php
                                    $documentos = [
                                        $documento21 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first(),
                                        $documento25 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first(),
                                        $documento27 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'NOTIFICACIÓN TMR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first(),
                                        $documento29 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first(),
                                    ];
                                ...
                                @php
                                    $documento21 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento99 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD DE COMPRA DE SERVICIOS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento22 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD DE EVALUACIÓN POR MEDICINA DEL TRABAJO EGS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento23 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD DE HISTORIA CLÍNICA')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento24 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ RESPUESTA TÉCNICO MÉDICO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();

                                    $documento25 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento26 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ RESPUESTA A NOTIFICACIÓN TMC')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documentoprof = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ REGISTRO DE DOCUMENTACIÓN PROFESIONAL')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                
                                    $documento29 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento30 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ SOLICITUD DE INFORME AL EMPLEADOR')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento31 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ REITERACIÓN DE SOLICITUD DEL INFORME AL EMPLEADOR')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento32 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ REMISIÓN DE RESPUESTA')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                @endphp
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            <br>
                            @php
                                $documento10 = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'NOTIFICACIÓN DE GESTORA')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                $documento103 = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'AGENDAMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                $documento104 = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'ORDENES DE COMPRA DE SERVICIOS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                            @endphp
                            <div class="text-center">
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            <div class="dropdown">
                                ...
                                @php
                                    $documentos = [
                                        $documento210 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first(),
                                        $documento250 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first(),
                                        $documento270 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'NOTIFICACIÓN TMR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first(),
                                        $documento290 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'EMPLEADOR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first(),
                                        $documentocancelacion = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'CANCELACIÓN DE TRÁMITE')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first(),
                                    ];
                                ...
                                @php
                                    $documento210 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento990 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD DE COMPRA DE SERVICIOS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento220 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD DE EVALUACIÓN POR MEDICINA DEL TRABAJO EGS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento230 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD DE HISTORIA CLÍNICA')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    /* $documento240 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ RESPUESTA COMPLEMENTARIA')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first(); */

                                    $documento250 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento260 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ RESPUESTA A NOTIFICACIÓN TMC')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documentoprofes = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ REGISTRO DE DOCUMENTACIÓN PROFESIONAL')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();

                                    $documento290 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'EMPLEADOR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento300 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'EMPLEADOR _ SOLICITUD DE INFORME AL EMPLEADOR')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento310 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'EMPLEADOR _ REITERACIÓN DE SOLICITUD DEL INFORME AL EMPLEADOR')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento320 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'EMPLEADOR _ REMISIÓN DE RESPUESTA')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                ...
                <div class="modal fade" id="modalEnteGestorSalud" tabindex="-1" role="dialog" aria-labelledby="modalEnteGestorSaludLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title titulomodal" id="modalEnteGestorSaludLabel">SITM - ENTE GESTOR DE SALUD</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                    ...
                                    <div class="container">
                                        @php
                                            ...
                                            $sitmentegestor = $cliente->tramites()
                                                ...
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $sitmentegestoradjmedica = $cliente->tramites()
                                                ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')
                                                ->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ ADJUNTO DE DOCUMENTACIÓN MEDICA')
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $sitmentregacarpeta = $cliente->tramites()
                                                ...
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $documento22 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD DE EVALUACIÓN MT')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento23 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD DE HISTORIA CLÍNICA')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento24 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD A EMPLEADOR')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento99 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD DE COMPRA DE SERVICIOS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento99otro = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICTUD DE MODIFICACION DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                        @endphp
                                        <div class="table-responsive">
                                            <div class="scroll-shadow-wrapper">
                                                <div class="scroll-shadow-container">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sitmentegestor as $documento)
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        ...
                                                        @foreach ($registrosGuardadosProgramacion as $registro)
                                                            @if ($registro->estudioespecialidad === 'PROGRAMACIÓN AL CLIENTE')
                                                                <tr class="text-center">
                                                                    <input type="hidden" name="tramitenombreprog" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                    <td>
                                            ...
                                            <div class="scroll-shadow-wrapper">
                                                <div class="scroll-shadow-container">
                                                    <table class="table table-bordered table-sm align-middle" id="tablaProgramaciones" style="margin-bottom: -5px;">
                                                        <thead class="thead-light">
                                                            <tr>
                                                                ...
                                                                @if (isset($registrosGuardadosProgramacion) && collect($registrosGuardadosProgramacion)->contains(function($item) {
                                                                    return $item->estudioespecialidad !== 'PROGRAMACIÓN AL CLIENTE' 
                                                                        && $item->estudioespecialidad !== 'HISTORIA CLINICA';
                                                                }))
                                                                <th class="text-center">MÉDICO_ATENCIÓN</th>
                                                                <th class="text-center">FECHA_PROG.</th>
                                                                <th class="text-center">HORA_PROG.</th>
                                                                <th class="text-center">OPCION_ATENCIÓN</th>
                                                                <th class="text-center">ORDEN_ESTUDIO/ESPECIALIDAD</th>
                                                                <th class="text-center">ASISTIÓ</th>
                                                        ...
                                                        <tbody>
                                                            @foreach ($registrosGuardadosProgramacion as $registro)
                                                                @if ($registro->estudioespecialidad !== 'PROGRAMACIÓN AL CLIENTE' && $registro->estudioespecialidad !== 'HISTORIA CLINICA')
                                                                    <tr class="text-center">
                                                                        <input type="hidden" name="tramitenombreprog" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                        <td>
                                                                            {{ $registro->estudioespecialidad }}
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->ordenprogramacion)
                                                                                <a href="{{ asset("tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/ORDENES/{$registro->ordenprogramacion}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER ORDEN</a>
                                                                            @else
                                                                                <input type="file" name="ordenprogramacion[{{ $registro->id }}]" class="form-control form-control-sm" value="{{ old('ordenprogramacion[]', $registro->ordenprogramacion) }}">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion)
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->informeprogramacion)
                                                                                <a href="{{ asset("tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/ORDENES/{$registro->informeprogramacion}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER INFORME</a>
                                                                            @else
                                                                                <input type="file" name="informeprogramacion[{{ $registro->id }}]" class="form-control form-control-sm">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion)
                                            ...
                                            @endif
                                            <script>
                                                const todasareasotro = @json($todasareas);
                                                ...
                                                function agregarFilaManual() {
                                                    ...
                                                    celda.innerHTML = `
                                                        <select class="form-control form-control-sm" name="estudioespecialidad[]">
                                                            ...
                                                            ${todasareasotro.map(area => `<option value="${area.area}">${area.area}</option>`).join('')}
                                                        </select>
                                                    `;
                                                }
                                            </script>
                                            ...
                                            @php
                                                $aseguradoraNombre = strtoupper(trim($aseguradora));
                                                $empiezaCon = function($cadena, $busqueda) {
                                                    return strpos($cadena, strtoupper($busqueda)) === 0;
                                                };
                                                $mostrarFormulario = false;
                                                $ocultarConBoton = false;
                                                if ($empiezaCon($aseguradoraNombre, 'CAJA PETROLERA DE SALUD') ||
                                                    $empiezaCon($aseguradoraNombre, 'SEGURO SOCIAL UNIVERSITARIO')) {
                                                    $mostrarFormulario = true;
                                                } elseif ($empiezaCon($aseguradoraNombre, 'CAJA NACIONAL DE SALUD')) {
                                                    if (count($sitmentegestoradjmedica) > 0) {
                                                        $mostrarFormulario = true;
                                                    } else {
                                                        $ocultarConBoton = true;
                                                    }
                                                } elseif ($empiezaCon($aseguradoraNombre, 'CAJA DE SALUD CORDES') ||
                                                        $empiezaCon($aseguradoraNombre, 'CAJA DE SALUD DE LA BANCA PRIVADA')) {
                                                    $mostrarFormulario = false;
                                                }
                                            @endphp
                                            @if($registrosGuardadosProgramacion && $registrosGuardadosProgramacion->count() > 0)
                                                    ...
                                                    <tbody>
                                                        @forelse ($sitmentregacarpeta as $documento)
                                                            <tr>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO/{$documento->document}") }}" 
                                                ...
                                                @if($mostrarFormulario)
                                                    <table class="table table-bordered table-sm align-middle text-center">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sitmentegestoradjmedica as $documento)
                                                                <tr class="text-center">
                                                                    <td class="align-middle text-center">{{ $documento->id }}</td>
                                                                    <td class="align-middle text-center">ADJUNTO DE DOCUMENTACIÓN MEDICA</td>
                                                                    <td class="align-middle text-center">{{ \Carbon\Carbon::parse($documento->fechasubida)->format('d-m-Y') }}</td>
                                                                    <td>
                                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER CARTA</a>
                                                                    </td>
                                                                    <td>
                                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO/{$documento->document2}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER FORMULARIO</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                            ...
                                                            @if(count($sitmentegestoradjmedica) == 0)
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        ADJUNTO DE DOCUMENTACIÓN MEDICA
                                                                        <input type="hidden" name="tramite[sitmentegestoradjmedica]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                        <input type="hidden" name="nivelprocedimiento[sitmentegestoradjmedica]" value="SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO">
                                                                        <input type="hidden" name="subprocedimiento[sitmentegestoradjmedica]" value="ENTE GESTOR DE SALUD _ ADJUNTO DE DOCUMENTACIÓN MEDICA">
                                                                    </td>
                                                                    <td>
                                                                        <input type="date" class="form-control text-center" name="fechasubida[sitmentegestoradjmedica]" value="{{ \Carbon\Carbon::now()->toDateString() }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                    </td>
                                                                    <td>
                                                                        <input type="file" name="archivo[sitmentegestoradjmedica]" class="dropify" accept="application/pdf">
                                                                    </td>
                                                                    <td>
                                                                        <input type="file" name="archivo2" class="dropify" accept="application/pdf">
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        </tbody>
                                                    </table>
                                                @elseif($ocultarConBoton)
                                                    <button type="button" class="btn btn-verdocumento mb-2" id="btnMostrarForm" style="margin-top:10px;">AGREGAR RESPUESTA Y FORMULARIO</button>
                                                            ...
                                                            <tbody>
                                                                @foreach ($sitmentegestoradjmedica as $documento)
                                                                    <tr>
                                                                        <td>{{ $documento->id }}</td>
                                                                        <td class="align-middle text-center">ADJUNTO DE DOCUMENTACIÓN MEDICA</td>
                                                                        <td>{{ \Carbon\Carbon::parse($documento->fechasubida)->format('d-m-Y') }}</td>
                                                                        <td>
                                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER CARTA</a>
                                                                        </td>
                                                                        <td>
                ...
                <div class="modal fade" id="modalNotificacionTMC" tabindex="-1" role="dialog" aria-labelledby="modalNotificacionTMCLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title titulomodal" id="modalNotificacionTMCLabel">SITM - NOTIFICACIÓN TMC</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento21tmc = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $sitmnotificaciontmc = $cliente->tramites()
                                                ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')
                                                ->where('subprocedimiento', 'NOTIFICACIÓN TMC _ NOTIFICACIÓN DE REQUERIMIENTO')
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $sitmnotificaciontmcadjmedica = $cliente->tramites()
                                                ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')
                                                ->where('subprocedimiento', 'NOTIFICACIÓN TMC _ ADJUNTO DE DOCUMENTACIÓN MEDICA')
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $sitmentregacarpetatmc = $cliente->tramites()
                                                ...
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $documento22tmc = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ SOLICITUD DE EVALUACIÓN MT')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento23tmc = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ SOLICITUD DE HISTORIA CLÍNICA')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento24tmc = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ SOLICITUD A EMPLEADOR')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento99tmc = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ SOLICITUD DE COMPRA DE SERVICIOS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento99otrotmc = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ SOLICTUD DE MODIFICACION DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                        @endphp
                                        <div class="table-responsive">
                                            <div class="scroll-shadow-wrapper">
                                                <div class="scroll-shadow-container">
                                                    <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sitmnotificaciontmc as $documento)
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ $documento->id }}</p>
                                                                    </td>
                                                            ...
                                                            @if ($sitmnotificaciontmc->isEmpty())
                                                                <tr class="fila-sitmnotificaciontmc">
                                                            @else
                                                                <tr class="fila-sitmnotificaciontmc d-none">
                                                            @endif
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control" disabled>
                                                                </td>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    ...
                                                                    <input type="hidden" name="tramite[]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                    <input type="hidden" name="nivelprocedimiento[]" value="SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO">
                                                                    <input type="hidden" name="subprocedimiento[]" value="NOTIFICACIÓN TMC _ NOTIFICACIÓN DE REQUERIMIENTO">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control text-center" name="citenotificacion[]">
                                                                </td>
                                                    ...
                                                    @if (!$sitmnotificaciontmc->isEmpty())
                                                        <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                            <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarSITMnotificaciontmc()">AGREGAR MÁS</button>
                                                        </div>
                                                    @endif
                                                    <script>
                                                        function agregarSITMnotificaciontmc() {
                                                            const filaOculta = document.querySelector('.fila-sitmnotificaciontmc.d-none');
                                                            if (filaOculta) {
                                                                filaOculta.classList.remove('d-none');
                                                            }
                                                        }
                                            ...
                                            @if (!$documento21tmc)
                                                <div class="mb-3">
                                                    <label><strong>SELECCIONAR ESPECIALIDADES</strong></label><br>
                                                    <div class="form-check form-check-inline" hidden>
                                                        <input class="form-check-input" type="checkbox" value="PROGRAMACIÓN AL CLIENTE" onchange="agregarEspecialidad4(this)" checked hidden id="checkProgCliente">
                                                        <label class="form-check-label" hidden>PROGRAMACIÓN AL CLIENTE</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="MEDICINA DEL TRABAJO" onchange="agregarEspecialidad4(this)">
                                                        <label class="form-check-label">MEDICINA DEL TRABAJO</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="TRABAJO SOCIAL" onchange="agregarEspecialidad4(this)">
                                                        <label class="form-check-label">TRABAJO SOCIAL</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="HISTORIA CLINICA" onchange="agregarEspecialidad4(this)">
                                                        <label class="form-check-label">HISTORIA CLINICA</label>
                                                    </div>
                                                </div>
                                            @endif
                                            <table class="table table-bordered table-sm align-middle" id="tablaProgramaciones41">
                                                @if (isset($registrosGuardadosProgSITMtmc) && collect($registrosGuardadosProgSITMtmc)->contains('estudioespecialidad', 'PROGRAMACIÓN AL CLIENTE'))
                                                    <thead class="thead-light">
                                                        <tr>
                                                            <th class="text-center">SUB_PROCEDIMIENTO</th>
                                                            <th class="text-center">ASEGURADORA</th>
                                                    ...
                                                    <tbody>
                                                        @foreach ($registrosGuardadosProgSITMtmc as $registro)
                                                            @if ($registro->estudioespecialidad === 'PROGRAMACIÓN AL CLIENTE')
                                                                <tr class="text-center">
                                                                    <input type="hidden" name="tramitenombreprog" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                    <td>
                                                                        {{ $registro->estudioespecialidad }}
                                                                        <input type="hidden" name="subtramite_id4[]" value="{{ $registro->id }}">
                                                                        <input type="hidden" name="estudioespecialidad4[]" value="{{ $registro->estudioespecialidad }}">
                                                                    </td>
                                                                    <td class="align-middle text-center"> 
                                                                        <span>{{$aseguradora}}</span>
                                                                    </td>
                                                                    <td hidden>
                                                                        <input type="text" name="nombremedicoprog4[]" class="form-control form-control-sm" value="">
                                                                    </td>
                                                                    <td hidden>
                                                                        <input type="text" name="opcionatencion4[]" class="form-control form-control-sm" value="">
                                                                    </td>
                                                                    <td hidden>
                                                                        <input type="text" name="observacion4[]" class="form-control form-control-sm" value="">
                                                                    </td>
                                                                    <td>
                                                                        @if ($registro->fechaprogramacion)
                                                                            {{ $registro->fechareprogramacion ?? $registro->fechaprogramacion }}
                                                                            <input type="hidden" name="fechaprogramacion4[]" value="{{ $registro->fechaprogramacion }}">
                                                                        @else
                                                                            <input type="date" name="fechaprogramacion4[]" class="form-control form-control-sm" value="{{ old('fechaprogramacion[]', $registro->fechaprogramacion) }}" min="{{ \Carbon\Carbon::now()->toDateString() }}">
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                                        @if ($registro->horaprogramacion)
                                                                            {{ $registro->horareprogramacion ?? $registro->horaprogramacion }}
                                                                            <input type="hidden" name="horaprogramacion4[]" value="{{ $registro->horaprogramacion }}">
                                                                        @else
                                                                            <input type="time" name="horaprogramacion4[]" class="form-control form-control-sm" value="{{ old('horaprogramacion[]', $registro->horaprogramacion) }}">
                                                                        @endif
                                                                    </td>
                                                                    <td hidden>
                                                                        <input type="file" name="ordenprogramacion4[{{ $loop->index }}]" value="" class="form-control form-control-sm">
                                                                    </td>
                                                                    <td>
                                                                        @if ($registro->fechaprogramacion)
                                                                            @if ($registro->asistenciaprogramacion == 1)
                                                                                SI
                                                                                <input type="hidden" name="asistenciaprogramacion4[]" value="{{ $registro->id }}">
                                                                            @else
                                                                                <input type="checkbox" name="asistenciaprogramacion4[]" value="{{ $registro->id }}">
                                                                            @endif
                                                                        @else
                                                                            <input type="checkbox" disabled>
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        @if ($registro->fechaprogramacion && $registro->asistenciaprogramacion == 0)
                                                                            <button type="button" class="btn btn-sm btn-verdocumento" onclick="habilitarReprogramacion4(this)">REPROGRAMAR</button>
                                                                            <div class="mt-2 d-none">
                                                                                <input type="date" name="fechareprogramacion4[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('fechareprogramacion[]', $registro->fechareprogramacion) }}">
                                                                                <input type="time" name="horareprogramacion4[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('horareprogramacion[]', $registro->horareprogramacion) }}">
                                                                                <input type="text" name="motivoreprogramacion4[{{ $registro->id }}]" class="form-control form-control-sm" placeholder="Motivo" value="{{ old('motivoreprogramacion[]', $registro->motivoreprogramacion) }}">
                                                                            </div>
                                                                        @elseif ($registro->motivoreprogramacion)
                                                                            CON REPROG. - MOTIVO: {{ $registro->motivoreprogramacion }}
                                                                        @else
                                            ...
                                            <div class="scroll-shadow-wrapper">
                                                <div class="scroll-shadow-container">
                                                    <table class="table table-bordered table-sm align-middle" id="tablaProgramaciones4" style="margin-bottom: -5px;">
                                                        <thead class="thead-light">
                                                            <tr>
                                                                <th class="text-center">ESTUDIO/ESPECIALIDAD</th>
                                                                @if (isset($registrosGuardadosProgSITMtmc) && collect($registrosGuardadosProgSITMtmc)->contains(function($item) {
                                                                    return $item->estudioespecialidad !== 'PROGRAMACIÓN AL CLIENTE'
                                                                        && $item->estudioespecialidad !== 'HISTORIA CLINICA';
                                                                }))
                                                                <th class="text-center">MÉDICO_ATENCIÓN</th>
                                                                ...
                                                                @if ($registro->estudioespecialidad !== 'PROGRAMACIÓN AL CLIENTE' && $registro->estudioespecialidad !== 'HISTORIA CLINICA')
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion || $registro->nombremedico)
                                                                                {{ $registro->nombremedico }}
                                                                                <input type="hidden" name="nombremedicoprog4[]" value="{{ $registro->nombremedico }}">
                                                                            @else
                                                                                <input type="text" name="nombremedicoprog4[]" class="form-control form-control-sm" value="{{ old('nombremedicoprog4[]', $registro->nombremedico) }}">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion)
                                                                                ...
                                                                                <input type="hidden" name="fechaprogramacion4[]" value="{{ $registro->fechaprogramacion }}">
                                                                            @else
                                                                                <input type="date" name="fechaprogramacion4[]" class="form-control form-control-sm" value="{{ old('fechaprogramacion4[]', $registro->fechaprogramacion) }}" min="{{ \Carbon\Carbon::now()->toDateString() }}">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->horaprogramacion)
                                                                                ...
                                                                                <input type="hidden" name="horaprogramacion4[]" value="{{ $registro->horaprogramacion }}">
                                                                            @else
                                                                                <input type="time" name="horaprogramacion4[]" class="form-control form-control-sm" value="{{ old('horaprogramacion4[]', $registro->horaprogramacion) }}">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->opcionatencion)
                                                                                {{ $registro->opcionatencion }}
                                                                                <input type="hidden" name="opcionatencion4[]" value="{{ $registro->opcionatencion }}">
                                                                            @else
                                                                                <select name="opcionatencion4[]" class="form-control form-control-sm">
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->ordenprogramacion)
                                                                                <a href="{{ asset("tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/ORDENES/{$registro->ordenprogramacion}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER ORDEN</a>
                                                                            @else
                                                                                <input type="file" name="ordenprogramacion[{{ $registro->id }}]" class="form-control form-control-sm">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->observacion)
                                                                                {{ $registro->observacion }}
                                                                                <input type="hidden" name="observacion4[]" value="{{ $registro->observacion }}">
                                                                            @else
                                                                                <input type="text" name="observacion4[]" class="form-control form-control-sm" value="{{ old('observacion4[]', $registro->observacion) }}">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion)
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion)
                                                                                @if ($registro->asistenciaprogramacion == 0)
                                                                                    <button type="button" class="btn btn-sm btn-verdocumento" onclick="habilitarReprogramacion4(this)">REPROGRAMAR</i></button>
                                                                                    <div class="mt-2 d-none">
                                                                                        <input type="date" name="fechareprogramacion4[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('fechareprogramacion4[]', $registro->fechareprogramacion) }}">
                                                                                        <input type="time" name="horareprogramacion4[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('horareprogramacion4[]', $registro->horareprogramacion) }}">
                                                                                        <input type="text" name="motivoreprogramacion4[{{ $registro->id }}]" class="form-control form-control-sm" placeholder="Motivo" value="{{ old('motivoreprogramacion4[]', $registro->motivoreprogramacion) }}">
                                                                                    </div>
                                                                                @else
                                                                                    @if ($registro->motivoreprogramacion)
                                                                                        CON REPROG. - MOTIVO: {{ $registro->motivoreprogramacion }}
                                            ...
                                            <div class="text-left mt-2">
                                                <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarFilaManual4()">AGREGAR MÁS</button>
                                            </div>
                                            <script>
                                                document.addEventListener('DOMContentLoaded', function () {
                                                    const checkbox = document.getElementById('checkProgCliente');
                                                    if (checkbox && checkbox.checked) {
                                                        agregarEspecialidad4(checkbox);
                                                    }
                                                });
                                            </script>
                                            <script>
                                                function habilitarReprogramacion4(btn) {
                                                    const contenedor = btn.nextElementSibling;
                                                    if (contenedor.classList.contains('d-none')) {
                                                        contenedor.classList.remove('d-none');
                                                    } else {
                                            ...
                                            @if (!$documento21tmc)
                                                <script>
                                                    const especialidadesAgregadas4 = new Set();
                                                    const todasareas4 = @json($todasareas);

                                                    function agregarEspecialidad4(checkbox) {
                                                        const tabla = document.getElementById('tablaProgramaciones4').getElementsByTagName('tbody')[0];
                                                        const valor = checkbox.value;

                                                        if (checkbox.checked && !especialidadesAgregadas4.has(valor)) {
                                                            const fila = tabla.insertRow();
                                                            const celda = fila.insertCell();
                                                            celda.setAttribute("colspan", 9);

                                                            if (valor === "PROGRAMACIÓN AL CLIENTE") {
                                                                celda.innerHTML = `<input type="hidden" name="estudioespecialidad4[]" value="${valor}">`;
                                                                fila.style.display = 'none';
                                                            } else {
                                                                celda.innerHTML = `<input type="hidden" name="estudioespecialidad4[]" value="${valor}">${valor}`;
                                                            }

                                                            especialidadesAgregadas4.add(valor);
                                                        } else if (!checkbox.checked && especialidadesAgregadas4.has(valor)) {
                                                            for (let i = 0; i < tabla.rows.length; i++) {
                                                                const input = tabla.rows[i].querySelector(`input[value="${valor}"]`);
                                                                if (input) {
                                                                    tabla.deleteRow(i);
                                                            ...
                                                            especialidadesAgregadas4.delete(valor);
                                                        }
                                                    }
                                                </script>
                                            @endif
                                            ...
                                            <script>
                                                const todasareas4otro = @json($todasareas);

                                                function agregarFilaManual4() {
                                                    const tabla = document.getElementById('tablaProgramaciones4').getElementsByTagName('tbody')[0];
                                                    const fila = tabla.insertRow();
                                                    ...
                                                    celda.setAttribute("colspan", 9);
                                                    celda.innerHTML =
                                                        `<select class="form-control form-control-sm" name="estudioespecialidad4[]">
                                                            <option value="" disabled selected>Seleccione un estudio/especialidad...</option>
                                                            ${todasareas4otro.map(area => `<option value="${area.area}">${area.area}</option>`).join('')}
                                                        </select>`;
                                                }
                                            </script>
                                            ...
                                            @php
                                                ...
                                                if ($empiezaCon($aseguradoraNombre, 'CAJA PETROLERA DE SALUD') ||
                                                    ...
                                                    if (count($sitmnotificaciontmcadjmedica) > 0) {
                                                        $mostrarFormulario = true;
                                                    } else {
                                                        $ocultarConBoton = true;
                                                    }
                                            ...
                                            @if($registrosGuardadosProgSITMtmc && $registrosGuardadosProgSITMtmc->count() > 0)
                                                ...
                                                @if($mostrarFormulario)
                                                    <table class="table table-bordered table-sm align-middle text-center">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sitmnotificaciontmcadjmedica as $documento)
                                                                <tr class="text-center">
                                                                    <td class="align-middle text-center">{{ $documento->id }}</td>
                                                                    <td class="align-middle text-center">ADJUNTO DE DOCUMENTACIÓN MEDICA</td>
                                                                    <td class="align-middle text-center">{{ \Carbon\Carbon::parse($documento->fechasubida)->format('d-m-Y') }}</td>
                                                            ...
                                                            @if(count($sitmnotificaciontmcadjmedica) == 0)
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        ADJUNTO DE DOCUMENTACIÓN MEDICA
                                                                        <input type="hidden" name="tramite[sitmnotificaciontmcadjmedica]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                        <input type="hidden" name="nivelprocedimiento[sitmnotificaciontmcadjmedica]" value="SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO">
                                                                        <input type="hidden" name="subprocedimiento[sitmnotificaciontmcadjmedica]" value="NOTIFICACIÓN TMC _ ADJUNTO DE DOCUMENTACIÓN MEDICA">
                                                                    </td>
                                                                    <td>
                                                                        <input type="date" class="form-control text-center" name="fechasubida[sitmnotificaciontmcadjmedica]" value="{{ \Carbon\Carbon::now()->toDateString() }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                    </td>
                                                                    <td>
                                                                        <input type="file" name="archivo[sitmnotificaciontmcadjmedica]" class="dropify" accept="application/pdf">
                                                                    </td>
                                                                    <td>
                                                                        <input type="file" name="archivo2" class="dropify" accept="application/pdf">
                                                                    </td>
                                                ...
                                                @elseif($ocultarConBoton)
                                                    <button type="button" class="btn btn-verdocumento mb-2" id="btnMostrarForm2" style="margin-top:10px;">AGREGAR RESPUESTA Y FORMULARIO</button>
                                                    <div id="contenedorFormulario2" style="display: none;">
                                                        <table class="table table-bordered table-sm align-middle text-center">
                                                            <thead class="thead-light">
                                                                <tr>
                                                                    <th style="width: 10%;">ID</th>
                                                    ...
                                                    <script>
                                                        document.getElementById('btnMostrarForm2').addEventListener('click', function() {
                                                            document.getElementById('contenedorFormulario2').style.display = 'block';
                                                            this.style.display = 'none';
                                                        });
                                                    </script>
                                                @endif
                                    ...
                                    <button type="submit" class="btn btn-subirarchivos d-block mx-auto mb-3" target="_blank" style="width: fit-content;">GUARDAR</button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="modalEmpleador" tabindex="-1" role="dialog" aria-labelledby="modalEmpleadorLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title titulomodal" id="modalEmpleadorLabel">SITM - EMPLEADOR</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            ...
                                            $documento29 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento30 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ CARTA SOLICITUD A EMPLEADOR')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento31 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ SOLICITUD DE MODIFICACIÓN DE CITE')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                                ...
                                                <tbody>
                                                    @foreach ($sitmempleadorrespuesta as $documento)
                                                        <tr>
                                                            ...
                                                            <td class="align-middle text-center">
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO/{$documento->document2}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $compraser1 = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'SOLICITUD DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            ...
                                            $cssegundanotificacion = $cliente->tramites()
                                                ...
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $csagendamiento = $cliente->tramites()
                                                ->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')
                                                ->where('subprocedimiento', 'AGENDAMIENTO')
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $csordencompradeservicios = $cliente->tramites()
                                                ->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')
                                                ->where('subprocedimiento', 'ORDEN DE COMPRA DE SERVICIOS')
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $csdevolucionviaticos = $cliente->tramites()
                                                ...
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $csrechazodeviaje = $cliente->tramites()
                                                ->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')
                                                ->where('subprocedimiento', 'RECHAZO DE VIAJE')
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $csrespuestasolcambiociudad = $cliente->tramites()
                                                ->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')
                                                ->where('subprocedimiento', 'RESPUESTA A SOLICITUD DE CAMBIO DE CIUDAD')
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $viaticosi = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'SEGUNDA NOTIFICACIÓN')->where('viaticos', 'SI')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $compraser1acep = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'SOLICITUD DE REQUERIMIENTO')->where('viaja', 'SI')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $comprasersolno = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'SOLICITUD DE REQUERIMIENTO')->where('viaja', 'NO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();

                                            $csordencsnoviaja = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'ORDEN DE COMPRA DE SERVICIOS')->where('viaja', 'NO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $csordencssiaceptado = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'ORDEN DE COMPRA DE SERVICIOS')->where('viaja', 'SI')->where('decisionviaja', 'ACEPTADO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $csordencssirechazado = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'ORDEN DE COMPRA DE SERVICIOS')->where('viaja', 'SI')->where('decisionviaja', 'RECHAZADO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();

                                            $csordencssiaceptadorespuesta = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'RESPUESTA A SOLICITUD DE CAMBIO DE CIUDAD')->where('decisionviaja', 'ACEPTADO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $csordencssirechazadorespuesta = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'RESPUESTA A SOLICITUD DE CAMBIO DE CIUDAD')->where('decisionviaja', 'RECHAZADO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                        @endphp
                                        <div class="table-responsive">
                                                        ...
                                                        <tbody>
                                                            @foreach ($cssolicitud as $documento)
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/COMPRA DE SERVICIOS/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                    ...
                                                    <table class="table table-bordered table-sm align-middle" id="tablaProgramaciones3" style="margin-bottom: -8px;">
                                                        <thead class="thead-light">
                                                            <tr>
                                                                ...
                                                                <th class="text-center">MÉDICO_DERIVADOR</th>
                                                                <th class="text-center">MÉDICO_ATENCIÓN</th>
                                                                <th class="text-center">FECHA_PROG.</th>
                                                                <th class="text-center">HORA_PROG.</th>
                                                                <th class="text-center">ORDEN_ESTUDIO/ESPECIALIDAD</th>
                                                            ...
                                                            @foreach ($registrosGuardadosProgramacioCS as $registro)
                                                                @if ($registro->opcionatencion === 'COMPRA DE SERVICIOS')
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->medicoderivador)
                                                                                {{ $registro->medicoderivador }}
                                                                                <input type="hidden" name="medicoderivador3[]" value="{{ $registro->medicoderivador }}">
                                                                            @else
                                                                                <input type="text" name="medicoderivador3[]" class="form-control form-control-sm" value="{{ old('medicoderivador3[]', $registro->medicoderivador) }}">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion || $registro->nombremedico)
                                                                            ...
                                                                            @else
                                                                                <input type="text" name="nombremedicoprog3[]" class="form-control form-control-sm" value="{{ old('nombremedicoprog3[]', $registro->nombremedico) }}">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion)
                                                                            ...
                                                                            @else
                                                                                <input type="date" name="fechaprogramacion3[]" class="form-control form-control-sm" value="{{ old('fechaprogramacion3[]', $registro->fechaprogramacion) }}" min="{{ \Carbon\Carbon::now()->toDateString() }}">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->horaprogramacion)
                                                                            ...
                                                                            @else
                                                                                <input type="time" name="horaprogramacion3[]" class="form-control form-control-sm" value="{{ old('horaprogramacion3[]', $registro->horaprogramacion) }}">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->ordenprogramacion)
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion)
                                                                                @if ($registro->asistenciaprogramacion == 0)
                                                                                    ...
                                                                                    <div class="mt-2 d-none">
                                                                                        <input type="date" name="fechareprogramacion3[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('fechareprogramacion3[]', $registro->fechareprogramacion) }}">
                                                                                        <input type="time" name="horareprogramacion3[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('horareprogramacion3[]', $registro->horareprogramacion) }}">
                                                                                        <input type="text" name="motivoreprogramacion3[{{ $registro->id }}]" class="form-control form-control-sm" placeholder="Motivo" value="{{ old('motivoreprogramacion3[]', $registro->motivoreprogramacion) }}">
                                                                                    </div>
                                                                                @else
                                                                                    @if ($registro->motivoreprogramacion)
                                                                                        CON REPROG. - MOTIVO: {{ $registro->motivoreprogramacion }}
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->asistenciaprogramacion == 1)
                                                                                ATENDIDO
                                                                            @else
                                                                                <button type="button" class="btn btn-sm btn-verdocumento mb-2" data-toggle="modal" data-target="#modalAgendamiento2">
                                                                                    AGENDAMIENTO CENTRO MÉDICO
                                                                                </button>
                                                                            @endif
                                                                        </td>
                                                                        <div class="modal fade" id="modalAgendamiento2" tabindex="-1" role="dialog" aria-labelledby="modalAgendamiento2Label" aria-hidden="true">
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                        <h5 class="modal-title" id="modalAgendamiento2Label">AGENDAMIENTO CENTRO MÉDICO</h5>
                                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
                                                                                            <span aria-hidden="true">&times;</span>
                                                                                        </button>
                                                                                    </div>
                                                                                    <div class="modal-body text-center">
                                                                                        <p>Selecciona al Centro Médico a contactar:</p>

                                                                                        @php
                                                                                            $mensaje = "Buen Día, Disculpe tengo un requerimiento de la Gestora Pública para una Cita Médica para el paciente "
                                                                                                . $cliente->nombrecompleto
                                                                                                . ", con C.I. " . $cicliente . " " . $ciexpcliente;
                                                                                            $mensajeUrl = urlencode($mensaje);

                                                                                            $mensaje2 = "Bueno Día Doctor. Disculpe nos llegó este requerimiento de una Compra de Servicios de la Gestora Pública. Para una consulta médica para el paciente "
                                                                                                . $cliente->nombrecompleto
                                                                                                . ". ¿Que día le podría atender?";
                                                                                            $mensajeUrl2 = urlencode($mensaje2);
                                                                                        @endphp

                                                                                        <a href="https://wa.me/59177023985?text={{ $mensajeUrl }}"
                                                                                        target="_blank" class="btn btn-sm btn-verdocumento mb-2 btn-block">
                                                                                            MEDICALCENTER
                                                                                        </a>

                                                                                        <a href="https://wa.me/59169193092?text={{ $mensajeUrl }}"
                                                                                        target="_blank" class="btn btn-sm btn-verdocumento mb-2 btn-block">
                                                                                            KOLPHING
                                                                                        </a>

                                                                                        <a href="https://wa.me/59172464848?text={{ $mensajeUrl2 }}"
                                                                                        target="_blank" class="btn btn-sm btn-verdocumento mb-2 btn-block">
                                                                                            DR. GUSTAVO MOLINA
                                                                                        </a>

                                                                                        <a href="https://wa.me/59173213405?text={{ $mensajeUrl2 }}"
                                                                                        target="_blank" class="btn btn-sm btn-verdocumento mb-2 btn-block">
                                                                                            DR. JUAN CARLOS
                                                                                        </a>
                                                                                    </div>
                                            ...
                                            @if ($csordencssiaceptadorespuesta || $csordencsnoviaja || $csordencssiaceptado || $comprasersolno)
                                                {{-- AGENDAMIENTO --}}
                                                <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -8px;">
                                                    <thead class="thead-light">
                                                        <tr>
                                                            ...
                                                            <th style="width: 20%;">RESPALDO</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        @foreach ($csagendamiento as $documento)
                                                            <tr>
                                                                <td class="align-middle text-center">
                                                                    <p class="mb-0">{{ $documento->id }}</p>
                                                                </td>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/COMPRA DE SERVICIOS/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER RESPALDO</a>
                                                                </td>
                                                            </tr>
                                                        @endforeach

                                                        @if ($csagendamiento->isEmpty())
                                                            <tr class="fila-csagendamiento">
                                                        @else
                                                            <tr class="fila-csagendamiento d-none">
                                                        @endif
                                                            <td class="align-middle text-center">
                                                                <input type="text" class="form-control" disabled>
                                                            </td>
                                                            ...
                                                            <td class="align-middle text-center">
                                                                <p class="mb-0">AGENDAMIENTO</p>
                                                                <input type="hidden" name="tramite[agendamiento]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                <input type="hidden" name="nivelprocedimiento[agendamiento]" value="COMPRA DE SERVICIOS">
                                                                <input type="hidden" name="subprocedimiento[agendamiento]" value="AGENDAMIENTO">
                                                            </td>
                                                            <td class="align-middle text-center">
                                                                @php
                                                                    $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                                                    ...
                                                                    $fechaLimiteStr = $fechaLimite->toDateString();
                                                                @endphp
                                                                <input type="date" class="form-control text-center" id="fechasubida12" name="fechasubida[agendamiento]" value="{{ $fechaSubidaDefault }}" data-max="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }} onchange="actualizarFechaRetorno12(this)">
                                                            </td>
                                                            <td class="align-middle text-center">
                                                                <input type="date" class="form-control text-center" id="fecharetorno12" name="fecharetorno[agendamiento]" value="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                            </td>
                                                            <td class="align-middle text-center">
                                                                <button type="button" class="btn btn-sm btn-verdocumento mb-2" data-toggle="modal" data-target="#modalAgendamiento">
                                                                    AGENDAMIENTO FUNCIONARIO
                                                                </button>
                                                                <input type="file" name="archivo[agendamiento]" class="dropify mx-auto d-block" accept="application/pdf">
                                                            </td>
                                                            <div class="modal fade" id="modalAgendamiento" tabindex="-1" role="dialog" aria-labelledby="modalAgendamientoLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="modalAgendamientoLabel">AGENDAMIENTO FUNCIONARIO</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body text-center">
                                                                            <p>Selecciona al funcionario a contactar:</p>

                                                                            @php
                                                                                $mensaje = "Buen Día, Por favor solicito el agendamiento correspondiente de la Compra de Servicios para el Afiliado "
                                                                                    . $cliente->nombrecompleto
                                                                                    . " con Cua: " . $nuacuacliente
                                                                                    . ", con C.I. " . $cicliente . " " . $ciexpcliente
                                                                                    . ". Me entregaron esta nota y me indican coordinar con este número";
                                                                                $mensajeUrl = urlencode($mensaje);
                                                                            @endphp

                                                                            <a href="https://wa.me/59174521036?text={{ $mensajeUrl }}"
                                                                            target="_blank" class="btn btn-sm btn-verdocumento mb-2 btn-block">
                                                                                CLAUDIA
                                                                            </a>

                                                                            <a href="https://wa.me/59162501530?text={{ $mensajeUrl }}"
                                                                            target="_blank" class="btn btn-sm btn-verdocumento mb-2 btn-block">
                                                                                ALEXIS
                                                                            </a>
                                                                        </div>
                                                ...
                                                @if (!$csagendamiento->isEmpty())
                                                    <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                        <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarCScsagendamiento()">AGREGAR MÁS</button>
                                                    </div>
                                                @endif
                                                <script>
                                                    function agregarCScsagendamiento() {
                                                        const filaOculta = document.querySelector('.fila-csagendamiento.d-none');
                                                        if (filaOculta) {
                                                            filaOculta.classList.remove('d-none');
                                                        }
                                                    }
                                                ...
                                                @if ($csordencssiaceptado && $csordencssirechazadorespuesta)
                                                    {{-- ORDEN DE TRASLADO --}}
                                                    <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -8px;">
                                                        <thead class="thead-light">
                                                            <tr>
                                                                ...
                                                                <th style="width: 10%;">NRO.</th>
                                                                <th style="width: 20%;">SUB_PROCEDIMIENTO</th>
                                                                <th style="width: 15%;">CITE_NOTIFICACIÓN</th>
                                                                <th style="width: 15%;">FECHA_CITE_NOTIF.</th>
                                                                <th style="width: 15%;">FECHA_REGISTRO</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @endif
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    <p class="mb-0">ORDEN DE TRASLADO</p>
                                                                    <input type="hidden" name="tramite[ordentraslado]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                    <input type="hidden" name="nivelprocedimiento[ordentraslado]" value="COMPRA DE SERVICIOS">
                                                                    <input type="hidden" name="subprocedimiento[ordentraslado]" value="ORDEN DE TRASLADO">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control text-center" name="citenotificacion[ordentraslado]">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="date" class="form-control text-center" name="fechacitenotificacion[ordentraslado]" value="{{ \Carbon\Carbon::now()->toDateString() }}">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    @php
                                                                        $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                                                    @endphp
                                                                    <input type="date" class="form-control text-center" name="fechasubida[ordentraslado]" value="{{ $fechaSubidaDefault }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="file" name="archivo[ordentraslado]" class="dropify mx-auto d-block" accept="application/pdf">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -8px;">
                                                        <thead class="thead-light">
                                                            <tr>
                                                                ...
                                                                <th style="width: 10%;">CITE_NOTIFICACIÓN</th>
                                                                <th style="width: 10%;">FECHA_CITE_NOTIF.</th>
                                                                <th style="width: 10%;">MEDIO_TRANSPORTE</th>
                                                                <th style="width: 10%;">FECHA/HORA_VIAJE</th>
                                                                <th style="width: 10%;">FECHA_REGISTRO</th>
                                                                <th style="width: 10%;">DOCUMENTO</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @foreach ($csavisoviajeasegurado as $documento)
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ $documento->transporteviaja }}</p>
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ \Carbon\Carbon::parse($documento->fechaviaje)->format('d-m-Y') }}</p>
                                                                        <p class="mb-0">{{ \Carbon\Carbon::parse($documento->horaviaje)->format('H:m') }}</p>
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ \Carbon\Carbon::parse($documento->fechasubida)->format('d-m-Y') }}</p>
                                                                    </td>
                                                            ...
                                                            @endif
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    <p class="mb-0">AVISO DE VIAJE DEL ASEGURADO</p>
                                                                    <input type="hidden" name="tramite[avisoviajeasegurado]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                    <input type="hidden" name="nivelprocedimiento[avisoviajeasegurado]" value="COMPRA DE SERVICIOS">
                                                                    <input type="hidden" name="subprocedimiento[avisoviajeasegurado]" value="AVISO DE VIAJE DEL ASEGURADO">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control text-center" name="citenotificacion[avisoviajeasegurado]">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="date" class="form-control text-center" name="fechacitenotificacion[avisoviajeasegurado]" value="{{ \Carbon\Carbon::now()->toDateString() }}">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <select name="transporteviaja[avisoviajeasegurado]" class="form-control recojo-select">
                                                                        <option value="">Seleccione una opción...</option>
                                                                        <option value="TERRESTRE">TERRESTRE</option>
                                                                        <option value="AÉREO">AÉREO</option>
                                                                    </select>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    <input type="date" class="form-control text-center" name="fechaviaje[avisoviajeasegurado]">
                                                                    <input type="time" class="form-control text-center" name="horaviaje[avisoviajeasegurado]">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    @php
                                                                        $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                                                    @endphp
                                                                    <input type="date" class="form-control text-center" name="fechasubida[avisoviajeasegurado]" value="{{ $fechaSubidaDefault }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="file" name="archivo[avisoviajeasegurado]" class="dropify mx-auto d-block" accept="application/pdf">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                ...
                                                <div class="scroll-shadow-wrapper">
                                                    <div class="scroll-shadow-container">
                                                        <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -8px;">
                                                            <thead class="thead-light">
                                                                <tr>
                                                                    ...
                                                                    <th style="width: 10%;">CITE_NOTA</th>
                                                                    <th style="width: 10%;">FECHA_CITE_NOTA</th>
                                                                    <th style="width: 20%;">CENTRO_MÉDICO/ESPECIALIDAD</th>
                                                                    <th style="width: 10%;">FECHA_REGISTRO</th>
                                                                    <th style="width: 10%;">DOCUMENTO</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                @foreach ($csordencompradeservicios as $documento)
                                                                    <tr>
                                                                        <td class="align-middle text-center">
                                                                            <p class="mb-0">{{ $documento->id }}</p>
                                                                        </td>
                                                                        ...
                                                                        <td class="align-middle text-center">
                                                                            <p class="mb-0">ORDEN DE COMPRA DE SERVICIOS</p>
                                                                        </td>
                                                                        <td class="align-middle text-center">
                                                                            <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                                        </td>
                                                                        ...
                                                                        <td class="align-middle text-center">
                                                                            <p class="mb-0">
                                                                                {{ $documento->nombremedico }}
                                                                                @if(!empty($documento->nombremedico2))
                                                                                    - {{ $documento->nombremedico2 }}
                                                                                @endif
                                                                                @if(!empty($documento->nombremedico3))
                                                                                    - {{ $documento->nombremedico3 }}
                                                                                @endif
                                                                            </p>
                                                                        </td>
                                                                        <td class="align-middle text-center">
                                                                ...
                                                                @if ($csordencompradeservicios->isEmpty())
                                                                    <tr class="fila-csordencompradeservicios">
                                                                @else
                                                                    <tr class="fila-csordencompradeservicios d-none">
                                                                @endif
                                                                    <td class="align-middle text-center">
                                                                        <input type="text" class="form-control" disabled>
                                                                    </td>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">ORDEN DE COMPRA DE SERVICIOS</p>
                                                                        <input type="hidden" name="tramite[ordencompradeservicios]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                        <input type="hidden" name="nivelprocedimiento[ordencompradeservicios]" value="COMPRA DE SERVICIOS">
                                                                        <input type="hidden" name="subprocedimiento[ordencompradeservicios]" value="ORDEN DE COMPRA DE SERVICIOS">
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <input type="text" class="form-control text-center" name="citenotificacion[ordencompradeservicios]">
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <input type="date" class="form-control text-center" name="fechacitenotificacion[ordencompradeservicios]" value="{{ \Carbon\Carbon::now()->toDateString() }}">
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <input type="text" class="form-control text-center" name="citenota[ordencompradeservicios]">
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <input type="date" class="form-control text-center" name="fechacitenota[ordencompradeservicios]" value="{{ \Carbon\Carbon::now()->toDateString() }}">
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <input type="text" class="form-control text-center mb-1" name="nombremedico[ordencompradeservicios]" placeholder="Centro Médico/Especialidad">
                                                                        <div id="campoMedico2" style="display: none;">
                                                                            <input type="text" class="form-control text-center mb-1" name="nombremedico2[ordencompradeservicios]" placeholder="Centro Médico/Especialidad">
                                                                        </div>
                                                                        <div id="campoMedico3" style="display: none;">
                                                                            <input type="text" class="form-control text-center mb-1" name="nombremedico3[ordencompradeservicios]" placeholder="Centro Médico/Especialidad">
                                                                        </div>
                                                                        <button type="button" class="btn btn-sm btn-outline-secondary agregaruno" onclick="document.getElementById('campoMedico2').style.display='block'; this.style.display='none';">
                                                                            Agregar
                                                                        </button>
                                                                        <button type="button" id="btnMedico3" class="btn btn-sm btn-outline-secondary" style="display:none;" onclick="document.getElementById('campoMedico3').style.display='block'; this.style.display='none';">
                                                                            Agregar
                                                                        </button>
                                                                    </td>
                                                                    <script>
                                                                        document.querySelector("button.agregaruno").addEventListener("click", function() {
                                                                            document.getElementById("btnMedico3").style.display = "inline-block";
                                                                        });
                                                                    </script>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        @php
                                                                            $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                                                        @endphp
                                                                        <input type="date" class="form-control text-center" name="fechasubida[ordencompradeservicios]" value="{{ $fechaSubidaDefault }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <input type="file" name="archivo[ordencompradeservicios]" class="dropify mx-auto d-block" accept="application/pdf">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        @if (!$csordencompradeservicios->isEmpty())
                                                            <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                                <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarCSordencompradeservicios()">AGREGAR MÁS</button>
                                                            </div>
                                                        @endif
                                                        <script>
                                                            function agregarCSordencompradeservicios() {
                                                                const filaOculta = document.querySelector('.fila-csordencompradeservicios.d-none');
                                                                if (filaOculta) {
                                                                    filaOculta.classList.remove('d-none');
                                                                }
                                                            }
                                                ...
                                                <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -8px;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @endif
                                                            ...
                                                            <td class="align-middle text-center">
                                                                <p class="mb-0">DEVOLUCIÓN DE VIÁTICOS</p>
                                                                <input type="hidden" name="tramite[devolucionviaticos]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                <input type="hidden" name="nivelprocedimiento[devolucionviaticos]" value="COMPRA DE SERVICIOS">
                                                                <input type="hidden" name="subprocedimiento[devolucionviaticos]" value="DEVOLUCIÓN DE VIÁTICOS">
                                                            </td>
                                                            <td class="align-middle text-center">
                                                                @php
                                                                    $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                                                @endphp
                                                                <input type="date" class="form-control text-center" name="fechasubida[devolucionviaticos]" value="{{ $fechaSubidaDefault }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                            </td>
                                                            <td class="align-middle text-center">
                                                                <input type="file" name="archivo[devolucionviaticos]" class="dropify mx-auto d-block" accept="application/pdf">
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            @if ($csordencssirechazado && $csordencssirechazadorespuesta)
                                                {{-- RECHAZO DE VIAJE --}}
                                                <div class="scroll-shadow-wrapper">
                                                    <div class="scroll-shadow-container">
                                                        <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -8px;">
                                                            ...
                                                            <tbody>
                                                                @foreach ($csrechazodeviaje as $documento)
                                                                    <tr>
                                                                        <td class="align-middle text-center">
                                                                            <p class="mb-0">{{ $documento->id }}</p>
                                                                        </td>
                                                                        ...
                                                                        <td class="align-middle text-center">
                                                                            <p class="mb-0">RECHAZO DE VIAJE</p>
                                                                        </td>
                                                                        <td class="align-middle text-center">
                                                                ...
                                                                @if ($csrechazodeviaje->isEmpty())
                                                                    <tr class="fila-csrechazodeviaje">
                                                                @else
                                                                    <tr class="fila-csrechazodeviaje d-none">
                                                                @endif
                                                                    <td class="align-middle text-center">
                                                                        <input type="text" class="form-control" disabled>
                                                                    </td>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">RECHAZO DE VIAJE</p>
                                                                        <input type="hidden" name="tramite[csrechazodeviaje]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                        <input type="hidden" name="nivelprocedimiento[csrechazodeviaje]" value="COMPRA DE SERVICIOS">
                                                                        <input type="hidden" name="subprocedimiento[csrechazodeviaje]" value="RECHAZO DE VIAJE">
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <input type="text" class="form-control text-center" name="citenotificacion[csrechazodeviaje]">
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <input type="date" class="form-control text-center" name="fechacitenotificacion[csrechazodeviaje]" value="{{ \Carbon\Carbon::now()->toDateString() }}">
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <input type="text" class="form-control text-center" name="motivorechazo[csrechazodeviaje]">
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        @php
                                                                            $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                                                        @endphp
                                                                        <input type="date" class="form-control text-center" name="fechasubida[csrechazodeviaje]" value="{{ $fechaSubidaDefault }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <input type="file" name="archivo[csrechazodeviaje]" class="dropify mx-auto d-block" accept="application/pdf">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        @if (!$csrechazodeviaje->isEmpty())
                                                            <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                                <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarCScsrechazodeviaje()">AGREGAR MÁS</button>
                                                            </div>
                                                        @endif
                                                        <script>
                                                            function agregarCScsrechazodeviaje() {
                                                                const filaOculta = document.querySelector('.fila-csrechazodeviaje.d-none');
                                                                if (filaOculta) {
                                                                    filaOculta.classList.remove('d-none');
                                                                }
                                                            }
                                                ...
                                                {{-- RESPUESTA A SOLICITUD DE CAMBIO DE CIUDAD --}}
                                                <div class="scroll-shadow-wrapper">
                                                    <div class="scroll-shadow-container">
                                                        <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -8px;">
                                                            <thead class="thead-light">
                                                            ...
                                                            <tbody>
                                                                @foreach ($csrespuestasolcambiociudad as $documento)
                                                                    <tr>
                                                                        <td class="align-middle text-center">
                                                                            <p class="mb-0">{{ $documento->id }}</p>
                                                                        </td>
                                                                        ...
                                                                        <td class="align-middle text-center">
                                                                            <p class="mb-0">RESPUESTA A SOLICITUD DE CAMBIO DE CIUDAD</p>
                                                                        </td>
                                                                        <td class="align-middle text-center">
                                                                            <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                                        </td>
                                                                        ...
                                                                        <td class="align-middle text-center">
                                                                            <p class="mb-0">{{ $documento->decisionviaja }}</p>
                                                                        </td>
                                                                        <td class="align-middle text-center">
                                                                            <p class="mb-0">{{ \Carbon\Carbon::parse($documento->fechasubida)->format('d-m-Y') }}</p>
                                                                        </td>
                                                                ...
                                                                @if ($csrespuestasolcambiociudad->isEmpty())
                                                                    <tr class="fila-csrespuestasolcambiociudad">
                                                                @else
                                                                    <tr class="fila-csrespuestasolcambiociudad d-none">
                                                                @endif
                                                                    <td class="align-middle text-center">
                                                                        <input type="text" class="form-control" disabled>
                                                                    </td>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">RESPUESTA A SOLICITUD DE CAMBIO DE CIUDAD</p>
                                                                        <input type="hidden" name="tramite[respuestasolcambiociudad]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                        <input type="hidden" name="nivelprocedimiento[respuestasolcambiociudad]" value="COMPRA DE SERVICIOS">
                                                                        <input type="hidden" name="subprocedimiento[respuestasolcambiociudad]" value="RESPUESTA A SOLICITUD DE CAMBIO DE CIUDAD">
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <input type="text" class="form-control text-center" name="citenotificacion[respuestasolcambiociudad]">
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <input type="date" class="form-control text-center" name="fechacitenotificacion[respuestasolcambiociudad]" value="{{ \Carbon\Carbon::now()->toDateString() }}">
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <select name="decisionviaja[respuestasolcambiociudad]" class="form-control recojo-select">
                                                                            <option value="">Seleccione una opción...</option>
                                                                            <option value="ACEPTADO">ACEPTADO</option>
                                                                            <option value="RECHAZADO">RECHAZADO</option>
                                                                        </select>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        @php
                                                                            $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                                                        @endphp
                                                                        <input type="date" class="form-control text-center" name="fechasubida[respuestasolcambiociudad]" value="{{ $fechaSubidaDefault }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                        <input type="file" name="archivo[respuestasolcambiociudad]" class="dropify mx-auto d-block" accept="application/pdf">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        @if (!$csrespuestasolcambiociudad->isEmpty())
                                                            <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                                <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarCScsrespuestasolcambiociudad()">AGREGAR MÁS</button>
                                                            </div>
                                                        @endif
                                                        <script>
                                                            function agregarCScsrespuestasolcambiociudad() {
                                                                const filaOculta = document.querySelector('.fila-csrespuestasolcambiociudad.d-none');
                                                                if (filaOculta) {
                                                                    filaOculta.classList.remove('d-none');
                                                                }
                                                            }
                                    ...
                                    <button type="submit" class="btn btn-sm btn-subirarchivos d-block mx-auto mb-3" target="_blank" style="width: fit-content;">GUARDAR</button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="modalEnteGestorSalud2" tabindex="-1" role="dialog" aria-labelledby="modalEnteGestorSalud2Label" aria-hidden="true">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title titulomodal" id="modalEnteGestorSalud2Label">SIC - ENTE GESTOR DE SALUD</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento21com = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $sitmentegestorcom = $cliente->tramites()
                                                ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')
                                                ->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ NOTIFICACIÓN DE REQUERIMIENTO')
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $sitmentegestoradjmedicacom = $cliente->tramites()
                                                ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')
                                                ->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ ADJUNTO DE DOCUMENTACIÓN MEDICA')
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $sitmentregacarpetacom = $cliente->tramites()
                                                ...
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $documento22com = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD DE EVALUACIÓN MT')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento23com = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD DE HISTORIA CLÍNICA')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento24com = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD A EMPLEADOR')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento99com = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICITUD DE COMPRA DE SERVICIOS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento99otrocom = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'ENTE GESTOR DE SALUD _ SOLICTUD DE MODIFICACION DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                        @endphp
                                        <div class="table-responsive">
                                            <div class="scroll-shadow-wrapper">
                                                <div class="scroll-shadow-container">
                                                    <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sitmentegestorcom as $documento)
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ $documento->id }}</p>
                                                                    </td>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/SOLICITUD DE INFORMACIÓN COMPLEMENTARIA/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach

                                                            @if ($sitmentegestorcom->isEmpty())
                                                                <tr class="fila-sitmentegestorcom">
                                                            @else
                                                                <tr class="fila-sitmentegestorcom d-none">
                                                            @endif
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control" disabled>
                                                                </td>
                                                    ...
                                                    @if (!$sitmentegestorcom->isEmpty())
                                                        <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                            <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarSITMentegestorcom()">AGREGAR MÁS</button>
                                                        </div>
                                                    @endif
                                                    <script>
                                                        function agregarSITMentegestorcom() {
                                                            const filaOculta = document.querySelector('.fila-sitmentegestorcom.d-none');
                                                            if (filaOculta) {
                                                                filaOculta.classList.remove('d-none');
                                                            }
                                                        }
                                            ...
                                            @if (!$documento21com)
                                                <div class="mb-3" style="margin-top: 20px;">
                                                    <label><strong>SELECCIONAR ESPECIALIDADES</strong></label><br>
                                                    <div class="form-check form-check-inline" hidden>
                                                        <input class="form-check-input" type="checkbox" value="PROGRAMACIÓN AL CLIENTE" onchange="agregarEspecialidadcom(this)" checked hidden id="checkProgClientecom">
                                                        <label class="form-check-label" hidden>PROGRAMACIÓN AL CLIENTE</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="MEDICINA DEL TRABAJO" onchange="agregarEspecialidadcom(this)">
                                                        <label class="form-check-label">MEDICINA DEL TRABAJO</label>
                                                    </div>
                                                    <br>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="TRABAJO SOCIAL" onchange="agregarEspecialidadcom(this)">
                                                        <label class="form-check-label">TRABAJO SOCIAL</label>
                                                    </div>
                                                    <br>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="HISTORIA CLINICA" onchange="agregarEspecialidadcom(this)">
                                                        <label class="form-check-label">HISTORIA CLINICA</label>
                                                    </div>
                                                </div>
                                            @endif
                                            <table class="table table-bordered table-sm align-middle" id="tablaProgramaciones2com">
                                                @if (isset($registrosGuardadosProgramacioncom) && collect($registrosGuardadosProgramacioncom)->contains('estudioespecialidad', 'PROGRAMACIÓN AL CLIENTE'))
                                                    <thead class="thead-light">
                                                        <tr>
                                                            <th class="text-center">SUB_PROCEDIMIENTO</th>
                                                            <th class="text-center">ASEGURADORA</th>
                                                    ...
                                                    <tbody>
                                                        @foreach ($registrosGuardadosProgramacioncom as $registro)
                                                            @if ($registro->estudioespecialidad === 'PROGRAMACIÓN AL CLIENTE')
                                                                <tr class="text-center">
                                                                    <input type="hidden" name="tramitenombreprog" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                    <td>
                                                                        {{ $registro->estudioespecialidad }}
                                                                        <input type="hidden" name="subtramite_id2[]" value="{{ $registro->id }}">
                                                                        <input type="hidden" name="estudioespecialidad2[]" value="{{ $registro->estudioespecialidad }}">
                                                                    </td>
                                                                    <td class="align-middle text-center"> 
                                                                        <span>{{$aseguradora}}</span>
                                                                    </td>
                                                                    <td hidden>
                                                                        <input type="text" name="nombremedicoprog2[]" class="form-control form-control-sm" value="">
                                                                    </td>
                                                                    <td hidden>
                                                                        <input type="text" name="opcionatencion2[]" class="form-control form-control-sm" value="">
                                                                    </td>
                                                                    <td>
                                                                        @if ($registro->fechaprogramacion)
                                                                            {{ $registro->fechareprogramacion ?? $registro->fechaprogramacion }}
                                                                            <input type="hidden" name="fechaprogramacion2[]" value="{{ $registro->fechaprogramacion }}">
                                                                        @else
                                                                            <input type="date" name="fechaprogramacion2[]" class="form-control form-control-sm" value="{{ old('fechaprogramacion2[]', $registro->fechaprogramacion) }}" min="{{ \Carbon\Carbon::now()->toDateString() }}">
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                                        @if ($registro->horaprogramacion)
                                                                            {{ $registro->horareprogramacion ?? $registro->horaprogramacion }}
                                                                            <input type="hidden" name="horaprogramacion2[]" value="{{ $registro->horaprogramacion }}">
                                                                        @else
                                                                            <input type="time" name="horaprogramacion2[]" class="form-control form-control-sm" value="{{ old('horaprogramacion2[]', $registro->horaprogramacion) }}">
                                                                        @endif
                                                                    </td>
                                                                    <td hidden>
                                                                        <input type="file" name="ordenprogramacion2[{{ $loop->index }}]" value="" class="form-control form-control-sm">
                                                                    </td>
                                                                    <td>
                                                                        @if ($registro->fechaprogramacion)
                                                                            @if ($registro->asistenciaprogramacion == 1)
                                                                                SI
                                                                                <input type="hidden" name="asistenciaprogramacion2[]" value="{{ $registro->id }}">
                                                                            @else
                                                                                <input type="checkbox" name="asistenciaprogramacion2[]" value="{{ $registro->id }}">
                                                                            @endif
                                                                        @else
                                                                            <input type="checkbox" disabled>
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        @if ($registro->fechaprogramacion && $registro->asistenciaprogramacion == 0)
                                                                            <button type="button" class="btn btn-sm btn-verdocumento" onclick="habilitarReprogramacioncom(this)">REPROGRAMAR</button>
                                                                            <div class="mt-2 d-none">
                                                                                <input type="date" name="fechareprogramacion2[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('fechareprogramacion2[]', $registro->fechareprogramacion) }}">
                                                                                <input type="time" name="horareprogramacion2[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('horareprogramacion2[]', $registro->horareprogramacion) }}">
                                                                                <input type="text" name="motivoreprogramacion2[{{ $registro->id }}]" class="form-control form-control-sm" placeholder="Motivo" value="{{ old('motivoreprogramacion2[]', $registro->motivoreprogramacion) }}">
                                                                            </div>
                                                                        @elseif ($registro->motivoreprogramacion)
                                                                            CON REPROG. - MOTIVO: {{ $registro->motivoreprogramacion }}
                                                                        @else
                                            ...
                                            <div class="scroll-shadow-wrapper">
                                                <div class="scroll-shadow-container">
                                                    <table class="table table-bordered table-sm align-middle" id="tablaProgramacionescom" style="margin-bottom: -5px;">
                                                        <thead class="thead-light">
                                                            <tr>
                                                                <th class="text-center">ESTUDIO/ESPECIALIDAD</th>
                                                                @if (isset($registrosGuardadosProgramacioncom) && collect($registrosGuardadosProgramacioncom)->contains(function($item) {
                                                                    return $item->estudioespecialidad !== 'PROGRAMACIÓN AL CLIENTE' 
                                                                        && $item->estudioespecialidad !== 'HISTORIA CLINICA';
                                                                }))
                                                                <th class="text-center">MÉDICO_ATENCIÓN</th>
                                                                ...
                                                                @if ($registro->estudioespecialidad !== 'PROGRAMACIÓN AL CLIENTE' && $registro->estudioespecialidad !== 'HISTORIA CLINICA')
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion || $registro->nombremedico)
                                                                                {{ $registro->nombremedico }}
                                                                                <input type="hidden" name="nombremedicoprog2[]" value="{{ $registro->nombremedico }}">
                                                                            @else
                                                                                <input type="text" name="nombremedicoprog2[]" class="form-control form-control-sm" value="{{ old('nombremedicoprog2[]', $registro->nombremedico) }}">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion)
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->opcionatencion)
                                                                                {{ $registro->opcionatencion }}
                                                                                <input type="hidden" name="opcionatencion2[]" value="{{ $registro->opcionatencion }}">
                                                                            @else
                                                                                <select name="opcionatencion2[]" class="form-control form-control-sm">
                                                                                    <option value="">Seleccione una opción</option>
                                                                                    <option value="{{ $aseguradora }}">{{ $aseguradora }}</option>
                                                                                    <option value="COMPRA DE SERVICIOS">COMPRA DE SERVICIOS</option>
                                                                                </select>
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->ordenprogramacion)
                                                                                <a href="{{ asset("tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/ORDENES/{$registro->ordenprogramacion}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER ORDEN</a>
                                                                            @else
                                                                                <input type="file" name="ordenprogramacion[{{ $registro->id }}]" class="form-control form-control-sm" value="{{ old('ordenprogramacion2[]', $registro->ordenprogramacion) }}">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion)
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion)
                                                                                @if ($registro->asistenciaprogramacion == 0)
                                                                                    <button type="button" class="btn btn-sm btn-verdocumento" onclick="habilitarReprogramacioncom(this)">REPROGRAMAR</i></button>
                                                                                    <div class="mt-2 d-none">
                                                                                        <input type="date" name="fechareprogramacion2[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('fechareprogramacion2[]', $registro->fechareprogramacion) }}">
                                                                                        <input type="time" name="horareprogramacion2[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('horareprogramacion2[]', $registro->horareprogramacion) }}">
                                                                                        <input type="text" name="motivoreprogramacion2[{{ $registro->id }}]" class="form-control form-control-sm" placeholder="Motivo" value="{{ old('motivoreprogramacion2[]', $registro->motivoreprogramacion) }}">
                                            ...
                                            <div class="text-left mt-2">
                                                <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarFilaManualcom()">AGREGAR MÁS</button>
                                            </div>
                                            <script>
                                                document.addEventListener('DOMContentLoaded', function () {
                                                    const checkbox = document.getElementById('checkProgClientecom');
                                                    if (checkbox && checkbox.checked) {
                                                        agregarEspecialidadcom(checkbox);
                                                    }
                                                });
                                            </script>
                                            <script>
                                                function habilitarReprogramacioncom(btn) {
                                                    const contenedor = btn.nextElementSibling;
                                                    if (contenedor.classList.contains('d-none')) {
                                                        contenedor.classList.remove('d-none');
                                                    } else {
                                            ...
                                            @if (!$documento21com)
                                                <script>
                                                    const especialidadesAgregadascom = new Set();
                                                    const todasareascom = @json($todasareas);

                                                    function agregarEspecialidadcom(checkbox) {
                                                        const tabla = document.getElementById('tablaProgramacionescom').getElementsByTagName('tbody')[0];
                                                        const valor = checkbox.value;

                                                        if (checkbox.checked && !especialidadesAgregadascom.has(valor)) {
                                                            const fila = tabla.insertRow();
                                                            const celda = fila.insertCell();
                                                            celda.setAttribute("colspan", 8);

                                                            if (valor === "PROGRAMACIÓN AL CLIENTE") {
                                                                celda.innerHTML = `<input type="hidden" name="estudioespecialidad2[]" value="${valor}">`;
                                                                fila.style.display = 'none';
                                                            } else {
                                                                celda.innerHTML = `<input type="hidden" name="estudioespecialidad2[]" value="${valor}">${valor}`;
                                                            }

                                                            especialidadesAgregadascom.add(valor);
                                                        } else if (!checkbox.checked && especialidadesAgregadascom.has(valor)) {
                                                            for (let i = 0; i < tabla.rows.length; i++) {
                                                                const input = tabla.rows[i].querySelector(`input[value="${valor}"]`);
                                                                if (input) {
                                                                    tabla.deleteRow(i);
                                                            ...
                                                            especialidadesAgregadascom.delete(valor);
                                                        }
                                                    } 
                                                </script>
                                            @endif
                                            <script>
                                                const todasareascom2 = @json($todasareas);

                                                function agregarFilaManualcom() {
                                                    const tabla = document.getElementById('tablaProgramacionescom').getElementsByTagName('tbody')[0];
                                                    const fila = tabla.insertRow();
                                                    ...
                                                    celda.setAttribute("colspan", 8);
                                                    celda.innerHTML = `
                                                        <select class="form-control form-control-sm" name="estudioespecialidad2[]">
                                                            <option value="" disabled selected>Seleccione un estudio/especialidad...</option>
                                                            ${todasareascom2.map(area => `<option value="${area.area}">${area.area}</option>`).join('')}
                                                        </select>
                                                    `;
                                                }
                                            </script>
                                            ...
                                            @php
                                                ...
                                                $mostrarFormulariocom = false;
                                                $ocultarConBotoncom = false;
                                                if ($empiezaCon($aseguradoraNombre, 'CAJA PETROLERA DE SALUD') ||
                                                    $empiezaCon($aseguradoraNombre, 'SEGURO SOCIAL UNIVERSITARIO')) {
                                                    $mostrarFormulariocom = true;
                                                } elseif ($empiezaCon($aseguradoraNombre, 'CAJA NACIONAL DE SALUD')) {
                                                    if (count($sitmentegestoradjmedicacom) > 0) {
                                                        $mostrarFormulariocom = true;
                                                    } else {
                                                        $ocultarConBotoncom = true;
                                                    }
                                                } elseif ($empiezaCon($aseguradoraNombre, 'CAJA DE SALUD CORDES') ||
                                                        $empiezaCon($aseguradoraNombre, 'CAJA DE SALUD DE LA BANCA PRIVADA')) {
                                                    $mostrarFormulariocom = false;
                                            ...
                                            @if($registrosGuardadosProgramacioncom && $registrosGuardadosProgramacioncom->count() > 0)
                                                    ...
                                                    <tbody>
                                                        @forelse ($sitmentregacarpetacom as $documento)
                                                            <tr>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/SOLICITUD DE INFORMACIÓN COMPLEMENTARIA/{$documento->document}") }}" 
                                                                    class="btn btn-sm btn-verdocumento" 
                                                                    target="_blank">VER DOCUMENTO</a>
                                                                </td>
                                                            </tr>
                                                ...
                                                @if($mostrarFormulariocom)
                                                    <table class="table table-bordered table-sm align-middle text-center">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sitmentegestoradjmedicacom as $documento)
                                                                <tr class="text-center">
                                                                    <td class="align-middle text-center">{{ $documento->id }}</td>
                                                                    <td class="align-middle text-center">ADJUNTO DE DOCUMENTACIÓN MEDICA</td>
                                                                    <td class="align-middle text-center">{{ \Carbon\Carbon::parse($documento->fechasubida)->format('d-m-Y') }}</td>
                                                                    <td>
                                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/SOLICITUD DE INFORMACIÓN COMPLEMENTARIA/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER CARTA</a>
                                                                    </td>
                                                                    <td>
                                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/SOLICITUD DE INFORMACIÓN COMPLEMENTARIA/{$documento->document2}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER FORMULARIO</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                            ...
                                                            @if(count($sitmentegestoradjmedicacom) == 0)
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        ADJUNTO DE DOCUMENTACIÓN MEDICA
                                                                        <input type="hidden" name="tramite[sitmentegestoradjmedicacom]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                        <input type="hidden" name="nivelprocedimiento[sitmentegestoradjmedicacom]" value="SOLICITUD DE INFORMACIÓN COMPLEMENTARIA">
                                                                        <input type="hidden" name="subprocedimiento[sitmentegestoradjmedicacom]" value="ENTE GESTOR DE SALUD _ ADJUNTO DE DOCUMENTACIÓN MEDICA">
                                                                    </td>
                                                                    <td>
                                                                        <input type="date" class="form-control text-center" name="fechasubida[sitmentegestoradjmedicacom]" value="{{ \Carbon\Carbon::now()->toDateString() }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                    </td>
                                                                    <td>
                                                                        <input type="file" name="archivo[sitmentegestoradjmedicacom]" class="dropify" accept="application/pdf">
                                                                    </td>
                                                                    <td>
                                                                        <input type="file" name="archivo2" class="dropify" accept="application/pdf">
                                                                    </td>
                                                ...
                                                @elseif($ocultarConBotoncom)
                                                    <button type="button" class="btn btn-verdocumento mb-2" id="btnMostrarFormcom" style="margin-top:10px;">AGREGAR RESPUESTA Y FORMULARIO</button>
                                                    <div id="contenedorFormulariocom" style="display: none;">
                                                        <table class="table table-bordered table-sm align-middle text-center">
                                                            <thead class="thead-light">
                                                                <tr>
                                                                    <th style="width: 10%;">ID</th>
                                                    ...
                                                    <script>
                                                        document.getElementById('btnMostrarFormcom').addEventListener('click', function() {
                                                            document.getElementById('contenedorFormulariocom').style.display = 'block';
                                                            this.style.display = 'none';
                                                        });
                                                    </script>
                                                @endif
                ...
                <div class="modal fade" id="modalNotificacionTMC2" tabindex="-1" role="dialog" aria-labelledby="modalNotificacionTMC2CLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title titulomodal" id="modalEnteGestorSalud2Label">SIC - NOTIFICACIÓN TMC</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento21com2 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $sitmentegestorcom2 = $cliente->tramites()
                                                ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')
                                                ->where('subprocedimiento', 'NOTIFICACIÓN TMC _ NOTIFICACIÓN DE REQUERIMIENTO')
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $sitmentegestoradjmedicacom2 = $cliente->tramites()
                                                ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')
                                                ->where('subprocedimiento', 'NOTIFICACIÓN TMC _ ADJUNTO DE DOCUMENTACIÓN MEDICA')
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $sitmentregacarpetacom2 = $cliente->tramites()
                                                ...
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $documento22com2 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ SOLICITUD DE EVALUACIÓN MT')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento23com2 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ SOLICITUD DE HISTORIA CLÍNICA')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento24com2 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ SOLICITUD A EMPLEADOR')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento99com2 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ SOLICITUD DE COMPRA DE SERVICIOS')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento99otrocom2 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'NOTIFICACIÓN TMC _ SOLICTUD DE MODIFICACION DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                        @endphp
                                        <div class="table-responsive">
                                            <div class="scroll-shadow-wrapper">
                                                <div class="scroll-shadow-container">
                                                    <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sitmentegestorcom2 as $documento)
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ $documento->id }}</p>
                                                                    </td>
                                                            ...
                                                            @if ($sitmentegestorcom2->isEmpty())
                                                                <tr class="fila-sitmentegestorcom2">
                                                            @else
                                                                <tr class="fila-sitmentegestorcom2 d-none">
                                                            @endif
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control" disabled>
                                                                </td>
                                                    ...
                                                    @if (!$sitmentegestorcom2->isEmpty())
                                                        <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                            <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarSITMentegestorcom2()">AGREGAR MÁS</button>
                                                        </div>
                                                    @endif
                                                    <script>
                                                        function agregarSITMentegestorcom2() {
                                                            const filaOculta = document.querySelector('.fila-sitmentegestorcom2.d-none');
                                                            if (filaOculta) {
                                                                filaOculta.classList.remove('d-none');
                                                            }
                                                        }
                                            ...
                                            @if (!$documento21com2)
                                                <div class="mb-3" style="margin-top: 20px;">
                                                    <label><strong>SELECCIONAR ESPECIALIDADES</strong></label><br>
                                                    <div class="form-check form-check-inline" hidden>
                                                        <input class="form-check-input" type="checkbox" value="PROGRAMACIÓN AL CLIENTE" onchange="agregarEspecialidadcomotro(this)" checked hidden id="checkProgClientecomotro">
                                                        <label class="form-check-label" hidden>PROGRAMACIÓN AL CLIENTE</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="MEDICINA DEL TRABAJO" onchange="agregarEspecialidadcomotro(this)">
                                                        <label class="form-check-label">MEDICINA DEL TRABAJO</label>
                                                    </div>
                                                    <br>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="TRABAJO SOCIAL" onchange="agregarEspecialidadcomotro(this)">
                                                        <label class="form-check-label">TRABAJO SOCIAL</label>
                                                    </div>
                                                    <br>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="HISTORIA CLINICA" onchange="agregarEspecialidadcomotro(this)">
                                                        <label class="form-check-label">HISTORIA CLINICA</label>
                                                    </div>
                                                </div>
                                            @endif
                                            <table class="table table-bordered table-sm align-middle" id="tablaProgramaciones2comotro">
                                                @if (isset($registrosGuardadosProgramacioncom2) && collect($registrosGuardadosProgramacioncom2)->contains('estudioespecialidad', 'PROGRAMACIÓN AL CLIENTE'))
                                                    <thead class="thead-light">
                                                        <tr>
                                                            <th class="text-center">SUB_PROCEDIMIENTO</th>
                                                            <th class="text-center">ASEGURADORA</th>
                                                    ...
                                                    <tbody>
                                                        @foreach ($registrosGuardadosProgramacioncom2 as $registro)
                                                            @if ($registro->estudioespecialidad === 'PROGRAMACIÓN AL CLIENTE')
                                                                <tr class="text-center">
                                                                    <input type="hidden" name="tramitenombreprog" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        @if ($registro->fechaprogramacion && $registro->asistenciaprogramacion == 0)
                                                                            <button type="button" class="btn btn-sm btn-verdocumento" onclick="habilitarReprogramacioncom2(this)">REPROGRAMAR</button>
                                                                            <div class="mt-2 d-none">
                                                                                <input type="date" name="fechareprogramacion4[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('fechareprogramacion4[]', $registro->fechareprogramacion) }}">
                                                                                <input type="time" name="horareprogramacion4[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('horareprogramacion4[]', $registro->horareprogramacion) }}">
                                                                                <input type="text" name="motivoreprogramacion4[{{ $registro->id }}]" class="form-control form-control-sm" placeholder="Motivo" value="{{ old('motivoreprogramacion4[]', $registro->motivoreprogramacion) }}">
                                            ...
                                            <div class="scroll-shadow-wrapper">
                                                <div class="scroll-shadow-container">
                                                    <table class="table table-bordered table-sm align-middle" id="tablaProgramacionescomotro" style="margin-bottom: -5px;">
                                                        <thead class="thead-light">
                                                            <tr>
                                                                <th class="text-center">ESTUDIO/ESPECIALIDAD</th>
                                                                @if (isset($registrosGuardadosProgramacioncom2) && collect($registrosGuardadosProgramacioncom2)->contains(function($item) {
                                                                    return $item->estudioespecialidad !== 'PROGRAMACIÓN AL CLIENTE' 
                                                                        && $item->estudioespecialidad !== 'HISTORIA CLINICA';
                                                                }))
                                                                <th class="text-center">MÉDICO_ATENCIÓN</th>
                                                                    ...
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->ordenprogramacion)
                                                                                <a href="{{ asset("tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/ORDENES/{$registro->ordenprogramacion}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER ORDEN</a>
                                                                            @else
                                                                                <input type="file" name="ordenprogramacion[{{ $registro->id }}]" class="form-control form-control-sm" value="{{ old('ordenprogramacion4[]', $registro->ordenprogramacion) }}">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion)
                                                                        ...
                                                                        <td>
                                                                            @if ($registro->fechaprogramacion)
                                                                                @if ($registro->asistenciaprogramacion == 0)
                                                                                    <button type="button" class="btn btn-sm btn-verdocumento" onclick="habilitarReprogramacioncom2(this)">REPROGRAMAR</i></button>
                                                                                    <div class="mt-2 d-none">
                                                                                        <input type="date" name="fechareprogramacion4[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('fechareprogramacion4[]', $registro->fechareprogramacion) }}">
                                                                                        <input type="time" name="horareprogramacion4[{{ $registro->id }}]" class="form-control form-control-sm mb-1" value="{{ old('horareprogramacion4[]', $registro->horareprogramacion) }}">
                                                                                        <input type="text" name="motivoreprogramacion4[{{ $registro->id }}]" class="form-control form-control-sm" placeholder="Motivo" value="{{ old('motivoreprogramacion4[]', $registro->motivoreprogramacion) }}">
                                            ...
                                            <div class="text-left mt-2">
                                                <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarFilaManualcomotro()">AGREGAR MÁS</button>
                                            </div>
                                            <script>
                                                document.addEventListener('DOMContentLoaded', function () {
                                                    const checkbox = document.getElementById('checkProgClientecomotro');
                                                    if (checkbox && checkbox.checked) {
                                                        agregarEspecialidadcomotro(checkbox);
                                                    }
                                                });
                                            </script>
                                            <script>
                                                function habilitarReprogramacioncom2(btn) {
                                                    const contenedor = btn.nextElementSibling;
                                                    if (contenedor.classList.contains('d-none')) {
                                                        contenedor.classList.remove('d-none');
                                                    } else {
                                            ...
                                            @if (!$documento21com2)
                                                <script>
                                                    const especialidadesAgregadascomotro = new Set();
                                                    const todasareascomotro = @json($todasareas);

                                                    function agregarEspecialidadcomotro(checkbox) {
                                                        const tabla = document.getElementById('tablaProgramacionescomotro').getElementsByTagName('tbody')[0];
                                                        const valor = checkbox.value;

                                                        if (checkbox.checked && !especialidadesAgregadascomotro.has(valor)) {
                                                            const fila = tabla.insertRow();
                                                            const celda = fila.insertCell();
                                                            celda.setAttribute("colspan", 8);
                                                            ...
                                                            especialidadesAgregadascomotro.add(valor);
                                                        } else if (!checkbox.checked && especialidadesAgregadascomotro.has(valor)) {
                                                            for (let i = 0; i < tabla.rows.length; i++) {
                                                                const input = tabla.rows[i].querySelector(`input[value="${valor}"]`);
                                                                if (input) {
                                                                    tabla.deleteRow(i);
                                                            ...
                                                            especialidadesAgregadascomotro.delete(valor);
                                                        }
                                                    } 
                                                </script>
                                            @endif
                                            <script>
                                                const todasareascom2otro = @json($todasareas);

                                                function agregarFilaManualcomotro() {
                                                    const tabla = document.getElementById('tablaProgramacionescomotro').getElementsByTagName('tbody')[0];
                                                    const fila = tabla.insertRow();
                                                    ...
                                                    celda.innerHTML = `
                                                        <select class="form-control form-control-sm" name="estudioespecialidad4[]">
                                                            <option value="" disabled selected>Seleccione un estudio/especialidad...</option>
                                                            ${todasareascom2otro.map(area => `<option value="${area.area}">${area.area}</option>`).join('')}
                                                        </select>
                                                    `;
                                                }
                                            </script>
                                            ...
                                            @php
                                                ...
                                                $mostrarFormulariocom2 = false;
                                                $ocultarConBotoncom2 = false;
                                                if ($empiezaCon($aseguradoraNombre, 'CAJA PETROLERA DE SALUD') ||
                                                    $empiezaCon($aseguradoraNombre, 'SEGURO SOCIAL UNIVERSITARIO')) {
                                                    $mostrarFormulariocom2 = true;
                                                } elseif ($empiezaCon($aseguradoraNombre, 'CAJA NACIONAL DE SALUD')) {
                                                    if (count($sitmentegestoradjmedicacom2) > 0) {
                                                        $mostrarFormulariocom2 = true;
                                                    } else {
                                                        $ocultarConBotoncom2 = true;
                                                    }
                                                } elseif ($empiezaCon($aseguradoraNombre, 'CAJA DE SALUD CORDES') ||
                                                        $empiezaCon($aseguradoraNombre, 'CAJA DE SALUD DE LA BANCA PRIVADA')) {
                                                    $mostrarFormulariocom2 = false;
                                            ...
                                            @if($registrosGuardadosProgramacioncom2 && $registrosGuardadosProgramacioncom2->count() > 0)
                                                ...
                                                @if($mostrarFormulariocom2)
                                                    <table class="table table-bordered table-sm align-middle text-center">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sitmentegestoradjmedicacom2 as $documento)
                                                                <tr class="text-center">
                                                                    <td class="align-middle text-center">{{ $documento->id }}</td>
                                                                    <td class="align-middle text-center">ADJUNTO DE DOCUMENTACIÓN MEDICA</td>
                                                                    <td class="align-middle text-center">{{ \Carbon\Carbon::parse($documento->fechasubida)->format('d-m-Y') }}</td>
                                                            ...
                                                            @if(count($sitmentegestoradjmedicacom2) == 0)
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        ADJUNTO DE DOCUMENTACIÓN MEDICA
                                                                        <input type="hidden" name="tramite[sitmentegestoradjmedicacom2]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                                        <input type="hidden" name="nivelprocedimiento[sitmentegestoradjmedicacom2]" value="SOLICITUD DE INFORMACIÓN COMPLEMENTARIA">
                                                                        <input type="hidden" name="subprocedimiento[sitmentegestoradjmedicacom2]" value="NOTIFICACIÓN TMC _ ADJUNTO DE DOCUMENTACIÓN MEDICA">
                                                                    </td>
                                                                    <td>
                                                                        <input type="date" class="form-control text-center" name="fechasubida[sitmentegestoradjmedicacom2]" value="{{ \Carbon\Carbon::now()->toDateString() }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                    </td>
                                                                    <td>
                                                                        <input type="file" name="archivo[sitmentegestoradjmedicacom2]" class="dropify" accept="application/pdf">
                                                                    </td>
                                                                    <td>
                                                                        <input type="file" name="archivo2" class="dropify" accept="application/pdf">
                                                                    </td>
                                                ...
                                                @elseif($ocultarConBotoncom2)
                                                    <button type="button" class="btn btn-verdocumento mb-2" id="btnMostrarFormcom2" style="margin-top:10px;">AGREGAR RESPUESTA Y FORMULARIO</button>
                                                    <div id="contenedorFormulariocom2" style="display: none;">
                                                        <table class="table table-bordered table-sm align-middle text-center">
                                                            <thead class="thead-light">
                                                                <tr>
                                                                    <th style="width: 10%;">ID</th>
                                                    ...
                                                    <script>
                                                        document.getElementById('btnMostrarFormcom2').addEventListener('click', function() {
                                                            document.getElementById('contenedorFormulariocom2').style.display = 'block';
                                                            this.style.display = 'none';
                                                        });
                                                    </script>
                                                @endif
                ...
                <div class="modal fade" id="modalEmpleador2" tabindex="-1" role="dialog" aria-labelledby="modalEmpleador2Label" aria-hidden="true">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title titulomodal" id="modalEmpleador2Label">SIC - EMPLEADOR</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            ...
                                            $documento292 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'EMPLEADOR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento302 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'EMPLEADOR _ CARTA SOLICITUD A EMPLEADOR')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                            $documento312 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')->where('subprocedimiento', 'EMPLEADOR _ SOLICITUD DE MODIFICACIÓN DE CITE')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();

                                            $sitmempleadornotificacion2 = $cliente->tramites()
                                                ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')
                                                ->where('subprocedimiento', 'EMPLEADOR _ NOTIFICACIÓN DE REQUERIMIENTO')
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                            $sitmempleadorrespuesta2 = $cliente->tramites()
                                                ->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN COMPLEMENTARIA')
                                                ->where('subprocedimiento', 'EMPLEADOR _ RESPUESTA A REQUERIMIENTO')
                                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                            ->get();
                                        ...
                                        <div class="table-responsive">
                                            <div class="scroll-shadow-wrapper">
                                                <div class="scroll-shadow-container">
                                                    <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sitmempleadornotificacion2 as $documento)
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        <p class="mb-0">{{ $documento->id }}</p>
                                                                    </td>
                                                            ...
                                                            @if ($sitmempleadornotificacion2->isEmpty())
                                                                <tr class="fila-sitmempleadornotificacion2">
                                                            @else
                                                                <tr class="fila-sitmempleadornotificacion2 d-none">
                                                            @endif
                                                                <td class="align-middle text-center">
                                                                    <input type="text" class="form-control" disabled>
                                                                </td>
                                                                ...
                                                                <td class="align-middle text-center">
                                                                    @php
                                                                        ...
                                                                        $fechaLimiteStr = $fechaLimite->toDateString();
                                                                    @endphp
                                                                    <input type="date" class="form-control text-center" id="fechasubida13" name="fechasubida[]" value="{{ $fechaSubidaDefault }}" data-max="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }} onchange="actualizarFechaRetorno13(this)">
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="date" class="form-control text-center" id="fecharetorno13" name="fecharetorno[]" value="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <input type="file" name="archivo[]" class="dropify mx-auto d-block" accept="application/pdf">
                                                                </td>
                                                    ...
                                                    @if (!$sitmempleadornotificacion2->isEmpty())
                                                    <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                        <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarSITMempleadornotificacion2()">AGREGAR MÁS</button>
                                                    </div>
                                                    @endif
                                                    <script>
                                                        function agregarSITMempleadornotificacion2() {
                                                            const filaOculta = document.querySelector('.fila-sitmempleadornotificacion2.d-none');
                                                            if (filaOculta) {
                                                                filaOculta.classList.remove('d-none');
                                                            }
                                                        }
                                            ...
                                            <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                                ...
                                                <tbody>
                                                    @foreach ($sitmempleadorrespuesta2 as $documento)
                                                        <tr>
                                                            <td class="align-middle text-center">
                                                                <p class="mb-0">{{ $documento->id }}</p>
                                                            </td>
                                                            ...
                                                            <td class="align-middle text-center">
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/SOLICITUD DE INFORMACIÓN COMPLEMENTARIA/{$documento->document2}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach

                                                    @if ($sitmempleadorrespuesta2->isEmpty())
                                                        <tr class="fila-sitmempleadorrespuesta2">
                                                    @else
                                                        <tr class="fila-sitmempleadorrespuesta2 d-none">
                                                    @endif
                                                        <td class="align-middle text-center">
                                                            <input type="text" class="form-control" disabled>
                                                        </td>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            @php
                                                                ...
                                                                $fechaLimiteStr = $fechaLimite->toDateString();
                                                            @endphp
                                                            <input type="date" class="form-control text-center" id="fechasubida14" name="fechasubida[]" value="{{ $fechaSubidaDefault }}" data-max="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }} onchange="actualizarFechaRetorno14(this)">
                                                        </td>
                                                        <td class="align-middle text-center">
                                                            <input type="date" class="form-control text-center" id="fecharetorno14" name="fecharetorno[]" value="{{ $fechaLimiteStr }}" {{ $puedeEditarFecha ? '' : 'readonly' }}>
                                                        </td>
                                                        <td class="align-middle text-center">
                                                            <input type="file" name="archivo[]" class="dropify mx-auto d-block" accept="application/pdf">
                                                        </td>
                                            ...
                                            @if (!$sitmempleadorrespuesta2->isEmpty())
                                            <div class="text-left mt-2" style="margin-bottom: 10px;">
                                                <button type="button" class="btn btn-sm btn-verdocumento" onclick="agregarSITMempleadorrespuesta2()">AGREGAR MÁS</button>
                                            </div>
                                            @endif
                                            <script>
                                                function agregarSITMempleadorrespuesta2() {
                                                    const filaOculta = document.querySelector('.fila-sitmempleadorrespuesta2.d-none');
                                                    if (filaOculta) {
                                                        filaOculta.classList.remove('d-none');
                                                    }
                                                }
                ...
                <div class="tab-pane fade" id="tab-content-3" role="tabpanel" aria-labelledby="tab-3">
                    <div class="row">
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <br>
                            @php
                                $documento41 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'NOTIFICACIÓN DE DICTAMEN')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                            @endphp
                            <div class="text-center">
                                @if ($documento41)
                        ...
                        @php
                            $documento43 = $cliente->tramites()->where('subprocedimiento', 'NOTIFICACIÓN DE DICTAMEN')->where('estadodictamen', 'ACEPTADO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                            $documentoRechazado = $cliente->tramites()->where('subprocedimiento', 'NOTIFICACIÓN DE DICTAMEN')->where('estadodictamen', 'RECHAZADO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                        @endphp
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            @elseif ($documento43)
                                ...
                                <br>
                                @php
                                    $documento43 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'ACEPTACIÓN DE DICTAMEN')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento44 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'FIRMA DE FORMULARIO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento45 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'FIRMA DE CONTRATO')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento46 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'COBRO DE PENSIÓN')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $documento47 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'NOTA DE RECHAZO DE TRÁMITE')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();

                                    $accedepensiondictamen = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE DICTAMEN')->where('accesopension', 'SI')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $noaccedepensiondictamene6 = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE DICTAMEN (EXCESO DE 6 MESES)')->where('accesopension', 'NO')->where('motivonopension', 'EXCESO DE 6 MESES')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                    $noaccedepensiondictamenfc = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE DICTAMEN (FALTA DE COBERTURA)')->where('accesopension', 'NO')->where('motivonopension', 'FALTA DE COBERTURA')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            @elseif ($documentoRechazado)
                                ...
                                <br>
                                @php
                                    $documento48 = $cliente->tramites()->where('subprocedimiento', 'INICIO PROCESO DE APELACIÓN')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                                @endphp
                                <div class="text-center">
                                    @if (!$documento48)
                                        <span class="mb-0 checkamarillo">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('admin.tramites.generarcartareclamo', $cliente) }}" method="GET" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" id="tramite" name="tramite" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)" hidden>
                    <input type="date" class="form-control" id="fechasubida" name="fechasubida" value="{{ \Carbon\Carbon::now()->toDateString() }}" hidden>
                    @csrf
                    <div class="row">
                        @php
                            $documento1 = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where('nivelprocedimiento', 'INGRESO DE TRÁMITE')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                            $documento5 = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where('nivelprocedimiento', 'FIRMA EAP')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                            $fechaingresoyeap = $documento1 && $documento5;

                            $primeracartasit = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'PRIMERA CARTA SIT')->first();
                            $segundacartasit = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'SEGUNDA CARTA SIT')->first();
                            $terceracartasit = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'TERCERA CARTA SIT')->first();
                            $primeracartareclamo = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'PRIMERA CARTA DE RECLAMO')->first();
                            $segundacartareclamo = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'SEGUNDA CARTA DE RECLAMO')->first();
                            $terceracartareclamo = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'TERCERA CARTA DE RECLAMO')->first();
                            $cartareclamoaps = $cliente->tramites()->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'CARTA DE RECLAMO APS')->first();
                        @endphp
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" id="tipocartareclamo" name="tipocartareclamo" value="PENSIÓN DE COMPENSACIÓN DE COTIZACIONES (SENASIR)" hidden>
...
<div class="modal fade" id="modalsolicitudes" tabindex="-1" role="dialog" aria-labelledby="modalsolicitudesLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title titulomodal" id="modalsolicitudesLabel">MISIVAS</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                                    ...
                                    <tbody>
                                        @forelse ($listasolicitudes as $solicitud)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/SOLICITUDES/{$solicitud->document}") }}"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuesta', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="nombretramite" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                    ...
                                                    <td>
                                                        @if ($solicitud->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/SOLICITUDES/{$solicitud->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                    ...
                                    <tbody>
                                        @forelse ($listaadjuntos as $adjunto)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/ADJUNTOS Y RESPUESTAS/{$adjunto->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuestaadjunto', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($adjunto->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/ADJUNTOS Y RESPUESTAS/{$adjunto->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
                                    ...
                                    <tbody>
                                        @forelse ($listacartas as $carta)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/CARTAS Y RECLAMOS/{$carta->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                    title="VER ADJUNTO/RESPUESTA" target="_blank"></a>
                                                </td>
                                                <form action="{{ route('admin.tramites.guardarrespuestacarta', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($carta->document3)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/CARTAS Y RECLAMOS/{$carta->document3}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <input type="text" name="observacionescarta" class="form-control form-control-sm" placeholder="Observación" required>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if ($carta->document2)
                                                    ...
                                                    <td>
                                                        @if ($carta->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/CARTAS Y RECLAMOS/{$carta->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
                                                                ...
                                                                <div class="col-auto">
                                                                    <button type="submit" class="btn btn-guardarnuevo guardar-btn3" disabled>
                                                                        <i class="fas fa-print"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr class="bg-light">
                                                    <td colspan="13">
                                                        <div class="row g-2">
                                                            ...
                                                            <div class="col-md-2">
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/CARTAS Y RECLAMOS/{$carta->document4}") }}"
                                                                class="btn btn-sm btn-verdocumento"
                                                                target="_blank">
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="formTramite22" action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    {!! Form::hidden('usuarioid', auth()->user()->id) !!}
                    {!! Form::hidden('usuarioregistro', auth()->user()->name) !!}
                    {!! Form::hidden('clienteid', $cliente->id) !!}
                    {!! Form::hidden('clientenombre', $cliente->nombrecompleto) !!}
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th style="width: 5%;">NRO_DICTAMEN</th>
                                        ...
                                        <tbody>
                                            @foreach ($dictamennotificacion as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/DICTAMEN/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <select class="form-control tipo" name="tiporiesgodictamen_disabled[]" disabled>
                                                        ...
                                                        <option value="GRAN COMPENSACIÓN DE COTIZACIONES (SENASIR)">GRAN COMPENSACIÓN DE COTIZACIONES (SENASIR)</option>
                                                    </select>
                                                    ...
                                                    document.addEventListener('input', function(e) {
                                                        if (e.target.classList.contains('porcentaje') || e.target.classList.contains('riesgo')) {
                                                            ...
                                                            if (riesgo === 'RIESGO PROFESIONAL') {
                                                                ...
                                                                else tipo = 'GRAN COMPENSACIÓN DE COTIZACIONES (SENASIR)';
                ...
                {{-- PLANILLA DE DICTAMEN --}}
                <form id="formCriterios" action="{{ route('admin.tramites.guardarcriterios', $cliente) }}" method="POST" style="margin-top: 20px;">
                    @csrf
                    {!! Form::hidden('usuarioid', auth()->user()->id) !!}
                    {!! Form::hidden('usuarioregistro', auth()->user()->name) !!}
                    {!! Form::hidden('clienteid', $cliente->id) !!}
                    ...
                    <div class="container">
                        <div class="table-responsive">
                            ...
                            @php
                                $fechaSiniestros = DB::table('criteriosdictamen')
                                    ->where('clienteid', $cliente->id)
                                    ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                                    ->where('nivel', 'FECHA SINIESTRO')
                                    ->first();

                                $tieneDatosGuardadosSiniestro = !empty($fechaSiniestros);

                                $fechasiniestro1 = $fechaSiniestros->fechasiniestro1 ?? '';
                                $fechasiniestro2 = $fechaSiniestros->fechasiniestro2 ?? '';
                            @endphp
                            <p><strong>FECHA DE SINIESTRO</strong></p> 
                            <table class="table table-bordered table-sm align-middle text-center" style="margin-top: -10px;">
                                <thead>
                                    <tr>
                                        <th>FECHA SINIESTRO 1</th>
                                        <th>FECHA SINIESTRO 2</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        @if ($tieneDatosGuardadosSiniestro)
                                            <td>{{ $fechasiniestro1 ? \Carbon\Carbon::parse($fechasiniestro1)->format('d/m/Y') : '0' }}</td>
                                            <td>{{ $fechasiniestro2 ? \Carbon\Carbon::parse($fechasiniestro2)->format('d/m/Y') : '0' }}</td>
                                        @else
                                            <td><input class="fechasiniestro" type="date" name="fechasiniestro[fechasiniestro1]" value="{{ old('fechasiniestro.fechasiniestro1') }}"></td>
                                            <td><input class="fechasiniestro" type="date" name="fechasiniestro[fechasiniestro2]" value="{{ old('fechasiniestro.fechasiniestro2') }}"></td>
                                        @endif
                                    </tr>
                                </tbody>
                            </table>
                ...
                @if (!$dictamennotificacionexiste)
                    <div class="d-flex justify-content-center" style="margin-top: 20px;">
                        <button type="button" class="btn btn-sm btn-subirarchivos" id="btnGuardarTodo" onclick="guardarAmbos()">GUARDAR DICTAMEN</button>
                    </div>
                @endif
                <script>
                    function guardarAmbos() {
                        ...
                        let form1 = document.getElementById('formTramite22');
                        ...
                        .then(() => {
                            alert('¡DICTAMEN GUARDADO EXITOSAMENTE!');
                            location.reload();
                        })
                        .catch(err => {
                            console.error(err);
                ...
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        @php
                            ...
                            $dictamenexiste = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'NOTIFICACIÓN DE DICTAMEN')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                            $existeexceso6mes = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'NOTIFICACIÓN DE DICTAMEN')->where('motivonopension', 'EXCESO DE 6 MESES')->first();
                            $existefaltacobertura = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'NOTIFICACIÓN DE DICTAMEN')->where('motivonopension', 'FALTA DE COBERTURA')->first();
                            $existeaccesopensionsi = $cliente->tramites()->where('nivelprocedimiento', 'DICTAMEN')->where('subprocedimiento', 'NOTIFICACIÓN DE DICTAMEN')->where('accesopension', 'SI')->first();
                            ...
                            $rechazosolinvdictamenexceso6mes = $cliente->tramites()
                                ->where('nivelprocedimiento', 'DICTAMEN')
                                ->where('subprocedimiento', 'RECHAZO DE SOLICITUD DE PENSIÓN POR COMPENSACIÓN DE COTIZACIONES (SENASIR) (EXCESO DE SEIS MESES)')
                                ->where('accesopension', 'NO')
                                ->where('motivonopension', 'EXCESO DE 6 MESES')
                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                            ->get();
                            ...
                            $renunciarevdictamenfaltacober = $cliente->tramites()
                                ->where('nivelprocedimiento', 'DICTAMEN')
                                ->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE DICTAMEN (FALTA DE COBERTURA)')
                                ->where('accesopension', 'NO')
                            ...
                            $rechazosolinvdictamenfaltacober = $cliente->tramites()
                                ->where('nivelprocedimiento', 'DICTAMEN')
                                ->where('subprocedimiento', 'RECHAZO DE SOLICITUD DE PENSIÓN POR COMPENSACIÓN DE COTIZACIONES (SENASIR) (FALTA DE COBERTURA)')
                                ->where('accesopension', 'NO')
                                ->where('motivonopension', 'FALTA DE COBERTURA')
                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                            ->get();
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RENUNCIA A REVISIÓN DE DICTAMEN</p>
                                                <input type="hidden" name="tramite[renunciarevdictamen]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                        ...
                                        <table class="table table-bordered table-sm align-middle text-center">
                                            ...
                                            <tbody>
                                                ...
                                                @endif
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">FIRMA DE CONTRATO</p>
                                                        <input type="hidden" name="tramite[firmacontratodictamen]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                        ...
                        @if($existeexceso6mes)
                        {{-- DICTAMEN NO ACCEDE A PENSION CON EXCESO DE SEIS MESES --}}
                            {{-- RENUNCIA A REVISION DE DICTAMEN --}}
                            <div class="scroll-shadow-wrapper">
                                <div class="scroll-shadow-container">
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RENUNCIA A REVISIÓN DE DICTAMEN (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[renunciarevdictamenexceso6mes]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                    <input type="hidden" name="nivelprocedimiento[renunciarevdictamenexceso6mes]" value="DICTAMEN">
                                                    <input type="hidden" name="subprocedimiento[renunciarevdictamenexceso6mes]" value="RENUNCIA A REVISIÓN DE DICTAMEN (EXCESO DE SEIS MESES)">
                            ...
                            {{-- RECHAZO DE SOLICITUD DE PENSIÓN POR COMPENSACIÓN DE COTIZACIONES (SENASIR) --}}
                            <div class="scroll-shadow-wrapper">
                                <div class="scroll-shadow-container">
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        <thead class="thead-light">
                                        ...
                                        <tbody>
                                            @foreach ($rechazosolinvdictamenexceso6mes as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR COMPENSACIÓN DE COTIZACIONES (SENASIR) (EXCESO DE SEIS MESES)</p>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                    </td>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR COMPENSACIÓN DE COTIZACIONES (SENASIR) (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[rechazosolinvdictamenexceso6mes]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                    <input type="hidden" name="nivelprocedimiento[rechazosolinvdictamenexceso6mes]" value="DICTAMEN">
                                                    <input type="hidden" name="subprocedimiento[rechazosolinvdictamenexceso6mes]" value="RECHAZO DE SOLICITUD DE PENSIÓN POR COMPENSACIÓN DE COTIZACIONES (SENASIR) (EXCESO DE SEIS MESES)">
                                ...
                                <tbody>
                                    ...
                                    @endif
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <input type="hidden" name="tramite[formulariodictamenexceso6mes]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                            <input type="hidden" name="nivelprocedimiento[formulariodictamenexceso6mes]" value="DICTAMEN">
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">FIRMA DE CONTRATO (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[firmacontratodictamenexceso6mes]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                    <input type="hidden" name="nivelprocedimiento[firmacontratodictamenexceso6mes]" value="DICTAMEN">
                        ...
                        {{-- DICTAMEN NO ACCEDE A PENSION CON FALTA DE COBERTURA --}}
                            {{-- RENUNCIA A REVISION DE DICTAMEN --}}
                            <div class="scroll-shadow-wrapper">
                                <div class="scroll-shadow-container">
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            @foreach ($renunciarevdictamenfaltacober as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">RENUNCIA A REVISIÓN DE DICTAMEN (FALTA DE COBERTURA)</p>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                    </td>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RENUNCIA A REVISIÓN DE DICTAMEN (FALTA DE COBERTURA)</p>
                                                    <input type="hidden" name="tramite[renunciarevdictamenfaltacober]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                    <input type="hidden" name="nivelprocedimiento[renunciarevdictamenfaltacober]" value="DICTAMEN">
                                                    <input type="hidden" name="subprocedimiento[renunciarevdictamenfaltacober]" value="RENUNCIA A REVISIÓN DE DICTAMEN (FALTA DE COBERTURA)">
                                        ...
                                        <tbody>
                                            @foreach ($rechazosolinvdictamenfaltacober as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR COMPENSACIÓN DE COTIZACIONES (SENASIR) (FALTA DE COBERTURA)</p>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                    </td>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR COMPENSACIÓN DE COTIZACIONES (SENASIR) (FALTA DE COBERTURA)</p>
                                                    <input type="hidden" name="tramite[rechazosolinvdictamenfaltacober]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                    <input type="hidden" name="nivelprocedimiento[rechazosolinvdictamenfaltacober]" value="DICTAMEN">
                                                    <input type="hidden" name="subprocedimiento[rechazosolinvdictamenfaltacober]" value="RECHAZO DE SOLICITUD DE PENSIÓN POR COMPENSACIÓN DE COTIZACIONES (SENASIR) (FALTA DE COBERTURA)">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        @php
                            $documento48 = $cliente->tramites()->where('subprocedimiento', 'INICIO PROCESO DE TERCERA SOLICITUD')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                        @endphp
                        <div class="row mb-3 align-items-center {{ !$documento48 ? 'no-documento' : '' }}">
                            <div class="col-md-4 text-center">
                                <p class="mb-0">ABRIR PROCESO DE TERCERA SOLICITUD</p>
                                <input type="text" class="form-control" id="tramite1" name="tramite[]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)" hidden>
                                <input type="text" class="form-control" id="nivelprocedimiento1" name="nivelprocedimiento[]" value="DICTAMEN" hidden>
                                <input type="text" class="form-control" id="subprocedimiento1" name="subprocedimiento[]" value="INICIO PROCESO DE TERCERA SOLICITUD" hidden>
                            </div>
                            <div class="col-md-4 text-center">
                                @php
                                    $documento48 = $cliente->tramites()->where('subprocedimiento', 'INICIO PROCESO DE TERCERA SOLICITUD')->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')->first();
                    ...
                    <div class="container">
                        ...
                        <div class="row mb-3 align-items-center no-documento">
                            <div class="col-md-3 text-center" hidden>
                                <input type="text" class="form-control" name="tramite[]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)" hidden>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($filtrados as $procedimientotramite)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center" style="width: 250px;">{{ $procedimientotramite->subprocedimiento }}</td>
                                            ...
                                            @if ($procedimientotramite->capturacomunicacion)
                                                ...
                                                <td class="align-middle text-center">
                                                    ...
                                                    @else
                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/INVALIDEZ/COMUNICACIONES/{$procedimientotramite->capturacomunicacion}") }}"
                                                        class="btn btn-sm btn-verdocumento"
                                                        target="_blank">
                                                        VER CAPTURA
                                                        </a>
                    ...
                    <div class="container">
                        @php
                            ...
                            $rechazocancelaciontramite = $cliente->tramites()
                                ->where('nivelprocedimiento', 'CANCELACIÓN')
                                ->where('subprocedimiento', 'RECHAZO DE CANCELACIÓN DE TRÁMITE')
                                ->where('tramite', 'COMPENSACIÓN DE COTIZACIONES (SENASIR)')
                            ->get();
                                        ...
                                        <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                            ...
                                            <tbody>
                                                ...
                                                @endif
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">CANCELACIÓN DE TRAMITE</p>
                                                        <input type="hidden" name="tramite[cancelaciontramitegestora]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <input type="text" class="form-control text-center" name="usuarioingreso[cancelaciontramitegestora]" value="GESTORA" readonly>
                                                    </td>
                                                    <td class="align-middle text-center">
                                        ...
                                        <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                            ...
                                            <tbody>
                                                ...
                                                @endif
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <input type="text" class="form-control text-center" name="usuarioingreso[]" value="{{ $cliente->nombrecompleto }}" readonly>
                                                    </td>
                                                    <td class="align-middle text-center">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th style="width: 20%;">SUB_PROCEDIMIENTO</th>
                                            <th style="width: 20%;">FECHA_REGISTRO</th>
                                            <th style="width: 20%;">CARTA_RECHAZO_CANCELACIÓN_GP</th>
                                            <th style="width: 20%;">CARTA_RECHAZO_CANCELACIÓN_APS</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($rechazocancelaciontramite as $documento)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RECHAZO DE CANCELACIÓN DE TRÁMITE</p>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">{{ \Carbon\Carbon::parse($documento->fechasubida)->format('d-m-Y') }}</p>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/DICTAMEN/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER CARTA</a>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/COMPENSACIÓN DE COTIZACIONES (SENASIR)/DICTAMEN/{$documento->document2}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER CARTA</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RECHAZO DE CANCELACIÓN DE TRÁMITE</p>
                                                <input type="hidden" name="tramite[rechazocancelaciontramite]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                                <input type="hidden" name="nivelprocedimiento[rechazocancelaciontramite]" value="CANCELACIÓN">
                                                <input type="hidden" name="subprocedimiento[rechazocancelaciontramite]" value="RECHAZO DE CANCELACIÓN DE TRÁMITE">
                                            </td>
                                            <td class="align-middle text-center">
                                                @php
                                                    $fechaSubidaDefault = \Carbon\Carbon::now()->toDateString();
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">ACEPTACIÓN DE CANCELACIÓN DE TRÁMITE</p>
                                                <input type="hidden" name="tramite[aceptacioncancelaciontramite]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">DESISTIMIENTO A CANCELACIÓN DE TRÁMITE</p>
                                                <input type="hidden" name="tramite[desistimientocancelaciontramite]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
                            ...
                            <table class="table table-bordered table-sm align-middle text-center">
                                ...
                                <tbody>
                                    ...
                                    @endif
                                        ...
                                        <td class="align-middle text-center">
                                            <input type="hidden" name="tramite[notiferronea]" value="COMPENSACIÓN DE COTIZACIONES (SENASIR)">
