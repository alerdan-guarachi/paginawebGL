...
<h5>PROCEDIMIENTO DE TRÁMITE DE RETIRO DE APORTES PARCIAL DE:</h5>
...
<div class="card">
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" id="myTabs">
            ...
            @php
                $documento5 = $cliente->tramites()->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->where('estadocomunicado', 'COMUNICADO')->first();
            @endphp
            @if (!$documento5)
            <li class="nav-item">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        @php
                            ...
                            $documento2 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->first();
                        @endphp
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <br>
                        @php
                            $documento3 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'VALIDACIÓN DE PODER')->first();
                        @endphp
                        <div class="text-center">
                            @if (!$documento3)
                                <span class="mb-0 checkamarillo">
                    ...
                    {{-- FIRMA EAP --}}
                    @php
                        $documento3 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'VALIDACIÓN DE PODER')->where('estadocomunicado', 'COMUNICADO')->first();
                    @endphp
                    <div class="col-12 col-md-4 mb-3">
                        <button type="button" class="btn btn-custom btn-block text-center" data-toggle="modal" data-target="#modalFirmaEAP" @if (!$documento3) disabled @endif>
                            <div class="d-flex flex-column align-items-center justify-content-center">
                                ...
                                @php
                                    $documento5 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                @endphp
                                @if (!$documento5)
                                    @if ($documento3)
                                        @php
            ...
            <div class="tab-pane fade" id="tab-content-2" role="tabpanel" aria-labelledby="tab-2">
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 mb-3">
                        ...
                        <br>
                        @php
                            $documento6 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'NOTIFICACIÓN DE GESTORA')->first();
                            $documento7 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'SOLICITUD DE CERTIFICADO DE OBITO LEGALIZADO')->first();
                            $documento8 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'RESPUESTA A NOTA DE GESTORA')->first();
                            $documento9 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'ADJUNTO DE DECLARACIÓN DE HEREDEROS')->first();
                        @endphp
                        <div class="text-center">
                                        ...
                                        <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="row mb-3 align-items-center {{ !$documento6 ? 'no-documento' : '' }}">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        @php
                                                            $documento6 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'NOTIFICACIONES, SOLICITUDES, ADJUNTOS Y RESPUESTAS')->where('subprocedimiento', 'NOTIFICACIÓN DE GESTORA')->first();
                                                        @endphp
                                                        @if ($documento6)
                                                ...
                                                <div class="row mb-3 align-items-center {{ !$documento7 ? 'no-documento' : '' }}">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        @php
                                                            $documento7 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'NOTIFICACIONES, SOLICITUDES, ADJUNTOS Y RESPUESTAS')->where('subprocedimiento', 'SOLICITUD DE CERTIFICADO DE OBITO LEGALIZADO')->first();
                                                        @endphp
                                                        @if ($documento7)
                                                ...
                                                <div class="row mb-3 align-items-center {{ !$documento8 ? 'no-documento' : '' }}">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        @php
                                                            $documento8 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'NOTIFICACIONES, SOLICITUDES, ADJUNTOS Y RESPUESTAS')->where('subprocedimiento', 'RESPUESTA A NOTA DE GESTORA')->first();
                                                        @endphp
                                                        @if ($documento8)
                                                ...
                                                <div class="row mb-3 align-items-center {{ !$documento9 ? 'no-documento' : '' }}">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        @php
                                                            $documento9 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'NOTIFICACIONES, SOLICITUDES, ADJUNTOS Y RESPUESTAS')->where('subprocedimiento', 'ADJUNTO DE DECLARACIÓN DE HEREDEROS')->first();
                                                        @endphp
                                                        @if ($documento9)
                                            ...
                                            @php
                                                $documento6 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'RECOJO DE NOTIFICACIÓN DE GESTORA')->first();
                                                $documento7 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'SOLICITUD DE CERTIFICADO DE OBITO LEGALIZADO')->first();
                                                $documento8 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'RESPUESTA A NOTA DE GESTORA')->first();
                                                $documento9 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'ADJUNTO DE DECLARACIÓN DE HEREDEROS')->first();
                                            @endphp
            ...
            <div class="tab-pane fade" id="tab-content-3" role="tabpanel" aria-labelledby="tab-3">
                <div class="row">
                    <div class="col-12 col-md-12 mb-3">
                        ...
                        <br>
                        @php
                            $documento11 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'FIRMA DE CONTRATO')->first();
                            $documento13 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'NOTA DE RECHAZO DE TRÁMITE')->first();
                        @endphp
                        <div class="text-center">
                    ...
                    <div class="container">
                        ...
                        <div class="row mb-3 align-items-center {{ !$documento2 ? 'no-documento' : '' }}">
                            <div class="col-md-4 text-center">
                                ...
                                <input type="text" class="form-control" id="tramite2" name="tramite[]" value="RETIRO DE APORTES PARCIAL" hidden>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        @php
                        $documento4 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'RECHAZO DE PODER')->first();
                        @endphp
                    ...
                    @php
                        $documento3 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'VALIDACION DE PODER')->first();
                        $documento4 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'RECHAZO DE PODER')->first();
                    @endphp
                    @if (!$documento3)
                        <button type="submit" class="btn btn-subirarchivos d-block mx-auto mb-3" target="_blank" style="width: fit-content;">SUBIR ARCHIVOS</button>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('admin.tramites.generarcartareclamo', $cliente) }}" method="GET" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <input type="text" class="form-control" id="tipocartareclamo" name="tipocartareclamo" value="RETIRO DE APORTES PARCIAL" hidden>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        @php
                            $documento11 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'FIRMA DE CONTRATO')->first();
                        @endphp
                        ...
                        <div class="row mb-3 align-items-center {{ !$documento13 ? 'no-documento' : '' }}">
                            <div class="col-md-4 text-center">
                                ...
                                @if (!$documento13)
                                <input type="text" class="form-control" id="tramite3" name="tramite[]" value="RETIRO DE APORTES PARCIAL" hidden>
            ...
            <div class="modal-body">
                <form id="seguimientoForm" action="{{ route('admin.tramites.guardartramitesclienteitaseguimiento', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        @php
                            $seguimientos = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'SEGUIMIENTO')->get();
                        @endphp
