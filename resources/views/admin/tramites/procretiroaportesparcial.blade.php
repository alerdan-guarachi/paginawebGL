...
{{-- @if($inicioocontinuidad)
    ...
    <a class="btn btn-sm float-right btn-cartareclamo" href="{{ route('admin.tramites.cartasprocretiroaportesparcial', $cliente->id) }}">NUEVA MISIVA</a>
...
@if($inicioocontinuidad)
    <div class="dropdown float-right ml-2">
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
            ...
            <a class="dropdown-item" href="{{ route('admin.tramites.cartasprocretiroaportesparcial', $cliente->id) }}">
...
<h5>PROCEDIMIENTO DE RETIRO DE APORTES PARCIAL DE:</h5>
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="tab-content-1" role="tabpanel" aria-labelledby="tab-1">
                    <form id="formTramite" action="{{ route('admin.tramites.guardariniciotramiteclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                        ...
                        {!! Form::hidden('tramite', 'RETIRO DE APORTES PARCIAL') !!}
    ...
    @if($inicioocontinuidad)
        ...
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs" id="myTabs">
                ...
                @php
                    $documento5 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')
                    ...
                    @if($tramiteinicio)
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <br>
                                @php
                                    $documento1 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                                    $documento2 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->first();
                                @endphp
                                <div class="text-center"> 
                            ...
                            @php
                                $documento1 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'RECEPCION DE TRÁMITE')->where('estadocomunicado', 'COMUNICADO')->first();
                                $documento2 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'INCLUSION DE PODER')->where('estadocomunicado', 'COMUNICADO')->first();
                            @endphp
                            <div class="col-12 col-md-3 mb-3">
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                <button type="button" class="btn btn-custom btn-block text-center" data-toggle="modal" data-target="#modalFirmaEAP" @if (!$documento3) disabled @endif>
                                    <div class="d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        @php
                                            $documento1 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                        @endphp
                                        @if (!$documento1)
                                            @if ($documento3)
                                                @php
                                ...
                                <br>
                                @php
                                    $documento5 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                @endphp
                                <div class="text-center">
                                    @if (!$documento1)
                                        <span class="mb-0 checkamarillo">
                    ...
                    @if($tramitecontinuidad)
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <br>
                                @php
                                    $documento3 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'VALIDACIÓN DE PODER')->first();
                                @endphp
                                <div class="text-center">
                                    @if (!$documento3)
                                        <span class="mb-0 checkamarillo">
                            ...
                            @php
                                ...
                                $estadotramite = $cliente->tramites()->where('nivelprocedimiento', 'INGRESO DE TRÁMITE')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->where('tramite', 'RETIRO DE APORTES PARCIAL')->whereIn('estadotramite', ['INGRESO DE TRÁMITE', 'FIRMA EAP'])->first();
                            @endphp
                            <div class="col-12 col-md-3 mb-3">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <p class="form-control-plaintext text-center">{{ $tiporetiroaportesparcial }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento1 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                                            $fecha = \Carbon\Carbon::now();
                                            $valor = $fecha->day <= 15 ? $fecha : $fecha->copy()->addMonth();
                                            $valorFormateado = $valor->format('m/y');
                                            $documento2 = $cliente->tramites()->where('subprocedimiento', 'INCLUSIÓN DE PODER')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                        @endphp
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        ...
                                                                        @if (!$documento1)
                                                                            <input type="hidden" name="tramite[]" value="RETIRO DE APORTES PARCIAL">
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        @if ($documento1)
                                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/INGRESO DE TRÁMITE/{$documento1->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                        ...
                                                        <table class="table table-bordered table-sm align-middle text-center">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        @if ($documento2)
                                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/INGRESO DE TRÁMITE/{$documento2->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                            @if ($puedeEditarArchivo)
                                                                                <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                                    <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                                    <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento4 = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE PODER')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                            $documento3 = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE PODER')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                            $documentoformval = $cliente->tramites()->where('subprocedimiento', 'FORMULARIO DE VALIDACIÓN DE PODER')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                            $correccionpoder = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE PODER')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="align-middle text-center">
                                                            ...
                                                            @if (!$documentoformval)
                                                                <input type="hidden" name="tramite[formulariovalidacion]" value="RETIRO DE APORTES PARCIAL">
                                                    ...
                                                    <tr>
                                                        <td class="align-middle text-center">
                                                            ...
                                                            @if (!$documento3)
                                                                <input type="hidden" name="tramite[validacionpoder]" value="RETIRO DE APORTES PARCIAL">
                                                        ...
                                                        <td class="align-middle text-center">
                                                            @if ($documento3)
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/NOTIFICACIÓN DE PODER/{$documento3->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                @if ($puedeEditarArchivo)
                                                                    <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                        <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                        <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                                                ...
                                                <table class="table table-bordered table-sm align-middle text-center">
                                                    ...
                                                    <tbody>
                                                                    ...
                                                                    <tr class="fila-formulariorecepcion">
                                                                        ...
                                                                        <td class="align-middle text-center">
                                                                            @if ($formulariorecepcion->document)
                                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/NOTIFICACIÓN DE PODER/{$formulariorecepcion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                            @else
                                                        ...
                                                        @if (!$validaciondocext || $rechazodocext && (!$rechazodocext || $rechazodocext))
                                                            @php
                                                                $rechazosDocExt = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'RETIRO DE APORTES PARCIAL')->get();
                                                                $validacionesDocExt = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'RETIRO DE APORTES PARCIAL')->get();
                                                            @endphp
                                                                ...
                                                                @if ($rechazosDocExt->count() > 0)
                                                                    @foreach ($rechazosDocExt as $rechazo)
                                                                        <tr class="fila-rechazo">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($rechazo->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/NOTIFICACIÓN DE PODER/{$rechazo->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                                                        ...
                                                        @if ($rechazodocext)
                                                            @php
                                                                $correccionesDocExt = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'RETIRO DE APORTES PARCIAL')->get();
                                                            @endphp
                                                                        ...
                                                                        <tr class="fila-correccion">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($correccion->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/NOTIFICACIÓN DE PODER/{$correccion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                                                                        ...
                                                                        <tr class="fila-validacion">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($validacion->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/NOTIFICACIÓN DE PODER/{$validacion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    {!! Form::hidden('apoderado', $apoderadoAsignado) !!}
                                    {!! Form::hidden('idtramite', $idTramite) !!}
                                    {!! Form::hidden('tramitenombreprog', 'RETIRO DE APORTES PARCIAL') !!}
                                    @csrf
                                    <div class="container">
                                        @php
                                            $documento5 = $cliente->tramites()->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                        @endphp
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm align-middle text-center">
                                                <thead class="thead-light">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            @if ($documento5)
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/FIRMA EAP/{$documento5->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                @if ($puedeEditarArchivo)
                                                                    <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                        <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                        <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                ...
                <div class="tab-pane fade" id="tab-content-2" role="tabpanel" aria-labelledby="tab-2">
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <br>
                            @php
                                $documento10 = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'NOTIFICACIÓN DE GESTORA')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                $documento103 = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'AGENDAMIENTO')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                $documento104 = $cliente->tramites()->where('nivelprocedimiento', 'COMPRA DE SERVICIOS')->where('subprocedimiento', 'ORDENES DE COMPRA DE SERVICIOS')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                            @endphp
                            <div class="text-center">
                                                ...
                                                <tbody>
                                                    @foreach ($cssolicitud as $documento)
                                                        <tr>
                                                            ...
                                                            <td class="align-middle text-center">
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/RESPUESTA A TRÁMITE/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    ...
                                                    @endif
                                                        ...
                                                        <td class="align-middle text-center">
                                                            <p class="mb-0">SELECCIÓN DE BENEFICIO</p>
                                                            <input type="hidden" name="tramite[respuestatramite]" value="RETIRO DE APORTES PARCIAL">
                                            ...
                                            <table class="table table-bordered table-sm align-middle text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endif
                                                        ...
                                                        <td class="align-middle text-center">
                                                            <p class="mb-0">NOTA DE RECHAZO</p>
                                                            <input type="hidden" name="tramite[notarechazo]" value="RETIRO DE APORTES PARCIAL">
                                            ...
                                            <table class="table table-bordered table-sm align-middle text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endif
                                                        ...
                                                        <td class="align-middle text-center">
                                                            <p class="mb-0">FORMULARIO DE RETIRO DE APORTES</p>
                                                            <input type="hidden" name="tramite[csformretiroaportes]" value="RETIRO DE APORTES PARCIAL">
                ...
                <div class="tab-pane fade" id="tab-content-3" role="tabpanel" aria-labelledby="tab-3">
                    <div class="row">
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <br>
                            @php
                                $documento41 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'NOTIFICACIÓN DE CONTRATO')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                            @endphp
                            <div class="text-center">
                                @if ($documento41)
                        ...
                        @php
                            $documento43 = $cliente->tramites()->where('subprocedimiento', 'NOTIFICACIÓN DE CONTRATO')->where('estadodictamen', 'ACEPTADO')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                            $documentoRechazado = $cliente->tramites()->where('subprocedimiento', 'NOTIFICACIÓN DE CONTRATO')->where('estadodictamen', 'RECHAZADO')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                        @endphp
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            @elseif ($documento43)
                                ...
                                <br>
                                @php
                                    $documento43 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'ACEPTACIÓN DE CONTRATO')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                    $documento44 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'FIRMA DE FORMULARIO')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                    $documento45 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'FIRMA DE CONTRATO')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                    $documento46 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'COBRO DE PENSIÓN')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                    $documento47 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'NOTA DE RECHAZO DE TRÁMITE')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();

                                    $accedepensiondictamen = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE CONTRATO')->where('accesopension', 'SI')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                    $noaccedepensiondictamene6 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE CONTRATO (EXCESO DE 6 MESES)')->where('accesopension', 'NO')->where('motivonopension', 'EXCESO DE 6 MESES')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                                    $noaccedepensiondictamenfc = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE CONTRATO (FALTA DE COBERTURA)')->where('accesopension', 'NO')->where('motivonopension', 'FALTA DE COBERTURA')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('admin.tramites.generarcartareclamo', $cliente) }}" method="GET" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" id="tramite" name="tramite" value="RETIRO DE APORTES PARCIAL" hidden>
                    <input type="date" class="form-control" id="fechasubida" name="fechasubida" value="{{ \Carbon\Carbon::now()->toDateString() }}" hidden>
                    @csrf
                    <div class="row">
                        @php
                            $documento1 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'INGRESO DE TRÁMITE')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                            $documento5 = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'FIRMA EAP')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                            $fechaingresoyeap = $documento1 && $documento5;

                            $primeracartasit = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'PRIMERA CARTA SIT')->first();
                            $segundacartasit = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'SEGUNDA CARTA SIT')->first();
                            $terceracartasit = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'TERCERA CARTA SIT')->first();
                            $primeracartareclamo = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'PRIMERA CARTA DE RECLAMO')->first();
                            $segundacartareclamo = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'SEGUNDA CARTA DE RECLAMO')->first();
                            $terceracartareclamo = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'TERCERA CARTA DE RECLAMO')->first();
                            $cartareclamoaps = $cliente->tramites()->where('tramite', 'RETIRO DE APORTES PARCIAL')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'CARTA DE RECLAMO APS')->first();
                        @endphp
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" id="tipocartareclamo" name="tipocartareclamo" value="PENSIÓN DE RETIRO DE APORTES PARCIAL" hidden>
                                    ...
                                    <tbody>
                                        @forelse ($listasolicitudes as $solicitud)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/SOLICITUDES/{$solicitud->document}") }}"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuesta', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="nombretramite" value="RETIRO DE APORTES PARCIAL">
                                                    ...
                                                    <td>
                                                        @if ($solicitud->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/SOLICITUDES/{$solicitud->document2}") }}"
                                    ...
                                    <tbody>
                                        @forelse ($listaadjuntos as $adjunto)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/ADJUNTOS Y RESPUESTAS/{$adjunto->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuestaadjunto', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($adjunto->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/ADJUNTOS Y RESPUESTAS/{$adjunto->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
                                    ...
                                    <tbody>
                                        @forelse ($listacartas as $carta)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/CARTAS Y RECLAMOS/{$carta->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                    title="VER ADJUNTO/RESPUESTA" target="_blank"></a>
                                                </td>
                                                <form action="{{ route('admin.tramites.guardarrespuestacarta', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($carta->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/CARTAS Y RECLAMOS/{$carta->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                    ...
                                                    <td>
                                                        @if ($carta->document3)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/CARTAS Y RECLAMOS/{$carta->document3}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
                                                ...
                                                <tr class="bg-light">
                                                    <td colspan="13">
                                                        <div class="row g-2">
                                                            ...
                                                            <div class="col-md-2">
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/CARTAS Y RECLAMOS/{$carta->document4}") }}"
                                                                class="btn btn-sm btn-verdocumento"
                                                                target="_blank">
                                    ...
                                    <tbody>
                                        @forelse ($listamisivas as $misiva)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/MISIVAS LIBRES/{$misiva->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuestamisivalibre', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($misiva->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/MISIVAS LIBRES/{$misiva->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                    ...
                                                    <td>
                                                        @if ($misiva->document3)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/MISIVAS LIBRES/{$misiva->document3}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
                                        ...
                                        <tbody>
                                            @foreach ($dictamennotificacion as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/CONTRATO/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                    </td>
                                                </tr>
                                            @endforeach
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        @php
                            $documento29 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                            $documento30 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ CARTA SOLICITUD A EMPLEADOR')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                            $documento31 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ SOLICITUD DE MODIFICACIÓN DE CITE')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();

                            $documento31 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ SOLICITUD DE MODIFICACIÓN DE CITE')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                            
                            $dictamenexiste = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'NOTIFICACIÓN DE CONTRATO')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                            ...
                            $rechazosolinvdictamenexceso6mes = $cliente->tramites()
                                ->where('nivelprocedimiento', 'CONTRATO')
                                ->where('subprocedimiento', 'RECHAZO DE SOLICITUD DE RETIRO DE APORTES PARCIAL (EXCESO DE SEIS MESES)')
                                ->where('accesopension', 'NO')
                                ->where('motivonopension', 'EXCESO DE 6 MESES')
                                ->where('tramite', 'RETIRO DE APORTES PARCIAL')
                            ->get();
                            ...
                            $rechazosolinvdictamenfaltacober = $cliente->tramites()
                                ->where('nivelprocedimiento', 'CONTRATO')
                                ->where('subprocedimiento', 'RECHAZO DE SOLICITUD DE RETIRO DE APORTES PARCIAL (FALTA DE COBERTURA)')
                                ->where('accesopension', 'NO')
                                ->where('motivonopension', 'FALTA DE COBERTURA')
                                ->where('tramite', 'RETIRO DE APORTES PARCIAL')
                            ->get();
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RENUNCIA A REVISIÓN DE CONTRATO</p>
                                                <input type="hidden" name="tramite[renunciarevdictamen]" value="RETIRO DE APORTES PARCIAL">
                                        ...
                                        <table class="table table-bordered table-sm align-middle text-center">
                                            ...
                                            <tbody>
                                                ...
                                                @endif
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">FIRMA DE CONTRATO</p>
                                                        <input type="hidden" name="tramite[firmacontratodictamen]" value="RETIRO DE APORTES PARCIAL">
                        ...
                        {{-- CONTRATO NO ACCEDE A PENSION CON EXCESO DE SEIS MESES --}}
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RENUNCIA A REVISIÓN DE CONTRATO (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[renunciarevdictamenexceso6mes]" value="RETIRO DE APORTES PARCIAL">
                            ...
                            {{-- RECHAZO DE SOLICITUD DE RETIRO DE APORTES PARCIAL --}}
                            <div class="scroll-shadow-wrapper">
                                <div class="scroll-shadow-container">
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        <thead class="thead-light">
                                        ...
                                        <tbody>
                                            @foreach ($rechazosolinvdictamenexceso6mes as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">RECHAZO DE SOLICITUD DE RETIRO DE APORTES PARCIAL (EXCESO DE SEIS MESES)</p>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                    </td>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RECHAZO DE SOLICITUD DE RETIRO DE APORTES PARCIAL (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[rechazosolinvdictamenexceso6mes]" value="RETIRO DE APORTES PARCIAL">
                                                    <input type="hidden" name="nivelprocedimiento[rechazosolinvdictamenexceso6mes]" value="CONTRATO">
                                                    <input type="hidden" name="subprocedimiento[rechazosolinvdictamenexceso6mes]" value="RECHAZO DE SOLICITUD DE RETIRO DE APORTES PARCIAL (EXCESO DE SEIS MESES)">
                                ...
                                <tbody>
                                    ...
                                    @endif
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <input type="hidden" name="tramite[formulariodictamenexceso6mes]" value="RETIRO DE APORTES PARCIAL">
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">FIRMA DE CONTRATO (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[firmacontratodictamenexceso6mes]" value="RETIRO DE APORTES PARCIAL">
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RENUNCIA A REVISIÓN DE CONTRATO (FALTA DE COBERTURA)</p>
                                                    <input type="hidden" name="tramite[renunciarevdictamenfaltacober]" value="RETIRO DE APORTES PARCIAL">
                                        ...
                                        <tbody>
                                            @foreach ($rechazosolinvdictamenfaltacober as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">RECHAZO DE SOLICITUD DE RETIRO DE APORTES PARCIAL (FALTA DE COBERTURA)</p>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                    </td>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RECHAZO DE SOLICITUD DE RETIRO DE APORTES PARCIAL (FALTA DE COBERTURA)</p>
                                                    <input type="hidden" name="tramite[rechazosolinvdictamenfaltacober]" value="RETIRO DE APORTES PARCIAL">
                                                    <input type="hidden" name="nivelprocedimiento[rechazosolinvdictamenfaltacober]" value="CONTRATO">
                                                    <input type="hidden" name="subprocedimiento[rechazosolinvdictamenfaltacober]" value="RECHAZO DE SOLICITUD DE RETIRO DE APORTES PARCIAL (FALTA DE COBERTURA)">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        @php
                            $documento48 = $cliente->tramites()->where('subprocedimiento', 'INICIO PROCESO DE APELACIÓN')->where('tramite', 'RETIRO DE APORTES PARCIAL')->first();
                        @endphp
                        <div class="row mb-3 align-items-center {{ !$documento48 ? 'no-documento' : '' }}">
                            <div class="col-md-4 text-center">
                                <p class="mb-0">ABRIR PROCESO DE APELACIÓN</p>
                                <input type="text" class="form-control" id="tramite1" name="tramite[]" value="RETIRO DE APORTES PARCIAL" hidden>
                    ...
                    <div class="container">
                        ...
                        <div class="row mb-3 align-items-center no-documento">
                            <div class="col-md-3 text-center" hidden>
                                <input type="text" class="form-control" name="tramite[]" value="RETIRO DE APORTES PARCIAL" hidden>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($procedimientotramite->capturacomunicacion)
                                                            ...
                                                            <td class="align-middle text-center">
                                                                ...
                                                                @else
                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/COMUNICACIONES/{$procedimientotramite->capturacomunicacion}") }}"
                                                                    class="btn btn-sm btn-verdocumento"
                                                                    target="_blank">
                                                                    VER CAPTURA
                                                                    </a>
                                                        ...
                                                        @else
                                                            <td class="align-middle text-center" colspan="8">
                                                                <form action="{{ route('tramites.subirArchivo', ['id' => $procedimientotramite->id, 'clienteId' => $cliente->id]) }}" method="POST" enctype="multipart/form-data" class="d-flex gap-2">
                                                                    @csrf
                                                                    <input type="hidden" name="tramitenombre" value="RETIRO DE APORTES PARCIAL">
                                        ...
                                        <form action="{{ route('admin.tramites.guardarseguimientoclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <table class="table table-striped table-bordered align-middle text-center table-sm tabla-comunicaciones" style="table-layout: fixed; width: 100%;">
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="align-middle text-center">
                                                                @if(!$seguimiento->capturacomunicacion)
                                                                    <span class="badge bg-warning text-dark">VACÍO</span>
                                                                @else
                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/COMUNICACIONES/{$seguimiento->capturacomunicacion}") }}"
                                                                        class="btn btn-sm btn-verdocumento"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="hidden" name="comtramitenombre" value="RETIRO DE APORTES PARCIAL">
                                        ...
                                        <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                            ...
                                            <tbody>
                                                ...
                                                @endif
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">CANCELACIÓN DE TRAMITE</p>
                                                        <input type="hidden" name="tramite[cancelaciontramitegestora]" value="RETIRO DE APORTES PARCIAL">
                                    ...
                                    <tbody>
                                        @foreach ($rechazocancelaciontramite as $documento)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/CANCELACIÓN/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER CARTA</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RECHAZO DE CANCELACIÓN DE TRÁMITE GP</p>
                                                <input type="hidden" name="tramite[rechazocancelaciontramite]" value="RETIRO DE APORTES PARCIAL">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RECHAZO DE CANCELACIÓN DE TRÁMITE APS</p>
                                                <input type="hidden" name="tramite[rechazocancelaciontramiteaps]" value="RETIRO DE APORTES PARCIAL">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">ACEPTACIÓN DE CANCELACIÓN DE TRÁMITE</p>
                                                <input type="hidden" name="tramite[aceptacioncancelaciontramite]" value="RETIRO DE APORTES PARCIAL">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">DESISTIMIENTO A CANCELACIÓN DE TRÁMITE</p>
                                                <input type="hidden" name="tramite[desistimientocancelaciontramite]" value="RETIRO DE APORTES PARCIAL">
                                ...
                                <tbody>
                                    @foreach ($notiferronea as $documento)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/NOTIFICACIÓN ERRÓNEA/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    @endif
                                        ...
                                        <td class="align-middle text-center">
                                            <input type="hidden" name="tramite[notiferronea]" value="RETIRO DE APORTES PARCIAL">
                                        ...
                                        <tbody>
                                            @foreach ($notifobservadas as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/NOTIFICACIÓN OBSERVADA/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        @if($documento->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/RETIRO DE APORTES PARCIAL/NOTIFICACIÓN OBSERVADA/{$documento->document2}") }}"
                                                            target="_blank"
                                                            class="btn btn-sm btn-verdocumento">
                                                            VER RESPUESTA
                                                            </a>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <input type="hidden" name="tramite[notifobservadas]" value="RETIRO DE APORTES PARCIAL">
