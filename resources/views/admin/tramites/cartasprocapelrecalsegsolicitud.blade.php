...
<a class="btn btn-sm float-right btn-regresar" href="{{ route('admin.tramites.procapelrecalsegsolicitud', $cliente->id) }}">REGRESAR</a>
<h5>MISIVAS DE APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD DE:</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.tramites.generarsolicitud', $cliente) }}" method="GET" enctype="multipart/form-data" id="formSolicitud">
                                        ...
                                        <input type="text" class="form-control" id="tramite" name="tramite" value="APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD" hidden>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <table class="table" id="opciones1Table">
                                                        <thead class="table-secondary">
                                                            <tr style="text-align: center">
                                                                <th class="col-lg-12">OPCIONES</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                                <td class="col-lg-12"><input type="text" name="opcionuno1" class="form-control" /></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <button type="button" class="btn btn-sm btn-verdocumento" id="agregaropciones1">AGREGAR MÁS</button>
                                                </div>
                                            </div>
                                            <script>
                                                $(document).ready(function() {
                                                    let opcionesCount1 = 1;
                                                    $('#agregaropciones1').on('click', function() {
                                                        opcionesCount1++;
                                                        if(opcionesCount1 > 20) return;

                                                        const nuevaFila = `
                                                            <tr>
                                                                <td class="col-lg-12"><input type="text" name="opcionuno${opcionesCount1}" class="form-control" /></td>
                                                            </tr>
                                                        `;
                                                        $('#opciones1Table tbody').append(nuevaFila);
                                                    });
                                                });
                                            </script>
                                            ...
                                            <div class="col-lg-12" id="tablaopciones2Container" style="display: none;">
                                                <div class="table-responsive">
                                                    <table class="table" id="opciones2Table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="col-lg-12"><input type="text" name="opciondos1" class="form-control" /></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <button type="button" class="btn btn-sm btn-verdocumento" id="agregaropciones2">AGREGAR MÁS</button>
                                                </div>
                                            </div>
                                            <script>
                                                $(document).ready(function() {
                                                    let opcionesCount2 = 1;
                                                    $('#agregaropciones2').on('click', function() {
                                                        opcionesCount2++;
                                                        if(opcionesCount2 > 20) return;

                                                        const nuevaFila = `
                                                            <tr>
                                                                <td class="col-lg-12"><input type="text" name="opciondos${opcionesCount2}" class="form-control" /></td>
                                                            </tr>
                                                        `;
                                                        $('#opciones2Table tbody').append(nuevaFila);
                                                    });
                                                });
                                            </script>
                                                                                                            ...
                                                                                                            <td class="text-center align-middle">
                                                                                                                @php
                                                                                                                    ...
                                                                                                                    $ruta = match(true) {
                                                                                                                        ...
                                                                                                                        in_array($tipoarea, ['PROGRAMACIONES', 'INFORMES ADICIONALES']) => "tramitesclientesita/{$cliente->id}/APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD/INFORMES/{$doc->document}",
                                                                                                                        $tipoarea === 'RSRD'=> "tramitesclientesita/{$cliente->id}/APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD/RSRD - ADJUNTO DOCUMENTACIÓN MÉDICA/{$doc->document}",
                                                                                                                        default => "documentacionclientesita/{$cliente->id}/{$doc->document}",
                                                                                                                    };
                                                                                                                @endphp
                                                                                                                <a href="{{ url($ruta) }}" target="_blank" class="btn btn-sm btn-verdoc" title="Ver documento">
                                            ...
                                            <div class="col-lg-12" id="tablaadjuntosContainer" style="display: none;">
                                                ...
                                                {{-- <input type="text" class="form-control" id="tipocartareclamo" name="tipocartareclamo" value="PENSIÓN DE APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD" hidden> --}}
                                            </div>
                                            <script>
                                                $(document).ready(function() {
                                                    let filaCount2 = 1;
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                $('#tipoPdfSelect2').on('change', function() {
                                                    ...
                                                    $('#txtcomple1Container').hide();
                                                    $('#txtcomple2Container').hide();
                                                    $('#txtcomple3Container').hide();
                                                    $('#tituloop1Container').hide();
                                                    $('#tablaopciones1Container').hide();
                                                    $('#tituloop2Container').hide();
                                                    $('#tablaopciones2Container').hide();
                                                    ...
                                                    if (selectedValue === 'ACTUALIZACIÓN DE DATOS') {
                                                        ...
                                                        $('#fechacontratoContainer').show();
                                                        $('#tablaEspecialidades').show();
                                                        $('#txtcomple1Container').show();
                                                        $('#txtcomple2Container').show();
                                                        $('#txtcomple3Container').show();
                                                        $('#tituloop1Container').show();
                                                        $('#tablaopciones1Container').show();
                                                        $('#tituloop2Container').show();
                                                        $('#tablaopciones2Container').show();
                                                    }
                                                });
                                            });
                                        </script>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.tramites.generaradjuntoyrespuesta', $cliente) }}" method="GET" enctype="multipart/form-data" id="formAdjunto">
                                        ...
                                        <input type="text" class="form-control" id="tramite2" name="tramite2" value="APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD" hidden>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <div class="form-group col-lg-5">
                                                        ...
                                                        ], null, ['class' => 'form-control', 'placeholder' => '', 'required' => 'required', 'id' => 'tiponivelproc']) !!}
                                                    </div>
                                                    <div class="form-group col-lg-5">
                                                    ...
                                                    <div class="form-group col-lg-4" id="nrosolrevdic2Container" style="display: none;">
                                                        {!! Form::label('nrosolrevdic2', 'Nro. Sol. Rev. Dic.:') !!}
                                                        {!! Form::text('nrosolrevdic2', null, ['class' => 'form-control', 'placeholder' => '']) !!}
                                                    </div>
                                                    <div class="form-group col-lg-4" id="fechasolrevdic2Container" style="display: none;">
                                                        {!! Form::label('fechasolrevdic2', 'Fecha Sol. Rev. Dic.:') !!}
                                                        {!! Form::date('fechasolrevdic2', null, ['class' => 'form-control', 'value' => '{{ \Carbon\Carbon::now()->toDateString() }}']) !!}
                                                    </div>
                                                    <div class="form-group col-lg-4" id="fechapressolrevdic2Container" style="display: none;">
                                                        {!! Form::label('fechapressolrevdic2', 'Fecha Pres. Sol.Rev. Dic.:') !!}
                                                        {!! Form::date('fechapressolrevdic2', null, ['class' => 'form-control', 'value' => '{{ \Carbon\Carbon::now()->toDateString() }}']) !!}
                                                    </div>
                                                    <div class="form-group col-lg-4" id="fechaautoadmision2Container" style="display: none;">
                                                        {!! Form::label('fechaautoadmision2', 'Fecha Auto Admisión:') !!}
                                                        {!! Form::date('fechaautoadmision2', null, ['class' => 'form-control', 'value' => '{{ \Carbon\Carbon::now()->toDateString() }}']) !!}
                                                    </div>
                                            ...
                                            <script>
                                                $(document).ready(function() {
                                                    $('#tipoPdfSelect22').on('change', function() {
                                                        ...
                                                        $('#nrosolrevdic2Container').hide();
                                                        $('#fechasolrevdic2Container').hide();
                                                        $('#fechapressolrevdic2Container').hide();
                                                        $('#fechaautoadmision2Container').hide();

                                                        var selectedValue = $(this).val();
                                                        var nivelProc = $('#tiponivelproc').val();
                                                        ...
                                                        if (selectedValue === 'ADJUNTO DE DOCUMENTOS') {
                                                            ...
                                                            if (nivelProc !== 'AUTO DE ADMISIÓN') {
                                                                $('#notatecnicomedico2Container').show();
                                                                $('#fechanotatecnicomedico2Container').show();
                                                                $('#tablaEspecialistas').show();
                                                                $('#nombremedico2Container').show();
                                                            } else {
                                                                $('#nrosolrevdic2Container').show();
                                                                $('#fechasolrevdic2Container').show();
                                                                $('#fechapressolrevdic2Container').show();
                                                                $('#fechaautoadmision2Container').show();
                                                                $('#tablaEspecialistas').show();
                                                                $('#nombremedico2Container').show();
                                                            }
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.tramites.generarcartareclamo', $cliente) }}" method="GET" enctype="multipart/form-data" id="formCarta">
                                        ...
                                        <input type="text" class="form-control" id="tramite" name="tramite3" value="APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD" hidden>
                                        <input type="date" class="form-control" id="fechasubida3" name="fechasubida3" value="{{ \Carbon\Carbon::now()->toDateString() }}" hidden>
                                        @csrf
                                        <div class="row">
                                            @php
                                                $documento1 = $cliente->tramites()->where('tramite', 'APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD')->where('nivelprocedimiento', 'INGRESO DE TRÁMITE')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                                                $documento5 = $cliente->tramites()->where('tramite', 'APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD')->where('nivelprocedimiento', 'FIRMA EAP')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                                $fechaingresoyeap = $documento1 && $documento5;

                                                $primeracartasit = $cliente->tramites()->where('tramite', 'APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'PRIMERA CARTA SIT')->first();
                                                $segundacartasit = $cliente->tramites()->where('tramite', 'APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'SEGUNDA CARTA SIT')->first();
                                                $terceracartasit = $cliente->tramites()->where('tramite', 'APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'TERCERA CARTA SIT')->first();
                                                $primeracartareclamo = $cliente->tramites()->where('tramite', 'APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'PRIMERA CARTA DE RECLAMO')->first();
                                                $segundacartareclamo = $cliente->tramites()->where('tramite', 'APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'SEGUNDA CARTA DE RECLAMO')->first();
                                                $terceracartareclamo = $cliente->tramites()->where('tramite', 'APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'TERCERA CARTA DE RECLAMO')->first();
                                                $cartareclamoaps = $cliente->tramites()->where('tramite', 'APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'CARTA DE RECLAMO APS')->first();
                                            @endphp
                                            ...
                                            <script>
                                                document.addEventListener("DOMContentLoaded", function () {
                                                    ...
                                                    const opciones = {
                                                        ...
                                                        "SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO - ENTE GESTOR DE SALUD": ["ADJUNTO Y RESPUESTA AL TÉCNICO MÉDICO", "SOLICITUD DE COMPRA DE SERVICIOS"],
                                                        ...
                                                        "SOLICITUD DE INFORMACIÓN COMPLEMENTARIA - ENTE GESTOR DE SALUD": ["ADJUNTO Y RESPUESTA AL COMPLEMENTARIO", "SOLICITUD DE COMPRA DE SERVICIOS"],
                                            ...
                                            <div class="form-group col-lg-3">
                                                {!! Form::label('nrorevisiondictamen3', 'Nro. Rev. Dic.:') !!}
                                                {!! Form::text('nrorevisiondictamen3', null, ['class' => 'form-control']) !!}
                                            </div>
                                            <div class="form-group col-lg-3">
                                                {!! Form::label('fecharevdictamen3', 'Fecha Rev. Dic.:') !!}
                                                {!! Form::date('fecharevdictamen3', null, ['class' => 'form-control']) !!}
                                            </div>
                                            <div class="form-group col-lg-3">
                                                {!! Form::label('porcentajedictamen3', 'Porcentaje Dic.:') !!}
                                                {!! Form::text('porcentajedictamen3', null, ['class' => 'form-control']) !!}
                                            </div>
                                            <div class="form-group col-lg-3">
                                                {!! Form::label('origendictamen3', 'Origen Dic.:') !!}
                                                {!! Form::text('origendictamen3', null, ['class' => 'form-control']) !!}
                                            </div>
                                            <div class="form-group col-lg-3">
                                                {!! Form::label('motivoorigendictamen3', 'Motivo Origen Dic.:') !!}
                                                {!! Form::text('motivoorigendictamen3', null, ['class' => 'form-control']) !!}
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.tramites.generarlibre', $cliente) }}" method="GET" enctype="multipart/form-data" id="formLibre">
                                        ...
                                        <input type="text" class="form-control" id="tramite4" name="tramite4" value="APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD" hidden>
