...
<a class="btn btn-sm float-right btn-regresar" href="{{ route('admin.tramites.procretiroaportestotal', $cliente->id) }}">REGRESAR</a>
<h5>MISIVAS DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES DE:</h5>
...
<div class="card">
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" id="myTabs">
            {{-- <li class="nav-item">
                <a class="nav-link" id="tab-1" data-toggle="tab" href="#tab-content-1" role="tab" aria-controls="tab-content-1" aria-selected="true">SOLICITUDES</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link active" id="tab-3" data-toggle="tab" href="#tab-content-3" role="tab" aria-controls="tab-content-3" aria-selected="false">CARTAS / RECLAMOS</a>
            </li>
            <li class="nav-item">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.tramites.generaradjuntoyrespuesta', $cliente) }}" method="GET" enctype="multipart/form-data" id="formAdjunto">
                                        ...
                                        <input type="text" class="form-control" id="tramite2" name="tramite2" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES" hidden>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.tramites.generarcartareclamo', $cliente) }}" method="GET" enctype="multipart/form-data" id="formCarta">
                                        ...
                                        <input type="text" class="form-control" id="tramite" name="tramite3" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES" hidden>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-8">
                                                ...
                                                {!! Form::select('nivelprocedimiento3', [
                                                    ...
                                                    'COMPRA DE SERVICIOS' => 'COMPRA DE SERVICIOS', */
                                                    'RESPUESTA A TRÁMITE' => 'RESPUESTA A TRÁMITE',
                                                    'COMPLEMENTACIÓN DEL TRÁMITE' => 'COMPLEMENTACIÓN DEL TRÁMITE',
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.tramites.generarlibre', $cliente) }}" method="GET" enctype="multipart/form-data" id="formLibre">
                                        ...
                                        <input type="text" class="form-control" id="tramite4" name="tramite4" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES" hidden>
