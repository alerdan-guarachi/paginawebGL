...
{{-- @if($inicioocontinuidad)
    ...
    <a class="btn btn-sm float-right btn-cartareclamo" href="{{ route('admin.tramites.cartasprocmasahereditaria', $cliente->id) }}">NUEVA MISIVA</a>
...
@if($inicioocontinuidad)
    <div class="dropdown float-right ml-2">
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
            ...
            <a class="dropdown-item" href="{{ route('admin.tramites.cartasprocmasahereditaria', $cliente->id) }}">
...
<h5>PROCEDIMIENTO DE MASA HEREDITARIA DE:</h5>
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="tab-content-1" role="tabpanel" aria-labelledby="tab-1">
                    <form id="formTramite" action="{{ route('admin.tramites.guardariniciotramiteclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                        ...
                        {!! Form::hidden('tramite', 'MASA HEREDITARIA') !!}
    ...
    @if($inicioocontinuidad)
        ...
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs" id="myTabs">
                ...
                @php
                    $documento5 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')
                    ...
                    @if($tramiteinicio)
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <br>
                                @php
                                    $datosAfiliado = $subtramites->where('tipo', 'DATOS DE AFILIADO')->where('tramite', 'MASA HEREDITARIA')->where('clienteid', $cliente->id)->first();
                                @endphp
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <br>
                                @php
                                    $documento1 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                                    $documento2 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->first();
                                @endphp
                                <div class="text-center"> 
                            ...
                            @php
                                $documento1 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'RECEPCION DE TRÁMITE')->where('estadocomunicado', 'COMUNICADO')->first();
                                $documento2 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'INCLUSION DE PODER')->where('estadocomunicado', 'COMUNICADO')->first();
                            @endphp
                            <div class="col-12 col-md-3 mb-3">
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                <button type="button" class="btn btn-custom btn-block text-center" data-toggle="modal" data-target="#modalFirmaEAP" @if (!$documento3) disabled @endif>
                                    <div class="d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        @php
                                            $documento1 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                        @endphp
                                        @if (!$documento1)
                                            @if ($documento3)
                                                @php
                                ...
                                <br>
                                @php
                                    $documento5 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                @endphp
                                <div class="text-center">
                                    @if (!$documento1)
                                        <span class="mb-0 checkamarillo">
                    ...
                    @if($tramitecontinuidad)
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <br>
                                @php
                                    $documento3 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->whereNotNull('capturacomunicacion');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'VALIDACIÓN DE PODER')->first();
                                @endphp
                                <div class="text-center">
                                    @if (!$documento3)
                                        <span class="mb-0 checkamarillo">
                            ...
                            @php
                                ...
                                $estadotramite = $cliente->tramites()->where('nivelprocedimiento', 'INGRESO DE TRÁMITE')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->where('tramite', 'MASA HEREDITARIA')->whereIn('estadotramite', ['INGRESO DE TRÁMITE', 'FIRMA EAP'])->first();
                            @endphp
                            <div class="col-12 col-md-3 mb-3">
                ...
                <div class="modal fade" id="modalDatosAfiliado" tabindex="-1" role="dialog" aria-labelledby="modalDatosAfiliadoLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardardatosafiliadomasahereditaria', $cliente) }}" method="POST">
                                    @csrf
                                    {!! Form::hidden('usuarioid', auth()->user()->id) !!}
                                    {!! Form::hidden('usuarioregistro', auth()->user()->name) !!}
                                    {!! Form::hidden('clienteid', $cliente->id) !!}
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="container p-3">
                                                        <div class="row mb-3">
                                                            <div class="col-12">
                                                                <label class="form-label fw-bold">Pensiones No Cobradas</label>
                                                                @if($datosAfiliado)
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-12">
                                                                ...
                                                                @if($datosAfiliado)
                                                                    <p class="form-control-plaintext">
                                                                        {{ $datosAfiliado->solicitante1 }}
                                                                        {{ $datosAfiliado->solicitante2 ? ' - '.$datosAfiliado->solicitante2 : '' }}
                                                                    </p>
                                                                    {!! Form::hidden('solicitante1', $datosAfiliado->solicitante1) !!}
                                                                    {!! Form::hidden('solicitante2', $datosAfiliado->solicitante2) !!}
                                                                @else
                                                                    @php
                                                                        $opcionessolicitantes = [
                                                                            'ESPOSA'=>'ESPOSA',
                                                                            'HIJOS MENORES A 25 AÑOS'=>'HIJOS MENORES A 25 AÑOS'
                                                                        ];
                                                                    @endphp
                                                                    <div class="d-flex flex-column">
                                                                        @foreach($opcionessolicitantes as $valors => $textos)
                                                                            <div class="form-check mb-1">
                                                                                <input type="checkbox" name="solicitantes[]" value="{{ $valors }}" class="form-check-input solicitante-check" id="solicitante-{{ $valors }}">
                                                                                <label class="form-check-label" for="solicitante-{{ $valors }}">{{ $textos }}</label>
                                                                            </div>
                                                                        @endforeach
                                                                    </div>
                                                                    {!! Form::hidden('solicitante1', null, ['id'=>'solicitante1']) !!}
                                                                    {!! Form::hidden('solicitante2', null, ['id'=>'solicitante2']) !!}
                                                                @endif
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row mb-3">
                                                            <div class="col-12">
                                                                <label class="form-label fw-bold">DH de 1er, 2do o 3er Grado</label>
                                                                @if($datosAfiliado)
                                                                    <p class="form-control-plaintext">
                                                                        {{ $datosAfiliado->dh123grado1 }}
                                                                        {{ $datosAfiliado->dh123grado2 ? ' - '.$datosAfiliado->dh123grado2 : '' }}
                                                                        {{ $datosAfiliado->dh123grado3 ? ' - '.$datosAfiliado->dh123grado3 : '' }}
                                                                    </p>
                                                                    {!! Form::hidden('dh123grado1', $datosAfiliado->dh123grado1) !!}
                                                                    {!! Form::hidden('dh123grado2', $datosAfiliado->dh123grado2) !!}
                                                                    {!! Form::hidden('dh123grado3', $datosAfiliado->dh123grado3) !!}
                                                                @else
                                                                    @php
                                                                        $opcionesdh = [
                                                                            'HIJOS MAYORES A 25 AÑOS'=>'HIJOS MAYORES A 25 AÑOS',
                                                                            'PADRES'=>'PADRES',
                                                                            'HERMANOS'=>'HERMANOS',
                                                                            'SOBRINOS'=>'SOBRINOS',
                                                                            'NIETOS'=>'NIETOS',
                                                                    ...
                                                                    @endphp
                                                                    <div class="d-flex flex-column">
                                                                        @foreach($opcionesdh as $valordh => $textodh)
                                                                            <div class="form-check mb-1">
                                                                                <input type="checkbox" name="dhs[]" value="{{ $valordh }}" class="form-check-input dh-check" id="dh-{{ $valordh }}">
                                                                                <label class="form-check-label" for="dh-{{ $valordh }}">{{ $textodh }}</label>
                                                                            </div>
                                                                        @endforeach
                                                                    </div>
                                                                    {!! Form::hidden('dh123grado1', null, ['id'=>'dh1']) !!}
                                                                    {!! Form::hidden('dh123grado2', null, ['id'=>'dh2']) !!}
                                                                    {!! Form::hidden('dh123grado3', null, ['id'=>'dh3']) !!}
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    document.addEventListener('DOMContentLoaded', function() {
                                                        ...
                                                        const s1 = document.getElementById('servicio1');
                                                        const s2 = document.getElementById('servicio2');
                                                        const s3 = document.getElementById('servicio3');
                                                        servicios.forEach(chk => {
                                                            chk.addEventListener('change', function() {
                                                                const seleccionados = Array.from(servicios).filter(c => c.checked).map(c => c.value);
                                                                if (seleccionados.length > 3) { this.checked = false; return; }
                                                                s1.value = seleccionados[0] || '';
                                                                s2.value = seleccionados[1] || '';
                                                                s3.value = seleccionados[2] || '';
                                                            });
                                                        });

                                                        // Grupo 2: Solicitantes
                                                        const solicitantes = document.querySelectorAll('.solicitante-check');
                                                        const so1 = document.getElementById('solicitante1');
                                                        const so2 = document.getElementById('solicitante2');
                                                        solicitantes.forEach(chk => {
                                                            chk.addEventListener('change', function() {
                                                                const seleccionados = Array.from(solicitantes).filter(c => c.checked).map(c => c.value);
                                                                if (seleccionados.length > 2) { this.checked = false; return; }
                                                                so1.value = seleccionados[0] || '';
                                                                so2.value = seleccionados[1] || '';
                                                            });
                                                        });

                                                        // Grupo 3: DH
                                                        const dhs = document.querySelectorAll('.dh-check');
                                                        const dh1 = document.getElementById('dh1');
                                                        const dh2 = document.getElementById('dh2');
                                                        const dh3 = document.getElementById('dh3');
                                                        dhs.forEach(chk => {
                                                            chk.addEventListener('change', function() {
                                                                const seleccionados = Array.from(dhs).filter(c => c.checked).map(c => c.value);
                                                                if (seleccionados.length > 3) { this.checked = false; return; }
                                                                dh1.value = seleccionados[0] || '';
                                                                dh2.value = seleccionados[1] || '';
                                                                dh3.value = seleccionados[2] || '';
                                                            });
                                                        });
                                                    });
                                                    </script>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento1 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                                            $fecha = \Carbon\Carbon::now();
                                            $valor = $fecha->day <= 15 ? $fecha : $fecha->copy()->addMonth();
                                            $valorFormateado = $valor->format('m/y');
                                            $documento2 = $cliente->tramites()->where('subprocedimiento', 'INCLUSIÓN DE PODER')->where('tramite', 'MASA HEREDITARIA')->first();
                                        @endphp
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="align-middle text-center">
                                                                        ...
                                                                        @if (!$documento1)
                                                                            <input type="hidden" name="tramite[]" value="MASA HEREDITARIA">
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        @if ($documento1)
                                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/INGRESO DE TRÁMITE/{$documento1->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                        ...
                                                        <table class="table table-bordered table-sm align-middle text-center">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        @if ($documento2)
                                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/INGRESO DE TRÁMITE/{$documento2->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                            @if ($puedeEditarArchivo)
                                                                                <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                                    <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                                    <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        @php
                                            $documento4 = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE PODER')->where('tramite', 'MASA HEREDITARIA')->first();
                                            $documento3 = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE PODER')->where('tramite', 'MASA HEREDITARIA')->first();
                                            $documentoformval = $cliente->tramites()->where('subprocedimiento', 'FORMULARIO DE VALIDACIÓN DE PODER')->where('tramite', 'MASA HEREDITARIA')->first();
                                            $correccionpoder = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE PODER')->where('tramite', 'MASA HEREDITARIA')->first();
                                            $rechazodocext = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'MASA HEREDITARIA')->first();
                                            $validaciondocext = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'MASA HEREDITARIA')->first();
                                            $correcciondocext = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'MASA HEREDITARIA')->first();
                                        @endphp
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm align-middle text-center">
                                                <thead class="thead-light">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="align-middle text-center">
                                                            ...
                                                            @if (!$documentoformval)
                                                                <input type="hidden" name="tramite[formulariovalidacion]" value="MASA HEREDITARIA">
                                                    ...
                                                    <tr>
                                                        <td class="align-middle text-center">
                                                            ...
                                                            @if (!$documento3)
                                                                <input type="hidden" name="tramite[validacionpoder]" value="MASA HEREDITARIA">
                                                        ...
                                                        <td class="align-middle text-center">
                                                            @if ($documento3)
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/NOTIFICACIÓN DE PODER/{$documento3->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                @if ($puedeEditarArchivo)
                                                                    <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                        <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                        <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                                            ...
                                            @if ($cliente->paisnacimiento !== 'BOLIVIA')
                                                <table class="table table-bordered table-sm align-middle text-center">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @php
                                                            $formulariosrecepcion = $cliente->tramites()->where('subprocedimiento', 'FORMULARIO DE RECEPCIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'MASA HEREDITARIA')->get();
                                                        @endphp
                                                                    ...
                                                                    <tr class="fila-formulariorecepcion">
                                                                        ...
                                                                        <td class="align-middle text-center">
                                                                            @if ($formulariorecepcion->document)
                                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/NOTIFICACIÓN DE PODER/{$formulariorecepcion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                            @else
                                                        ...
                                                        @if (!$validaciondocext || $rechazodocext && (!$rechazodocext || $rechazodocext))
                                                            @php
                                                                $rechazosDocExt = $cliente->tramites()->where('subprocedimiento', 'RECHAZO DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'MASA HEREDITARIA')->get();
                                                                $validacionesDocExt = $cliente->tramites()->where('subprocedimiento', 'VALIDACIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'MASA HEREDITARIA')->get();
                                                            @endphp
                                                                ...
                                                                @if ($rechazosDocExt->count() > 0)
                                                                    @foreach ($rechazosDocExt as $rechazo)
                                                                        <tr class="fila-rechazo">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($rechazo->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/NOTIFICACIÓN DE PODER/{$rechazo->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                                                        ...
                                                        @if ($rechazodocext)
                                                            @php
                                                                $correccionesDocExt = $cliente->tramites()->where('subprocedimiento', 'CORRECCIÓN DE DOCUMENTOS EXTRANJEROS')->where('tramite', 'MASA HEREDITARIA')->get();
                                                            @endphp
                                                                        ...
                                                                        <tr class="fila-correccion">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($correccion->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/NOTIFICACIÓN DE PODER/{$correccion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                                                                        ...
                                                                        <tr class="fila-validacion">
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                @if ($validacion->document)
                                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/NOTIFICACIÓN DE PODER/{$validacion->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                                @else
                                                                                    <span class="text-muted">Sin archivo</span>
                                                                                @endif
                                                                            </td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    {!! Form::hidden('apoderado', $apoderadoAsignado) !!}
                                    {!! Form::hidden('idtramite', $idTramite) !!}
                                    {!! Form::hidden('tramitenombreprog', 'MASA HEREDITARIA') !!}
                                    @csrf
                                    <div class="container">
                                        @php
                                            $documento5 = $cliente->tramites()->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->where('tramite', 'MASA HEREDITARIA')->first();
                                        @endphp
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm align-middle text-center">
                                                <thead class="thead-light">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            @if ($documento5)
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/FIRMA EAP/{$documento5->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                                @if ($puedeEditarArchivo)
                                                                    <div class="d-flex align-items-center justify-content-center gap-2" style="margin-top:5px;">
                                                                        <input type="file" name="archivo_reemplazo" class="dropify" accept="application/pdf">
                                                                        <button type="submit" name="accion" value="reemplazarArchivo" class="btn btn-sm btn-subirarchivos" title="REEMPLAZAR ARCHIVO">
                ...
                <div class="tab-pane fade" id="tab-content-3" role="tabpanel" aria-labelledby="tab-3">
                    <div class="row">
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <br>
                            @php
                                $documento41 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'NOTIFICACIÓN DE CONTRATO')->where('tramite', 'MASA HEREDITARIA')->first();
                            @endphp
                            <div class="text-center">
                                @if ($documento41)
                        ...
                        @php
                            $documento43 = $cliente->tramites()->where('subprocedimiento', 'NOTIFICACIÓN DE CONTRATO')->where('estadodictamen', 'ACEPTADO')->where('tramite', 'MASA HEREDITARIA')->first();
                            $documentoRechazado = $cliente->tramites()->where('subprocedimiento', 'NOTIFICACIÓN DE CONTRATO')->where('estadodictamen', 'RECHAZADO')->where('tramite', 'MASA HEREDITARIA')->first();
                        @endphp
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            @elseif ($documento43)
                                ...
                                <br>
                                @php
                                    $documento43 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'ACEPTACIÓN DE CONTRATO')->where('tramite', 'MASA HEREDITARIA')->first();
                                    $documento44 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'FIRMA DE FORMULARIO')->where('tramite', 'MASA HEREDITARIA')->first();
                                    $documento45 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'FIRMA DE CONTRATO')->where('tramite', 'MASA HEREDITARIA')->first();
                                    $documento46 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'COBRO DE PENSIÓN')->where('tramite', 'MASA HEREDITARIA')->first();
                                    $documento47 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'NOTA DE RECHAZO DE TRÁMITE')->where('tramite', 'MASA HEREDITARIA')->first();

                                    $accedepensiondictamen = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE CONTRATO')->where('accesopension', 'SI')->where('tramite', 'MASA HEREDITARIA')->first();
                                    $noaccedepensiondictamene6 = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE CONTRATO (EXCESO DE 6 MESES)')->where('accesopension', 'NO')->where('motivonopension', 'EXCESO DE 6 MESES')->where('tramite', 'MASA HEREDITARIA')->first();
                                    $noaccedepensiondictamenfc = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'RENUNCIA A REVISIÓN DE CONTRATO (FALTA DE COBERTURA)')->where('accesopension', 'NO')->where('motivonopension', 'FALTA DE COBERTURA')->where('tramite', 'MASA HEREDITARIA')->first();
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('admin.tramites.generarcartareclamo', $cliente) }}" method="GET" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" id="tramite" name="tramite" value="MASA HEREDITARIA" hidden>
                    <input type="date" class="form-control" id="fechasubida" name="fechasubida" value="{{ \Carbon\Carbon::now()->toDateString() }}" hidden>
                    @csrf
                    <div class="row">
                        @php
                            $documento1 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'INGRESO DE TRÁMITE')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                            $documento5 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'FIRMA EAP')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                            $fechaingresoyeap = $documento1 && $documento5;

                            $primeracartasit = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'PRIMERA CARTA SIT')->first();
                            $segundacartasit = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'SEGUNDA CARTA SIT')->first();
                            $terceracartasit = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'TERCERA CARTA SIT')->first();
                            $primeracartareclamo = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'PRIMERA CARTA DE RECLAMO')->first();
                            $segundacartareclamo = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'SEGUNDA CARTA DE RECLAMO')->first();
                            $terceracartareclamo = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'TERCERA CARTA DE RECLAMO')->first();
                            $cartareclamoaps = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'CARTAS / RECLAMOS')->where('subprocedimiento', 'CARTA DE RECLAMO APS')->first();
                        @endphp
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" id="tipocartareclamo" name="tipocartareclamo" value="PENSIÓN DE MASA HEREDITARIA" hidden>
                                    ...
                                    <tbody>
                                        @forelse ($listasolicitudes as $solicitud)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/SOLICITUDES/{$solicitud->document}") }}"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuesta', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="nombretramite" value="MASA HEREDITARIA">
                                                    ...
                                                    <td>
                                                        @if ($solicitud->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/SOLICITUDES/{$solicitud->document2}") }}"
                                    ...
                                    <tbody>
                                        @forelse ($listaadjuntos as $adjunto)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/ADJUNTOS Y RESPUESTAS/{$adjunto->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuestaadjunto', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($adjunto->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/ADJUNTOS Y RESPUESTAS/{$adjunto->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
                                    ...
                                    <tbody>
                                        @forelse ($listacartas as $carta)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/CARTAS Y RECLAMOS/{$carta->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                    title="VER ADJUNTO/RESPUESTA" target="_blank"></a>
                                                </td>
                                                <form action="{{ route('admin.tramites.guardarrespuestacarta', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($carta->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/CARTAS Y RECLAMOS/{$carta->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                    ...
                                                    <td>
                                                        @if ($carta->document3)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/CARTAS Y RECLAMOS/{$carta->document3}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
                                                ...
                                                <tr class="bg-light">
                                                    <td colspan="13">
                                                        <div class="row g-2">
                                                            ...
                                                            <div class="col-md-2">
                                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/CARTAS Y RECLAMOS/{$carta->document4}") }}"
                                                                class="btn btn-sm btn-verdocumento"
                                                                target="_blank">
                                    ...
                                    <tbody>
                                        @forelse ($listamisivas as $misiva)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/MISIVAS LIBRES/{$misiva->document}") }}"
                                                    class="btn btn-sm btn-verdocumento fas fa-eye"
                                                ...
                                                <form action="{{ route('admin.tramites.guardarrespuestamisivalibre', $cliente) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($misiva->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/MISIVAS LIBRES/{$misiva->document2}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                    ...
                                                    <td>
                                                        @if ($misiva->document3)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/MISIVAS LIBRES/{$misiva->document3}") }}"
                                                            class="btn btn-sm btn-verdocumento"
                                                            title="VER RESPUESTA" target="_blank"><i class="fas fa-eye"></i></a>
                                                        @else
                                                            <div class="row gx-2">
                                        ...
                                        <tbody>
                                            @foreach ($dictamennotificacion as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/CONTRATO/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                    </td>
                                                </tr>
                                            @endforeach
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        @php
                            $documento29 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ NOTIFICACIÓN DE REQUERIMIENTO')->where('tramite', 'MASA HEREDITARIA')->first();
                            $documento30 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ CARTA SOLICITUD A EMPLEADOR')->where('tramite', 'MASA HEREDITARIA')->first();
                            $documento31 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ SOLICITUD DE MODIFICACIÓN DE CITE')->where('tramite', 'MASA HEREDITARIA')->first();

                            $documento31 = $cliente->tramites()->where('nivelprocedimiento', 'SOLICITUD DE INFORMACIÓN TÉCNICO MÉDICO')->where('subprocedimiento', 'EMPLEADOR _ SOLICITUD DE MODIFICACIÓN DE CITE')->where('tramite', 'MASA HEREDITARIA')->first();
                            
                            $dictamenexiste = $cliente->tramites()->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'NOTIFICACIÓN DE CONTRATO')->where('tramite', 'MASA HEREDITARIA')->first();
                            ...
                            $rechazosolinvdictamenexceso6mes = $cliente->tramites()
                                ->where('nivelprocedimiento', 'CONTRATO')
                                ->where('subprocedimiento', 'RECHAZO DE SOLICITUD DE PENSIÓN POR MASA HEREDITARIA (EXCESO DE SEIS MESES)')
                                ->where('accesopension', 'NO')
                                ->where('motivonopension', 'EXCESO DE 6 MESES')
                                ->where('tramite', 'MASA HEREDITARIA')
                            ->get();
                            ...
                            $rechazosolinvdictamenfaltacober = $cliente->tramites()
                                ->where('nivelprocedimiento', 'CONTRATO')
                                ->where('subprocedimiento', 'RECHAZO DE SOLICITUD DE PENSIÓN POR MASA HEREDITARIA (FALTA DE COBERTURA)')
                                ->where('accesopension', 'NO')
                                ->where('motivonopension', 'FALTA DE COBERTURA')
                                ->where('tramite', 'MASA HEREDITARIA')
                            ->get();
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RENUNCIA A REVISIÓN DE CONTRATO</p>
                                                <input type="hidden" name="tramite[renunciarevdictamen]" value="MASA HEREDITARIA">
                                        ...
                                        <table class="table table-bordered table-sm align-middle text-center">
                                            ...
                                            <tbody>
                                                ...
                                                @endif
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">FIRMA DE CONTRATO</p>
                                                        <input type="hidden" name="tramite[firmacontratodictamen]" value="MASA HEREDITARIA">
                        ...
                        {{-- CONTRATO NO ACCEDE A PENSION CON EXCESO DE SEIS MESES --}}
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RENUNCIA A REVISIÓN DE CONTRATO (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[renunciarevdictamenexceso6mes]" value="MASA HEREDITARIA">
                            ...
                            {{-- RECHAZO DE SOLICITUD DE PENSIÓN POR MASA HEREDITARIA --}}
                            <div class="scroll-shadow-wrapper">
                                <div class="scroll-shadow-container">
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        <thead class="thead-light">
                                        ...
                                        <tbody>
                                            @foreach ($rechazosolinvdictamenexceso6mes as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR MASA HEREDITARIA (EXCESO DE SEIS MESES)</p>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                    </td>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR MASA HEREDITARIA (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[rechazosolinvdictamenexceso6mes]" value="MASA HEREDITARIA">
                                                    <input type="hidden" name="nivelprocedimiento[rechazosolinvdictamenexceso6mes]" value="CONTRATO">
                                                    <input type="hidden" name="subprocedimiento[rechazosolinvdictamenexceso6mes]" value="RECHAZO DE SOLICITUD DE PENSIÓN POR MASA HEREDITARIA (EXCESO DE SEIS MESES)">
                                ...
                                <tbody>
                                    ...
                                    @endif
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <input type="hidden" name="tramite[formulariodictamenexceso6mes]" value="MASA HEREDITARIA">
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">FIRMA DE CONTRATO (EXCESO DE SEIS MESES)</p>
                                                    <input type="hidden" name="tramite[firmacontratodictamenexceso6mes]" value="MASA HEREDITARIA">
                                    ...
                                    <table class="table table-bordered table-sm align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RENUNCIA A REVISIÓN DE CONTRATO (FALTA DE COBERTURA)</p>
                                                    <input type="hidden" name="tramite[renunciarevdictamenfaltacober]" value="MASA HEREDITARIA">
                                        ...
                                        <tbody>
                                            @foreach ($rechazosolinvdictamenfaltacober as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR MASA HEREDITARIA (FALTA DE COBERTURA)</p>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">{{ $documento->citenotificacion }}</p>
                                                    </td>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="mb-0">RECHAZO DE SOLICITUD DE PENSIÓN POR MASA HEREDITARIA (FALTA DE COBERTURA)</p>
                                                    <input type="hidden" name="tramite[rechazosolinvdictamenfaltacober]" value="MASA HEREDITARIA">
                                                    <input type="hidden" name="nivelprocedimiento[rechazosolinvdictamenfaltacober]" value="CONTRATO">
                                                    <input type="hidden" name="subprocedimiento[rechazosolinvdictamenfaltacober]" value="RECHAZO DE SOLICITUD DE PENSIÓN POR MASA HEREDITARIA (FALTA DE COBERTURA)">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        @php
                            $documento48 = $cliente->tramites()->where('subprocedimiento', 'INICIO PROCESO DE APELACIÓN')->where('tramite', 'MASA HEREDITARIA')->first();
                        @endphp
                    ...
                    <div class="container">
                        ...
                        <div class="row mb-3 align-items-center no-documento">
                            <div class="col-md-3 text-center" hidden>
                                <input type="text" class="form-control" name="tramite[]" value="MASA HEREDITARIA" hidden>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($procedimientotramite->capturacomunicacion)
                                                            ...
                                                            <td class="align-middle text-center">
                                                                ...
                                                                @else
                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/COMUNICACIONES/{$procedimientotramite->capturacomunicacion}") }}"
                                                                    class="btn btn-sm btn-verdocumento"
                                                                    target="_blank">
                                                                    VER CAPTURA
                                                                    </a>
                                                        ...
                                                        @else
                                                            <td class="align-middle text-center" colspan="8">
                                                                <form action="{{ route('tramites.subirArchivo', ['id' => $procedimientotramite->id, 'clienteId' => $cliente->id]) }}" method="POST" enctype="multipart/form-data" class="d-flex gap-2">
                                                                    @csrf
                                                                    <input type="hidden" name="tramitenombre" value="MASA HEREDITARIA">
                                        ...
                                        <form action="{{ route('admin.tramites.guardarseguimientoclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <table class="table table-striped table-bordered align-middle text-center table-sm tabla-comunicaciones" style="table-layout: fixed; width: 100%;">
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="align-middle text-center">
                                                                @if(!$seguimiento->capturacomunicacion)
                                                                    <span class="badge bg-warning text-dark">VACÍO</span>
                                                                @else
                                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/COMUNICACIONES/{$seguimiento->capturacomunicacion}") }}"
                                                                        class="btn btn-sm btn-verdocumento"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="hidden" name="comtramitenombre" value="MASA HEREDITARIA">
                                        ...
                                        <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                            ...
                                            <tbody>
                                                ...
                                                @endif
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <p class="mb-0">CANCELACIÓN DE TRAMITE</p>
                                                        <input type="hidden" name="tramite[cancelaciontramitegestora]" value="MASA HEREDITARIA">
                                    ...
                                    <tbody>
                                        @foreach ($rechazocancelaciontramite as $documento)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/CANCELACIÓN/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER CARTA</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RECHAZO DE CANCELACIÓN DE TRÁMITE GP</p>
                                                <input type="hidden" name="tramite[rechazocancelaciontramite]" value="MASA HEREDITARIA">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center" style="margin-bottom: -5px;">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">RECHAZO DE CANCELACIÓN DE TRÁMITE APS</p>
                                                <input type="hidden" name="tramite[rechazocancelaciontramiteaps]" value="MASA HEREDITARIA">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">ACEPTACIÓN DE CANCELACIÓN DE TRÁMITE</p>
                                                <input type="hidden" name="tramite[aceptacioncancelaciontramite]" value="MASA HEREDITARIA">
                                ...
                                <table class="table table-bordered table-sm align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="mb-0">DESISTIMIENTO A CANCELACIÓN DE TRÁMITE</p>
                                                <input type="hidden" name="tramite[desistimientocancelaciontramite]" value="MASA HEREDITARIA">
                                ...
                                <tbody>
                                    @foreach ($notiferronea as $documento)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/NOTIFICACIÓN ERRÓNEA/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    @endif
                                        ...
                                        <td class="align-middle text-center">
                                            <input type="hidden" name="tramite[notiferronea]" value="MASA HEREDITARIA">
                                        ...
                                        <tbody>
                                            @foreach ($notifobservadas as $documento)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/NOTIFICACIÓN OBSERVADA/{$documento->document}") }}" class="btn btn-sm btn-verdocumento" target="_blank">VER DOCUMENTO</a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        @if($documento->document2)
                                                            <a href="{{ url("/tramitesclientesita/{$cliente->id}/MASA HEREDITARIA/NOTIFICACIÓN OBSERVADA/{$documento->document2}") }}"
                                                            target="_blank"
                                                            class="btn btn-sm btn-verdocumento">
                                                            VER RESPUESTA
                                                            </a>
                                            ...
                                            @endif
                                                ...
                                                <td class="align-middle text-center">
                                                    <input type="hidden" name="tramite[notifobservadas]" value="MASA HEREDITARIA">
