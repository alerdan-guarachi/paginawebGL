...
<h5>PROCEDIMIENTO DE TRÁMITE DE MASA HEREDITARIA DE:</h5>
...
<div class="card">
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" id="myTabs">
            ...
            @php
                $documento5 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->where('estadocomunicado', 'COMUNICADO')->first();
            @endphp
            @if (!$documento5)
            <li class="nav-item">
                ...
                @if($tramiteinicio)
                    <div class="row">
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <br>
                            @php
                                $documento1 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->where('capturacomunicacion', 'like', '%.jpg');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->first();
                                $documento2 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->where('capturacomunicacion', 'like', '%.jpg');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->first();
                            @endphp
                        ...
                        @php
                            $documento3 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->where('capturacomunicacion', 'like', '%.jpg');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'VALIDACIÓN DE PODER')->where('estadocomunicado', 'COMUNICADO')->first();
                        @endphp
                        <div class="col-12 col-md-6 mb-3">
                            <button type="button" class="btn btn-custom btn-block text-center" data-toggle="modal" data-target="#modalFirmaEAP" @if (!$documento1) disabled @endif>
                                <div class="d-flex flex-column align-items-center justify-content-center">
                                    ...
                                    @php
                                        $documento1 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->where('capturacomunicacion', 'like', '%.jpg');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                    @endphp
                                    @if (!$documento1)
                                        @if ($documento3)
                                            @php
                            ...
                            <br>
                            @php
                                $documento5 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->where('capturacomunicacion', 'like', '%.jpg');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                            @endphp
                            <div class="text-center">
                                @if (!$documento1)
                                    <span class="mb-0 checkamarillo">
                ...
                @if($tramitecontinuidad)
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <br>
                            @php
                                $documento3 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where(function ($query) {$query->whereNotNull('capturacomunicacion')->where(function ($subQuery) {$subQuery->where('capturacomunicacion', 'like', '%.jpg');});})->where('estadocomunicado', 'COMUNICADO')->where('subprocedimiento', 'VALIDACIÓN DE PODER')->first();
                            @endphp
                            <div class="text-center">
                                @if (!$documento3)
                                    <span class="mb-0 checkamarillo">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        ...
                                        @if($tramiteinicio)
                                            <div class="row mb-3 align-items-center {{ !$documento1 ? 'no-documento' : '' }}">
                                                ...
                                                <div class="col-md-4 text-center">
                                                    @php
                                                        $documento1 = $cliente->tramites()->where('subprocedimiento', 'RECEPCIÓN DE TRÁMITE')->where('tramite', 'MASA HEREDITARIA')->first();
                                                    @endphp
                                                    @if ($documento1)
                                    ...
                                    @php
                                        ...
                                        $documento2 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'INCLUSIÓN DE PODER')->first();
                                    @endphp
                                    @if (!$documento1 || !$documento2)
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        ...
                                        @php
                                        $documento3 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'VALIDACIÓN DE PODER')->first();
                                        @endphp
                                        ...
                                        @php
                                        $documento4 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'RECHAZO DE PODER')->first();
                                        @endphp
                                    ...
                                    @php
                                        $documento3 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'VALIDACION DE PODER')->first();
                                        $documento4 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'RECHAZO DE PODER')->first();
                                    @endphp
                                    @if (!$documento3)
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        ...
                                        @php
                                                    $documento5 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'ESTADO DE AHORRO PREVISIONAL')->first();
                                                @endphp
            ...
            <div class="tab-pane fade" id="tab-content-2" role="tabpanel" aria-labelledby="tab-2">
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 mb-3">
                        ...
                        <br>
                        @php
                            $documento6 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'NOTIFICACIÓN DE GESTORA')->first();
                            $documento7 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'SOLICITUD DE CERTIFICADO DE OBITO LEGALIZADO')->first();
                            $documento8 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'RESPUESTA A NOTA DE GESTORA')->first();
                            $documento9 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'ADJUNTO DE DECLARACIÓN DE HEREDEROS')->first();
                        @endphp
                        <div class="text-center">
                                        ...
                                        <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="row mb-3 align-items-center {{ !$documento6 ? 'no-documento' : '' }}">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        @php
                                                            $documento6 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'NOTIFICACIONES, SOLICITUDES, ADJUNTOS Y RESPUESTAS')->where('subprocedimiento', 'NOTIFICACIÓN DE GESTORA')->first();
                                                        @endphp
                                                        @if ($documento6)
                                                ...
                                                <div class="row mb-3 align-items-center {{ !$documento7 ? 'no-documento' : '' }}">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        @php
                                                            $documento7 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'NOTIFICACIONES, SOLICITUDES, ADJUNTOS Y RESPUESTAS')->where('subprocedimiento', 'SOLICITUD DE CERTIFICADO DE OBITO LEGALIZADO')->first();
                                                        @endphp
                                                        @if ($documento7)
                                                ...
                                                <div class="row mb-3 align-items-center {{ !$documento8 ? 'no-documento' : '' }}">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        @php
                                                            $documento8 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'NOTIFICACIONES, SOLICITUDES, ADJUNTOS Y RESPUESTAS')->where('subprocedimiento', 'RESPUESTA A NOTA DE GESTORA')->first();
                                                        @endphp
                                                        @if ($documento8)
                                                ...
                                                <div class="row mb-3 align-items-center {{ !$documento9 ? 'no-documento' : '' }}">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        @php
                                                            $documento9 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'NOTIFICACIONES, SOLICITUDES, ADJUNTOS Y RESPUESTAS')->where('subprocedimiento', 'ADJUNTO DE DECLARACIÓN DE HEREDEROS')->first();
                                                        @endphp
                                                        @if ($documento9)
                                            ...
                                            @php
                                                $documento6 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'RECOJO DE NOTIFICACIÓN DE GESTORA')->first();
                                                $documento7 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'SOLICITUD DE CERTIFICADO DE OBITO LEGALIZADO')->first();
                                                $documento8 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'RESPUESTA A NOTA DE GESTORA')->first();
                                                $documento9 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'ADJUNTO DE DECLARACIÓN DE HEREDEROS')->first();
                                            @endphp
            ...
            <div class="tab-pane fade" id="tab-content-3" role="tabpanel" aria-labelledby="tab-3">
                <div class="row">
                    <div class="col-12 col-md-12 mb-3">
                        ...
                        <br>
                        @php
                            $documento11 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'FIRMA DE CONTRATO')->first();
                            $documento13 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('subprocedimiento', 'NOTA DE RECHAZO DE TRÁMITE')->first();
                        @endphp
                        <div class="text-center">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.tramites.guardartramitesclienteita', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        @php
                            $documento11 = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'CONTRATO')->where('subprocedimiento', 'FIRMA DE CONTRATO')->first();
                        @endphp
                        ...
                        <div class="row mb-3 align-items-center {{ !$documento13 ? 'no-documento' : '' }}">
                            <div class="col-md-4 text-center">
                                ...
                                @if (!$documento13)
                                <input type="text" class="form-control" id="tramite3" name="tramite[]" value="MASA HEREDITARIA" hidden>
            ...
            <div class="modal-body">
                <form id="seguimientoForm" action="{{ route('admin.tramites.guardartramitesclienteitaseguimiento', $cliente) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        @php
                            $seguimientos = $cliente->tramites()->where('tramite', 'MASA HEREDITARIA')->where('nivelprocedimiento', 'SEGUIMIENTO')->get();
                        @endphp
