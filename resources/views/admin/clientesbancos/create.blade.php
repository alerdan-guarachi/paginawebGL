            ...
            <div class="card-body">
                <div class="row ">
                    <div class="col-lg-12">
                        ...
                        {!! Form::open(['route' => 'admin.clientesbancos.store', 'method'=>'POST']) !!}
                            ...
                            <div class="row">     
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('celular', null, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '8', 'onkeypress' => 'return event.charCode >= 48 && event.charCode <= 57']) !!}
                                        @error('celular')
                                            <small class="text-danger fas fa-exclamation-circle">
                                                {{$message}}
                                            </small>
