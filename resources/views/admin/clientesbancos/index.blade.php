    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    @foreach ($clientebancos as $clientebanco)
                    <tr>
                        <td>{{$clientebanco->nombrecompleto}}</td>
                        ...
                        <td width="10px">
                            <abbr title="Documentacion">
                                <a class="btn btn-sm fas fa-edit btn-documentacion" href="{{route('admin.clientesbancos.documentacioncliente', $clientebanco)}}" ></a>
                            </abbr>
                        </td>
                        {{-- <td width="10px">
                            <abbr title="Documentacion">
                                <a class="btn btn-sm fas fa-edit btn-documentacion" href="{{route('admin.clientesbancos.verdocumentacioncliente', $clientebanco)}}" ></a>
                            </abbr>
                        </td> --}}
                    </tr>
                    @endforeach
