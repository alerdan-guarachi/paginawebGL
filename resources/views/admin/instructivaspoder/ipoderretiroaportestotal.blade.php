...
<body>
    <main>
        ...
        <h3><strong>QUE OTORGA:</strong> El Sr/a. {{$cliente->nombrecompleto}} con C.I. {{$cliente->ci}} {{$cliente->ciexp}}, 
            ...
            derechohabientes, firmar formulario de actualización de datos y estado, Solicitar copias legalizadas y simples de cualquier ámbito con relación 
            a dicho trámite, asistir a reuniones con facultades de decisión, memoriales, cartas notariales, inscripciones, autorizaciones y cualquier otro 
            documento que sea necesario, hasta la culminación del trámite en las oficinas de Gestora Pública de la Seguridad Social de Largo Plazo. 
            Más Poder. - para sustituir total o individual el presente poder, y en caso de ser necesario otorgar poder a favor de terceros u otras personas 
            ...
            estado de cuentas, recabar estado de cuentas y certificado de verificación de estado de cuentas y firmar contrato de Retiros Mínimos, 
            Retiro Final, pago de compensación de cotizaciones y firma de liquidación en Gestora Pública de la Seguridad Social de Largo Plazo. Asimismo, 
            solicitar, consultar, verificar y gestionar la habilitación de pago y realizar gestiones y seguimiento del mismo. Más Poder para Apersonamiento 
            ante las oficinas de la Autoridad de Fiscalización y Control de Pensiones y Seguros APS para realizar toda clase de gestiones relacionadas con 
            el trámite de Prestación de Vejez y Prestación Solidaria de Vejez, Retiros Mínimos, Retiro Final y/o Pago de Compensación de Cotizaciones Mensual 
            y Global, pudiendo solicitar información verbal y escrita, Facultad para llenar, suscribir y presentar formularios físicos o digitales, incluidos 
            aquellos correspondientes al Buzón de Reclamos y Sugerencias, presentar cartas de reclamo, memoriales, solicitudes, peticiones, reclamos 
            administrativos y cualquier otra actuación necesaria, realizar seguimiento a reclamos y solicitudes, notificarse y recoger respuestas, informes, 
            notas y cualquier otra documentación relacionada con el trámite. Del poder conferente, sin que, por no estar expresamente consignado en el 
            presente, sea dado por insuficiente, aclarándose que todas las cláusulas de este poder son enunciativas y no limitativas, facultando a los 
