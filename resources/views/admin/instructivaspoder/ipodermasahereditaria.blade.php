...
<body>
    <main>
        ...
        <h3><strong>QUE OTORGA:</strong> El Sr/a. {{$cliente->nombrecompleto}} con C.I. {{$cliente->ci}} {{$cliente->ciexp}}, 
            ...
            Solicitar y suscribir el formulario de actualización de datos en la gestora pública de la seguridad social de largo 
            plazo. Inicie con el <strong>TRAMITE DE MASA HEREDITARIA,</strong> en el marco de la Ley 065 Solicitar Entregar documentos de 
            acreditación de los herederos para su revisión, solicitar el estado de ahorro previsional, consolidar el estado de 
            ahorro previsional, Iniciar tramite de masa hereditaria firmando la solicitud correspondiente, firmar la liquidación 
            y acta de entrega de masa hereditaria (pensiones no cobradas), firmar contrato de entrega de masa hereditaria 
            (cuenta Individual), en suma solicitar, recibir, entregar, y firmar todo tipo de documentos inherentes al trámite 
            de masa hereditaria hasta su culminación . Sin que por falta de cláusula expresa alguna, deje de surtir sus efectos, 
            ni se alegue falta de personería en los apoderados. Más Poder, para recabar Estado de Cuentas, firmar el formulario 
            de Solicitud, firmar formulario de declaración de derechohabientes, asistir a reuniones con facultades de decisión, 
            memoriales, cartas notariales, inscripciones, autorizaciones y cualquier otro documento que sea necesario, hasta la 
            culminación del trámite así mismo, poder para firmar de contratos y actas, recojo de cheques en representación del 
            afiliado titular o el derechohabiente en las oficinas de  afpclie. Más Poder.- para transferir o sustituir el 
            presente poder, y en caso de ser necesario otorgar poder a favor de terceros u otras personas para la continuación 
            y conclusión del presente trámite, todo con el fin de solicitar <strong>TRAMITE DE MASA HEREDITARIA,</strong> del poder conferente, 
