...
<div class="card">
    <div class="card-body">
        <div class="row ">
            <div class="col-lg-12">
                {!! Form::model($cliente, ['route' => ['admin.instructivaspoder.store', $cliente], 'method' => 'POST', 'files' => true]) !!}
                {!! Form::hidden('usuarioid', auth()->user()->id) !!}
                {!! Form::hidden('usuarioregistro', auth()->user()->name) !!}
                {!! Form::text('clienteitaid', $cliente->id) !!}
                {!! Form::text('clienteitanombre', $cliente->nombrecompleto) !!}
