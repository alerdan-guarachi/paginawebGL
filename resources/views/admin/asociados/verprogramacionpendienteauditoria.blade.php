...
@section('content_header')
    ...
    <h1>PROGRAMACIONES PENDIENTES DE CLIENTES AUDITORIA</h1>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <!-- Buscador de programaciones pendientes de Clientes ITA -->
            <nav class="navbar navbar-expand-lg float-right">
                <div class="container-fluid">
                    <div class="d-flex flex-wrap align-items-center">
                        <form action="{{ route('admin.asociados.buscarprogramacionpendienteauditoria', $asociado) }}"
                            method="get" class="form-inline">
                            <div class="flex-grow-1">
                                <input name="buscarpor" class="form-control mr-sm-2" type="search"
                                    placeholder="ESTUDIO / ESPECIALIDAD" aria-label="Search">
                            </div>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 120px;">Fecha de Batería</th>
                    ...
                    <tbody>
                        @foreach ($accionesPendientes as $accion)
                            <tr>
                                <td class="align-middle">{{ $accion->ps_id }}</td>
                                <td class="align-middle">{{ $accion->ps_clienteauditorianombre }}</td>
                                <td class="align-middle">{{ $accion->ps_accionnombre }}</td>
                                <td class="align-middle">{{ $accion->ps_proveedorasignado }}</td>
                                ...
                                <td class="align-middle" width="10px">
                                    <abbr title="Subir documentación">
                                        <a class="btn btn-sm btn-verprogramacion" href="{{ route('admin.asociados.crearprogramacionclienteauditoria', $accion->ps_clienteauditoriaid) }}">
