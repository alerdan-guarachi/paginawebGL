...
@endif
<h5>SUBIR REQUISITOS DE RETIRO DE APORTES PARCIAL DE:</h5>
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12">
                {!! Form::model($cliente, ['route' => ['admin.asociados.guardardocrequisitosretiroaportesparcial', $cliente], 'method' => 'PUT', 'files' => true]) !!}
...
@endif
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-7">
                                <label>REQUISITOS DE RETIRO DE APORTES PARCIAL</label>
                                <div class="card"> 
                                    <div class="card-body">
