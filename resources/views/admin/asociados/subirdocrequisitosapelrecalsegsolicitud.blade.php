...
@endif
<h5>SUBIR REQUISITOS DE APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD DE:</h5>
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12">
                {!! Form::model($cliente, ['route' => ['admin.asociados.guardardocrequisitosapelrecalsegsolicitud', $cliente], 'method' => 'PUT', 'files' => true]) !!}
...
@endif
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-7">
                                <label>REQUISITOS DE APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD</label>
                                <div class="card"> 
                                    <div class="card-body">
