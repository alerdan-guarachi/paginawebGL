        ...
        <nav class="navbar navbar-expand-lg float-right">
            <div class="container-fluid">
                <div class="d-flex flex-wrap align-items-center">
                    <form action="{{ route('buscardocumentoclienteita', $cliente) }}" method="get" class="form-inline">
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$documentacioncliente->id}}</td>
                        <td>{{$documentacioncliente->fechabateria}}</td>
                        <td>{{$documentacioncliente->accion}}</td>
                        <td>
                            @if ($documentacioncliente->document)
                            <a href="{{ asset('/documentacionclientesita/' . $cliente->id . '/' . $documentacioncliente->document) }}" class="btn btn-verdocumentacion" data-url="{{ asset('/documentacionclientesita/' . $cliente->id . '/'  . $documentacioncliente->document) }}">
                            ...
                            <a href="{{ asset('/documentacionclientesita/' . $cliente->id . '/'  . $documentacioncliente->document) }}" class="btn btn-descargardocumentacion" download>
                        ...
                        <td>
                            ...
                            <a href="{{ asset('/documentacionclientesita/' . $cliente->id . '/'  . $documentacioncliente->image) }}" class="btn btn-verimagen" target="_blank">
                                <i class="fas fa-eye"></i>
                            </a>
                            @can('descargardocumentacion')
                            <a href="{{ asset('/documentacionclientesita/' . $cliente->id . '/'  . $documentacioncliente->image) }}" class="btn btn-descargarimagen" download>
                                <i class="fas fa-download"></i>
                            </a>
                            @endcan
                            @endif
                        ...
                        <td>
                            ...
                            <a href="{{ asset('/documentacionclientesita/' . $cliente->id . '/'  . $documentacioncliente->image2) }}" class="btn btn-verimagen" target="_blank">
                                <i class="fas fa-eye"></i>
                            </a>
                            @can('descargardocumentacion')
                            <a href="{{ asset('/documentacionclientesita/' . $cliente->id . '/'  . $documentacioncliente->image2) }}" class="btn btn-descargarimagen" download>
                                <i class="fas fa-download"></i>
                            </a>
                            @endcan
                            @endif
