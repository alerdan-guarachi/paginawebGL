...
<h1>DOCUMENTACIÓN PENDIENTE DE CLIENTES COMUNES</h1>
@stop 
        ...
        <nav class="navbar navbar-expand-lg float-right">
            <div class="container-fluid">
                <div class="d-flex flex-wrap align-items-center">
                    <form action="{{ route('admin.asociados.documentacionmultipleclientecomun', $asociado) }}" method="get" class="form-inline">
