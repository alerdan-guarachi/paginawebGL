...
<a class="btn btn-sm float-right btn-crear" href="{{ route('admin.asociados.generarpdfcotizacionclientebanco', ['clientebanco' => $clientebanco, 'buscarporfecha' => $fechaSeleccionada, 'buscarporarea' => $areaSeleccionada, 'total' => $total]) }}">GENERAR PDF</a>
        ...
        <nav class="navbar navbar-expand-lg float-right">
            <div class="container-fluid">
                <div class="d-flex flex-wrap align-items-center">
                    <form action="{{ route('buscarbateriaclientebanco', $clientebanco) }}" method="get" class="form-inline">
