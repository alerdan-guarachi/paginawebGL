...
<body>
    <table>
        ...
        <tr>
            ...
            <td class="ancho" colspan="2">{{ $clientebanco->empresa }}</td>
            <th class="ancho">Regional</th>
            <td class="ancho" colspan="2">{{ $clientebanco->lugarnacimiento }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="ancho">{{ $clientebanco->lugarnacimiento }}</td>
        </tr>
        <tr>
            <th class="ancho" colspan="2">Residencia</th>
            <td class="ancho" colspan="2">{{ $clientebanco->lugarnacimiento }}</td>
            <th class="ancho" colspan="2">Grado de instruccion</th>
            <td class="ancho" colspan="2">{{ $clientebanco->gradoinstruccion }}</td>
        </tr>
        <tr>
            ...
            <td class="ancho" colspan="2">{{ $clientebanco->telefono }}</td>
        </tr>
        <tr>
            <th class="ancho" colspan="2">Cedula de identidad</th>
            <td class="ancho" colspan="2">{{ $clientebanco->ci }}</td>
        ...
        <tr>
            ...
            <td class="ancho" colspan="2">{{ $clientebanco->direccion }}</td>
            <th class="ancho" colspan="2">Profesion/Ocupacion</th>
            <td class="ancho" colspan="2">{{  $clientebanco->ocupacion }}</td>
        </tr>
        <tr>
            <th class="ancho" colspan="2">Ente gestor de salud</th>
            <td class="ancho" colspan="2">{{ $clientebanco->entgestorsalud }}</td>
            <th class="ancho" colspan="2">Actividad laboral</th>
            <td class="ancho" colspan="2">{{  $clientebanco->estadolaboral }}</td>
        </tr>
        <tr>
