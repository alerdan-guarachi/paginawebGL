...
<a class="btn btn-sm float-right btn-subirrequisitos" href="{{ route('admin.asociados.subirdocrequisitosretiroaportestotal', $cliente) }}">SUBIR REQUISITOS</a>
<h5>REQUISITOS DE RETIRO DE APORTES TOTAL:</h5>
...
@section('content')
    <form id="pdfForm" action="{{ route('admin.asociados.descargarchecklistclienteita', $cliente) }}" method="POST" style="display: none;">
        ...
        <input type="hidden" name="tramitecliente" id="tramitecliente" value="RETIRO DE APORTES TOTAL">
    </form>
</div>
