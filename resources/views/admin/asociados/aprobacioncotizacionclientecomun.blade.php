...
<a class="btn btn-sm float-right btn-aprobarcotizacion" href="{{ route('admin.asociados.aprobarcotizacionprogramacionclientecomun', $clientecomun) }}">APROBAR COTIZACION</a>
<a class="btn btn-sm float-right btn-crear" href="{{ route('admin.asociados.generarpdfcotizacionclientecomun', [ 
    'clientecomun' => $clientecomun->id,
