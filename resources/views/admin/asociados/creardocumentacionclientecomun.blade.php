...
<a class="btn btn-sm float-right btn-multiple" href="{{ route('admin.asociados.documentacionmultipleclientecomun', 3) }}">DOC. MÚLTIPLE</a>
...
<div class="card">
    <div class="card-body">
        <div class="row ">
            <div class="col-lg-12">
                {!! Form::model($clientecomun, ['route' => ['admin.asociados.guardardocumentacionclientecomun', $clientecomun], 'method' => 'POST', 'files' => true]) !!}
