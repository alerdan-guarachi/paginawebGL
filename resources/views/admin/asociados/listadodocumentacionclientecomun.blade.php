        ...
        <nav class="navbar navbar-expand-lg float-right">
            <div class="container-fluid">
                <div class="d-flex flex-wrap align-items-center">
                    <form action="{{ route('buscardocumentoclientecomun', $clientecomun) }}" method="get" class="form-inline">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ asset('/documentacionclientescomunes/' . $clientecomun->id . '/'  . $documentacioncliente->document) }}" class="btn btn-verdocumentacion" data-url="{{ asset('/documentacionclientescomunes/' . $clientecomun->id . '/' . $documentacioncliente->document) }}">
                            ...
                            <a href="{{ asset('/documentacionclientescomunes/' . $clientecomun->id . '/'  . $documentacioncliente->document) }}" class="btn btn-descargardocumentacion" download>
                        ...
                        <td>
                            ...
                            <a href="{{ asset('/documentacionclientescomunes/' . $clientecomun->id . '/'  . $documentacioncliente->image) }}" class="btn btn-verimagen" target="_blank">
                                <i class="fas fa-eye"></i>
                            </a>
                            @can('descargardocumentacion')
                            <a href="{{ asset('/documentacionclientescomunes/' . $clientecomun->id . '/'  . $documentacioncliente->image) }}" class="btn btn-descargarimagen" download>
                                <i class="fas fa-download"></i>
                            </a>
                            @endcan
                            @endif
                        ...
                        <td>
                            ...
                            <a href="{{ asset('/documentacionclientescomunes/' . $clientecomun->id . '/'  . $documentacioncliente->image2) }}" class="btn btn-verimagen" target="_blank">
                                <i class="fas fa-eye"></i>
                            </a>
                            @can('descargardocumentacion')
                            <a href="{{ asset('/documentacionclientescomunes/' . $clientecomun->id . '/'  . $documentacioncliente->image2) }}" class="btn btn-descargarimagen" download>
                                <i class="fas fa-download"></i>
                            </a>
                            @endcan
                            @endif
