...
<h5>EDITAR ACCIÓN DE:</h5>
<h3>{{$areaaccion->asociado}}</h3>
@stop
...
<div class="container col-lg-12">
    <div class="card">
        <div class="card-body">
            <div class="row ">
                <div class="col-lg-12">
                    {!! Form::model($areaaccion, ['route' => ['admin.asociados.actualizarbateriabanco', $areaaccion], 'method' => 'PUT']) !!}
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('tiponombre', null, ['class' => 'form-control', 'placeholder' => '', 'readonly' => true]) !!}
                                @error('tiponombre')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('categoria', $categoria, null, ['class' => 'form-control', 'placeholder' => '']) !!}
                                @error('categoria')
                                    <small class="text-danger fas fa-exclamation-circle">
                                        {{$message}}
                                    </small>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('estado', $estado, null, ['class' => 'form-control', 'placeholder' => '']) !!}
                                @error('estado')
                                    <small class="text-danger fas fa-exclamation-circle">
                                        {{$message}}
                                    </small>
