                                ...
                                <form target="_blank" method="GET" id="formDireccion{{ $accion->id }}">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-success" onclick="enviarMensajeWhatsApp({{ $accion->id }}, '{{ $clienteauditoria->celular }}', '{{ addslashes($accion->proveedornombre) }}', '{{ addslashes($accion->areanombre) }}', '{{ $accion->fechaasignada }}', '{{ $accion->horadesde }}')"><i class="fab fa-whatsapp mr-1"></i> Enviar</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
