...
<a class="btn btn-sm float-right btn-subirrequisitos" href="{{ route('admin.asociados.subirdocrequisitospensionderivretiro', $cliente) }}">SUBIR REQUISITOS</a>
<h5>REQUISITOS DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES:</h5>
...
@section('content')
    <form id="pdfForm" action="{{ route('admin.asociados.descargarchecklistclienteitapensionderivretiro', $cliente) }}" method="POST" style="display: none;">
        @csrf
        ...
        <input type="hidden" name="tramitecliente" id="tramitecliente" value="PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES">
    </form>
</div>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="form-group" style="margin-top: -10px;">
                    ...
                    <label for="avcci">AVC/CARNET ASEGURADO (FALLECIDO)</label>
                </div>
                @endif
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="cnacasegurado" value="cnacasegurado" id="cnacasegurado" checked>
                    <label for="cnacasegurado" style="min-height: 20px;">CERTIFICADO NACIMIENTO ASEGURADO (FALLECIDO)</label>
                </div>
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="ciasegurado" value="ciasegurado" id="ciasegurado" checked disabled>
                    <label for="ciasegurado" style="min-height: 20px;">CARNET IDENTIDAD ASEGURADO (FALLECIDO)</label>
                </div>
                <div class="form-group" style="margin-top: -10px;">
                ...
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="cdefuncion" value="cdefuncion" id="cdefuncion">
                    <label for="cdefuncion" style="min-height: 20px;">CERTIFICADO DE DEFUNCIÓN</label>
                </div>
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="cmeddifuncion" value="cmeddifuncion" id="cmeddifuncion">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="compenzacioncotizacion" value="compenzacioncotizacion" id="compenzacioncotizacion">
                    <label for="compenzacioncotizacion" class="color-toggle">CERTIFICADO DE COMPENZACIÓN DE COTIZACIONES</label>
                </div>
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="contratojubilacion" value="contratojubilacion" id="contratojubilacion">
                    <label for="contratojubilacion" style="min-height: 20px;">CONTRATO DE JUBILACIÓN</label>
                </div>
                <script>
