                ...
                <table class="table table-striped table-sm table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Observaciones</th>
                            <th>Estado</th>
                            <th class="text-center">Fecha_Batería</th>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                ...
                                                                <button type="submit"
                                                                    class="btn btn-asignartramite2 d-block mx-auto mb-3"
                    ...
                    <form id="form-asignar-tramite"
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                {!! Form::select('tramite', $tramites, null, ['class' => 'form-control','placeholder' => '','required']) !!}
                                @error('tramite')
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('observaciones', null, ['class' => 'form-control', 'placeholder' => '','required']) !!}
                                @error('observaciones')
                                    <small class="text-danger fas fa-exclamation-circle">
                                        {{ $message }}
                                    </small>
                        ...
                        <button type="submit" class="btn btn-asignartramite2 d-block mx-auto mb-3" target="_blank"
