...
@endif
<h5>SUBIR REQUISITOS DE INVALIDEZ DE:</h5>
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12">
                {!! Form::model($cliente, ['route' => ['admin.asociados.guardardocrequisitos', $cliente], 'method' => 'PUT', 'files' => true]) !!}
                ...
                {!! Form::submit('SUBIR REQUISITOS', ['class' => 'btn btn-crear']) !!}
                {!! Form::close() !!}
            </div>
        </div>
    </div>
...
@endif
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <label>REQUISITOS DE INVALIDEZ</label>
                                <div class="card"> 
                                    <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <script>
                                            ...
                                            function toggleButton() {
                                                // Habilita el botón si al menos un checkbox está marcado
