...
@endif
<h5>REQUISITOS DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES DE:</h5>
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12">
                {!! Form::model($cliente, ['route' => ['admin.asociados.guardardocrequisitospensionderivretiro', $cliente], 'method' => 'PUT', 'files' => true]) !!}
...
@endif
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-7">
                                <label>REQUISITOS DE PENSIÓN POR MUERTE CON DERIVACIÓN A RETIRO DE APORTES</label>
                                <div class="card"> 
                                    <div class="card-body">
