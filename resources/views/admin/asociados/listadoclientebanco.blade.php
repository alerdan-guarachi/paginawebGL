...
<a class="btn btn-sm float-right btn-agregar" href="{{ route('admin.asociados.crearclientebanco', $asociado->id) }}">CREAR CLIENTE</a>
<h5>CLIENTES</h5>
        ...
        <nav class="navbar navbar-expand-lg float-right">
            <div class="container-fluid">
                <div class="d-flex flex-wrap align-items-center">
                    <form action="{{ route('buscarclientesbanco', $asociado) }}" method="get" class="form-inline">
