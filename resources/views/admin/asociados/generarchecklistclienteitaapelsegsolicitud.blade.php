...
<a class="btn btn-sm float-right btn-subirrequisitos" href="{{ route('admin.asociados.subirdocrequisitosapelsegsolicitud', $cliente) }}">SUBIR REQUISITOS</a>
<h5>DERIVACIÓN Y REQUISITOS DE APELACIÓN SEGUNDA SOLICITUD:</h5>
                        ...
                        <div class="card shadow-sm h-100" style="background-color: #fdf4e3;">
                            ...
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                {!! Form::open(['route' => 'generar.pdf.consentimiento', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
                                    ...
                                    {!! Form::hidden('tramite', 'APELACIÓN SEGUNDA SOLICITUD') !!}
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="modal-footer">
                                                <form id="formRecomendar" method="POST" action="{{ route('admin.asociados.recomendarestudioespecialidad') }}">
                                                    ...
                                                    <input type="hidden" name="tramiterecomendacion" value="APELACIÓN SEGUNDA SOLICITUD">
                                                            ...
                                                            @foreach($ultimosRegistros as $rec)
                                                                @php
                                                                    $existe = \DB::table('bateriasubclientes as b')
                                                                        ...
                                                                        ->where('t.tramite', 'APELACIÓN SEGUNDA SOLICITUD')
                                                                        ->exists();
                                                                @endphp
