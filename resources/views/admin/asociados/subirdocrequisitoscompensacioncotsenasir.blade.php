...
@endif
<h5>SUBIR REQUISITOS DE COMPENSACIÓN DE COTIZACIONES (SENASIR) DE:</h5>
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12">
                {!! Form::model($cliente, ['route' => ['admin.asociados.guardardocrequisitoscompensacioncotsenasir', $cliente], 'method' => 'PUT', 'files' => true]) !!}
...
@endif
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-7">
                                <label>REQUISITOS DE COMPENSACIÓN DE COTIZACIONES (SENASIR)</label>
                                <div class="card"> 
                                    <div class="card-body">
