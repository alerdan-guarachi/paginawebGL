                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ asset('/documentacionclientesbanco/' . $clientebanco->id . '/' . $documentacioncliente->document) }}" class="btn btn-verdocumentacion" data-url="{{ asset('/documentacionclientesbanco/' . $clientebanco->id . '/'  . $documentacioncliente->document) }}">
                            ...
                            <a href="{{ asset('/documentacionclientesbanco/' . $clientebanco->id . '/'  . $documentacioncliente->document) }}" class="btn btn-descargardocumentacion" download>
                        ...
                        <td>
                            ...
                            <a href="{{ asset('/documentacionclientesbanco/' . $clientebanco->id . '/'  . $documentacioncliente->image) }}" class="btn btn-verimagen" target="_blank">
                                <i class="fas fa-eye"></i>
                            </a>
                            @can('descargardocumentacion')
                            <a href="{{ asset('/documentacionclientesbanco/' . $clientebanco->id . '/'  . $documentacioncliente->image) }}" class="btn btn-descargarimagen" download>
                                <i class="fas fa-download"></i>
                            </a>
                            @endcan
                            @endif
                        ...
                        <td>
                            ...
                            <a href="{{ asset('/documentacionclientesbanco/' . $clientebanco->id . '/'  . $documentacioncliente->image2) }}" class="btn btn-verimagen" target="_blank">
                                <i class="fas fa-eye"></i>
                            </a>
                            @can('descargardocumentacion')
                            <a href="{{ asset('/documentacionclientesbanco/' . $clientebanco->id . '/'  . $documentacioncliente->image2) }}" class="btn btn-descargarimagen" download>
                                <i class="fas fa-download"></i>
                            </a>
                            @endcan
                            @endif
