...
<div class="card">
    <div class="card-body">
        {!! Form::model($asociado, ['route' => ['admin.asociados.guardarpreclienteita', $asociado], 'method' => 'POST', 'files' => true]) !!}
        {!! Form::hidden('users_id', auth()->user()->id) !!}
        {!! Form::hidden('usuarioregistro', auth()->user()->name) !!}
        {!! Form::hidden('idprecliente', $precliente->id) !!}
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('sucursal', $suc, old('sucursal', $precliente->sucursal ?? ''), ['class' => 'form-control', 'placeholder' => '']) !!}
                            @error('sucursal')
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('apepaterno', old('apepaterno', $precliente->apepaterno ?? ''), ['class' => 'form-control','id' => 'apepaterno','maxlength' => '45']) !!}
                            @error('apepaterno')
                                <small class="text-danger fas fa-exclamation-circle">
                                    {{$message}}
                                </small>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('apematerno', old('apematerno', $precliente->apematerno ?? ''), ['class' => 'form-control', 'id' => 'apematerno', 'placeholder' => '', 'maxlength' => '45']) !!}
                            @error('apematerno')
                                <small class="text-danger fas fa-exclamation-circle">
                                    {{$message}}
                                </small>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('nombres', old('nombres', $precliente->nombres ?? ''), ['class' => 'form-control', 'id' => 'nombres', 'placeholder' => '', 'maxlength' => '45']) !!}
                            @error('nombres')
                                <small class="text-danger fas fa-exclamation-circle">
                                    {{$message}}
                                </small>
                ...
                {!! Form::hidden('nombrecompleto', old('nombrecompleto', $precliente->nombrecompleto ?? ''), ['id' => 'nombrecompleto']) !!}
                <script>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('ci', old('ci', $precliente->ci ?? ''), ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'onkeypress' => 'return event.charCode >= 48 && event.charCode <= 57']) !!}
                            @error('ci')
                                <small class="text-danger fas fa-exclamation-circle">
                                    {{$message}}
                                </small>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('email', old('email', $precliente->email ?? ''), ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45']) !!}
                            @error('email')
                                <small class="text-danger fas fa-exclamation-circle">
                                    {{$message}}
                                </small>
                    ...
                    <div class="col-lg-5">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <select id="pais" class="form-control">
                                        ...
                                        <option value="591" selected>BOL</option>
                                ...
                                {!! Form::text('celular', old('celular', $precliente->celular ?? ''), ['id' => 'celular', 'class' => 'form-control', 'placeholder' => '', 'maxlength' => '25', 'onkeypress' => 'return event.charCode >= 48 && event.charCode <= 57']) !!}
                            </div>
                            @error('celular')
                                <small class="text-danger fas fa-exclamation-circle">
                                    {{$message}}
                        ...
                        <script>
                            ...
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                // 👉 AGREGAR CODIGO DE PAIS AL CARGAR LA PAGINA
                                if (paisSelect.value && celularInput.value) {
                                    if (!celularInput.value.startsWith(paisSelect.value)) {
                                        celularInput.value = paisSelect.value + celularInput.value;
                                    }
                                } else if (paisSelect.value && !celularInput.value) {
                                    celularInput.value = paisSelect.value;
                                }
