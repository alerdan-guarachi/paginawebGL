...
{{-- <a class="btn btn-sm float-right custom2-button"  data-toggle="modal" data-target="#ventanaModal">BATERIA CLIENTE</a> --}}
...
<h4>PROGRAMAR CLIENTE "{{$clienteauditoria->nombrecompleto}}"</h4>
@stop
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    @if($accionesCliente)
                    {!! Form::model($clienteauditoria, ['route' => ['admin.asociados.guardarprogramacionclienteauditoria', $clienteauditoria], 'method' => 'POST']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6" hidden>
                                <div class="form-group">
                                    ...
                                    {!! Form::text('telefono', null, ['class' => 'form-control', 'placeholder' => '', 'readonly' => true]) !!}
                                    @error('telefono')
                                        <small class="text-danger fas fa-exclamation-circle">
                                            {{$message}}
                                        </small>
                                                ...
                                                <div>
                                                    <?php 
                                                        ...
                                                        foreach($proveedores as $proveedor) {
                                                            ...
                                                            $optionLabel = $proveedor['proveedornombre'] . ' (' . $horario . ') (' . $proveedor['tiempoatencion'] . ') (' . $proveedor['accion'] . ') (' . $proveedor['area'] . ') (' . $proveedor['precio'] . ')';
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    {!! Form::label('fechaasignada', 'Fecha programada:') !!}
                                    {!! Form::date('fechaasignada', null, ['class' => 'form-control', 'min' => \Carbon\Carbon::now()->format('Y-m-d'), 'id' => 'fechaasignada']) !!}
                                    @error('fechaasignada')
                                        <small class="text-danger fas fa-exclamation-circle">
                                            {{ $message }}
                                        </small>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    {!! Form::label('horariodisponible', 'Horarios disponibles:') !!}
                                    {!! Form::select('horariodisponible'.$accion, [], null, ['class' => 'form-control horariodisponible no-bloquear', 'placeholder' => '', 'data-accion' => $accion, 'id' => 'horariosdisponibles', 'disabled']) !!}
                                    @error('horariodisponible')
                                        <small class="text-danger fas fa-exclamation-circle">
                                            {{ $message }}
                                        </small>
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    const fechaAsignada = document.getElementById('fechaasignada');
                                    const horariosDisponibles = document.getElementById('horariosdisponibles');
                            
                                    fechaAsignada.addEventListener('change', function() {
                                        if (fechaAsignada.value) {
                                            horariosDisponibles.removeAttribute('disabled');
                                        } else {
                                            horariosDisponibles.setAttribute('disabled', 'disabled');
                                        }
                                    });
                                });
                            </script>
