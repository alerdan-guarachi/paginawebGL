...
<a class="btn btn-sm float-right btn-subirrequisitos" href="{{ route('admin.asociados.subirdocrequisitosapelrecalsegsolicitud', $cliente) }}">SUBIR REQUISITOS</a>
<h5>DERIVACIÓN Y REQUISITOS DE APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD:</h5>
...
@section('content')
    <form id="pdfForm" action="{{ route('admin.asociados.descargarchecklistclienteita', $cliente) }}" method="POST" style="display: none;">
        ...
        <input type="hidden" name="tramitecliente" id="tramitecliente" value="APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD">
    </form>
</div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-4" style="margin-top: 55px;">
                ...
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="solrecaldictamen" value="solrecaldictamen" id="solrecaldictamen">
                    <label for="solrecaldictamen" style="min-height: 20px;">SOLICITUD RECALIF. DICTAMEN</label>
                </div>
            </div>
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <label for="anteriordictamen" style="min-height: 20px;">DICTAMEN O RESOLUCION</label>
                </div>
            </div>
        </div>
                        ...
                        <div class="card shadow-sm h-100" style="background-color: #fdf4e3;">
                            ...
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                {!! Form::open(['route' => 'generar.pdf.consentimiento', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
                                    ...
                                    {!! Form::hidden('tramite', 'APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD') !!}
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="modal-footer">
                                                <form id="formRecomendar" method="POST" action="{{ route('admin.asociados.recomendarestudioespecialidad') }}">
                                                    ...
                                                    <input type="hidden" name="tramiterecomendacion" value="APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD">
                                                            ...
                                                            @foreach($ultimosRegistros as $rec)
                                                                @php
                                                                    $existe = \DB::table('bateriasubclientes as b')
                                                                        ...
                                                                        ->where('t.tramite', 'APELACIÓN DE RECALIFICACIÓN SEGUNDA SOLICITUD')
                                                                        ->exists();
                                                                @endphp
