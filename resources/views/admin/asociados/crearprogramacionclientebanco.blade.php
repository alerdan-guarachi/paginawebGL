...
<a class="btn btn-sm float-right btn-crear" href="{{route('admin.asociados.reprogramacionclientebanco', $clientebanco)}}">REPROGRAMAR</a>
@endcan
<a class="btn btn-sm float-right btn-bateria" data-toggle="modal" data-target="#ventanaModal">PROGRAMACIONES DEL CLIENTE</a>
{{-- <a class="btn btn-sm float-right btn-crear" href="{{route('admin.asociados.estadoprogramacionclientebanco', $clientebanco)}}">PROGRAMACIONES</a> --}}
...
<div class="card">
    <div class="card-body">
        {!! Form::model($clientebanco, ['route' => ['admin.asociados.guardarprogramacionclientebanco', $clientebanco], 'method' => 'POST']) !!}
            <div class="row">
                @if($accionesCliente)
                    {!! Form::hidden('usuarioid', auth()->user()->id) !!}
                    {!! Form::hidden('usuarioregistro', auth()->user()->name) !!}
                    {!! Form::hidden('clientebancoid', $id) !!}
                    {!! Form::hidden('clientebanconombre', $clientebanco->nombrecompleto) !!}
                    <div class="col-lg-8">
