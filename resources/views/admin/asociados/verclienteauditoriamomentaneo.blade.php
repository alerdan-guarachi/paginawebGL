                                    ...
                                    <div class="col-md-12">
                                        <table style="width: 100%;">
                                            <tbody>
                                                ...
                                                @if(in_array($clienteauditoria->estadocivil, ['CASAD@', 'UNION LIBRE']))
                                                    <tr>
                                                        <th>Nombre Esp/Cony.</th>
                                                        <td>{{ $clienteauditoria->nombreespcon }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th>CI Esp/Cony.</th>
                                                        <td>{{ $clienteauditoria->ciespcon }}</td>
                                                    </tr>
                                                @endif
                                            </tbody>
                                        </table>
                ...
                <div class="modal-body">
                    <div style="background-color: #e9fbff;  border-radius: 40px;">
                        <div style="text-align: center;padding: 1.5px;">
                            <strong style="color: #26a1c0; font-size:20px;">EDITAR CAMPOS</strong>
                        </div>
                        <div class="row text-center">
                            @can('admin.asociados.editarclienteauditoria')
                            <div class="col-12 mb-3 d-flex justify-content-center align-items-center">
                                <a href="{{ route('admin.asociados.editarclienteauditoriamomentaneo', $clienteauditoria) }}" class="btn btn-etapa1 btn-icono btn-block" data-toggle="tooltip" data-placement="top" title="EDITAR">
                    ...
                    <div style="margin-top: 10px; background-color: #fff0e3;  border-radius: 40px;">
                        <div style="text-align: center; padding: 1.5px;">
                            <strong  style="color: #c47a35; font-size:20px;">PASAR A CLIENTE FIJO</strong>
                        </div>
                        <div class="row text-center">
                            @can('admin.asociados.editarclienteauditoria')
                            <div class="col-12 mb-3 d-flex justify-content-center align-items-center">
                                <a href="{{ route('admin.asociados.editarclienteauditoria', $clienteauditoria) }}" class="btn btn-otros btn-icono btn-block" data-toggle="tooltip" data-placement="top" title="ACTUALIZAR">
