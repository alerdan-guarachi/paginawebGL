...
@section('content_header')
    ...
    <h1>PROGRAMACIONES PENDIENTES DE CLIENTES COMUNES</h1>
@stop
            ...
            <nav class="navbar navbar-expand-lg float-right">
                <div class="container-fluid">
                    <div class="d-flex flex-wrap align-items-center">
                        <form action="{{ route('admin.asociados.buscarprogramacionpendientecomun', $asociado) }}"
                    ...
                    <tbody>
                        @foreach ($accionesPendientes as $accion)
                            <tr>
                                ...
                                <td class="align-middle">{{ $accion->ps_clientecomunnombre }}</td>
                                ...
                                <td class="align-middle" width="10px">
                                    <abbr title="Subir documentación">
                                        <a class="btn btn-sm btn-verprogramacion" href="{{ route('admin.asociados.crearprogramacionclientecomun', $accion->ps_clientecomunid) }}">
