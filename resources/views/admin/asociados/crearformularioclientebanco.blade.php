            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('motivoconsulta', $clientebanco->motivoconsulta, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        {!! Form::label('Ente gestor de salud:') !!}
                        {!! Form::text('entgestorsalud', $clientebanco->entgestorsalud, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('actividadlaboral', $clientebanco->actividadlaboral, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
            </div>
