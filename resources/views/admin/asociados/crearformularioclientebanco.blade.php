...
<h1>FICHA MEDICA DE "{{$clientebanco->nombrecompleto}}"</h1>
@stop
...
<div class="card">
    <div class="card-body">
        ...
        <div class="">
            <form action="{{ route('admin.asociados.generarpdfclientebanco', $clientebanco) }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            {!! Form::label('Empresa:') !!}
                            {!! Form::text('empresa', $clientebanco->empresa, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            {!! Form::label('Regional:') !!}
                            {!! Form::text('regional', $clientebanco->lugarnacimiento, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="form-group">
                            ...
                            {!! Form::text('nombrecompleto', $clientebanco->nombrecompleto, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            {!! Form::label('Código:') !!}
                            {!! Form::text('nombrecompleto', $clientebanco->id, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            {!! Form::label('Edad:') !!}
                            {!! Form::text('edad', $clientebanco->edad, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            {!! Form::label('Lugar de nacimiento:') !!}
                            {!! Form::text('lugarnacimiento', $clientebanco->lugarnacimiento, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('residencia', $clientebanco->lugarnacimiento, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            {!! Form::label('Grado de instrucción:') !!}
                            {!! Form::text('gradoinstruccion', $clientebanco->gradoinstruccion, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('telefono', $clientebanco->telefono, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            {!! Form::label('Direccion domiciliaria:') !!}
                            {!! Form::text('domicilio', $clientebanco->domicilio, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('motivoconsulta', $clientebanco->motivoconsulta, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '255']) !!}
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            {!! Form::label('Ente gestor de salud:') !!}
                            {!! Form::text('entgestorsalud', $clientebanco->entgestorsalud, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('ocupacion', $clientebanco->ocupacion, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            {!! Form::label('Actividad laboral:') !!}
                            {!! Form::text('actividadlaboral', $clientebanco->estadolaboral, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                </div>
