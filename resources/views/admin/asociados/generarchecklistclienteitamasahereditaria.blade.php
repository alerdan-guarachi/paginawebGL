...
<a class="btn btn-sm float-right btn-subirrequisitos" href="{{ route('admin.asociados.subirdocrequisitosmasahereditaria', $cliente) }}">SUBIR REQUISITOS</a>
<h5>REQUISITOS DE MASA HEREDITARIA:</h5>
...
@section('content')
    <form id="pdfForm" action="{{ route('admin.asociados.descargarchecklistclienteita', $cliente) }}" method="POST" style="display: none;">
        ...
        <input type="hidden" name="tramitecliente" id="tramitecliente" value="MASA HEREDITARIA">
    </form>
</div>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="form-group" style="margin-top: -10px;">
                    ...
                    <label for="cdefuncion" style="min-height: 20px;">CERTIFICADO DE DIFUNCION</label>
                </div>
            </div>
            <div class="col-md-4" style="margin-top: 55px;">
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="tdeclaherederos" value="tdeclaherederos" id="tdeclaherederos" checked>
                    <label for="tdeclaherederos" style="min-height: 20px;">TESTIMONIO DE DECLARATORIA DE HEREDEROS</label>
                </div>
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="cnacherederos" value="cnacherederos" id="cnacherederos" checked>
                    <label for="cnacherederos" style="min-height: 20px;">CERTIFICADO NACIMIENTO DECLARADOS HEREDEROS</label>
                </div>
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="cideclaherederos" value="cideclaherederos" id="cideclaherederos" checked>
                    <label for="cideclaherederos" style="min-height: 20px;">CARNET IDENTIDAD DECLARADOS HEREDEROS</label>
                </div>
            </div>
            {{-- <div class="col-md-4">
                ...
                @if (strtolower($genero) === 'femenino')
                    <div class="form-group" style="margin-top: -10px;">
                        <input type="checkbox" name="cnactreshijos" value="cnactreshijos" id="cnactreshijos" checked>
                        <label for="cnactreshijos" style="min-height: 20px;">CERTIFICADO NACIMIENTO DE 3 HIJOS</label>
                    </div>
                @endif
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="ctrabajoinsalubre" value="ctrabajoinsalubre" id="ctrabajoinsalubre" checked>
                    <label for="ctrabajoinsalubre" style="min-height: 20px;">CERTIFICADO TRABAJO INSALUBRE</label>
                </div>
                <script>
