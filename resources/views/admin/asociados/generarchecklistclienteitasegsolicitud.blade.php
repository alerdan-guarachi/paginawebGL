...
<h5>REQUISITOS DE SEGUNDA SOLICITUD:</h5>
<h3>{{$cliente->nombrecompleto}}</h3>
@stop

@section('content')
    <form id="pdfForm" action="{{ route('admin.asociados.descargarchecklistclienteitasegsolicitud', $cliente) }}" method="POST" style="display: none;">
        @csrf
