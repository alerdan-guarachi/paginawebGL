...
<a class="btn btn-sm float-right btn-subirrequisitos" href="{{ route('admin.asociados.subirdocrequisitosjubilacion', $cliente) }}">SUBIR REQUISITOS</a>
<h5>REQUISITOS DE JUBILACIÓN:</h5>
...
@section('content')
    <form id="pdfForm" action="{{ route('admin.asociados.descargarchecklistclienteita', $cliente) }}" method="POST" style="display: none;">
        ...
        <input type="hidden" name="tramitecliente" id="tramitecliente" value="JUBILACIÓN">
    </form>
</div>
    ...
    <div class="card-body">    
        <div class="row">
            ...
            <div class="col-md-4" style="margin-top: 55px;">
                ...
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="ccompcotsenasir" value="ccompcotsenasir" id="ccompcotsenasir" checked>
                    <label for="ccompcotsenasir" style="min-height: 20px;">CERTIFICADO COMPENZACION COTIZACIONES SENASIR</label>
                </div>
            </div>
            <div class="col-md-4">
