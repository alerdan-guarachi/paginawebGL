...
@endif
<h5>SUBIR REQUISITOS DE TERCERA SOLICITUD DE:</h5>
...
@endif
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-7">
                                <label>REQUISITOS DE TERCERA SOLICITUD</label>
                                <div class="card"> 
                                    <div class="card-body">
                                ...
                                <div class="card"> 
                                    <div class="card-body">
                                        <form id="pdfForm" action="{{ route('admin.asociados.descargarchecklistclienteita2', $cliente) }}" method="POST">
                                            ...
                                            <input type="hidden" name="tramitecliente" id="tramitecliente" value="TERCERA SOLICITUD">
                                            <div class="form-group">
