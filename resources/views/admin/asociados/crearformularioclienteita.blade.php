...
@endif
<h1>FICHA MEDICA DE "{{$cliente->nombrecompleto}}"</h1>
@stop
...
<div class="card">
    <div class="card-body">
        <h3 style="text-align: center; font-weight: bold;">FICHA GENERAL</h3>
        <div class="">
            <form action="{{ route('admin.asociados.generarpdfclienteita', $cliente) }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            {!! Form::label('Empresa:') !!}
                            {!! Form::text('empresa', $cliente->empresa, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            {!! Form::label('Regional:') !!}
                            {!! Form::text('regional', $cliente->lugarnacimiento, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="form-group">
                            ...
                            {!! Form::text('nombrecompleto', $cliente->nombrecompleto, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            {!! Form::label('Código:') !!}
                            {!! Form::text('nombrecompleto', $cliente->id, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            {!! Form::label('Edad:') !!}
                            {!! Form::text('edad', $cliente->edad, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            {!! Form::label('Lugar de nacimiento:') !!}
                            {!! Form::text('lugarnacimiento', $cliente->lugarnacimiento, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('residencia', $cliente->lugarnacimiento, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            {!! Form::label('Grado de instrucción:') !!}
                            {!! Form::text('gradoinstruccion', $cliente->gradoinstruccion, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('telefono', $cliente->telefono, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            {!! Form::label('Direccion domiciliaria:') !!}
                            {!! Form::text('domicilio', $cliente->domicilio, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('motivoconsulta', $cliente->motivoconsulta, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '255']) !!}
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            {!! Form::label('Ente gestor de salud:') !!}
                            {!! Form::text('entgestorsalud', $cliente->entgestorsalud, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('actividadlaboral', $cliente->estadolaboral, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                        </div>
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-guardarformulario">GUARDAR FICHA MÉDICA</button>
            </form>
        </div>
    </div>
</div>
