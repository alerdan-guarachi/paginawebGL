...
<a class="btn btn-sm float-right btn-subirrequisitos" href="{{ route('admin.asociados.subirdocrequisitospensionmuerte', $cliente) }}">SUBIR REQUISITOS</a>
<h5>REQUISITOS DE PENSIÓN POR MUERTE:</h5>
...
@section('content')
    <form id="pdfForm" action="{{ route('admin.asociados.descargarchecklistclienteita', $cliente) }}" method="POST" style="display: none;">
        ...
        <input type="hidden" name="tramitecliente" id="tramitecliente" value="PENSIÓN POR MUERTE">
    </form>
</div>
    ...
    <div class="card-body">    
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                @if ($numHijosMenores > 0 || $numHijosMenores !== null)
                    <div class="form-group" style="margin-top: -10px;">
                        <input type="checkbox" name="cestudioshijos" value="cestudioshijos" id="cestudioshijos" checked>
                        <label for="cestudioshijos" style="min-height: 20px;">CERTIFICADO ESTUDIOS HIJOS < 25</label>
                    </div>
                @endif
                <script>
