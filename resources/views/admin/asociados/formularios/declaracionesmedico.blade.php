        ...
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            {!! Form::text('apepaterno', $clientebanco->nombrecompleto, [
                                'class' => 'form-control',
                                'placeholder' => '',
                                'maxlength' => '45',
                                'readonly' => 'readonly',
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('ocupacion', $clientebanco->ocupacionprofesion, [
                                'class' => 'form-control',
                                'placeholder' => '',
                                'maxlength' => '45',
                                'readonly' => 'readonly',
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('fechanacimiento', $clientebanco->fechanacimiento, [
                                'class' => 'form-control',
                                'placeholder' => '',
                                'maxlength' => '45',
                                'readonly' => 'readonly',
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            {!! Form::label('Genero:') !!}
                            {!! Form::text('genero', $clientebanco->genero, [
                                'class' => 'form-control',
                                'placeholder' => '',
                                'maxlength' => '45',
                                'readonly' => 'readonly',
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('estadocivil', $clientebanco->estadocivil, [
                                'class' => 'form-control',
                                'placeholder' => '',
                                'maxlength' => '45',
                                'readonly' => 'readonly',
            ...
            {!! Form::open(['method' => 'POST', 'files' => true,]) !!}
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[1][respuesta]" value="si"
                                        id="rsi" onclick="mostrarFormulario01()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[1][respuesta]" value="no"
                                        id="rno" onclick="ocultarFormulario01()">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[1][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[1][direccionmedico]', null, [
                                                'class' => 'form-control',
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard01()"><i class="fas fa-plus"></i></button></abbr>
                                <abbr id="menosFormularioAbbr01" title="Menos Formulario" style="display: none;">
                                    <button type="button" class="btn btn-menos" onclick="ocultarSiguienteCard01()"><i
                                            class="fas fa-minus"></i></button></abbr>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[1][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[1][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="2">
                    ...
                    {!! Form::hidden(
                        'preguntas[2][pregunta_nombre]',
                        'Mareos, desmayos, convulsiones, cefaleas, torpeza al hablar, parálisis o ataque cerebral; enfermedades de tipo mental  o nerviosa',
                    ) !!}
                    {!! Form::hidden('preguntas[2][cliente_id]', $clientebanco->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                            <p>Mareos, desmayos, convulsiones, cefaleas, torpeza al hablar, parálisis o ataque cerebral;
                                enfermedades de tipo mental o nerviosa</p>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[2][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario02()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[2][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario02()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[2][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[2][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard02()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[2][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[2][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="3">
                    ...
                    {!! Form::hidden(
                        'preguntas[3][pregunta_nombre]',
                        'Dificultad al respirar, ronquera o tos persistente, hemóptisis, bronquitis, pleuresía, asma, efisema, tuberculosis o enfermedad respiratoria crónica',
                    ) !!}
                    {!! Form::hidden('preguntas[3][cliente_id]', $clientebanco->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                            <p>Dificultad al respirar, ronquera o tos persistente, hemóptisis, bronquitis, pleuresía, asma,
                                efisema, tuberculosis o enfermedad respiratoria crónica</p>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[3][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario03()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[3][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario03()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[3][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[3][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard03()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[3][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[3][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="4">
                    ...
                    {!! Form::hidden(
                        'preguntas[4][pregunta_nombre]',
                        'Dolor en el pecho, palpitaciones, hipertensión, fiebre reumática, soplo cardíaco, ataque cardíaco u otra enfermedad del sistema cardiovascular',
                    ) !!}
                    {!! Form::hidden('preguntas[4][cliente_id]', $clientebanco->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                            <p>Dolor en el pecho, palpitaciones, hipertensión, fiebre reumática, soplo cardíaco, ataque cardíaco
                                u otra enfermedad del sistema cardiovascular</p>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[4][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario04()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[4][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario04()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[4][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[4][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard04()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[4][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[4][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="5">
                    ...
                    {!! Form::hidden(
                        'preguntas[5][pregunta_nombre]',
                        'Ictericia, hemorragia intestinal, úlcera, hernia, apendicitis, colitis, diverticulitis, hemorroides, indigestión frecuente, o cualquier otra enfermedad del estómago, intestinos, hígado o vesícula',
                    ) !!}
                    {!! Form::hidden('preguntas[5][cliente_id]', $clientebanco->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                            <p>Ictericia, hemorragia intestinal, úlcera, hernia, apendicitis, colitis, diverticulitis,
                                hemorroides, indigestión frecuente, o cualquier otra enfermedad del estómago, intestinos, hígado
                                o vesícula</p>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[5][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario05()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[5][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario05()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[5][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[5][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard05()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[5][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[5][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="6">
                    ...
                    {!! Form::hidden(
                        'preguntas[6][pregunta_nombre]',
                        'Azúcar, albúmina, sangre o pus en la orina, enfermedad venérea, piedra u otra enfermedad de los riñones, vejiga, próstata o aparato reproductor',
                    ) !!}
                    {!! Form::hidden('preguntas[6][cliente_id]', $clientebanco->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                            <p>Azúcar, albúmina, sangre o pus en la orina, enfermedad venérea, piedra u otra enfermedad de los
                                riñones, vejiga, próstata o aparato reproductor</p>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[6][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario06()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[6][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario06()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[6][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[6][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard06()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[6][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[6][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="7">
                    ...
                    {!! Form::hidden(
                        'preguntas[7][pregunta_nombre]',
                        'Diabetes, enfermedad de la tiroides u otras glándulas endocrinas',
                    ) !!}
                    ...
                    <div class="row odd-row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[7][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario07()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[7][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario07()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[7][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[7][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard07()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[7][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[7][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="8">
                    ...
                    {!! Form::hidden(
                        'preguntas[8][pregunta_nombre]',
                        'Neuritis, ciática, reumatismo, artritis, gota, o cualquier otra enfermedad o defecto muscular óseo, incluyendo la columna, espalda y articulacione',
                    ) !!}
                    {!! Form::hidden('preguntas[8][cliente_id]', $clientebanco->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                            <p>Neuritis, ciática, reumatismo, artritis, gota, o cualquier otra enfermedad o defecto muscular
                                óseo, incluyendo la columna, espalda y articulacione</p>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[8][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario08()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[8][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario08()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[8][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[8][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard08()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[8][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[8][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="9">
                    ...
                    <div class="row odd-row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[9][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario09()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[9][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario09()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[9][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[9][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard09()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[9][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[9][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="10">
                    ...
                    {!! Form::hidden(
                        'preguntas[10][pregunta_nombre]',
                        'Enfermedad de la piel, ganglios linfáticos, quistes, tumores, cáncer',
                    ) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[10][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario010()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[10][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario010()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[10][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[10][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard010()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[10][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[10][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="11">
                    ...
                    <div class="row odd-row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[11][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario011()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[11][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario011()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[11][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[11][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard011()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[11][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[11][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[12][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario012()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[12][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario012()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="13">
                    ...
                    <div class="row odd-row">
                        <div class="col-lg-10">
                            <p>En la actualidad, fuma usted o durante los últimos 12 meses ha fumado cigarrillos, cigarros, pipa
                                o ha usado tabaco en cualquier forma</p>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[13][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario013()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[13][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario013()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="14">
                    ...
                    {!! Form::hidden(
                        'preguntas[14][pregunta_nombre]',
                        'Ha usado alguna vez drogas estupefacientes, menos que fuera bajo consejo médico',
                    ) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[14][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario014()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[14][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario014()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="15">
                    ...
                    {!! Form::hidden(
                        'preguntas[15][pregunta_nombre]',
                        'Está usted actualmente sometido a observación, tratamiento o medicación por alguna enfermedad',
                    ) !!}
                    ...
                    <div class="row odd-row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[15][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario015()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[15][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario015()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[15][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[15][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard015()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[15][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[15][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="16">
                    ...
                    {!! Form::hidden(
                        'preguntas[16][pregunta_nombre]',
                        'Tiene usted la intención de buscar consejo médico, tratamiento o hacer cualquier prueba médica',
                    ) !!}
                    {!! Form::hidden('preguntas[16][cliente_id]', $clientebanco->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                            <p>Tiene usted la intención de buscar consejo médico, tratamiento o hacer cualquier prueba médica
                            </p>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[16][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario016()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[16][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario016()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[16][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[16][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard016()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[16][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[16][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="17">
                    ...
                    {!! Form::hidden(
                        'preguntas[17][pregunta_nombre]',
                        'Ha tenido alguna enfermedad física o mental aparte de las ya mencionadas',
                    ) !!}
                    ...
                    <div class="row odd-row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[17][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario017()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[17][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario017()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[17][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[17][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard017()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[17][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[17][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="18">
                    ...
                    {!! Form::hidden(
                        'preguntas[18][pregunta_nombre]',
                        'Ha tenido alguna revisión, consulta, lesión u operación quirúrgica',
                    ) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[18][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario018()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[18][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario018()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[18][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[18][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard018()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[18][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[18][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="19">
                    ...
                    {!! Form::hidden(
                        'preguntas[19][pregunta_nombre]',
                        'Ha sido paciente en hospital, clínica, sanatorio u otros estable cimientos médicos',
                    ) !!}
                    ...
                    <div class="row odd-row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[19][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario019()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[19][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario019()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[19][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[19][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard019()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[19][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[19][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="20">
                    ...
                    {!! Form::hidden(
                        'preguntas[20][pregunta_nombre]',
                        'Ha sido sometido a electrocardiograma, rayos x u otro tipo de análisis',
                    ) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[20][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario020()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[20][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario020()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[20][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[20][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard020()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[20][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[20][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="21">
                    ...
                    {!! Form::hidden(
                        'preguntas[21][pregunta_nombre]',
                        'Se le ha aconsejado algún análisis, hospitalización u operación que no se hubiera realizado',
                    ) !!}
                    ...
                    <div class="row odd-row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[21][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario021()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[21][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario021()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[21][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[21][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard021()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[21][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[21][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="22">
                    ...
                    {!! Form::hidden(
                        'preguntas[22][pregunta_nombre]',
                        'Ha tenido aplazamiento, rechazo o reducción del servicio militar por deficiencia física o mental',
                    ) !!}
                    {!! Form::hidden('preguntas[22][cliente_id]', $clientebanco->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                            <p>Ha tenido aplazamiento, rechazo o reducción del servicio militar por deficiencia física o mental
                            </p>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[22][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario022()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[22][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario022()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[22][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[22][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard022()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[22][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[22][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="23">
                    ...
                    {!! Form::hidden(
                        'preguntas[23][pregunta_nombre]',
                        'Realiza Deportes u hobbies riesgosos como: Bombero, Piloto Civil, Andinismo, Carreras de Veleocidad, Alas Delta, Parapente, Paracaidismo, Buceo, Motociclismo, u otro que se considere peligroso',
                    ) !!}
                    {!! Form::hidden('preguntas[23][cliente_id]', $clientebanco->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                            <p>Realiza Deportes u hobbies riesgosos como: Bombero, Piloto Civil, Andinismo, Carreras de
                                Veleocidad, Alas Delta, Parapente, Paracaidismo, Buceo, Motociclismo, u otro que se considere
                                peligroso</p>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[23][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario023()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[23][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario023()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="24">
                    ...
                    {!! Form::hidden(
                        'preguntas[24][pregunta_nombre]',
                        'Ha solicitado o percibido alguna vez indemnizaciones por incapacidad de cualquier tipo',
                    ) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[24][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario024()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[24][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario024()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[24][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[24][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard024()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[24][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[24][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="25">
                    ...
                    <div class="row odd-row">
                        <div class="col-lg-10">
                            <p>Hay en su familia antecedentes de tuberculosis, diabetes, cáncer, hipertensión, enfermedad
                                sanguínea o renal, enfermedad mental o suicidio</p>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[25][respuesta]"
                                        value="si" id="rsi" onclick="mostrarFormulario025()">
                                    <label class="form-check-label" for="rsi">SI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="preguntas[25][respuesta]"
                                        value="no" id="rno" onclick="ocultarFormulario025()">
                                    <label class="form-check-label" for="rno">NO</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[25][gradorecuperacion]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[25][direccionmedico]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                                ...
                                <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                        onclick="mostrarSiguienteCard025()"><i class="fas fa-plus"></i></button></abbr>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[25][gradorecuperacion2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'GRADO DE RECUPERACIÓN',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('', '') !!}
                                            {!! Form::text('preguntas[25][direccionmedico2]', null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                            ]) !!}
                                        </div>
                ...
                <div class="Familiares">
                    <div class="section">
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                ...
                                <div class="form-group">
                                    <select name="familiares[padre][estado]" class="form-control estadosalud">
                                        <option value=""></option>
                            ...
                            <div class="col-lg-2 edadvi hidden">
                                ...
                                <div class="form-group">
                                    <input type="text" name="familiares[padre][edad_vivo]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-lg-2 edadfa hidden">
                                ...
                                <div class="form-group">
                                    <input type="text" name="familiares[padre][edad_fallecer]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-lg-3 causafa hidden">
                                ...
                                <div class="form-group">
                                    <input type="text" name="familiares[padre][causa_fallecimiento]"
                            ...
                            <div class="col-lg-3 obser hidden">
                                ...
                                <div class="form-group">
                                    <input type="text" name="familiares[padre][observaciones]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="section">
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <label>Estado de salud</label>
                                <div class="form-group">
                                    <select name="familiares[madre][estado]" class="form-control estadosalud">
                                        <option value=""></option>
                                        <option value="vivo">Vivo</option>
                                        <option value="fallecido">Fallecido</option>
                                    </select>
                            ...
                            <div class="col-lg-2 edadvi hidden">
                                <label>Edad vivo</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[madre][edad_vivo]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-lg-2 edadfa hidden">
                                <label>Edad al fallecer</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[madre][edad_fallecer]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-lg-3 causafa hidden">
                                <label>Causa de fallecimiento</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[madre][causa_fallecimiento]"
                                        class="form-control" disabled>
                                </div>
                            </div>
                            <div class="col-lg-3 obser hidden">
                                <label>Observaciones / Enfermedades</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[madre][observaciones]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="section">
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <label>Estado de salud</label>
                                <div class="form-group">
                                    <select name="familiares[hermanos][estado]" class="form-control estadosalud">
                                        <option value=""></option>
                                        <option value="vivo">Vivo</option>
                                        <option value="fallecido">Fallecido</option>
                                    </select>
                            ...
                            <div class="col-lg-2 edadvi hidden">
                                <label>Edad vivo</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[hermanos][edad_vivo]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-lg-2 edadfa hidden">
                                <label>Edad al fallecer</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[hermanos][edad_fallecer]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-lg-3 causafa hidden">
                                <label>Causa de fallecimiento</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[hermanos][causa_fallecimiento]"
                                        class="form-control" disabled>
                                </div>
                            </div>
                            <div class="col-lg-3 obser hidden">
                                <label>Observaciones / Enfermedades</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[hermanos][observaciones]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="section">
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <label>Estado de salud</label>
                                <div class="form-group">
                                    <select name="familiares[n_vivo][estado]" class="form-control estadosalud">
                                        <option value=""></option>
                                        <option value="vivo">Vivo</option>
                                        <option value="fallecido">Fallecido</option>
                                    </select>
                            ...
                            <div class="col-lg-2 edadvi hidden">
                                <label>Edad vivo</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[n_vivo][edad_vivo]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-lg-2 edadfa hidden">
                                <label>Edad al fallecer</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[n_vivo][edad_fallecer]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-lg-3 causafa hidden">
                                <label>Causa de fallecimiento</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[n_vivo][causa_fallecimiento]"
                                        class="form-control" disabled>
                                </div>
                            </div>
                            <div class="col-lg-3 obser hidden">
                                <label>Observaciones / Enfermedades</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[n_vivo][observaciones]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="section">
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <label>Estado de salud</label>
                                <div class="form-group">
                                    <select name="familiares[n_muerto][estado]" class="form-control estadosalud">
                                        <option value=""></option>
                                        <option value="vivo">Vivo</option>
                                        <option value="fallecido">Fallecido</option>
                                    </select>
                            ...
                            <div class="col-lg-2 edadvi hidden">
                                <label>Edad vivo</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[n_muerto][edad_vivo]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-lg-2 edadfa hidden">
                                <label>Edad al fallecer</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[n_muerto][edad_fallecer]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-lg-3 causafa hidden">
                                <label>Causa de fallecimiento</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[n_muerto][causa_fallecimiento]"
                                        class="form-control" disabled>
                                </div>
                            </div>
                            <div class="col-lg-3 obser hidden">
                                <label>Observaciones / Enfermedades</label>
                                <div class="form-group">
                                    <input type="text" name="familiares[n_muerto][observaciones]" class="form-control"
                                        disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="estatura" class="form-control" placeholder=""
                                        maxlength="45">
                    ...
                    <div class="26">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="preguntas[26][respuesta]"
                                            value="si" id="rsi" onclick="mostrarFormulario026()">
                                        <label class="form-check-label" for="rsi">SI</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="preguntas[26][respuesta]"
                                            value="no" id="rno" onclick="ocultarFormulario026()">
                                        <label class="form-check-label" for="rno">NO</label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[26][gradorecuperacion]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'GRADO DE RECUPERACIÓN',
                                                ]) !!}
                                            </div>
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[26][direccionmedico]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                                ]) !!}
                                            </div>
                                    ...
                                    <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                            onclick="mostrarSiguienteCard026()"><i class="fas fa-plus"></i></button></abbr>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[26][gradorecuperacion2]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'GRADO DE RECUPERACIÓN',
                                                ]) !!}
                                            </div>
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[26][direccionmedico2]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                                ]) !!}
                                            </div>
                    ...
                    @if ($clientebanco->genero === 'Femenino')
                        <div class="27">
                            ...
                            {!! Form::hidden(
                                'preguntas[27][pregunta_nombre]',
                                'Ha tenido alguna vez transtornos de la mestruación, pechos, aparato genital o alteraciones en el embarazo',
                            ) !!}
                            {!! Form::hidden('preguntas[27][cliente_id]', $clientebanco->id) !!}
                            <div class="row odd-row">
                                <div class="col-lg-10">
                                    <p>Ha tenido alguna vez transtornos de la mestruación, pechos, aparato genital o
                                        alteraciones en el embarazo</p>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="preguntas[27][respuesta]"
                                                value="si" id="rsi" onclick="mostrarFormulario027()">
                                            <label class="form-check-label" for="rsi">SI</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="preguntas[27][respuesta]"
                                                value="no" id="rno" onclick="ocultarFormulario027()">
                                            <label class="form-check-label" for="rno">NO</label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    {!! Form::label('', '') !!}
                                                    {!! Form::text('preguntas[27][gradorecuperacion]', null, [
                                                        'class' => 'form-control',
                                                        'placeholder' => 'GRADO DE RECUPERACIÓN',
                                                    ]) !!}
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    {!! Form::label('', '') !!}
                                                    {!! Form::text('preguntas[27][direccionmedico]', null, [
                                                        'class' => 'form-control',
                                                        'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                                    ]) !!}
                                                </div>
                                        ...
                                        <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                                onclick="mostrarSiguienteCard027()"><i
                                                    class="fas fa-plus"></i></button></abbr>
                                        <abbr id="menosFormularioAbbr027" title="Menos Formulario" style="display: none;">
                                            <button type="button" class="btn btn-menos"
                                                onclick="ocultarSiguienteCard027()">
                                                <i class="fas fa-minus"></i>
                                            </button>
                                        </abbr>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    {!! Form::label('', '') !!}
                                                    {!! Form::text('preguntas[27][gradorecuperacion2]', null, [
                                                        'class' => 'form-control',
                                                        'placeholder' => 'GRADO DE RECUPERACIÓN',
                                                    ]) !!}
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    {!! Form::label('', '') !!}
                                                    {!! Form::text('preguntas[27][direccionmedico2]', null, [
                                                        'class' => 'form-control',
                                                        'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                                    ]) !!}
                                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="preguntas[27][respuesta]"
                                                value="si" id="rsi" onclick="mostrarFormulario028()">
                                            <label class="form-check-label" for="rsi">SI</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="preguntas[27][respuesta]"
                                                value="no" id="rno" onclick="ocultarFormulario028()">
                                            <label class="form-check-label" for="rno">NO</label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    {!! Form::label('', '') !!}
                                                    {!! Form::text('preguntas[28][cuantosmeses]', null, [
                                                        'class' => 'form-control',
                    ...
                    <div class="29">
                        ...
                        <div class="row odd-row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="preguntas[29][respuesta]"
                                            value="si" id="rsi" onclick="mostrarFormulario029()">
                                        <label class="form-check-label" for="rsi">SI</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="preguntas[29][respuesta]"
                                            value="no" id="rno" onclick="ocultarFormulario029()">
                                        <label class="form-check-label" for="rno">NO</label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[29][detallescompletos]', null, [
                                                    'class' => 'form-control',
                    ...
                    <div class="30">
                        ...
                        {!! Form::hidden(
                            'preguntas[30][pregunta_nombre]',
                            'Ha recibido usted tratamiento o consejo médico en relación al SIDA o condiciones relacionadas con él, o en relación a enfermedades de transmisión sexual',
                        ) !!}
                        {!! Form::hidden('preguntas[30][cliente_id]', $clientebanco->id) !!}
                        <div class="row">
                            <div class="col-lg-10">
                                <p>Ha recibido usted tratamiento o consejo médico en relación al SIDA o condiciones relacionadas
                                    con él, o en relación a enfermedades de transmisión sexual</p>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="preguntas[30][respuesta]"
                                            value="si" id="rsi" onclick="mostrarFormulario030()">
                                        <label class="form-check-label" for="rsi">SI</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="preguntas[30][respuesta]"
                                            value="no" id="rno" onclick="ocultarFormulario030()">
                                        <label class="form-check-label" for="rno">NO</label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[30][gradorecuperacion]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'GRADO DE RECUPERACIÓN',
                                                ]) !!}
                                            </div>
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[30][direccionmedico]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                                ]) !!}
                                            </div>
                                    ...
                                    <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                            onclick="mostrarSiguienteCard030()"><i class="fas fa-plus"></i></button></abbr>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[30][gradorecuperacion2]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'GRADO DE RECUPERACIÓN',
                                                ]) !!}
                                            </div>
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[30][direccionmedico2]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                                ]) !!}
                                            </div>
                    ...
                    <div class="31">
                        ...
                        {!! Form::hidden(
                            'preguntas[31][pregunta_nombre]',
                            'Le han dicho que ha tenido SIDA o el Complejo Relacionado al SIDA',
                        ) !!}
                        ...
                        <div class="row odd-row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="preguntas[31][respuesta]"
                                            value="si" id="rsi" onclick="mostrarFormulario031()">
                                        <label class="form-check-label" for="rsi">SI</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="preguntas[31][respuesta]"
                                            value="no" id="rno" onclick="ocultarFormulario031()">
                                        <label class="form-check-label" for="rno">NO</label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[31][gradorecuperacion]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'GRADO DE RECUPERACIÓN',
                                                ]) !!}
                                            </div>
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[31][direccionmedico]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                                ]) !!}
                                            </div>
                                    ...
                                    <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                            onclick="mostrarSiguienteCard031()"><i class="fas fa-plus"></i></button></abbr>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[31][gradorecuperacion2]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'GRADO DE RECUPERACIÓN',
                                                ]) !!}
                                            </div>
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[31][direccionmedico2]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                                ]) !!}
                                            </div>
                    ...
                    <div class="32">
                        ...
                        {!! Form::hidden(
                            'preguntas[32][pregunta_nombre]',
                            'Ha tenido o le han informado que tiene prueba sanguíneas positivas para anticuerpos del virus del SIDA',
                        ) !!}
                        {!! Form::hidden('preguntas[32][cliente_id]', $clientebanco->id) !!}
                        <div class="row">
                            <div class="col-lg-10">
                                <p>Ha tenido o le han informado que tiene prueba sanguíneas positivas para anticuerpos del virus
                                    del SIDA</p>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="preguntas[32][respuesta]"
                                            value="si" id="rsi" onclick="mostrarFormulario032()">
                                        <label class="form-check-label" for="rsi">SI</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="preguntas[32][respuesta]"
                                            value="no" id="rno" onclick="ocultarFormulario032()">
                                        <label class="form-check-label" for="rno">NO</label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[32][gradorecuperacion]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'GRADO DE RECUPERACIÓN',
                                                ]) !!}
                                            </div>
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[32][direccionmedico]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                                ]) !!}
                                            </div>
                                    ...
                                    <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                            onclick="mostrarSiguienteCard032()"><i class="fas fa-plus"></i></button></abbr>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[32][gradorecuperacion2]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'GRADO DE RECUPERACIÓN',
                                                ]) !!}
                                            </div>
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[32][direccionmedico2]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                                ]) !!}
                                            </div>
                    ...
                    <div class="33">
                        ...
                        {!! Form::hidden(
                            'preguntas[33][pregunta_nombre]',
                            'Tiene usted alguno de estos síntomas sin explicación fatiga pérdida de peso, diarrea, ganglios linfáticos inflamados o extrañas lesiones en la piel',
                        ) !!}
                        {!! Form::hidden('preguntas[33][cliente_id]', $clientebanco->id) !!}
                        <div class="row odd-row">
                            <div class="col-lg-10">
                                <p>Tiene usted alguno de estos síntomas sin explicación fatiga pérdida de peso, diarrea,
                                    ganglios linfáticos inflamados o extrañas lesiones en la piel</p>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="preguntas[33][respuesta]"
                                            value="si" id="rsi" onclick="mostrarFormulario033()">
                                        <label class="form-check-label" for="rsi">SI</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="preguntas[33][respuesta]"
                                            value="no" id="rno" onclick="ocultarFormulario033()">
                                        <label class="form-check-label" for="rno">NO</label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[33][gradorecuperacion]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'GRADO DE RECUPERACIÓN',
                                                ]) !!}
                                            </div>
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[33][direccionmedico]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                                ]) !!}
                                            </div>
                                    ...
                                    <abbr title="Nuevo Formulario"><button type="button" class="btn btn-mas"
                                            onclick="mostrarSiguienteCard033()"><i class="fas fa-plus"></i></button></abbr>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[33][gradorecuperacion2]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'GRADO DE RECUPERACIÓN',
                                                ]) !!}
                                            </div>
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('', '') !!}
                                                {!! Form::text('preguntas[33][direccionmedico2]', null, [
                                                    'class' => 'form-control',
                                                    'placeholder' => 'DIRECCIÓN DEL MÉDICO',
                                                ]) !!}
                                            </div>
                    ...
                    <br>
                    <P>Confirmo que soy la persona arriba mencionada como Propuesto Asegurado y que las declaraciones y
                        respuestas precedentes, una vez debidamente comprobadas son completas, auténticas, correctamente
                        transcritas y forman parte de la solicitud de Seguro sobre mi vida hecha a Nacional Vida Seguros de
                        Personas S.A. Por la presente autorizo a todo médico, hospital, compañía de seguros u otra institución o
                        persona cualesquiera a que, dentro de los límites legales, faciliten a Nacional Vida Seguros de Personas
                        S.A. o su representante, información sobre mi estado de salud, historial médico y cualquier
                        hospitalización, recomendación, diagnóstico, tratamiento, enfermedad o dolencia. Una fotocopia de esta
                        autorización será asimismo válida</P>
                    <br>
                    <div class="Firmada">
                    ...
                    <div class="firm-container">
                        <div class="firm-column">
                            ...
                            <div class="firm-line">
                                <div class="title">
                                    <button type="button" onclick="document.getElementById('medico_signature').click()" title="SUBIR FIRMA" class="btn btn-success"><i class="fas fa-upload"></i></button>
                        ...
                        <div class="firm-column">
                            ...
                            <div class="firm-line">
                                <div class="title">
                                    ...
                                    <button type="button" onclick="document.getElementById('propuesto_signature').click()" title="SUBIR FIRMA" class="btn btn-success"><i class="fas fa-upload"></i></button>
                ...
                <div style="text-align: center; margin-bottom: 10px;">
                    ...
                    {!! Form::submit('GUARDAR DECLARACION JURADA', ['class' => 'btn btn-success', 'formaction' => route('admin.asociados.formularios.guardardeclaracion', $clientebanco), 'disabled' => true, 'id' => 'generate_pdf_button']) !!}
                </div>
            {!! Form::close() !!}
                <script>
