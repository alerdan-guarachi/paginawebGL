...
@endif
<h5>SUBIR REQUISITOS DE APELACIÓN DE:</h5>
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12">
                {!! Form::model($cliente, ['route' => ['admin.asociados.guardardocrequisitosapelacion', $cliente], 'method' => 'PUT', 'files' => true]) !!}
...
@endif
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <label>REQUISITOS DE APELACIÓN</label>
                                <div class="card"> 
                                    <div class="card-body">
                                ...
                                <div class="card"> 
                                    <div class="card-body">
                                        <form id="pdfForm" action="{{ route('admin.asociados.descargarchecklistclienteita2', $cliente) }}" method="POST">
                                            ...
                                            <input type="hidden" name="tramitecliente" id="tramitecliente" value="APELACIÓN">
                                            <div class="form-group">
