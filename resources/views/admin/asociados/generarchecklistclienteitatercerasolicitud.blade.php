...
<a class="btn btn-sm float-right btn-subirrequisitos" href="{{ route('admin.asociados.subirdocrequisitostercerasolicitud', $cliente) }}">SUBIR REQUISITOS</a>
<h5>DERIVACIÓN Y REQUISITOS DE TERCERA SOLICITUD:</h5>
...
@section('content')
    <form id="pdfForm" action="{{ route('admin.asociados.descargarchecklistclienteitatercerasolicitud', $cliente) }}" method="POST" style="display: none;">
        @csrf
                        ...
                        <div class="card shadow-sm h-100" style="background-color: #fdf4e3;">
                            ...
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                {!! Form::open(['route' => 'generar.pdf.consentimiento', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
                                    ...
                                    {!! Form::hidden('tramite', 'TERCERA SOLICITUD') !!}
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="modal-footer">
                                                <form id="formRecomendar" method="POST" action="{{ route('admin.asociados.recomendarestudioespecialidad') }}">
                                                    ...
                                                    <input type="hidden" name="tramiterecomendacion" value="TERCERA SOLICITUD">
                                                            ...
                                                            @foreach($ultimosRegistros as $rec)
                                                                @php
                                                                    $existe = \DB::table('bateriasubclientes as b')
                                                                        ...
                                                                        ->where('t.tramite', 'TERCERA SOLICITUD')
                                                                        ->exists();
                                                                @endphp
