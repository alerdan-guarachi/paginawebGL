...
<form id="pdfForm" action="{{ route('admin.asociados.descargarchecklistclienteita', $cliente) }}" method="POST" style="display: none;">
    ...
    <input type="hidden" name="tramitecliente" id="tramitecliente" value="INVALIDEZ">
</form>
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="margin-top: 55px;">
                ...
                @if (strtolower($estadoCivil) === 'union libre')
                    <div class="form-group" style="margin-top: -10px;">
                        <input type="checkbox" name="cunionlibre" value="cunionlibre" id="cunionlibre" >
                        <label for="cunionlibre" style="min-height: 20px;">CERTIFICADO DE UNIÓN LIBRE</label>
                    </div>
                    <div class="form-group" style="margin-top: -10px;">
                        <input type="checkbox" name="cnacimientounionlibre" value="cnacimientounionlibre" id="cnacimientounionlibre" >
                        <label for="cnacimientounionlibre" style="min-height: 20px;">CERTIFICADO NACIMIENTO DE UNIÓN LIBRE</label>
                    </div>
                    <div class="form-group" style="margin-top: -10px;">
                        <input type="checkbox" name="ciunionlibre" value="ciunionlibre" id="ciunionlibre" >
                        <label for="ciunionlibre" style="min-height: 20px;">CARNET IDENTIDAD DE UNIÓN LIBRE</label>
                    </div>
                @endif
                @if (strtolower($estadoCivil) === 'divorciad@')
                    <div class="form-group" style="margin-top: -10px;">
                        <input type="checkbox" name="cdivorcio" value="cdivorcio" id="cdivorcio" >
            ...
            <div class="col-md-4">
                ...
                @if (strtolower($estadoLaboral) === 'activo')
                    <div class="form-group">
                        <input type="checkbox" name="ctrabajo" value="ctrabajo" id="ctrabajo" >
                        <label for="ctrabajo" style="min-height: 20px;">CERTIFICADO DE TRABAJO</label>
                    </div>
                    <div class="form-group" style="margin-top: -10px;">
                        <input type="checkbox" name="boletapago" value="boletapago" id="boletapago" >
                ...
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="actdatos" value="actdatos" id="actdatos" >
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="modal-footer">
                                                <form id="formRecomendar" method="POST" action="{{ route('admin.asociados.recomendarestudioespecialidad') }}">
                                                    ...
                                                    <input type="hidden" name="tramiterecomendacion" value="INVALIDEZ">
