...
<body>
    <table>
        ...
        <tr>
            ...
            <td class="ancho" colspan="2">{{ $clienteauditoria->empresa }}</td>
            <th class="ancho">Regional</th>
            <td class="ancho" colspan="2">{{ $clienteauditoria->lugarnacimiento }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="ancho" colspan="4">{{ $clienteauditoria->nombrecompleto }}</td>
            <th class="ancho">Codigo</th>
            <td class="ancho">{{ $clienteauditoria->id }}</td>
        </tr>
        <tr>
            <th class="ancho">Genero</th>
            <td class="ancho">{{ $clienteauditoria->genero }}</td>
            <th class="ancho">Fecha de nac.</th>
            <td class="ancho">{{ $clienteauditoria->fechanacimiento }}</td>
            <th class="ancho">Edad</th>
            <td class="ancho">{{ $clienteauditoria->edad }}</td>
            <th class="ancho">Lugar de nac.</th>
            <td class="ancho">{{ $clienteauditoria->lugarnacimiento }}</td>
        </tr>
        <tr>
            <th class="ancho" colspan="2">Residencia</th>
            <td class="ancho" colspan="2">{{ $clienteauditoria->lugarnacimiento }}</td>
            <th class="ancho" colspan="2">Grado de instruccion</th>
            <td class="ancho" colspan="2">{{ $clienteauditoria->gradoinstruccion }}</td>
        </tr>
        <tr>
            <th class="ancho" colspan="2">Estado civil</th>
            <td class="ancho" colspan="2">{{ $clienteauditoria->estadocivil }}</td>
            <th class="ancho" colspan="2">Telefono del paciente</th>
            <td class="ancho" colspan="2">{{ $clienteauditoria->telefono }}</td>
        </tr>
        <tr>
            <th class="ancho" colspan="2">Cedula de identidad</th>
            <td class="ancho" colspan="2">{{ $clienteauditoria->ci }}</td>
            <th class="ancho" colspan="2">Motivo de consulta</th>
            <td class="ancho" colspan="2">{{  $clienteauditoria->motivoconsulta }}</td>
        </tr>
        <tr>
            <th class="ancho" colspan="2">Direccion domiciliaria</th>
            <td class="ancho" colspan="2">{{ $clienteauditoria->direccion }}</td>
            <th class="ancho" colspan="2">Profesion/Ocupacion</th>
            <td class="ancho" colspan="2">{{  $clienteauditoria->ocupacion }}</td>
        </tr>
        <tr>
            <th class="ancho" colspan="2">Ente gestor de salud</th>
            <td class="ancho" colspan="2">{{ $clienteauditoria->entgestorsalud }}</td>
            <th class="ancho" colspan="2">Actividad laboral</th>
            <td class="ancho" colspan="2">{{  $clienteauditoria->estadolaboral }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th class="ancho" colspan="2">Uso de lentes</th>
            <td class="ancho" colspan="2">{{ Session::get('usalentes') }}</td>
        </tr>
        <tr>
