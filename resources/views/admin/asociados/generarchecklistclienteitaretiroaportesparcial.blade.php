...
<a class="btn btn-sm float-right btn-subirrequisitos" href="{{ route('admin.asociados.subirdocrequisitosretiroaportesparcial', $cliente) }}">SUBIR REQUISITOS</a>
<h5>REQUISITOS DE RETIRO DE APORTES PARCIAL:</h5>
...
@section('content')
    <form id="pdfForm" action="{{ route('admin.asociados.descargarchecklistclienteita', $cliente) }}" method="POST" style="display: none;">
        ...
        <input type="hidden" name="tramitecliente" id="tramitecliente" value="RETIRO DE APORTES PARCIAL">
    </form>
</div>
    ...
    <div class="card-body">    
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group" style="margin-top: -10px;">
                    <input type="checkbox" name="contratojubilacion" value="contratojubilacion" id="contratojubilacion" checked>
