...
<a class="btn btn-sm float-right btn-regresar" href="{{ route('admin.asociados.verclienteauditoriamomentaneo', $clienteauditoria) }}">REGRESAR</a>
...
@endif
    <div class="card">
        <div class="card-body">
            <div class="row ">
                <div class="col-lg-12">
                    {!! Form::model($clienteauditoria, ['route' => ['admin.asociados.actualizarclienteauditoriamomentaneo', $clienteauditoria], 'method' => 'PUT']) !!}
