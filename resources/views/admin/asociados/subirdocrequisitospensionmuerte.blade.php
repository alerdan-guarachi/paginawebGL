...
@endif
<h5>SUBIR REQUISITOS DE PENSIÓN POR MUERTE DE:</h5>
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12">
                {!! Form::model($cliente, ['route' => ['admin.asociados.guardardocrequisitospensionmuerte', $cliente], 'method' => 'PUT', 'files' => true]) !!}
...
@endif
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-7">
                                <label>REQUISITOS DE PENSIÓN POR MUERTE</label>
                                <div class="card"> 
                                    <div class="card-body">
