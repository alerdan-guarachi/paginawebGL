...
<a class="btn btn-sm float-right btn-generarpdf" href="{{ route('admin.asociados.generarpdfprogramacionclientebanco', ['clientebanco' => $clientebanco, 'buscarpor' => $fechaSeleccionada]) }}">GENERAR PDF</a>
        ...
        <nav class="navbar navbar-expand-lg float-right">
            <div class="container-fluid">
                <div class="d-flex flex-wrap align-items-center">
                    <form action="{{ route('buscarprogramacionclientesbanco', $clientebanco) }}" method="get" class="form-inline">
                    ...
                    <tr>
                        ...
                        <td width="10px">
                            <abbr title="Recordar">
                                ...
                                @else 
                                    href="https://wa.me/{{ $clientebanco->celular }}?text={{ $mensajeCodificado }}" 
                                @endif>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['route' => ['admin.asociados.guardarestadoprogramacionclientebanco', $clientebanco], 'method' => 'POST']) !!}
                {!! Form::hidden('usuarioid', auth()->user()->id) !!}
                {!! Form::hidden('usuarioregistro', auth()->user()->name) !!}
                {!! Form::hidden('clientebancoid', $id) !!}
                {!! Form::hidden('clientebanconombre', $nombreclientebanco) !!}
                ...
                <div class="form-group" hidden>
                    ...
                    {!! Form::text('nombrecompleto', $clientebanco->nombrecompleto, ['id' => 'modalNombreCompleto', 'class' => 'form-control', 'readonly']) !!}
                </div>
                <div class="form-group">
