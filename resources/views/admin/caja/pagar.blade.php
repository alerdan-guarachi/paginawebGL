...
@section('content')
    <div class="container-fluid">
                    ...
                    <div class="search-options-container">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="form-check mb-0 mr-3">
                                ...
                                <label class="form-check-label" for="buscar_f_retrasadas">Buscar por Fechas
                                    Retrasadas</label>
                            </div>
                            <div class="form-check mb-0 mr-3">
                            ...
                            <div class="form-check mb-0">
                                <input type="checkbox" class="form-check-input" id="buscar_orden">
                                <label class="form-check-label" for="buscar_orden">Buscar por Orden</label>
                            </div>
                            <div class="form-check mb-0">
        ...
        <div class="totales-container">
            <div>Total Egresos: <span class="text-success font-weight-bold">14027.80</span></div>
