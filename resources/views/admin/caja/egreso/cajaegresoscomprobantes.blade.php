...
@else
    <div class="d-flex align-items-center justify-content-between mb-0">
        <div class="flex-grow-1">
            <h2 class="font-weight-bold">CAJA DE EGRESOS CON COMPROBANTES</h2>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ${registro.comprobante 
                                        ? `<a class="btn btn-sm btn-outline-secondary ver-comprobante-btn" data-archivo="${registro.comprobante}">VER</a>` 
                                        : 'Sin archivo'}
                                </td>
                                <td>
                                    ${registro.factura 
                                        ? `<a class="btn btn-sm btn-outline-secondary ver-factura-btn" data-archivo="${registro.factura}">VER</a>` 
                                        : 'Sin archivo'}
                                </td>
