...
@section('content_header')
    <div class="d-flex align-items-center justify-content-between mb-0">
        ...
        <a class="btn float-right btn-outline-secondary" data-toggle="modal" data-target="#cierresModal" style="margin-right: 10px;">
            CIERRES DE CAJA
        </a>
        ...
        <div class="table-responsive">
            <form id="cierreCajaForm" method="POST" action="{{ route('cierre.caja') }}">
                ...
                <table class="table table-bordered table-striped" style="background-color:#ffffff">
                    <thead>
                        <tr>
                            ...
                            <th>Comprob.</th>
                            <th>
                                <input type="checkbox" id="selectAllAprobarCierre"> Aprob. Cierre
                            </th>
                            <th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if ($registro->docrespaldoegreso)
                                        <a href="{{ asset('documentacioncaja/egresos/' . $registro->usuarioregistroid . '/' . $registro->docrespaldoegreso) }}" class="btn btn-sm btn-outline-success" target="_blank" title="VER RESPALDO"><i class="fas fa-eye"></i></a>
                                    @else
                                        <span class="badge badge-danger">VACIO</span>
                                    @endif
                                </td>
                ...
                <div class="mt-3 d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-outline-success aprobar-cierre-btn" name="accion" value="aprobar" id="aprobarCierreBtn">APROBAR CIERRE</button>
                    @endcan
                    @can('admin.caja.ingresos.cerrarcaja')
                    <button type="submit" class="btn btn-outline-danger cerrar-caja-btn" name="accion" value="cerrar" id="cerrarCajaBtn">CERRAR CAJA</button>
                    @endcan
                </div>
