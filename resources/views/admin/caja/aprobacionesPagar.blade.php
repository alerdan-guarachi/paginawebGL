...
@section('content')
    <div class="container-fluid">
        ...
        <div class="btn-group d-flex justify-content-between mb-3">
            <button class="btn btn-secondary" onclick="window.location='{{ route('admin.caja.pagar') }}'">Cuentas Pendientes</button>
            {{-- <button class="btn btn-secondary">Enviar Cuentas</button> --}}
            <button class="btn btn-secondary" onclick="window.location='{{ route('admin.caja.aprobacionesPagar') }}'">APROBACIONES DE CUENTAS</button>
        </div>
