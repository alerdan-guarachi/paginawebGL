            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('apepaterno', $cliente->nombres . ' ' . $cliente->apepaterno . ' ' . $cliente->apematerno, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('ocupacion', $cliente->ocupacion, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        {!! Form::label('Fecha de nacimiento:') !!}
                        {!! Form::text('fechanacimiento', $cliente->fechanacimiento, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        {!! Form::label('Genero:') !!}
                        {!! Form::text('genero', $cliente->genero, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('estadocivil', $cliente->estadocivil, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        {!! Form::label('CI:') !!}
                        {!! Form::text('ci', $cliente->ci, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '45', 'readonly' => 'readonly']) !!}
                    </div>
                </div>
            </div>
        </div>
...
@php
    ...
    "Apellido Paterno: " . strtoupper($cliente->apepaterno) . "\n" .
    "Apellido Materno: " . strtoupper($cliente->apematerno) . "\n" .
    "Ocupación: " . strtoupper($cliente->ocupacion) . "\n" .
    "Fecha de Nacimiento: " . strtoupper($cliente->fechanacimiento) . "\n" .
    "Género: " . strtoupper($cliente->genero) . "\n" .
    "Estado Civil: " . strtoupper($cliente->estadocivil) . "\n" .
    "CI: " . strtoupper($cliente->ci) . "\n\n";
...
<script>
    ...
    document.getElementById('TM').addEventListener('input', actualizarQR);
            ...
            {!! Form::open(['route' => 'admin.formularios.store', 'method' => 'POST']) !!}
                ...
                <div class="1">
                    ...
                    {!! Form::hidden('preguntas[1][cliente_id]', $cliente->id) !!}
                ...
                <div class="2">
                    ...
                    {!! Form::hidden('preguntas[2][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="3">
                    ...
                    {!! Form::hidden('preguntas[3][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="4">
                    ...
                    {!! Form::hidden('preguntas[4][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="5">
                    ...
                    {!! Form::hidden('preguntas[5][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="6">
                    ...
                    {!! Form::hidden('preguntas[6][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="7">
                    ...
                    {!! Form::hidden('preguntas[7][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="8">
                    ...
                    {!! Form::hidden('preguntas[8][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="9">
                    ...
                    {!! Form::hidden('preguntas[9][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="10">
                    ...
                    {!! Form::hidden('preguntas[10][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="11">
                    ...
                    {!! Form::hidden('preguntas[11][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="12">
                    ...
                    {!! Form::hidden('preguntas[12][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="13">
                    ...
                    {!! Form::hidden('preguntas[13][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="14">
                    ...
                    {!! Form::hidden('preguntas[14][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="15">
                    ...
                    {!! Form::hidden('preguntas[15][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="16">
                    ...
                    {!! Form::hidden('preguntas[16][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="17">
                    ...
                    {!! Form::hidden('preguntas[17][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="18">
                    ...
                    {!! Form::hidden('preguntas[18][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="19">
                    ...
                    {!! Form::hidden('preguntas[19][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="20">
                    ...
                    {!! Form::hidden('preguntas[20][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="21">
                    ...
                    {!! Form::hidden('preguntas[21][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="22">
                    ...
                    {!! Form::hidden('preguntas[22][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="23">
                    ...
                    {!! Form::hidden('preguntas[23][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="24">
                    ...
                    {!! Form::hidden('preguntas[24][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="25">
                    ...
                    {!! Form::hidden('preguntas[25][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="26">
                    ...
                    {!! Form::hidden('preguntas[26][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="27">
                    ...
                    {!! Form::hidden('preguntas[27][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="28">
                    ...
                    {!! Form::hidden('preguntas[28][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="29">
                    ...
                    {!! Form::hidden('preguntas[29][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="30">
                    ...
                    {!! Form::hidden('preguntas[30][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="31">
                    ...
                    {!! Form::hidden('preguntas[31][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
                ...
                <div class="32">
                    ...
                    {!! Form::hidden('preguntas[32][cliente_id]', $cliente->id) !!}
                    <div class="row">
                        <div class="col-lg-10">
                ...
                <div class="33">
                    ...
                    {!! Form::hidden('preguntas[33][cliente_id]', $cliente->id) !!}
                    <div class="row odd-row">
                        <div class="col-lg-10">
