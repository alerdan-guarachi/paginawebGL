...
@endif
    <div class="card">
        <div class="card-body">
            <div class="row ">
                <div class="col-lg-12">
                    {!! Form::open(['route' => 'admin.inventario.guardaractivofijo', 'method'=>'POST']) !!}
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-md-2 form-group">
                                ...
                                <input type="number" class="form-control" id="minimocantidad" name="minimocantidad">
                            </div> --}}
                            <div class="col-md-2 form-group">
