    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid justify-content-end">
            <div class="d-flex flex-wrap align-items-center">
                <form id="search-form" action="{{ route('buscarconsiliacionclientebanco') }}" method="get" class="form-inline">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('btn-mostrar-todo').addEventListener('click', function() {
                window.location.href = "{{ route('buscarconsiliacionclientebanco') }}";
            });
                                        ...
                                        @if (!$item['consiliacion'])
                                            <tr>
                                                ...
                                                <td>   
                                                        ...
                                                        href="{{ route('admin.ordenes.ordenesventa.create', ['clientebanco' => $item['clientebancoid']]) }}"
                                                        target="_blank"
